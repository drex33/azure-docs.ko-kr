...
description: 이 사양에서는 Azure Media Services용 조각화된 MP4 기반 라이브 스트리밍 수집에 대한 프로토콜 및 형식을 설명합니다. 이 문서에서는 매우 중복되고 강력한 라이브 수집 메커니즘을 구축하는 모범 사례도 다룹니다.
...
## <a name="1-conformance-notation"></a>1. 적합성 표기법
...
## <a name="11-special-types-of-ingestion-formats"></a>11. 특수한 유형의 수집 형식
