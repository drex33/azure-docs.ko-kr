---
title: Azure Portal을 사용하여 Windows VM 만들기 및 암호화
...
1. 새로 만들기 페이지의 인기에서 **Windows Server 2016 Datacenter** 를 선택합니다.
...
1. “관리” 탭을 선택하고 진단 스토리지 계정이 있는지 확인합니다. 스토리지 계정이 없는 경우 “새로 만들기”를 선택하고, 새 계정에 이름을 지정하고, “확인”을 선택합니다.
...
1. **암호화 설정** > **암호화할 디스크** 에서 **OS 및 데이터 디스크** 를 선택합니다.
    ...
    :::image type="content" source="../media/disk-encryption/portal-quickstart-disks-to-encryption.png" alt-text="OS 및 데이터 디스크를 보여주는 스크린샷.":::

1. **암호화 설정** 에서 **암호화를 위한 Key Vault 및 키 선택** 을 선택합니다.
1. **Azure Key Vault에서 키 선택** 화면에서 **새로 만들기** 를 선택합니다.

    :::image type="content" source="../media/disk-encryption/portal-qs-keyvault-create.png" alt-text="새로 만들기 옵션을 보여주는 스크린샷.":::
...
이 빠른 시작에서는 암호화 키에 사용된 Key Vault를 만들고, 가상 머신을 만들고, 암호화에 대해 가상 머신을 활성화했습니다.  
