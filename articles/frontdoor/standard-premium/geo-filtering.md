---
title: Azure Front Door Standard/Premium | 대한 도메인의 지역 필터링 Microsoft Docs
description: 이 문서에서는 Azure Front Door Standard/Premium 대한 지역 필터링 정책에 대해 알아봅니다.
services: frontdoor
documentationcenter: ''
author: duongau
editor: ''
...
ms.locfileid: "123441480"
---
# <a name="geo-filtering-on-a-domain-for-azure-front-door-standardpremium-preview"></a>Azure Front Door 표준/Premium 도메인에 대한 지역 필터링(미리 보기)
...
Azure Portal 사용하거나 빠른 시작 [템플릿](https://github.com/Azure/azure-quickstart-templates/tree/master/quickstarts/microsoft.network/front-door-standard-premium-geo-filtering)을 사용하여 [Front Door](../../web-application-firewall/afds/waf-front-door-create-portal.md) 대한 지역 필터링 정책을 구성할 수 있습니다.
...
- [지역 필터링 WAF 정책을 설정하는](../../web-application-firewall/afds/waf-front-door-create-portal.md) 방법을 알아봅니다.
