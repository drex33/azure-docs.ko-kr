...
로그에서 헌팅하는 동안 긴급하게 해결해야 하는 사항을 찾으면 쉽게 책갈피를 만들고 인시던트로 승격하거나 기존 인시던트에서 추가할 수 있습니다. 인시던트 에 대한 자세한 내용은 [Microsoft Sentinel을 사용하여 인시던트 조사를 참조하세요.](investigate-cases.md)
