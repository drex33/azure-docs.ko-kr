...
이 문서에서는 OSMF 및 OSMF 플러그 인에 대한 일반적인 작업 지식을 갖춘 것으로 가정합니다. OSMF에 대한 자세한 내용은 공식 OSMF 사이트에서 설명서를 참조하세요.
...
2. src를 부드러운 스트리밍 원본(예: http:\//devplatem.vo.msecnd.net/Sintel/Sintel_H264.ism/manifest)으로 설정 
