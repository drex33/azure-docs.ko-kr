...
이 샘플 XML에서는 해당 지역과 매핑된 지역 코드에 대한 인사이트를 제공합니다. 이러한 지역 코드를 사용하여 Recovery Services 자격 증명 모음의 프라이빗 엔드포인트에 대한 사용자 지정 DNS 영역을 만들고 추가합니다.

## <a name="mapping-details"></a>매핑 세부 정보
