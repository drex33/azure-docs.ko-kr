---
title: Azure Cosmos DB Table API에 대한 Azure CLI 샘플
...
| [서버리스 Azure Cosmos 계정 및 테이블 만들기](../scripts/cli/table/create.md?toc=%2fcli%2fazure%2ftoc.json)| Table API에 대한 서버리스 Azure Cosmos DB 계정 및 테이블을 만듭니다. |
