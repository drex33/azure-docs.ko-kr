...
ms.locfileid: "123539176"
---
# <a name="call-a-webhook-with-a-classic-metric-alert-in-azure-monitor"></a>Azure Monitor에서 클래식 메트릭 경고를 사용하여 웹후크 호출

> [!WARNING]
> 이 문서에서는 기존 클래식 메트릭 경고를 사용하는 방법을 설명합니다. 이제 Azure Monitor는 [최신 근 실시간 메트릭 경고 및 새 경고 환경](./alerts-overview.md)을 지원합니다. 클래식 경고는 퍼블릭 클라우드 사용자에 대해 [사용 중지됩니다.](./monitoring-classic-retirement.md) Azure Government 클라우드 및 Azure 중국 21Vianet에 대한 클래식 경고는 **2024년 2월 29일** 에 사용 중지됩니다.
>
