---
title: Azure PowerShell를 사용 하 여 통합 런타임 만들기
description: azure에서 ssis 패키지를 배포 하 고 실행할 수 있도록 Azure Data Factory에서 Azure PowerShell를 사용 하 여 azure ssis 통합 런타임을 만드는 방법에 대해 알아봅니다.
