---
title: Azure Cosmos DB는 SQL .NET Standard API, SDK 및 리소스
description: 릴리스 날짜, 사용 중지 날짜 및 Azure Cosmos DB .NET SDK의 각 버전 간 변경 내용을 포함하여 SQL API 및 .NET SDK에 대한 모든 것을 알아봅니다.
author: anfeldma-ms
