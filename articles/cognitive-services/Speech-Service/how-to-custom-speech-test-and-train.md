...
|-----------|-----------------|----------|-------------------|----------|
| [오디오만](#audio-data-for-testing) | 예<br>시각적 검사에 사용 | 5개 이상의 오디오 파일 | 예 | 해당 없음 |
...
데이터 집합을 만들고 업로드 하려면 [데이터 집합 만들기](https://centralus.dev.cognitive.microsoft.com/docs/services/speech-to-text-api-v3-0/operations/CreateDataset) 요청을 사용 합니다.
...
업로드 중에 Speech Studio에서 기존 프로젝트에 새 데이터 집합을 연결 하려면 [데이터 집합 만들기](https://centralus.dev.cognitive.microsoft.com/docs/services/speech-to-text-api-v3-0/operations/CreateDataset) 를 사용 하 고 다음 형식에 따라 요청 본문을 작성 합니다.
```json
{
  "kind": "Acoustic",
...
요소에 필요한 Project URL은 `project` [Get Projects](https://centralus.dev.cognitive.microsoft.com/docs/services/speech-to-text-api-v3-0/operations/GetProjects) 요청을 사용 하 여 가져올 수 있습니다.
...
발음 항목의 경우 [유니버설 전화 집합](phone-sets.md)에 대 한 설명을 참조 하세요.
