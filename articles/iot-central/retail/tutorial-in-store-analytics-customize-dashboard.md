...
1. Northwind 브랜드 이미지를 표시하는 이미지 타일에서 **구성** 을 선택합니다. 
    ...
    :::image type="content" source="media/tutorial-in-store-analytics-customize-dashboard/brand-image-edit.png" alt-text="Azure IoT Central 브랜드 이미지 편집.":::
...
1. 레이아웃 변경 내용을 확인합니다. 
    ...
    :::image type="content" source="media/tutorial-in-store-analytics-customize-dashboard/firmware-battery-tiles.png" alt-text="Azure IoT Central 펌웨어 배터리 타일.":::
...
이 섹션에서는 [Azure IoT Central에서 스토어 내 분석 애플리케이션 만들기](./tutorial-in-store-analytics-create-app.md) 자습서에서 추가한 RuuviTag 센서의 환경 원격 분석을 표시하는 두 개의 원격 분석 타일을 추가합니다. 
...
1. **결합** 을 선택합니다. 
    ...
    :::image type="content" source="media/tutorial-in-store-analytics-customize-dashboard/add-zone1-ruuvi.png" alt-text="Azure IoT Central RuuviTag 타일 1 추가.":::
...
1. **저장** 을 선택합니다. 대시보드에서 두 개의 새 타일에 영역 원격 분석이 표시됩니다.
    ...
    :::image type="content" source="media/tutorial-in-store-analytics-customize-dashboard/all-ruuvitag-tiles.png" alt-text="Azure IoT Central 모든 RuuviTag 타일.":::
...
1. **저장** 을 선택합니다.  업데이트된 대시보드에는 시뮬레이션된 선점 센서를 기반으로 하는 두 개의 체크 아웃 영역에 대한 수만 표시됩니다.
    ...
    :::image type="content" source="media/tutorial-in-store-analytics-customize-dashboard/people-traffic-two-lanes.png" alt-text="Azure IoT Central 사람 트래픽 2개 레인.":::
...
1. **저장** 을 선택합니다.  
    ...
    :::image type="content" source="media/tutorial-in-store-analytics-customize-dashboard/add-ruuvi-property-tiles.png" alt-text="Azure IoT Central RuuviTag 속성 타일.":::
...
1. 완료된 Contoso 대시보드를 확인합니다. 
    ...
    :::image type="content" source="media/tutorial-in-store-analytics-customize-dashboard/completed-dashboard.png" alt-text="Azure IoT Central 대시보드 사용자 지정 완료.":::
