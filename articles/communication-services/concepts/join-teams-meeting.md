...
ms.openlocfilehash: 16d35dbc8b7efcb4c1ae04ea78b9f354408aba0b
ms.sourcegitcommit: dcf3424d7149fceaea0340eb0657baa2c27882a5
ms.translationtype: MT
ms.contentlocale: ko-KR
ms.lasthandoff: 11/30/2021
ms.locfileid: "133266430"
---
...
Azure Communication Services sdk를 사용 하 여 Teams id를 사용할 수도 있습니다. 자세한 내용은 [여기](./teams-interop.md)를 참조하세요.

[개인 사용에 대 한 Teams](https://www.microsoft.com/microsoft-teams/teams-for-home)에 대해 상호 운용성을 사용 하도록 설정 되지 않았습니다.
...
Teams 익명 회의 참여와 마찬가지로 애플리케이션에 참여할 회의 링크가 있어야 합니다. 이 링크는 Graph API 또는 Microsoft Teams의 일정에서 가져올 수 있습니다. Teams에 표시 되는 byoi 사용자의 이름은 SDK를 호출 하는 통신 서비스를 통해 구성할 수 있으며, 사용자가 Azure Active Directory Teams를 사용 하 여 인증 되지 않았음을 알리기 위해 "외부"로 레이블이 지정 됩니다. 첫 번째 ACS 사용자가 Teams 회의에 조인 하면 Teams 클라이언트에서 일부 기능을 사용할 수 없다는 메시지를 표시 합니다. 참가자 중 한 명에 게 사용자 지정 클라이언트를 사용 하 고 있기 때문입니다.
...
- 통신 서비스 사용자는 Teams 채널에 대해 예약 된 Teams 모임에 참가 하 고 오디오 및 비디오를 사용할 수 있지만, 채널의 멤버가 아니므로 채팅 메시지를 보내거나 받을 수는 없습니다.
- 통신 서비스 사용자는 Teams 웹 세미나 조인할 수 있지만, 발표자 및 참석자 역할은 현재 적용 되지 않기 때문에, 통신 서비스 사용자는 화면 공유, 카메라 켜기/끄기 등의 참석자에 게 적합 하지 않은 작업을 수행 하거나 응용 프로그램에서 해당 작업에 대 한 UX를 제공 하는 경우 음소거를 해제할 수 있습니다.
...
- 반응,, 함께 모드, 브레이크 실 등의 기능은 사용자 Teams에만 사용할 수 있습니다.
- 통신 서비스 사용자는 모임에서 앱&폴링 또는 Q와 상호 작용할 수 없습니다.
