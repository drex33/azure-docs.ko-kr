...
|아랍어 | `ar`|  | ✅ |
|아스투리아스어 |`ast`|✅ | |
|아제르바이잔어 (라틴 문자) | `az` | ✅ 미리 보기 | |
|바스크어  |`eu`| ✅ | |
|벨로루시 (키릴 자모) | `be` |✅ 미리 보기 | |
|벨로루시어 (라틴 문자) | `be` |✅ 미리 보기 | |
|비슬라마어   |`bi`|✅ | |
...
|카친어(라틴어) | `kac` |✅ | |
|Kara-Kalpak(라틴어) | `kaa` | ✅ | |
|Kara-Kalpak(키릴자크) | `kaa-cyrl` | ✅ 미리 보기 | |
|Karachay-Balkar |`krc`|✅ 미리 보기 | |
|카슈비아어 | `csb` |✅ | |
|Kaakah(키릴 자식) |`kk-cyrl`|✅ 미리 보기 | |
