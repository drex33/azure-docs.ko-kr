...
다음 목록에는 2.1 버전의 현재 GA 언어 및 Form Recognizer 3.0 미리 보기 버전의 새 미리 보기가 포함되어 있습니다. 이러한 언어는 레이아웃 및 사용자 지정 모델에서 지원됩니다. 미리 보기 릴리스에는 현재 GA 언어에 대한 향상된 기능이 포함되어 있습니다.
...
다음 표에서는 Form Recognizer의 레이아웃 및 사용자 지정 모델 기능에서 지원하는 인쇄 언어를 보여줍니다.
