...
- 이 기능은 MFA(Multi-Factor Authentication) 등의 [조건부 액세스](../conditional-access/overview.md) 기능에서 원활하게 작동하여 사용자를 보호합니다.
...
- [빠른 시작](how-to-connect-pta-quick-start.md) - Azure AD 통과 인증을 시작하고 실행합니다.
...
- [FAQ(질문과 대답)](how-to-connect-pta-faq.yml)  - 질문과 대답을 다루고 있습니다.
