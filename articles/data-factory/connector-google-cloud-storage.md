...
### <a name="google-cloud-storage-as-a-source-type"></a>원본 유형으로 Google Cloud Storage
...
| 옵션 2: GCS 접두사<br>- 접두사 | 원본 GCS 파일을 필터링하기 위해 데이터 세트에 구성된 지정된 버킷의 GCS 키 이름에 대한 접두사입니다. 이름이 `bucket_in_dataset/this_prefix`로 시작하는 GCS 키가 선택됩니다. 와일드카드 필터보다 나은 성능을 제공하는 GCS의 서비스 필터를 활용합니다. | 예 |
