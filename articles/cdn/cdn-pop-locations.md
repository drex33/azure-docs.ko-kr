...
이 문서에는 Azure CDN(Content Delivery Network) 제품에 대해 지역별로 정렬된 POP(point-of-presence) 위치를 포함하는 최신 도시권이 나열되어 있습니다. 각 도시권은 둘 이상의 POP를 포함할 수 있습니다. 예를 들어 Microsoft의 Azure CDN 100개 도시 간에 118개의 POP가 있습니다. 
