---
title: Azure Cognitive Services 지원 및 도움말 옵션
description: Azure Cognitive Services와 통합되는 애플리케이션을 만들 때 질문 및 문제에 대한 도움과 지원을 얻는 방법입니다.
...
이제 막 Azure Cognitive Services의 기능을 탐색하기 시작했나요? 애플리케이션에 새로운 기능을 구현하는 경우를 가정해 볼 수 있습니다. 또는 서비스를 사용한 후 개선 방법에 대한 제안이 있나요? 다음은 Cognitive Services에 대한 지원을 받고, 최신 상태를 유지하고, 피드백을 제공하고, 버그를 보고할 수 있는 옵션입니다.
...
Microsoft 엔지니어, Azure MVP(가장 귀중한 전문가) 또는 전문가 커뮤니티의 기술 제품 관련 질문에 대한 빠르고 안정적인 답변을 얻으려면 Azure가 커뮤니티 지원을 위해 선호하는 대상인 [Microsoft Q&A](/answers/products/azure?product=all)에 참여하세요.
...
* [Metrics Advisor(미리 보기)](https://feedback.azure.com/d365community/forum/09041fae-0b25-ec11-b6e6-000d3a4f0858?c=6c8853b4-0b25-ec11-b6e6-000d3a4f0858)
