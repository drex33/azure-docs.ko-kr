...
description: Azure Resource Manager 템플릿 및 PowerShell 스크립팅을 사용하여 여러 Azure App Service 앱을 예측 가능한 방식과 단일 유닛으로 배포하는 방법에 대해 알아봅니다.
...
* [Azure 리소스 관리자 템플릿 언어](../azure-resource-manager/templates/syntax.md)
