---
title: CLI 스크립트 - Azure Database for MySQL - 유연한 서버에서 읽기 복제본 만들기 및 관리
...
ms.locfileid: "131844120"
---
# <a name="create-and-manage-read-replicas-in-an-azure-database-for-mysql---flexible-server-using-azure-cli"></a>Azure CLI를 사용하여 Azure Database for MySQL - 유연한 서버에서 읽기 복제본 만들기 및 관리
