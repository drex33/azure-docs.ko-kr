...
description: Azure Cosmos DB for Mongo API에 저장된 데이터와 관련된 문제를 해결하기 위해 진단 로그를 쿼리하는 방법에 대해 알아봅니다
services: cosmos-db
...
ms.locfileid: "113356692"
---
# <a name="troubleshoot-issues-with-advanced-diagnostics-queries-for-mongo-api"></a>Mongo API에 대한 고급 진단 쿼리 문제 해결
...
- 지정된 기간의 제한된 요청(statusCode = 429 또는 16500) 
...
- 특정 시간 창에서 시간 초과된 요청(statusCode = 50) 
