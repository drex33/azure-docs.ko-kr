...
description: Azure Event Grid를 사용하면 Blob Storage 이벤트를 구독하고, 이벤트를 트리거하고, 결과를 볼 수 있습니다. Azure PowerShell을 사용하면 스토리지 이벤트를 웹 엔드포인트로 라우팅할 수 있습니다.
author: normesta
ms.author: normesta
...
토픽을 구독하여 Event Grid에 추적하려는 이벤트를 알립니다. 다음 예제에서는 사용자가 만든 스토리지 계정을 구독하고 웹앱의 URL을 이벤트 알림의 엔드포인트로 전달합니다. 웹앱에 대한 엔드포인트는 접미사 `/api/updates/`를 포함해야 합니다.
