...
- **공격 분석:** 공격 진행 중에 5분 단위로 세부 보고서를 가져오고, 공격이 종료된 후에는 전체 요약을 가져옵니다. 공격 중에 거의 실시간으로 모니터링할 수 있도록 완화 흐름 로그를 [Microsoft Sentinel](../sentinel/data-connectors-reference.md#azure-ddos-protection) 또는 오프라인 SIEM(보안 정보 및 이벤트 관리) 시스템으로 스트리밍합니다.
...
* [학습 모듈: Azure DDoS Protection 소개](/learn/modules/introduction-azure-ddos-protection/)
