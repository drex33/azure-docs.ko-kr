...
> [!IMPORTANT]
> 대량 실행기 라이브러리는 현재 [서버리스](serverless.md) 계정에서 지원되지 않습니다. .NET에서는 V3 버전의 SDK에서 사용할 수 있는 [대량 지원](https://devblogs.microsoft.com/cosmosdb/introducing-bulk-support-in-the-net-sdk/)을 사용하는 것이 좋습니다.
...
## <a name="how-does-the-bulk-executor-operate"></a>대량 실행기의 작동 방식 
...
대량 실행기 라이브러리는 컬렉션에 할당된 처리량을 최대로 활용합니다. 각 Azure Cosmos DB 파티션 키 범위에 대해  [AIMD 스타일 정체 제어 메커니즘](https://tools.ietf.org/html/rfc5681)을 사용하여 속도 제한 및 제한 시간을 효율적으로 처리합니다. 
