...
ms.locfileid: "132529342"
---
# <a name="suppress-alerts-from-microsoft-defender-for-cloud"></a>클라우드용 Microsoft Defender에서 경고 표시 안 함
...
|----|:----|
|릴리스 상태:|GA(일반 공급)|
|가격 책정:|Free<br>(대부분의 보안 경고는 [향상된 보안 기능에서만](enable-enhanced-security.md)사용할 수 있습니다.)|
