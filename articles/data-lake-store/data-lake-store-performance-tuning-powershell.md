...
description: Azure Data Lake Storage Gen1에서 Azure PowerShell을 사용할 때 성능을 향상하는 방법에 대한 팁입니다.
author: normesta
...
이 문서에서는 PowerShell을 사용하여 Data Lake Storage Gen1에서 작업하는 동안 더 나은 성능을 얻을 수 있도록 조정 가능한 속성을 설명합니다.
...
## <a name="how-to-determine-property-values"></a>속성 값을 확인하는 방법
