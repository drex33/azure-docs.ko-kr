---
title: 대칭 키를 사용하여 Windows IoT Edge 디바이스 만들기 및 프로비전 - Azure IoT Edge | Microsoft Docs
description: 대칭 키로 수동 프로비저닝을 사용하여 IoT Hub 단일 Windows IoT Edge 디바이스 만들기 및 프로비전
author: kgremban
...
ms.locfileid: "131853361"
---
# <a name="create-and-provision-an-iot-edge-device-on-windows-using-symmetric-keys"></a>대칭 키를 사용하여 Windows IoT Edge 디바이스 만들기 및 프로비전

[!INCLUDE [iot-edge-version-201806](../../includes/iot-edge-version-201806.md)]

이 문서에서는 Windows IoT Edge 디바이스를 등록하고 프로비전하는 엔드 투 엔드 지침을 제공합니다.
...
>
>Windows Linux용 Azure IoT Edge를 사용하려는 경우 [해당하는 방법 가이드의](how-to-provision-single-device-linux-on-windows-symmetric.md)단계를 따르면 됩니다.
...
이 문서에서는 대칭 키를 인증 방법으로 사용하는 방법을 다룹니다. X.509 인증서를 사용하려면 [X.509 인증서를 사용하여 Windows IoT Edge 디바이스 만들기 및 프로비저닝을 참조하세요.](how-to-provision-single-device-windows-x509.md)

> [!NOTE]
> 설정할 디바이스가 많고 각 디바이스를 수동으로 프로비전하지 않으려는 경우 다음 문서 중 하나를 사용하여 IoT Edge IoT Hub 디바이스 프로비저닝 서비스에서 작동하는 방법을 알아봅니다.
>
> * [X.509 인증서를 사용하여 대규모로 IoT Edge 디바이스 만들기 및 프로비전](how-to-provision-devices-at-scale-windows-x509.md)
> * [TPM을 사용하여 대규모로 IoT Edge 디바이스 만들기 및 프로비전](how-to-provision-devices-at-scale-windows-tpm.md)
> * [대칭 키를 사용하여 대규모로 IoT Edge 디바이스 만들기 및 프로비전](how-to-provision-devices-at-scale-windows-symmetric.md)
