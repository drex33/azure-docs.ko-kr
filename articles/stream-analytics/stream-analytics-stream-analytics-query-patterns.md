...
**DATEDIFF** 는 두 개의 DateTime 필드 간에 시간 차이를 비교하고 반환하는 날짜 관련 함수입니다. 자세한 내용은 [날짜 함수](/stream-analytics-query/date-and-time-functions-azure-stream-analytics)를 참조하세요.
...
자세한 내용은 [JavaScript](./stream-analytics-javascript-user-defined-functions.md) 및 [C#](./stream-analytics-edge-csharp-udf.md)을 참조하세요.
