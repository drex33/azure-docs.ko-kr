---
title: '빠른 시작: 의료 분야 Text Analytics REST API 및 클라이언트 라이브러리 사용'
titleSuffix: Azure Cognitive Services
description: 이 빠른 시작을 사용하여 의료 분야 Text Analytics 사용을 시작합니다.
...
이 문서를 사용하여 클라이언트 라이브러리 및 REST API를 사용하여 의료 분야 Text Analytics를 시작합니다. 다음 단계에 따라 텍스트 마이닝을 위한 예제 코드를 사용해 봅니다.
