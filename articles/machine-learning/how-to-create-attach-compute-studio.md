...
[위 단계](#portal-create)를 수행하여 컴퓨팅 인스턴스를 만듭니다.  그런 다음, 양식을 다음과 같이 작성합니다.

:::image type="content" source="media/concept-compute-instance/create-compute-instance.png" alt-text="새 컴퓨팅 인스턴스 만들기":::
...
|SSH 액세스 사용/사용 안 함     |   SSH 액세스는 기본적으로 사용하지 않도록 설정되어 있습니다.  SSH 액세스는 생성되면 변경될 수 없습니다. [VS Code 원격](how-to-set-up-vs-code-remote.md)을 사용하여 대화형으로 디버깅하려면 액세스를 사용하도록 설정해야 합니다.   |
|고급 설정     |  선택 사항입니다. 가상 네트워크를 구성합니다. **리소스 그룹**, **가상 네트워크** 및 **서브넷** 을 지정하여 Azure VNet(Azure Virtual Network) 내에 컴퓨팅 인스턴스를 만듭니다. 자세한 내용은 VNet의 [네트워크 요구 사항](./how-to-secure-training-vnet.md)을 참조하세요.  또한 고급 설정을 사용하여 [설치 스크립트](how-to-create-manage-compute-instance.md#setup-script)를 지정합니다. |

### <a name="compute-clusters"></a><a name="amlcompute"></a> 컴퓨팅 클러스터
