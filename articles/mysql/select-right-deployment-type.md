...
| 온라인 스토리지 크기 조정 | 지원 여부| 지원 여부| 지원되지 않음|
| 자동 스토리지 크기 조정 | 지원 여부| 지원 여부| 지원되지 않음|
| 추가 IOP 크기 조정 | 지원되지 않음| 지원됨| 지원되지 않음|
...
| 운영 체제 패치| 자동  | 사용자 지정 유지 관리 기간 제어로 자동 | 최종 사용자가 관리 |
| MySQL 패치     | 자동  | 사용자 지정 유지 관리 기간 제어로 자동 | 최종 사용자가 관리 |
| 고가용성 | 단일 가용성 영역 내 기본 제공 HA| 가용성 영역 내 및 가용성 영역 간 기본 제공 HA | 클러스터링, 복제 등을 사용하여 사용자 지정 관리|
| 영역 중복 | 지원되지 않음 | 지원 여부 | 지원 여부|
| 영역 배치 | 지원되지 않음 | 지원 여부 | 지원 여부|
| 하이브리드 시나리오 | [데이터 내부 복제](./concepts-data-in-replication.md)에서 지원됨| [데이터 내부 복제](./flexible-server/concepts-data-in-replication.md)에서 지원됨 | 최종 사용자가 관리 |
| 읽기 복제본 | 지원됨(최대 5개의 복제본)| 지원됨(최대 10개의 복제본)| 최종 사용자가 관리 |
| Backup | 7-35일 보존으로 자동화 | 1-35일 보존으로 자동화 | 최종 사용자가 관리 |
| 데이터베이스 작업 모니터링 | 지원 여부 | 지원 여부 | 최종 사용자가 관리 |
| 재해 복구 | 지역 중복 백업 스토리지 및 지역 간 읽기 복제본으로 지원 | 제공 예정| 복제 기술로 사용자 지정 관리 |
| Query Performance Insight | 지원 여부 | 미리 보기에서 사용할 수 없음| 최종 사용자가 관리 |
| 예약 인스턴스 가격 책정 | 지원 여부 | 제공 예정 | 지원 여부 |
| Azure AD 인증 | 지원 여부 | 미리 보기에서 사용할 수 없음 | 지원되지 않음|
| 미사용 데이터 암호화 | 고객 관리형 키로 지원됨 | 서비스 관리형 키로 지원됨 | 지원되지 않음|
