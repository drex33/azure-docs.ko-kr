...
ms.date: 03/14/2019
ms.author: jeedes
ms.openlocfilehash: 88c7141d446d03a5e7b2926826af109768ec6409
ms.sourcegitcommit: 0770a7d91278043a83ccc597af25934854605e8b
ms.translationtype: HT
ms.contentlocale: ko-KR
ms.lasthandoff: 09/13/2021
ms.locfileid: "124826153"
---
...
* PerformanceCentre에서 **SP** 시작 SSO를 지원합니다.
...
4. 검색 상자에 **PerformanceCentre** 를 입력하고 결과 패널에서 **PerformanceCentre** 를 선택한 후 **추가** 단추를 클릭하여 애플리케이션을 추가합니다.

     ![결과 목록의 PerformanceCentre](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성 및 테스트

이 섹션에서는 **Britta Simon** 이라는 테스트 사용자를 기반으로 PerformanceCentre에서 Azure AD Single Sign-On을 구성하고 테스트합니다.
Single Sign-On이 작동하려면 Azure AD 사용자와 PerformanceCentre의 관련 사용자 간에 연결 관계를 설정해야 합니다.

PerformanceCentre에서 Azure AD Single Sign-on을 구성하고 테스트하려면 다음 구성 요소를 완료해야 합니다.

1. **[Azure AD Single Sign-On 구성](#configure-azure-ad-single-sign-on)** - 사용자가 이 기능을 사용할 수 있도록 합니다.
2. **[PerformanceCentre Single Sign-On 구성](#configure-performancecentre-single-sign-on)** - 애플리케이션 쪽에서 Single Sign-On 설정을 구성합니다.
3. **[Azure AD 테스트 사용자 만들기](#create-an-azure-ad-test-user)** - Britta Simon으로 Azure AD Single Sign-On을 테스트하는 데 사용합니다.
4. **[Azure AD 테스트 사용자 할당](#assign-the-azure-ad-test-user)** - Britta Simon이 Azure AD Single Sign-on을 사용할 수 있도록 합니다.
5. **[PerformanceCentre 테스트 사용자 만들기](#create-performancecentre-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 PerformanceCentre에 만듭니다.
...
1. [Azure Portal](https://portal.azure.com/)의 **PerformanceCentre** 애플리케이션 통합 페이지에서 **Single Sign-On** 을 선택합니다.
...
4. **기본 SAML 구성** 섹션에서 다음 단계를 수행합니다.
    ...
    ![PerformanceCentre 도메인 및 URL Single Sign-On 정보](common/sp-identifier.png)

    a. **로그온 URL** 텍스트 상자에서 `http://<companyname>.performancecentre.com/saml/SSO` 패턴을 사용하는 URL을 입력합니다.
...
6. **PerformanceCentre 설정** 섹션에서 요구 사항에 따라 적절한 URL을 복사합니다.
...
### <a name="configure-performancecentre-single-sign-on"></a>PerformanceCentre Single Sign-on 구성
...
1. Azure Portal에서 **엔터프라이즈 애플리케이션**, **모든 애플리케이션**, **PerformanceCentre** 를 차례로 선택합니다.

    ![엔터프라이즈 애플리케이션 블레이드](common/enterprise-applications.png)

2. 애플리케이션 목록에서 **PerformanceCentre** 를 선택합니다.

    ![애플리케이션 목록의 PerformanceCentre 링크](common/all-applications.png)
...
### <a name="create-performancecentre-test-user"></a>PerformanceCentre 테스트 사용자 만들기
...
액세스 패널에서 PerformanceCentre 타일을 클릭하면 SSO를 설정한 PerformanceCentre에 자동으로 로그인됩니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510)를 참조하세요.
