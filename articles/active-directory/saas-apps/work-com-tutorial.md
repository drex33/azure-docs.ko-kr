...
3. 왼쪽 탐색창의 **관리** 섹션에서 **도메인 관리** 를 클릭해 관련된 섹션을 확장한 다음 **내 도메인** 을 클릭해 **내 도메인** 페이지를 엽니다. 
    ...
    ![스크린샷은 관리 창에서 도메인 관리를 선택한 내 도메인을 보여줍니다.](./media/work-com-tutorial/ic767825.png "내 도메인")
...
10. Work.com 클래식 포털의 왼쪽 탐색창에서 **도메인 관리** 를 클릭해 관련된 섹션을 확장한 다음 **내 도메인** 을 클릭해 **내 도메인** 페이지를 엽니다. 
    ...
    ![스크린샷은 도메인 관리에서 선택한 내 도메인을 보여줍니다.](./media/work-com-tutorial/ic794115.png "내 도메인")

11. **내 도메인** 페이지의 **로그인 페이지 브랜딩** 섹션에서 **편집** 을 클릭합니다.
    
    ![스크린샷은 편집을 선택할 수 있는 로그인 페이지 브랜딩 섹션을 보여줍니다.](./media/work-com-tutorial/ic767826.png "로그인 페이지 브랜딩")

12. **로그인 페이지 브랜딩** 페이지의 **인증 서비스** 섹션에 **SAML SSO 설정** 이름이 표시됩니다. 이름을 선택하고 **저장** 을 클릭합니다.
    
    ![스크린샷은 설정 이름(PPE)을 선택할 수 있는 로그인 페이지 브랜딩을 보여줍니다.](./media/work-com-tutorial/ic784366.png "로그인 페이지 브랜딩")
