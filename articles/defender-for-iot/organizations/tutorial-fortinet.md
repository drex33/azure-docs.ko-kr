...
1. FortiGate 전달 규칙을 구성하려면 다음 매개 변수를 설정합니다.
    ...
    | **들어오는 인터페이스** | 수신 인터페이스 포트를 입력합니다. |
    | **나가는 인터페이스** | 송신 인터페이스 포트를 입력합니다. |
...
이 자습서에서는 Fortinet 통합을 시작하는 방법을 알아보았습니다. 계속하여 [Palo Alto 통합](./tutorial-palo-alto.md)에 대해 알아보세요.
