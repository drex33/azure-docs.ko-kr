...
ms.locfileid: "128659800"
---
# <a name="how-to-protect-private-dns-zones-and-records"></a>프라이빗 DNS 영역 및 레코드 보호 방법

[!INCLUDE [updated-for-az](../../includes/updated-for-az.md)]

프라이빗 DNS 영역 및 레코드는 중요한 리소스입니다. DNS 영역 또는 단일 DNS 레코드를 삭제하면 서비스 중단이 발생할 수 있습니다. 따라서 DNS 영역 및 레코드를 무단 변경하거나 실수로 변경하지 않아야 합니다.
...
Azure RBAC(역할 기반 액세스 제어)를 사용하면 Azure 사용자, 그룹 및 리소스에 대해 세분화된 액세스 관리가 가능합니다. Azure RBAC를 사용하면 사용자에게 필요한 액세스 수준을 부여할 수 있습니다. Azure RBAC를 사용하여 액세스를 관리하는 방법은 [Azure RBAC(Role Based Access Control)란?](../role-based-access-control/overview.md)을 참조하세요.
...
:::image type="content" source="./media/dns-protect-private-zones-recordsets/resource-group-rbac.png" alt-text="프라이빗 DNS 리소스 그룹에 대한 RBAC 스크린샷":::
...
:::image type="content" source="./media/dns-protect-private-zones-recordsets/zone-rbac.png" alt-text="프라이빗 DNS 영역에 대한 RBAC 스크린샷":::
...
:::image type="content" source="./media/dns-protect-private-zones-recordsets/record-set-rbac-1.png" alt-text="프라이빗 DNS 레코드 모음에 대한 RBAC 스크린샷":::

:::image type="content" source="./media/dns-protect-private-zones-recordsets/record-set-rbac-2.png" alt-text="프라이빗 DNS 레코드 세트의 역할 할당 스크린샷":::
...
:::image type="content" source="./media/dns-protect-private-zones-recordsets/zone-locks.png" alt-text="프라이빗 DNS 영역 잠금 스크린샷":::
