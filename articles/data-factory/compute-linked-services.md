...
| [ML Studio(클래식)](#azure-machine-learning-studio-classic-linked-service) | [ML Studio(classic) 작업: Batch Execution 및 리소스 업데이트](transform-data-using-machine-learning.md) |
...
Azure Machine Learning studio (클래식) 연결 된 서비스를 만들어 Machine Learning studio (클래식) 일괄 처리 점수 매기기 끝점을 data factory 또는 Synapse 작업 영역에 등록 합니다.
