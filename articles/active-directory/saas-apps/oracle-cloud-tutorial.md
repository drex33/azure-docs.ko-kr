...
* Oracle Cloud Infrastructure Console은 [**자동** 사용자 프로비저닝 및 프로비저닝 해제](oracle-cloud-infrastructure-console-provisioning-tutorial.md)(권장)를 지원합니다.
...
Oracle Cloud Infrastructure Console을 구성한 후에는 세션 제어를 적용하여 조직의 중요한 데이터의 반출 및 침입을 실시간으로 보호할 수 있습니다. 세션 제어는 조건부 액세스에서 확장됩니다. [Microsoft Defender for Cloud Apps를 사용하여 세션 제어를 적용하는 방법을 알아봅니다](/cloud-app-security/proxy-deployment-aad).
