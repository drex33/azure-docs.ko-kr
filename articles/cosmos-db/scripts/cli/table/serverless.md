---
title: Azure Cosmos DB용 Table API 서버리스 계정 및 테이블 만들기
description: Azure Cosmos DB용 Table API 서버리스 계정 및 테이블 만들기
author: markjbrown
ms.author: mjbrown
...
ms.locfileid: "132730514"
---
# <a name="create-an-azure-cosmos-table-api-serverless-account-and-table-using-azure-cli"></a>Azure CLI를 사용하여 Azure Cosmos Table API 서버리스 계정 및 테이블 만들기
