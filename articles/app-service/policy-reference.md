...
ms.openlocfilehash: 693ff8d602e97c9b344b1cf9868f736c77b9f79f
ms.sourcegitcommit: e8b229b3ef22068c5e7cd294785532e144b7a45a
ms.translationtype: MT
ms.contentlocale: ko-KR
ms.lasthandoff: 09/04/2021
ms.locfileid: "123474086"
---
# <a name="azure-policy-built-in-definitions-for-azure-app-service"></a>Azure App Service에 대한 Azure Policy 기본 제공 정의

이 페이지는 Azure App Service에 대한 [Azure Policy](../governance/policy/overview.md) 기본 제공 정책 정의의 인덱스입니다. 다른 서비스에 대한 추가 Azure Policy 기본 제공 기능은 [Azure Policy 기본 제공 정의](../governance/policy/samples/built-in-policies.md)를 참조하세요.
