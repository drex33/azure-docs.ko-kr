...
ms.date: 11/03/2021
ms.topic: how-to
ms.openlocfilehash: 2f99ecd5db11707741f497e0550045d4cf36c175
ms.sourcegitcommit: 01b678462a4a390c30463c525432ffbbbe0195cf
ms.translationtype: MT
ms.contentlocale: ko-KR
ms.lasthandoff: 11/23/2021
ms.locfileid: "132953675"
---
...
> [!TIP]
> 배포를 시작 하기 전에이 문서의 모든 정보를 검토 합니다. 

## <a name="deployment-steps"></a>배포 단계

Azure Arc 사용 데이터 서비스를 사용 하려면 다음 작업을 완료 해야 합니다.

1. 배포 계획

   이 문서의 세부 정보는 계획을 안내 합니다.

1. [클라이언트 도구를 설치](install-client-tools.md)합니다.
1. Kubernetes 클러스터에 액세스 합니다.

   데모, 테스트 및 유효성 검사를 위해 Azure Kubernetes 서비스 클러스터를 사용할 수 있습니다. 클러스터를 만들려면 [AKS에서 클러스터 만들기의](create-aks-cluster-data-controller.md)단계를 수행 합니다.

1. [직접 연결 모드 (필수 구성 요소)에서 Azure Arc 데이터 컨트롤러를 만듭니다](create-data-controller-direct-prerequisites.md).

   데이터 컨트롤러를 만드는 다른 방법은 [다음 단계](#next-steps)아래의 링크를 참조 하세요.

1. 데이터 서비스를 만듭니다.

   예를 들어 [azure Arc에서 azure SQL 관리 되는 인스턴스를 만듭니다](create-sql-managed-instance.md).

1. Azure Data Studio를 사용 하 여 커넥트 합니다.
...
- **연결 모드**: azure Arc 사용 데이터 서비스 환경에서 azure로의 연결 수준을 결정 합니다. 선택한 연결 모드에 따라 배포 방법에 대 한 옵션이 결정 됩니다. 자세한 내용은 [연결 모드 및 요구 사항](./connectivity.md)을 참조 하세요.
