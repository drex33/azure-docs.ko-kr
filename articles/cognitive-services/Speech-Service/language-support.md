...
ms.openlocfilehash: b5136be6e319129766dd307030ed197671725ba9
ms.sourcegitcommit: 5c1cd21464e8165b16eb8d63ab31ab7b1a8f3675
ms.translationtype: MT
ms.contentlocale: ko-KR
ms.lasthandoff: 11/29/2021
ms.locfileid: "133206766"
---
...
정확도를 향상시키기 위해 **오디오 + 인간 레이블이** 지정된 대본, 일반 **텍스트,** 구조적 **텍스트** 및 발음을 업로드하여 일부 언어 및 기준 모델 버전에 사용자 지정을 사용할 수 **있습니다.** 기본적으로 일반 텍스트 사용자 지정은 사용 가능한 모든 기준 모델에 대해 지원됩니다. 사용자 지정에 대한 자세한 내용은 [Custom Speech 시작](./custom-speech-overview.md)을 참조하세요.
...
|------------------------------------|--------|---------------------------------------------------|-------------------------------|--------------------------|
| 아랍어(알제리아)                   | `ar-DZ` | 일반 텍스트                                   |                           |                          |
| 아랍어(바레인), 최신 표준  | `ar-BH` | 일반 텍스트                                   |                           |                          |
| 아랍어(이집트)                     | `ar-EG` | 일반 텍스트                                   | 예                          |                          |
| 아랍어(이라크)                      | `ar-IQ` | 일반 텍스트                                   |                           |                          |
| 아랍어(이스라엘)                    | `ar-IL` | 일반 텍스트                                   |                           |                          |
| 아랍어(요르단)                    | `ar-JO` | 일반 텍스트                                   |                           |                          |
| 아랍어(쿠웨이트)                    | `ar-KW` | 일반 텍스트                                   |                           |                          |
| 아랍어(레바논)                   | `ar-LB` | 일반 텍스트                                   |                           |                          |
| 아랍어(리비아)                     | `ar-LY` | 일반 텍스트                                   |                           |                          |
| 아랍어(모로코)                   | `ar-MA` | 일반 텍스트                                   |                           |                          |
| 아랍어(오만)                      | `ar-OM` | 일반 텍스트                                   |                           |                          |
| 아랍어(카타르)                     | `ar-QA` | 일반 텍스트                                   |                           |                          |
| 아랍어(사우디아라비아)              | `ar-SA` | 일반 텍스트                                   |                           |                          |
| 아랍어(팔레스타인 자치 정부)     | `ar-PS` | 일반 텍스트                                   |                           |                          |
| 아랍어(시리아)                     | `ar-SY` | 일반 텍스트                                   |                           |                          |
| 아랍어(튀니지)                   | `ar-TN` | 일반 텍스트                                   |                           |                          |
| 아랍어(아랍에미리트)      | `ar-AE` | 일반 텍스트                                   |                           |                          |
| 아랍어(예멘)                     | `ar-YE` | 일반 텍스트                                   |                           |                          |
| 불가리아어(불가리아)               | `bg-BG` | 일반 텍스트                                   |                           |                          |
| 카탈로니아어(스페인)                    | `ca-ES` | 일반 텍스트<br>발음                  | 예                          |                          |
| 중국어(광둥어, 번체)   | `zh-HK` | 일반 텍스트                 |        예                   |                          |
| 중국어(북경어, 간체)     | `zh-CN` | 일반 텍스트                 |     예                      | 예                         |
| 중국어(대만어)       | `zh-TW` | 일반 텍스트                 |           예                |                          |
| 크로아티아어(크로아티아)                 | `hr-HR` | 일반 텍스트<br>발음                  |                           |                          |
| 체코어(체코)             | `cs-CZ` | 일반 텍스트<br>발음                  |                           |                          |
| 덴마크어(덴마크)                   | `da-DK` | 일반 텍스트<br>발음                  | 예                          |                          |
| 네덜란드어(네덜란드)                | `nl-NL` | 일반 텍스트<br>발음|    예                       |                          |
| 영어(오스트레일리아)                | `en-AU` | 일반 텍스트<br>발음| 예                          |                          |
| 영어(캐나다)                   | `en-CA` | 일반 텍스트<br>발음| 예                          |                          |
| 영어(가나)                    | `en-GH` | 일반 텍스트<br>발음                  |                           |                          |
| 영어(홍콩)                | `en-HK` | 일반 텍스트<br>발음                  |                           |                          |
| 영어(인도)                    | `en-IN` | 일반 텍스트<br>구조적 텍스트(20210907)<br>발음 |                          |                          |
| 영어(아일랜드)                  | `en-IE` | 일반 텍스트<br>발음                  |                           |                          |
| 영어 (케냐)                    | `en-KE` | 일반 텍스트<br>발음                  |                           |                          |
| 영어(뉴질랜드)              | `en-NZ` | 일반 텍스트<br>발음 |                          |                          |
| 영어(나이지리아)                  | `en-NG` | 일반 텍스트<br>발음                  |                           |                          |
| 영어(필리핀)              | `en-PH` | 일반 텍스트<br>발음                  |                           |                          |
| 영어(싱가포르)                | `en-SG` | 일반 텍스트<br>발음                  |                           |                          |
| 영어(남아프리카)             | `en-ZA` | 일반 텍스트<br>발음                  |                           |                          |
| 영어(탄자니아)                 | `en-TZ` | 일반 텍스트<br>발음                  |                           |                          |
| 영어(영국)           | `en-GB` | 오디오(20201019)<br>일반 텍스트<br>구조적 텍스트 (20210906)<br>발음| 예                          | 예                         |
| 영어(미국)            | `en-US` | 오디오(20201019, 20210223)<br>일반 텍스트<br>구조적 텍스트 (20211012)<br>발음| 예                          | 예                         |
| 에스토니아어(에스토니아)                  | `et-EE` | 일반 텍스트<br>발음                  |                           |                          |
| 필리핀어(필리핀)             | `fil-PH`| 일반 텍스트<br>발음                  |                           |                          |
| 핀란드어(핀란드)                  | `fi-FI` | 일반 텍스트<br>발음                  |     예                      |                          |
| 프랑스어(캐나다)                    | `fr-CA` | 오디오(20201015)<br>일반 텍스트<br>구조적 텍스트 (20210908)<br>발음|     예                      |                          |
| 프랑스어(프랑스)                    | `fr-FR` | 오디오(20201015)<br>일반 텍스트<br>구조적 텍스트 (20210908)<br>발음|      예                     |                          |
| 프랑스어(스위스)               | `fr-CH` | 일반 텍스트<br>발음                  |                           |                          |
| 독일어(오스트리아)                   | `de-AT` | 일반 텍스트<br>발음                  |                           |                          |
| 독일어(스위스)               | `de-CH` | 일반 텍스트<br>발음                  |                           |                          |
| 독일어(독일)                   | `de-DE` | 오디오 (20201127)<br>일반 텍스트<br>구조적 텍스트 (20210831)<br>발음|  예                         |                          |
| 그리스어(그리스)                     | `el-GR` | 일반 텍스트                                   |  예                         |                          |
| 구자라트어(인도)                  | `gu-IN` | 일반 텍스트                                   |                           |                          |
| 히브리어(이스라엘)                    | `he-IL` | 일반 텍스트                                   |                           |                          |
| 힌디어(인도)                      | `hi-IN` | 일반 텍스트                 |     예                      |                          |
| 헝가리어(헝가리)                | `hu-HU` | 일반 텍스트<br>발음                  |                           |                          |
| 인도네시아어(인도네시아)             | `id-ID` | 일반 텍스트<br>발음                  |                           |                          |
| 아일랜드어(아일랜드)                    | `ga-IE` | 일반 텍스트<br>발음                  |                           |                          |
| 이탈리아어(이탈리아)                    | `it-IT` | 오디오(20201016)<br>일반 텍스트<br>발음|      예                     |                          |
| 일본어(일본)                   | `ja-JP` | 일반 텍스트                                   |      예                     |                          |
| 카나다어 (인도)                   | `kn-IN` | 일반 텍스트                                   |                           |                          |
| 한국어(한국)                     | `ko-KR` | 오디오(20201015)<br>일반 텍스트                 |      예                     |                          |
| 라트비아어(라트비아)                   | `lv-LV` | 일반 텍스트<br>발음                  |                           |                          |
| 리투아니아어(리투아니아)             | `lt-LT` | 일반 텍스트<br>발음                  |                           |                          |
| 말레이어(말레이시아)                   | `ms-MY` | 일반 텍스트                                   |                           |                          |
| 몰타어(몰타)                    | `mt-MT` | 일반 텍스트                                   |                           |                          |
| 마라티어(인도)                    | `mr-IN` | 일반 텍스트                                   |                           |                          |
| 노르웨이어(복말)(노르웨이)         | `nb-NO` | 일반 텍스트                                   |     예                      |                          |
| 페르시아어(이란)                     | `fa-IR` | 일반 텍스트                                   |                           |                          |
| 폴란드어(폴란드)                    | `pl-PL` | 일반 텍스트<br>발음                  |       예                    |                          |
| 포르투갈어(브라질)                | `pt-BR` | 오디오(20201015)<br>일반 텍스트<br>발음|          예                 |                          |
| 포르투갈어(포르투갈)              | `pt-PT` | 일반 텍스트<br>발음                  |             예              |                          |
| 루마니아어(루마니아)                 | `ro-RO` | 일반 텍스트<br>발음                  |  예                         |                          |
| 러시아어(러시아)                   | `ru-RU` | 일반 텍스트                 |                예           |                          |
| 슬로바키아어(슬로바키아)                  | `sk-SK` | 일반 텍스트<br>발음                  |                           |                          |
| 슬로베니아어(슬로베니아)               | `sl-SI` | 일반 텍스트<br>발음                  |                           |                          |
| 스페인어(아르헨티나)                | `es-AR` | 일반 텍스트<br>발음                  |                           |                          |
| 스페인어(볼리비아)                  | `es-BO` | 일반 텍스트<br>발음                  |                           |                          |
| 스페인어(칠레)                    | `es-CL` | 일반 텍스트<br>발음                  |                           |                          |
| 스페인어(콜롬비아)                 | `es-CO` | 일반 텍스트<br>발음                  |                           |                          |
| 스페인어(코스타리카)               | `es-CR` | 일반 텍스트<br>발음                  |                           |                          |
| 스페인어(쿠바)                     | `es-CU` | 일반 텍스트<br>발음                  |                           |                          |
| 스페인어(도미니카 공화국)       | `es-DO` | 일반 텍스트<br>발음                  |                           |                          |
| 스페인어(에콰도르)                  | `es-EC` | 일반 텍스트<br>발음                  |                           |                          |
| 스페인어(엘살바도르)              | `es-SV` | 일반 텍스트<br>발음                  |                           |                          |
| 스페인어(적도 기니)        | `es-GQ` | 일반 텍스트                                   |                           |                          |
| 스페인어(과테말라)                | `es-GT` | 일반 텍스트<br>발음                  |                           |                          |
| 스페인어(온두라스)                 | `es-HN` | 일반 텍스트<br>발음                  |                           |                          |
| 스페인어(멕시코)                   | `es-MX` | 일반 텍스트<br>구조적 텍스트 (20210908)<br>발음|    예                       |                          |
| 스페인어(니카라과)                | `es-NI` | 일반 텍스트<br>발음                  |                           |                          |
| 스페인어(파나마)                   | `es-PA` | 일반 텍스트<br>발음                  |                           |                          |
| 스페인어(파라과이)                 | `es-PY` | 일반 텍스트<br>발음                  |                           |                          |
| 스페인어(페루)                     | `es-PE` | 일반 텍스트<br>발음                  |                           |                          |
| 스페인어(푸에르토리코)              | `es-PR` | 일반 텍스트<br>발음                  |                           |                          |
| 스페인어(스페인)                    | `es-ES` | 오디오(20201015)<br>일반 텍스트<br>구조적 텍스트(20210908)<br>발음|  예                         |                          |
| 스페인어(우루과이)                  | `es-UY` | 일반 텍스트<br>발음                  |                           |                          |
| 스페인어(미국)                      | `es-US` | 일반 텍스트<br>발음                  |                           |                          |
| 스페인어(베네수엘라)                | `es-VE` | 일반 텍스트<br>발음                  |                           |                          |
| 스와힐리어(케냐)                    | `sw-KE` | 일반 텍스트                                   |                           |                          |
| 스웨덴어(스웨덴)                   | `sv-SE` | 일반 텍스트<br>발음                  |   예                        |                          |
| 타밀어(인도)                      | `ta-IN` | 일반 텍스트                                   |                           |                          |
| 텔루구어(인도)                     | `te-IN` | 일반 텍스트                                   |                           |                          |
| 태국어(태국)                    | `th-TH` | 일반 텍스트                                   |      예                     |                          |
| 터키어(터키)                   | `tr-TR` | 일반 텍스트                                   |                           |                          |
| 베트남어(베트남)               | `vi-VN` | 일반 텍스트                                   |                           |                          |
...
| 영어(영국) | `en-GB` | Female | `en-GB-MiaNeural`<sup>2021 년 10 월 30 일에 사용 중지 됨, 아래 참조</sup> | 일반 |
...
| 소말리아 (소말리아) | `so-SO` | Female | `so-SO-UbaxNeural` <sup>새로 생성</sup>  | 일반 |
| 소말리아 (소말리아) | `so-SO`| Male | `so-SO-MuuseNeural` <sup>새로 생성</sup>  | 일반 |
...
> [!IMPORTANT]
> 영어(영국) 음성은 `en-GB-MiaNeural` **2021년 10월 30일에** 사용 중지되었습니다. 이제 에 대한 모든 서비스 `en-GB-MiaNeural` 요청은 `en-GB-SoniaNeural` **2021년 10월 30일** 이후 자동으로 다시 지시됩니다.
> 컨테이너 신경망 TTS를 사용하는 경우 **2021년 10월 30일부터** 최신 버전을 [다운로드하여](speech-container-howto.md#get-the-container-image-with-docker-pull) 배포하세요. 이전 버전의 모든 요청이 거부됩니다.
