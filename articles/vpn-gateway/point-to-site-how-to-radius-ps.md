---
title: '지점 및 사이트 간 연결과 RADIUS 인증을 사용하여 가상 네트워크에 컴퓨터 연결: PowerShell'
titleSuffix: Azure VPN Gateway
description: P2S 및 RADIUS 인증을 사용하여 Windows 및 OS X 클라이언트를 가상 네트워크에 안전하게 연결하는 방법을 알아봅니다.
