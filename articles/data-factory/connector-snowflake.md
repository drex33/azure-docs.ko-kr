...
## <a name="create-a-linked-service-to-snowflake-using-ui"></a>UI를 사용하여 Snowflake에 연결된 서비스 만들기
...
2. Snowflake를 검색하고 Snowflake 커넥터를 선택합니다.
    ...
    :::image type="content" source="media/connector-snowflake/snowflake-connector.png" alt-text="Snowflake 커넥터의 스크린샷.":::    

1. 서비스 세부 정보를 구성하고 연결을 테스트하고 새 연결된 서비스를 만듭니다.

    :::image type="content" source="media/connector-snowflake/configure-snowflake-linked-service.png" alt-text="Snowflake의 연결된 서비스 구성의 스크린샷.":::
