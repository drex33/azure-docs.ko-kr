...
- [Azure Policy를 사용 하 여 규모에 Azure Monitor 배포](deploy-scale.md)
...
- [Azure Monitor에서 데이터 시각화](visualizations.md)
...
- [Azure Data Explorer 인사이트](insights/data-explorer.md)
