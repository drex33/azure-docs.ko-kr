...
description: 이 문서에서는 Azure 의료 Api IoT 커넥터에서 FHIR 대상 매핑을 구성 하 고 사용 하는 방법을 설명 합니다.
author: msjasteppe
...
이 문서에서는 FHIR 대상 매핑을 사용하는 방법을 배웠습니다. 디바이스 매핑을 사용하는 방법을 알아보려면 다음을 참조하세요.
