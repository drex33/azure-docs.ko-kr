...
[Form Recognizer][fr-containers] 컨테이너 이미지는 `mcr.microsoft.com` 컨테이너 레지스트리 신디케이트에서 찾을 수 있습니다. 이미지는 `azure-cognitive-services/form-recognizer` 리포지토리 내에 있습니다.

컨테이너 이미지에는 다음 태그를 사용할 수 있습니다.

# <a name="latest-version"></a>[최신 버전](#tab/current)

`v2.1`에 대한 릴리스 정보:

Form Recognizer 컨테이너는 현재 제어된 미리 보기로 제공됩니다. 이 컨테이너를 사용하려면 [온라인 요청](https://customervoice.microsoft.com/Pages/ResponsePage.aspx?id=v4j5cvGGr0GRqy180BHbR7en2Ais5pxKtso_Pz4b1_xUNlpBU1lFSjJUMFhKNzVHUUVLN1NIOEZETiQlQCN0PWcu)을 제출하고 승인을 받아야 합니다.
...
| `1.14.1-amd64-<locale-and-voice>`           | `<locale>`은 아래에 나열된 사용 가능한 로캘 중 하나로 대체합니다. 예: `1.14.1-amd64-en-us-ariarus`. |

| v1.14.1에 대한 로캘                         | 메모                                                                      | 다이제스트                         |
|---------------------------------------------|:---------------------------------------------------------------------------|:-------------------------------|
| `ar-eg-hoda`                                | `ar-EG` 로캘과 `ar-EG-Hoda` 음성이 있는 컨테이너 이미지입니다.            | `sha256:506c4694cb4628aab870d81b53885c4b63f7d167fcc3407dd7a203ab3da6bd9b` |
| `ar-sa-naayf`                               | `ar-SA` 로캘과 `ar-SA-Naayf` 음성이 있는 컨테이너 이미지입니다.           | `sha256:ec6963d01458464eff3ed2be965cbe782c11bd751022ead9d4dad39caa7db4a1` |
| `bg-bg-ivan`                                | `bg-BG` 로캘과 `bg-BG-Ivan` 음성이 있는 컨테이너 이미지입니다.            | `sha256:d296080e707bb20eba7db2473c8caa76c17ded594b8a82e0932a71694ee0f2a9` |
| `ca-es-herenarus`                           | `ca-ES` 로캘과 `ca-ES-HerenaRUS` 음성이 있는 컨테이너 이미지입니다.       | `sha256:80545662ec2dce6949c902351dd29be9778749ee980efc0c78be5074a9e126a8` |
| `cs-cz-jakub`                               | `cs-CZ` 로캘과 `cs-CZ-Jakub` 음성이 있는 컨테이너 이미지입니다.           | `sha256:206773547eadde8e5e396ebac9f7a17e0e20ba6c8a453f7c03c8723689224384` |
| `da-dk-hellerus`                            | `da-DK` 로캘과 `da-DK-HelleRUS` 음성이 있는 컨테이너 이미지입니다.        | `sha256:b5636a23d0d0a9c6f5c93885a1033730bf1f0c12335769fc544bb23f1697ae21` |
| `de-at-michael`                             | `de-AT` 로캘과 `de-AT-Michael` 음성이 있는 컨테이너 이미지입니다.         | `sha256:df6d494145125b1945626834084f8f8d91d7b996edf417e33ec8d9441665cc16` |
| `de-ch-karsten`                             | `de-CH` 로캘과 `de-CH-Karsten` 음성이 있는 컨테이너 이미지입니다.         | `sha256:65a088fa6dc97d60c2d35214af0c90a6e9a33ae2f4082270dcc7961a64e38bfd` |
| `de-de-heddarus`                            | `de-DE` 로캘과 `de-DE-Hedda` 음성이 있는 컨테이너 이미지입니다.           | `sha256:acd5c459d0447aa39e4bf5ed74c7f4fdfa275c3ca0cabc24ee4f110f6500e743` |
| `de-de-hedda`                               | `de-DE` 로캘과 `de-DE-Hedda` 음성이 있는 컨테이너 이미지입니다.           | `sha256:acd5c459d0447aa39e4bf5ed74c7f4fdfa275c3ca0cabc24ee4f110f6500e743` |
| `de-de-stefan-apollo`                       | `de-DE` 로캘과 `de-DE-Stefan-Apollo` 음성이 있는 컨테이너 이미지입니다.   | `sha256:a879c3dff58420b8af5fb955e8cb5727c76f7acddfe89dde298ca0934d72f1aa` |
| `el-gr-stefanos`                            | `el-GR` 로캘과 `el-GR-Stefanos` 음성이 있는 컨테이너 이미지입니다.        | `sha256:50422aa0cd5b58a5e1c4e334e7098f7590f02fbfb392a5d08fde2018577a6cac` |
| `en-au-catherine`                           | `en-AU` 로캘과 `en-AU-Catherine` 음성이 있는 컨테이너 이미지입니다.       | `sha256:68ee93b7e541836fb4df93a6925edc9734a8390765fd10b9541eddb94788128d` |
| `en-au-hayleyrus`                           | `en-AU` 로캘과 `en-AU-HayleyRUS` 음성이 있는 컨테이너 이미지입니다.       | `sha256:b4c6a1580faf6466238060c9e26b2c9bf17da2ee8492f856fceb96e927722c70` |
| `en-ca-heatherrus`                          | `en-CA` 로캘과 `en-CA-HeatherRUS` 음성이 있는 컨테이너 이미지입니다.      | `sha256:1ada3a373ae2e3475c8e1ee9b2a5966ae126376bb5ac0c01e07591b53de5c2e4` |
| `en-ca-linda`                               | `en-CA` 로캘과 `en-CA-Linda` 음성이 있는 컨테이너 이미지입니다.           | `sha256:4989ac096aa8923ef16c823cd3767730dcbea633827d269a1e5dc9206325edcc` |
| `en-gb-george-apollo`                       | `en-GB` 로캘과 `en-GB-George-Apollo` 음성이 있는 컨테이너 이미지입니다.   | `sha256:1fc5a152d99e61823a8d0253ba1c04a79c1a846b5c135e1638695f47d21b936c` |
| `en-gb-hazelrus`                            | `en-GB` 로캘과 `en-GB-HazelRUS` 음성이 있는 컨테이너 이미지입니다.        | `sha256:8814ea674f531e12e0d502cc542afbabf5123107f05792215c81f68a259cd5e8` |
| `en-gb-susan-apollo`                        | `en-GB` 로캘과 `en-GB-Susan-Apollo` 음성이 있는 컨테이너 이미지입니다.    | `sha256:3dd9b566fb592009693159d2c1eeebb034e22124746ee4d20f7b904a04e90a5b` |
| `en-ie-sean`                                | `en-IE` 로캘과 `en-IE-Sean` 음성이 있는 컨테이너 이미지입니다.            | `sha256:a1cddb74a6f14c3f9e3514dbcd64d05406f36e79089ef8217fcb724f8126a3e9` |
| `en-in-heera-apollo`                        | `en-IN` 로캘과 `en-IN-Heera-Apollo` 음성이 있는 컨테이너 이미지입니다.    | `sha256:1f5e27a078dc61d558864b29e060e963fe1cd4e56d5a5c33e943088803f3b3fd` |
| `en-in-priyarus`                            | `en-IN` 로캘과 `en-IN-PriyaRUS` 음성이 있는 컨테이너 이미지입니다.        | `sha256:0f2873c0a80159624960b1d7c3dafa1e60be69f94aa1939bac37bdb941240ba1` |
| `en-in-ravi-apollo`                         | `en-IN` 로캘과 `en-IN-Ravi-Apollo` 음성이 있는 컨테이너 이미지입니다.     | `sha256:338a4c2b0923d44895ebba1d3aed13eef8ec775c911e39ee9acd33b304831db0` |
| `en-us-aria24krus`                          | `en-US` 로캘과 `en-US-Aria24kRUS` 음성이 있는 컨테이너 이미지입니다.      | `sha256:ab856028f3ab7c7af881b4e53fe957bc89d3f8bb1daf7b3376593f845cac1fad` |
| `en-us-ariarus`                             | `en-US` 로캘과 `en-US-AriaRUS` 음성이 있는 컨테이너 이미지입니다.         | `sha256:ab856028f3ab7c7af881b4e53fe957bc89d3f8bb1daf7b3376593f845cac1fad` |
| `en-us-benjaminrus`                         | `en-US` 로캘과 `en-US-BenjaminRUS` 음성이 있는 컨테이너 이미지입니다.     | `sha256:0e4862eb77acb3b3f5c08984ce3605d06e12876b72d5c48dcd86e05461aecff7` |
| `en-us-guy24krus`                           | `en-US` 로캘과 `en-US-Guy24kRUS` 음성이 있는 컨테이너 이미지입니다.       | `sha256:bde0c632722de7093c787c076e73cfcc84ce6afa282fc269a7fb5e3edc5e986a` |
| `en-us-zirarus`                             | `en-US` 로캘과 `en-US-ZiraRUS` 음성이 있는 컨테이너 이미지입니다.         | `sha256:feebe5f990e6713c2a8e3759059553c9b9ec59505449686896bd7ef25d2d4bd8` |
| `es-es-helenarus`                           | `es-ES` 로캘과 `es-ES-HelenaRUS` 음성이 있는 컨테이너 이미지입니다.       | `sha256:84b9517218281c7660f2851e819dc79a003cd2c06adf50341a46293dab3754db` |
| `es-es-laura-apollo`                        | `es-ES` 로캘과 `es-ES-Laura-Apollo` 음성이 있는 컨테이너 이미지입니다.    | `sha256:fbcdd314a1c94b60a338c9a3b352fdb19bc0d64d1e698ae8ca9b30eeb0cc89b0` |
| `es-es-pablo-apollo`                        | `es-ES` 로캘과 `es-ES-Pablo-Apollo` 음성이 있는 컨테이너 이미지입니다.    | `sha256:4d0a3a6f789acbee3cf52e26ce4f2bc7f15a1d51bd4a4187262fbd432a7a0512` |
| `es-mx-hildarus`                            | `es-MX` 로캘과 `es-MX-HildaRUS` 음성이 있는 컨테이너 이미지입니다.        | `sha256:232730b6b1732a6169b024f9513527a01f515b5534ffbe5e6b0ec816c452333b` |
| `es-mx-raul-apollo`                         | `es-MX` 로캘과 `es-MX-Raul-Apollo` 음성이 있는 컨테이너 이미지입니다.     | `sha256:a24417b4e2d2f22c17a6a2ea6ae8acd67386881c1c10e7cb4988a4fc93e06b72` |
| `fi-fi-heidirus`                            | `fi-FI` 로캘과 `fi-FI-HeidiRUS` 음성이 있는 컨테이너 이미지입니다.        | `sha256:24178c994f15ef135453b6417c3866e5cc6e0db4767a0ed70a446fe67d2124de` |
| `fr-ca-caroline`                            | `fr-CA` 로캘과 `fr-CA-Caroline` 음성이 있는 컨테이너 이미지입니다.        | `sha256:3e9b860513a1f0ebfe4280fa7994348305c78fccf00906e1983e1e557b44d455` |
| `fr-ca-harmonierus`                         | `fr-CA` 로캘과 `fr-CA-HarmonieRUS` 음성이 있는 컨테이너 이미지입니다.     | `sha256:3b5a7a1e8a01782e12a1b39f9f2981a3f1798751351251e6d477f4df1b5f4997` |
| `fr-ch-guillaume`                           | `fr-CH` 로캘과 `fr-CH-Guillaume` 음성이 있는 컨테이너 이미지입니다.       | `sha256:b2cbd6b417b42e11d6d64d8a1f26b2f00f398ec2225207dd89043b859712b261` |
| `fr-fr-hortenserus`                         | `fr-FR` 로캘과 `fr-FR-HortenseRUS` 음성이 있는 컨테이너 이미지입니다.     | `sha256:dc2b98bb93526bc95bff551a3dc3869afff041a904022bc3bd2d30b0b7ce1993` |
| `fr-fr-julie-apollo`                        | `fr-FR` 로캘과 `fr-FR-Julie-Apollo` 음성이 있는 컨테이너 이미지입니다.    | `sha256:1af6a1807b4d4d48a1f7229e6e03360d9bb979113bbe4f4590975f9e98f09af1` |
| `fr-fr-paul-apollo`                         | `fr-FR` 로캘과 `fr-FR-Paul-Apollo` 음성이 있는 컨테이너 이미지입니다.     | `sha256:0b5ed83a9a48cba741b5e491926bb5a1e3022eda8660b573e3abb231f3f81b73` |
| `he-il-asaf`                                | `he-IL` 로캘과 `he-IL-Asaf` 음성이 있는 컨테이너 이미지입니다.            | `sha256:5f2307252f16876be05545581f1698c8a8834c4b462db76c151400c538f1aff4` |
| `hi-in-hemant`                              | `hi-IN` 로캘과 `hi-IN-Hemant` 음성이 있는 컨테이너 이미지입니다.          | `sha256:a86d04e0ae19a1ca30ba14a4951e8f8d78c4c27a78378f07e5f37a753e282ea9` |
| `hi-in-kalpana-apollo`                      | `hi-IN` 로캘과 `hi-IN-Kalpana-Apollo` 음성이 있는 컨테이너 이미지입니다.  | `sha256:1e56c468fae9c07c76581a7c7430d9bcc02eeaee5e4657830a2c59649cdfd80c` |
| `hi-in-kalpana`                             | `hi-IN` 로캘과 `hi-IN-Kalpana` 음성이 있는 컨테이너 이미지입니다.         | `sha256:1e56c468fae9c07c76581a7c7430d9bcc02eeaee5e4657830a2c59649cdfd80c` |
| `hr-hr-matej`                               | `hr-HR` 로캘과 `hr-HR-Matej` 음성이 있는 컨테이너 이미지입니다.           | `sha256:7445bc7d1d73c5bb4775de73253b4733fbe53caae93a7bd5093f2cf61dc7f7cd` |
| `hu-hu-szabolcs`                            | `hu-HU` 로캘과 `hu-HU-Szabolcs` 음성이 있는 컨테이너 이미지입니다.        | `sha256:96050684a66cede45f5a757dc6faa45663efcae1739abc820a77a7e171b7733a` |
| `id-id-andika`                              | `id-ID` 로캘과 `id-ID-Andika` 음성이 있는 컨테이너 이미지입니다.          | `sha256:28065b6532a04912cb59104e7d6d1904be3b71b8f45427082825c752c3f1737e` |
| `it-it-cosimo-apollo`                       | `it-IT` 로캘과 `it-IT-Cosimo-Apollo` 음성이 있는 컨테이너 이미지입니다.   | `sha256:ee465ab38a0b9331fdf7a1baeda62b6a368b2aceb10754158e3f14a45b473dfd` |
| `it-it-luciarus`                            | `it-IT` 로캘과 `it-IT-LuciaRUS` 음성이 있는 컨테이너 이미지입니다.        | `sha256:b15a06df122dac510aa9327aa623147435ce2e576ebbe0be1c28ecf19b4f9717` |
| `ja-jp-ayumi-apollo`                        | `ja-JP` 로캘과 `ja-JP-Ayumi-Apollo` 음성이 있는 컨테이너 이미지입니다.    | `sha256:cbced8cfbd556c8a169bfd2da35446787c5f5acd1607083155cf2f8e7ad8b2a2` |
| `ja-jp-harukarus`                           | `ja-JP` 로캘과 `ja-JP-HarukaRUS` 음성이 있는 컨테이너 이미지입니다.       | `sha256:1dda74d78c7227c45720e6aac912053160a65957b43b0b528376dc3f7a8570f6` |
| `ja-jp-ichiro-apollo`                       | `ja-JP` 로캘과 `ja-JP-Ichiro-Apollo` 음성이 있는 컨테이너 이미지입니다.   | `sha256:ffa25c2702b5156e97eb9457085341d035add070d43638e78b0ae9f2f23fe76b` |
| `ko-kr-heamirus`                            | `ko-KR` 로캘과 `ko-KR-HeamiRUS` 음성이 있는 컨테이너 이미지입니다.        | `sha256:f4955991abb31d5814913e49c17535f79b618f3376de75af1feac74ff9430cd5` |
| `ms-my-rizwan`                              | `ms-MY` 로캘과 `ms-MY-Rizwan` 음성이 있는 컨테이너 이미지입니다.          | `sha256:4c4fdfc2c70ae624d69c1435433068efacccd96809e9112a4fcb1f4e52802d00` |
| `nb-no-huldarus`                            | `nb-NO` 로캘과 `nb-NO-HuldaRUS` 음성이 있는 컨테이너 이미지입니다.        | `sha256:080902d1f8f67d018746d3099d2739fc203cf87959912e45352a7525c7b95bb9` |
| `nl-nl-hannarus`                            | `nl-NL` 로캘과 `nl-NL-HannaRUS` 음성이 있는 컨테이너 이미지입니다.        | `sha256:b3c808f060b29485c8a18f5b717f96f4f1d5c724811012cf9ad4654b658b08f6` |
| `pl-pl-paulinarus`                          | `pl-PL` 로캘과 `pl-PL-PaulinaRUS` 음성이 있는 컨테이너 이미지입니다.      | `sha256:f95ded0a8f5dc9bf53f469fcd8c9608fa53ab45b5fdc915f132fff3cb6fcb8e0` |
| `pt-br-daniel-apollo`                       | `pt-BR` 로캘과 `pt-BR-Daniel-Apollo` 음성이 있는 컨테이너 이미지입니다.   | `sha256:da85762763f2a4cf6de112244138aee57235bbfab807e5dd80b76e9fc6703e44` |
| `pt-br-heloisarus`                          | `pt-BR` 로캘과 `pt-BR-HeloisaRUS` 음성이 있는 컨테이너 이미지입니다.      | `sha256:085dd402f070660f2a0a9139b2b09ec7699191533e4b442260364715fd83ff38` |
| `pt-pt-heliarus`                            | `pt-PT` 로캘과 `pt-PT-HeliaRUS` 음성이 있는 컨테이너 이미지입니다.        | `sha256:4cf8270fb836dda947580886891c79d07ccd9cca7cfb19d328fafba9f61d5303` |
| `ro-ro-andrei`                              | `ro-RO` 로캘과 `ro-RO-Andrei` 음성이 있는 컨테이너 이미지입니다.          | `sha256:a11f8da57c87b49145293b1c91e2073f96a70301b839e9d9848fdd1a2a164aed` |
| `ru-ru-ekaterinarus`                        | `ru-RU` 로캘과 `ru-RU-EkaterinaRUS` 음성이 있는 컨테이너 이미지입니다.    | `sha256:e6619b9518029ba9e19d6b98dbe1b79c676c135248c32c9a3c3c2e3edb56efc7` |
| `ru-ru-irina-apollo`                        | `ru-RU` 로캘과 `ru-RU-Irina-Apollo` 음성이 있는 컨테이너 이미지입니다.    | `sha256:04ecb7975978c004fbe2960e74d71b9d1fdfbaea904f1104f519f43351dc77e5` |
| `ru-ru-pavel-apollo`                        | `ru-RU` 로캘과 `ru-RU-Pavel-Apollo` 음성이 있는 컨테이너 이미지입니다.    | `sha256:c7fe3fc2fd40891e51fe00c3bbbf5386b7400cee6091956ad08fa974fe7518d7` |
| `sk-sk-filip`                               | `sk-SK` 로캘과 `sk-SK-Filip` 음성이 있는 컨테이너 이미지입니다.           | `sha256:e7624a3f3521a663bfd96f30904f722b16c6b2523fa2d150a578311c2abfe7b1` |
| `sl-si-lado`                                | `sl-SI` 로캘과 `sl-SI-Lado` 음성이 있는 컨테이너 이미지입니다.            | `sha256:898ab51ca3e6697b39391fdc34d76f79cea6a40dc53f9fb16ae9241e09eeaec1` |
| `sv-se-hedvigrus`                           | `sv-SE` 로캘과 `sv-SE-HedvigRUS` 음성이 있는 컨테이너 이미지입니다.       | `sha256:7aba595a1b4994dfb2002bc7c56e1dc94d92bb3e49ba9024ef2ebd8614deb24d` |
| `ta-in-valluvar`                            | `ta-IN` 로캘과 `ta-IN-Valluvar` 음성이 있는 컨테이너 이미지입니다.        | `sha256:850f8b7e23434c01fd3c901549bf00e541f0e86f96e75ed22531036acc899418` |
| `te-in-chitra`                              | `te-IN` 로캘과 `te-IN-Chitra` 음성이 있는 컨테이너 이미지입니다.          | `sha256:cc155a9aba2e1f4786702b570608c4aa344fddaba9bd6f3d705a2cc8d5990b37` |
| `th-th-pattara`                             | `th-TH` 로캘과 `th-TH-Pattara` 음성이 있는 컨테이너 이미지입니다.         | `sha256:3c0c5b6ea14b697219420730f195553ac691ff69cb65a7aecb3df2e35de2f3b8` |
| `tr-tr-sedarus`                             | `tr-TR` 로캘과 `tr-TR-SedaRUS` 음성이 있는 컨테이너 이미지입니다.         | `sha256:ee98a8a4e5ccd68ca0fe7c485a7595f4b62930ee2a13cc85e3c5486954a18c4c` |
| `vi-vn-an`                                  | `vi-VN` 로캘과 `vi-VN-An` 음성이 있는 컨테이너 이미지입니다.              | `sha256:2bfa898d787863b7ec55421b8d21db7b2ba89c904a95705573a02bb43b2226de` |
| `zh-cn-huihuirus`                           | `zh-CN` 로캘과 `zh-CN-HuihuiRUS` 음성이 있는 컨테이너 이미지입니다.       | `sha256:f5afefbd54a45418fbffa6f272e2dc8651fbd06276ce7d4ecf2e50ea1b947b12` |
| `zh-cn-kangkang-apollo`                     | `zh-CN` 로캘과 `zh-CN-Kangkang-Apollo` 음성이 있는 컨테이너 이미지입니다. | `sha256:fc314d3e4729ec77b2cfdb1408d3aeed7f6d17b7e3c353e4cfc31fc9712eccd3` |
| `zh-cn-yaoyao-apollo`                       | `zh-CN` 로캘과 `zh-CN-Yaoyao-Apollo` 음성이 있는 컨테이너 이미지입니다.   | `sha256:102c47ff3b91c7106cf116f86dad5814a2d893672fa833d082d30ae500df8112` |
| `zh-hk-danny-apollo`                        | `zh-HK` 로캘과 `zh-HK-Danny-Apollo` 음성이 있는 컨테이너 이미지입니다.    | `sha256:75892d547cc35964fe079efd077e83825c38f43179bee4486e672113ff56d612` |
| `zh-hk-tracy-apollo`                        | `zh-HK` 로캘과 `zh-HK-Tracy-Apollo` 음성이 있는 컨테이너 이미지입니다.    | `sha256:e7cf6d4d0d7509c829a39cceac03f1f97e2f0f496bc1193d2291cac6ce08a007` |
| `zh-hk-tracyrus`                            | `zh-HK` 로캘과 `zh-HK-TracyRUS` 음성이 있는 컨테이너 이미지입니다.        | `sha256:e7cf6d4d0d7509c829a39cceac03f1f97e2f0f496bc1193d2291cac6ce08a007` |
| `zh-tw-hanhanrus`                           | `zh-TW` 로캘과 `zh-TW-HanHanRUS` 음성이 있는 컨테이너 이미지입니다.       | `sha256:6d9c790d7a322dd6dc56512d008055e72863b9fa5c01a5bd074de79227d45093` |
| `zh-tw-yating-apollo`                       | `zh-TW` 로캘과 `zh-TW-Yating-Apollo` 음성이 있는 컨테이너 이미지입니다.   | `sha256:acf24aca14e04a4120f9fd71c5eadd9e1f61e61c835e5482249dae2a1546ee02` |
| `zh-tw-zhiwei-apollo`                       | `zh-TW` 로캘과 `zh-TW-Zhiwei-Apollo` 음성이 있는 컨테이너 이미지입니다.   | `sha256:90767a1712dc74a9a3d1c73d5613c088d2d28034a2d8430e4cfd7062478dbd29` |
...
* `1.3.0` 버전에 대한 릴리스 정보:
    * `SingleLanguage` 및 연속 모드로 독립 실행형 언어 ID를 지원합니다.
