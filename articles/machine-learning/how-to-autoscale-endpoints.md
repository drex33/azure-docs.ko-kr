...
Azure Monitor 자동 크기 조정은 다양 한 규칙 집합을 지원 합니다. 메트릭 기반 크기 조정 (예: CPU 사용률 >70%), 일정 기반 크기 조정 (예: 최대 업무 시간에 대 한 크기 조정 규칙) 또는 조합을 구성할 수 있습니다. 자세한 내용은 [Microsoft Azure의 자동 크기 조정 개요](/azure-monitor/autoscale/autoscale-overview.md)를 참조 하세요.
...
* 일정을 매주  __토요일과__ __일요일__ 반복으로 설정합니다.
...
Azure Monitor 사용하여 자동 크기 조정에 대한 자세한 내용은 다음 문서를 참조하세요.
