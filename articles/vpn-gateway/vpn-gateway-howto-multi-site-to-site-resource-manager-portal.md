...
ms.date: 04/29/2021
ms.author: cherylmc
ms.openlocfilehash: eabda2f39796737918457657f8c44dbfca556e39
ms.sourcegitcommit: 1e9139680ca51f55ac965c4dd6dd82bf2fd43675
ms.translationtype: MT
ms.contentlocale: ko-KR
ms.lasthandoff: 12/04/2021
ms.locfileid: "133539556"
---
...
**ExpressRoute/사이트간 공존 연결 정보**

* 이 문서의 단계를 사용하여 기존 ExpressRoute/사이트간 공존 연결에 새 VPN 연결을 추가할 수 있습니다.
* 이 문서의 단계를 사용하여 새 ExpressRoute/사이트간 공존 연결을 구성할 수 없습니다. 새로운 공존 연결을 만들려면 [ExpressRoute/S2S 공존 연결을 참조하세요.](../expressroute/expressroute-howto-coexist-resource-manager.md)

## <a name="prerequisites"></a><a name="before"></a>필수 조건

다음 사항을 확인합니다.

* 새로운 공존 ExpressRoute 및 VPN Gateway 사이트간 연결을 구성하지 않습니다.
...
1. **로컬 네트워크 게이트웨이 만들기** 페이지에서 다음 필드에 정보를 입력합니다.
   ...
   * **엔드포인트:** 연결하려는 사이트에 있는 VPN 디바이스 또는 엔드포인트 FQDN의 공용 IP 주소입니다. 다른 VPN 게이트웨이에 대한 연결을 만들려면 이 필드에서 다른 게이트웨이의 IP 주소를 사용할 수 있습니다.
