---
title: Microsoft Defender for Cloud의 적응 네트워크 강화 | Microsoft Docs
...
ms.locfileid: "132529316"
---
# <a name="improve-your-network-security-posture-with-adaptive-network-hardening"></a>적응형 네트워크 강화를 통해 네트워크 보안 상태 개선

[!INCLUDE [Banner for top of topics](./includes/banner.md)]

적응 네트워크 강화는 Microsoft Defender for Cloud의 에이전트 없는 기능으로,이 네트워크 강화 도구를 활용 하기 위해 컴퓨터에 설치할 필요는 없습니다.

이 페이지에서는 Defender for Cloud에서 적응 네트워크 강화를 구성 하 고 관리 하는 방법을 설명 합니다.
...
1. 적응 네트워크 강화 타일 (1) 또는 적응 네트워크 강화와 관련 된 insights 패널 항목 (2)을 선택 합니다. 
...
1. 적응 네트워크 강화 권장 사항에 대 한 세부 정보 페이지는 네트워크 Vm이 세 개의 탭으로 그룹화 된 **인터넷 연결 virtual machines** 권장 사항에 적용 됩니다.
   ...
   * **검색되지 않은 리소스**: 다음 이유 중 하나로 인해 적응형 네트워크 강화 알고리즘을 실행할 수 없는 VM입니다.
      ...
      * **충분 한 데이터를 사용할 수 없습니다**. 정확한 트래픽 강화 권장 사항을 생성 하기 위해 Defender for Cloud에는 최소 30 일의 트래픽 데이터가 필요 합니다.
      * **서버에 대해 Microsoft defender에서 VM을 보호 하지 않음**: [서버용 microsoft defender](defender-for-servers-introduction.md) 로 보호 되는 vm만이 기능을 사용할 수 있습니다.
...
클라우드에 대해 Defender에서 권장 하지 않은 "허용" 규칙을 추가할 수 있습니다.
