...
4. **추가** 를 클릭합니다. 사용자 또는 그룹 선택 영역에서 **Purview 카탈로그** 를 추가합니다. **읽기** 및 **실행** 권한을 선택합니다. 아래 스크린샷에 표시된 것처럼 추가 옵션에서 **이 폴더 및 모든 하위 폴더** 와 **액세스 권한 항목 및 기본 권한 항목** 을 선택해야 합니다. **확인**
   :::image type="content" source="./media/register-scan-adls-gen1/gen1-managed-service-identity-authentication.png" alt-text="MSI 인증 세부 정보":::를 클릭합니다.
...
4. **추가** 를 클릭합니다. 사용자 또는 그룹 선택에서 **서비스 주체 애플리케이션** 을 추가합니다. **읽기** 및 **실행** 권한을 선택합니다. 아래 스크린샷에 표시된 것처럼 추가 옵션에서 **이 폴더 및 모든 하위 폴더** 와 **액세스 권한 항목 및 기본 권한 항목** 을 선택해야 합니다. **확인**
   :::image type="content" source="./media/register-scan-adls-gen1/gen1-service-principal-permissions.png" alt-text="서비스 주체 인증 세부 정보":::를 클릭합니다.
