...
ms.openlocfilehash: 86bc2516e27ad392fdc6f3e6960cbfb67b11ded8
ms.sourcegitcommit: 56235f8694cc5f88db3afcc8c27ce769ecf455b0
ms.translationtype: HT
ms.contentlocale: ko-KR
ms.lasthandoff: 11/24/2021
ms.locfileid: "133046702"
---
...
이 빠른 시작을 사용하여 Bing News Search API에 대한 첫 번째 호출을 수행할 수 있습니다. 이 간단한 JavaScript 애플리케이션은 검색 쿼리를 API에 보내고 JSON 응답을 표시합니다.

이 애플리케이션은 JavaScript로 작성되어 Node.js에서 실행되지만 API는 대부분의 프로그래밍 언어와 호환되는 RESTful 웹 서비스입니다.
...
2. API 엔드포인트, 뉴스 API 검색 경로, 구독 키 및 검색어에 대한 변수를 만듭니다. 다음 코드에서 글로벌 엔드포인트를 사용하거나 리소스의 Azure Portal에 표시되는 [사용자 지정 하위 도메인](../../cognitive-services/cognitive-services-custom-subdomains.md) 엔드포인트를 사용할 수 있습니다. 
...
1. HTTP 호출, `response`를 매개 변수로 사용하는 `response_handler` 함수를 정의합니다. 
   ...
   다음 단계에서 이 함수에 코드를 추가합니다.

2. JSON 응답 본문을 포함할 변수를 정의합니다.  
