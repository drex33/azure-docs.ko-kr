...
![파트너 센터의 제품 개요 페이지를 보여줍니다. [라이브 전환] 단추와 미리 보기 링크가 표시됩니다.](./media/publish-status-publisher-signoff.png)
...
3. 제품을 선택합니다.
4. 왼쪽 탐색 메뉴에서 **기록** 탭을 선택합니다. 다음 이벤트(제품에 해당하는 경우)에 대한 세부 정보가 페이지에 제공됩니다.
