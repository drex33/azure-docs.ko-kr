...
Azure Data Factory를 만들려면 [az datafactory create](/cli/azure/datafactory#az_datafactory_create) 명령을 실행합니다.
...
[az datafactory show](/cli/azure/datafactory#az_datafactory_factory_show) 명령을 사용하여 만든 데이터 팩터리를 볼 수 있습니다.
