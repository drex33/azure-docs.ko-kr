...
### <a name="step-4-check-azure-backup-extension-health"></a>4단계: Azure Backup 확장 상태 확인
...
>[!Note]
>키 자격 증명 모음에 액세스하는 데 필요한 권한이 이미 설정된 경우 잠시 후 작업을 다시 시도합니다.
