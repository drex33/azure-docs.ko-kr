...
|[Azure Machine Learning 컴퓨팅 인스턴스](../articles/machine-learning/how-to-create-manage-compute-instance.md) | 예(SDK를 통해)  | 예 | 예 |
...
|[Azure Arc 지원 Kubernetes(미리](../articles/machine-learning/how-to-attach-compute-targets.md#kubernetes) 보기) | 예 | 예 | 예 |
