...
최신 버전의 Azure Resource Manager PowerShell cmdlet을 다운로드하고 설치합니다. PowerShell cmdlet 다운로드 및 설치에 대한 자세한 내용은 [Azure PowerShell 설치 및 구성 방법](/powershell/azure/)을 참조하세요.
...
## <a name="delete-a-site-to-site-vpn-gateway"></a><a name="S2S"></a>사이트 간 VPN 게이트웨이 삭제
...
## <a name="delete-a-vnet-to-vnet-vpn-gateway"></a><a name="v2v"></a>VNet 간 VPN 게이트웨이 삭제
...
### <a name="3-get-the-list-of-connections-in-both-directions"></a>3. 양방향 연결 목록을 가져옵니다.
...
## <a name="delete-a-point-to-site-vpn-gateway"></a><a name="deletep2s"></a>지점 및 사이트 간 VPN Gateway 삭제
