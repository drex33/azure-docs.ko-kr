...
스토리지 계정에 대한 액세스를 허용하려면 신뢰할 수 있는 서비스 목록의 Azure 서비스가 이 스토리지 계정에 __액세스할 수 있도록 스토리지 계정을 구성합니다.__ 이 설정을 사용하면 관리형 서비스가 Azure 데이터 센터 네트워크를 통해 스토리지에 액세스할 수 있습니다. 
