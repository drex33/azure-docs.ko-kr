...
* [JDK(Java Development Kit) 7 이상](/java/azure/jdk/)
...
이러한 도구를 처음 설치하는 경우 coreservlets.com에서 [자습서: TomCat7 설치 및 Eclipse에서 사용](https://www.youtube.com/watch?v=jOdCfW7-ybI&t=2s) 문서에 있는 [빠른 시작] 섹션의 단계별 설치 지침을 제공합니다.
