---
title: CLI 스크립트 - Azure Database for MySQL - 유연한 서버의 서버 매개 변수 나열 및 변경
...
ms.locfileid: "131844300"
---
# <a name="list-and-change-server-parameters-of-an-azure-database-for-mysql---flexible-server-using-azure-cli"></a>Azure CLI를 사용하여 Azure Database for MySQL - 유연한 서버의 서버 매개 변수 나열 및 변경
