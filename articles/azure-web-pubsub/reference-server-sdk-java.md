---
title: 참조-Azure 웹 PubSub 용 Java SDK
description: 이 참조는 Azure 웹 PubSub 서비스용 Java SDK를 설명 합니다.
author: vicancy
ms.author: lianwei
ms.service: azure-web-pubsub
ms.topic: conceptual
ms.date: 11/01/2021
ms.openlocfilehash: df9c8330f3d9775d709089b5bea7c04a3bf3529c
ms.sourcegitcommit: 991268c548dd47e5f7487cd025c7501b9315e477
ms.translationtype: MT
ms.contentlocale: ko-KR
ms.lasthandoff: 11/30/2021
ms.locfileid: "133287824"
---
# <a name="azure-web-pubsub-service-client-library-for-java"></a>Java 용 Azure 웹 PubSub 서비스 클라이언트 라이브러리
...
### <a name="create-a-webpubsubserviceclient-using-connection-string"></a>`WebPubSubServiceClient`연결 문자열을 사용 하 여 만들기
...
### <a name="create-a-webpubsubserviceclient-using-access-key"></a>`WebPubSubServiceClient`액세스 키를 사용 하 여 만들기
...
모든 클라이언트 라이브러리는 기본적으로 Tomcat 네이티브 Boring SSL 라이브러리를 사용하여 SSL 작업에 대한 네이티브 수준 성능을 사용하도록 설정합니다. Boring SSL 라이브러리는 Linux/macOS/Windows용 네이티브 라이브러리를 포함하는 uber jar로, JDK 내에서 기본 SSL 구현에 비해 더 나은 성능을 제공합니다. 종속성 크기를 줄이는 방법에 대 한 자세한 내용은 wiki의 [성능 조정][performance_tuning] 섹션을 참조 하세요.
