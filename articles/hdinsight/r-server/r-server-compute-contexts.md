...
다음 표에는 호출 실행 방법을 설정하는 다양한 컴퓨팅 컨텍스트 옵션이 요약되어 있습니다.
...
[Machine Learning 서버 설명서](/machine-learning-server/)에서 [분산 컴퓨팅 개요](/machine-learning-server/r/how-to-revoscaler-distributed-computing)를 참조할 수도 있습니다.
