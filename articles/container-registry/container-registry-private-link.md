...
> [!NOTE]
> 2021 년 10 월부터 새 컨테이너 레지스트리는 최대 200 개인 끝점을 허용 합니다. 이전에 만든 레지스트리는 최대 10 개의 개인 끝점을 허용 합니다. [Az acr show-usage](/cli/azure/acr#az_acr_show_usage) 명령을 사용 하 여 레지스트리의 제한을 확인 합니다.
