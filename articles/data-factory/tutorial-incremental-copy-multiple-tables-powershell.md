...
ms.date: 07/05/2021
ms.openlocfilehash: c708f1e9a0f6cda35946969e83a74c17a8e82a2b
ms.sourcegitcommit: 8152290a8817d0882035f7f3f1fd56b80f87dcda
ms.translationtype: HT
ms.contentlocale: ko-KR
ms.lasthandoff: 11/30/2021
ms.locfileid: "133312591"
---
...
3. **다음 작업을 사용하여 파이프라인을 만듭니다.**
    ...
    다. 이전 워터마크 값보다 크고 새 워터마크 값보다 크거나 같은 워터마크 열 값을 사용하여 원본 데이터 저장소에서 행을 복사하는 복사 작업 만듭니다. 그런 다음 원본 데이터 스토리지의 델타 데이터를 새 파일로 Azure Blob Storage에 복사합니다.
...
6. 모든 파이프라인 실행과 해당 상태를 볼 수 있습니다. 다음 예제에서 파이프라인 실행의 상태는 **성공** 입니다. 파이프라인에 전달된 매개 변수를 확인하려면 **매개 변수** 열의 링크를 선택합니다. 오류가 발생하면 **오류** 열에 링크가 표시됩니다.
    ...
    :::image type="content" source="media/tutorial-incremental-copy-multiple-tables-powershell/monitor-pipeline-runs-4.png" alt-text="스크린샷은 파이프라인을 포함한 데이터 팩터리에 대한 파이프라인 실행을 보여 줍니다.":::    
