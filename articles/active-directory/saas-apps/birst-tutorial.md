...
* 사용자가 자신의 Azure AD 계정으로 Birst Agile Business Analytics에 자동으로 로그인(Single Sign-On)되도록 설정할 수 있습니다.
...
* Birst Agile Business Analytics에서 **SP** 시작 SSO를 지원합니다.
...
4. 검색 상자에 **Birst Agile Business Analytics** 를 입력하고, 결과 패널에서 **Birst Agile Business Analytics** 를 선택한 다음, **추가** 단추를 클릭하여 애플리케이션을 추가합니다.

    ![결과 목록의 Birst Agile Business Analytics](common/search-new-app.png)
...
5. **[Birst Agile Business Analytics 테스트 사용자 만들기](#create-birst-agile-business-analytics-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 Birst Agile Business Analytics에 만듭니다.
...
1. [Azure Portal](https://portal.azure.com/)의 **Birst Agile Business Analytics** 애플리케이션 통합 페이지에서 **Single Sign-On** 을 선택합니다.
...
4. **기본 SAML 구성** 섹션에서 다음 단계를 수행합니다.
    ...
    ![Birst Agile Business Analytics 도메인 및 URL Single Sign-On 정보](common/sp-intiated.png)
...
6. **Birst Agile Business Analytics 설정** 섹션에서 요구 사항에 따라 적절한 URL을 복사합니다.
...
### <a name="configure-birst-agile-business-analytics-single-sign-on"></a>Birst Agile Business Analytics Single Sign-On 구성

**Birst Agile Business Analytics** 쪽에서 Single Sign-On을 구성하려면 Azure Portal에서 다운로드한 **인증서(Base64)** 와 적절히 복사한 URL을 [Birst Agile Business Analytics 지원 팀](mailto:info@birst.com)에 보내야 합니다. 이렇게 설정하면 SAML SSO 연결이 양쪽에서 제대로 설정됩니다.
...
1. Azure Portal에서 **엔터프라이즈 애플리케이션**, **모든 애플리케이션**, **Birst Agile Business Analytics** 를 차례로 선택합니다.

    ![엔터프라이즈 애플리케이션 블레이드](common/enterprise-applications.png)

2. 애플리케이션 목록에서 **Birst Agile Business Analytics** 를 선택합니다.

    ![애플리케이션 목록의 Birst Agile Business Analytics 링크](common/all-applications.png)
...
### <a name="create-birst-agile-business-analytics-test-user"></a>Birst Agile Business Analytics 테스트 사용자 만들기

이 섹션에서는 Birst Agile Business Analytics에서 Britta Simon이라는 사용자를 만듭니다. [Birst Agile Business Analytics 지원 팀](mailto:info@birst.com)과 협력하여 Birst Agile Business Analytics 플랫폼에 사용자를 추가합니다. Single Sign-On을 사용하려면 먼저 사용자를 만들고 활성화해야 합니다.

### <a name="test-single-sign-on"></a>Single Sign-On 테스트 

이 섹션에서는 액세스 패널을 사용하여 Azure AD Single Sign-On 구성을 테스트합니다.

액세스 패널에서 Birst Agile Business Analytics 타일을 클릭하면 SSO를 설정한 Birst Agile Business Analytics에 자동으로 로그인되어야 합니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510)를 참조하세요.
