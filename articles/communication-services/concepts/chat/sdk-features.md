...
ms.subservice: chat
ms.openlocfilehash: b9a62b7f2072fc1f2356f3c2b17adef384274cbb
ms.sourcegitcommit: 3d04177023a3136832adb561da831ccc8e9910c7
ms.translationtype: HT
ms.contentlocale: ko-KR
ms.lasthandoff: 11/23/2021
ms.locfileid: "132939389"
---
...
|Notification Hub를 사용하는 모바일 푸시 알림 |  채팅 SDK는 Azure Notification Hub를 Communication Services 리소스에 연결하여 채팅 스레드에서 발생하는 수신 메시지 및 기타 작업에 대해 클라이언트가 알림을 받을 수 있도록 하는 API를 제공합니다. 모바일 앱이 포그라운드에서 실행되지 않는 상황에서 최종 사용자에게 알리기 위해 [팝업 알림](../notifications.md)(“알림”)을 실행하는 패턴을 사용할 수 있습니다([채팅 개념](concepts.md#push-notifications) 참조).                                     | ❌   | ❌    | ❌  | ❌  | ❌  | ✔️  | 
| Event Grid를 사용하는 서버 이벤트             | Azure Event Grid에서 사용할 수 있는 채팅 이벤트를 사용하여 사용자 지정 알림 서비스를 연결하거나 해당 이벤트를 웹후크에 게시하여 채팅이 완료된 후 CRM 레코드 업데이트와 같은 비즈니스 논리를 실행합니다.   | ✔️   | ✔️  | ✔️    | ✔️  |  ✔️    | ✔️   |    
