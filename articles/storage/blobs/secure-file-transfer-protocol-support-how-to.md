---
title: SFTP(미리 보기) | 사용하여 Azure Blob Storage 커넥트 Microsoft Docs
...
ms.openlocfilehash: 21315ad319f3199603c3e24bc29e3a918d705245
ms.sourcegitcommit: e9e332a512ed615a3c8ad5a11baa21649f14116d
ms.translationtype: MT
ms.contentlocale: ko-KR
ms.lasthandoff: 11/24/2021
ms.locfileid: "133097927"
---
# <a name="connect-to-azure-blob-storage-by-using-the-ssh-file-transfer-protocol-sftp-preview"></a>SFTP(SSH 파일 전송 프로토콜)(미리 보기)를 사용하여 Azure Blob Storage 커넥트

SFTP 클라이언트를 사용하여 Azure Storage 계정의 Blob Storage 엔드포인트에 안전하게 연결한 다음 파일을 업로드하고 다운로드할 수 있습니다. 이 문서에서는 SFTP를 사용하도록 설정한 다음 SFTP 클라이언트를 사용하여 Blob Storage 연결하는 방법을 보여 줍니다. 

Azure Blob Storage SFTP 지원에 대한 자세한 내용은 [Azure Blob Storage SFTP(SSH 파일 전송 프로토콜)를](secure-file-transfer-protocol-support.md)참조하세요.
...
- 온-프레미스 네트워크에서 연결하는 경우 클라이언트가 포트 22를 통해 나가는 통신을 허용하는지 확인합니다. SFTP는 해당 포트를 사용합니다.
