...
5. **새 사용자** 페이지에서 **사용자 초대** 를 선택하고 게스트 사용자 정보를 추가합니다.
   ...
   -  **역할**: 사용자에 대한 Azure AD 관리 권한이 필요한 경우 **역할** 옆의 **사용자** 를 선택하여 Azure AD 역할에 추가할 수 있습니다.  외부 게스트 사용자를 위한 Azure 역할에 대해 [자세히 알아보세요](../../role-based-access-control/role-assignments-external-users.md).
