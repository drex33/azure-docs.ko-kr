...
아래 샘플 PowerShell 명령에는 이미 만들어져 있는 단순한 환경이 필요합니다. 이 문서에 표시된 대로 명령을 실행하려면 먼저 [VNet 만들기에](/previous-versions/azure/virtual-network/virtual-networks-create-vnet-classic-netcfg-ps)설명된 테스트 환경을 빌드합니다.
