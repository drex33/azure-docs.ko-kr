---
title: '신경망 회귀: 구성 요소 참조'
titleSuffix: Azure Machine Learning
description: Azure Machine Learning 신경망 회귀 구성 요소를 사용하여 사용자 지정 가능한 신경망 알고리즘을 사용하여 회귀 모델을 만드는 방법을 알아봅니다.
...
ms.locfileid: "131570056"
---
# <a name="neural-network-regression-component"></a>신경망 회귀 구성 요소
...
이 구성 요소를 사용하여 사용자 지정 가능한 신경망 알고리즘을 사용하여 회귀 모델을 만듭니다.
...
+ [기본 아키텍처를 사용하여 신경망 모델 만들기](#bkmk_DefaultArchitecture)  
    ...
    신경망을 처음 사용하는 경우 여기에서 시작합니다. 구성 요소는 신경망에 대한 깊은 지식 없이 모델 튜닝뿐만 아니라 다양한 사용자 지정을 지원합니다. 
...
1.  디자이너에서 파이프라인에 **신경망 회귀** 구성 요소를 추가합니다. 이 구성 요소는 **회귀** 범주의 **Machine Learning**, **초기화** 에서 찾을 수 있습니다. 
