...
1. [Analytics 열기 및 쿼리 작성](../logs/log-analytics-tutorial.md).
...
3. Power BI Desktop을 열고 **데이터 가져오기** > **빈 쿼리** 를 선택합니다. 그런 다음 쿼리 편집기의 **보기** 에서 **고급 편집기** 를 선택합니다.
   ...
   ![고급 편집기가 강조 표시된 Power BI Desktop을 보여주는 스크린샷](./media/export-power-bi/advancedquery.png)

4. 쿼리에서 항목을 선택하고 깔때기 시각화를 선택합니다.

   ![Power BI Desktop 깔때기 시각화 옵션을 보여주는 스크린샷](./media/export-power-bi/selectsequence.png)
...
애플리케이션에서 보낸 데이터의 양에 따라 원격 분석의 백분율만 보내는 적응 샘플링 기능을 사용할 수 있습니다. 이는 SDK 또는 수집에서 샘플링을 수동으로 설정한 경우에도 마찬가지입니다. [샘플링에 대해 자세히 알아봅니다](./sampling.md).
...
2. **데이터 가져오기** ![왼쪽 하단 모서리의 데이터 가져오기 아이콘 스크린샷](./media/export-power-bi/001.png), **서비스** 를 엽니다.
    ...
    ![스크린샷은 서비스 창에 있는 가져오기 단추를 보여줍니다.](./media/export-power-bi/002.png)
...
4. Application Insights 리소스의 세부 정보를 제공한 다음, **로그인** 합니다.
    ...
    ![스크린샷은 Application Insights에 연결 창을 보여줍니다.](./media/export-power-bi/005.png)
...
* [Analytics 자습서](../logs/log-analytics-tutorial.md)