---
title: CLI 스크립트 - VNet에서 Azure Database for MySQL - 유연한 서버(미리 보기) 만들기
...
ms.locfileid: "128604661"
---
# <a name="create-an-azure-database-for-mysql---flexible-server-preview-in-a-vnet-using-azure-cli"></a>Azure CLI를 사용하여 VNet에서 Azure Database for MySQL - 유연한 서버(미리 보기) 만들기
