...
X.509 인증서 인증을 사용하는 디바이스는 IoT Edge 런타임의 설치 및 프로비저닝을 완료하려면 IoT Hub 이름, 디바이스 이름 및 인증서 파일이 필요합니다.
...
Visual Studio Code 통해 X.509 인증서를 통한 디바이스 등록은 지원되지 않지만 필요한 경우 IoT Edge 디바이스를 볼 수 있습니다.
