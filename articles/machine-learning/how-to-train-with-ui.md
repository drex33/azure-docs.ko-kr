...
큐레이팅 환경은 일반적인 ML 워크로드에서 사용되는 Python 패키지의 Azure 정의 컬렉션입니다. 큐레이팅 환경은 기본적으로 작업 영역에서 사용할 수 있습니다. 이러한 환경은 실행 준비 오버헤드를 줄일 수 있는 캐시된 Docker 이미지에서 지원됩니다. “큐레이팅 환경” 페이지에 표시되는 카드에는 각 환경의 세부 정보가 표시됩니다. 
