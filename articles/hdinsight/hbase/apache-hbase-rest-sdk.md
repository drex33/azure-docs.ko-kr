...
HBase는 데이터 형식이 다음 이미지처럼 표시되도록 [Cloud BigTable](https://cloud.google.com/bigtable/)을 구현합니다.

:::image type="content" source="./media/apache-hbase-rest-sdk/hdinsight-table-roles.png" alt-text="Apache HBase 샘플 데이터 출력" border="true":::
