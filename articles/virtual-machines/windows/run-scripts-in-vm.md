...
[직렬 콘솔](/troubleshoot/azure/virtual-machines/serial-console-windows)은 키보드를 VM에 연결하는 것과 유사하게 VM에 대 한 직접 액세스를 제공합니다.
...
* [직렬 콘솔](/troubleshoot/azure/virtual-machines/serial-console-windows)
