...
| 기능                                                                           | 기본 통과                                                                                                | 표준 통과                                                                                             | 표준 720P 또는 Premium 1080P 인코딩 이벤트                                                                                                                          |
| --------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 단일 비트 전송률 입력은 클라우드에서 여러 비트 전송률로 트랜스코딩됩니다.            | 아니요                                                                                                                | 아니요                                                                                                                | 예                                                                                                                                                          |
| 기여 피드에 대한 최대 비디오 해상도                                    | 4K(60프레임/초에서 4096x2160)                                                                                   | 4K(60프레임/초에서 4096x2160)                                                                                   | 1080p(30프레임/초에서 1920x1088)                                                                                                                           |
| 기여 피드에서 권장되는 최대 계층(대역폭 한도 내에서) | 최대 집계 대역폭이 5Mbps로 제한됩니다.                                                                                              | 최대 집계 대역폭 60Mbps로 제한                                                                                                       | 비디오 트랙 1개 및 오디오 1개(추가 트랙이 자동으로 삭제) 트랙                                                                                                                                                    |
| 출력의 최대 계층                                                          | 입력과 같음                                                                                                     | 입력과 같음                                                                                                     | 최대 6개(아래 시스템 사전 설정 참조)                                                                                                                           |
| 기여 피드의 최대 집계 대역폭                                  | 최대 5Mbps의 결합된 입력을 지원하며, 개별 비트 전송률에서는 4Mbps를 초과하지 않습니다. 비디오 프레임 속도 제한이 없습니다.                                                                                                     | 최대 60Mbps의 결합된 입력을 지원하며, 개별 비트 전송률에서는 20Mbps를 초과하지 않습니다. 비디오 프레임 속도 제한이 없습니다.                                                                                                    | 단일 비트 전송률 입력을 지원합니다. 개별 입력 대역폭은 20Mbps를 초과할 수 없습니다. 비디오 프레임 속도는 초당 60프레임을 초과할 수 없습니다.                                                                                                                                                         |
| 허용되는 최대 DVR(시간 이동) 기간                                  | 최대 8시간                                                                                                     | 최대 25시간                                                                                                    | 최대 25시간                                                                                                                                               |
| 허용되는 최대 라이브 출력 수                                            | 1개의 라이브 출력만                                                                                                | 최대 3개의 라이브 출력                                                                                              | 최대 3개의 라이브 출력                                                                                                                                         |
| 기여에서 단일 계층의 최대 전송률                            | 최대 4Mbps                                                                                                      | 20Mbps                                                                                                           | 20Mbps                                                                                                                                                      |
