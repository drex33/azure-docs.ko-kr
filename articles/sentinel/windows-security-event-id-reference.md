---
title: Azure Sentinel | 보낼 수 있는 보안 이벤트 집합 Windows Microsoft Docs
description: Windows 시스템에서 Azure Sentinel 작업 영역으로 수집 및 스트리밍할 수 있는 미리 빌드된 Windows 보안 이벤트 집합에 대해 알아봅니다.
services: sentinel
...
ms.locfileid: "131482895"
---
# <a name="windows-security-event-sets-that-can-be-sent-to-azure-sentinel"></a>Azure Sentinel 보낼 수 있는 Windows 보안 이벤트 집합
...
이 문서에서는 Windows 이벤트 컬렉션을 Azure Sentinel 필터링하는 방법을 배웠습니다.
