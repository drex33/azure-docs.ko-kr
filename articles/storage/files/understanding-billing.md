...
공유가 기준 IOPS를 초과하고 버스트 버킷에 크레딧이 있을 때마다 최대 허용 최고 버스트 속도로 버스트됩니다. 크레딧이 남아 있는 한 공유는 계속 버스팅할 수 있지만, 이는 누적된 버스트 크레딧 수에 따라 달라집니다. 기준 IOPS를 초과하는 각 IO는 1 크레딧을 사용하고 모든 크레딧을 사용하면 공유는 기준 IOPS로 돌아갑니다.
