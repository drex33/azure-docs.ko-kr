...
이 세대에서 CPU 코어는 6배(최대 48개의 실제 코어까지) 증가했으며, EPC(암호화된 메모리)는 1500x에서 256GB로 증가했으며, 일반 메모리는 12배에서 384GB로 증가했습니다. 이러한 모든 변경 내용은 Gen-On-Gen의 성능을 크게 향상시키고 완전히 새로운 시나리오의 잠금을 해제합니다. 
...
총 메모리 암호화: 다중 키 사용<br>
[Premium Storage](premium-storage-performance.md): 지원됨<br>
[Ultra-Disk Storage:](disks-enable-ultra-ssd.md)지원됨<br>
[가속화된 네트워킹:](../virtual-network/create-vm-accelerated-networking-cli.md)지원됨(CLI 프로비저닝 또는 ARM 템플릿에만 해당)<br>
