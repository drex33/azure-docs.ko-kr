...
장치를 프로 비전 하려면 TPM 칩에서 정보를 수집 하 고 장치 프로 비전 서비스의 인스턴스에 제공 하 여 서비스에서 연결을 시도할 때 장치를 인식할 수 있도록 해야 합니다.

먼저 각 TPM 칩에 고유한 인증 키를 확인 해야 하며이 키와 관련 된 TPM 칩 제조업체에서 가져옵니다. 그런 다음 장치에 대 한 등록 ID를 제공 해야 합니다. 예를 들어 인증 키의 SHA-256 해시를 만들어 TPM 디바이스의 고유한 등록 ID를 파생할 수 있습니다.
