---
title: Azure Cost Management로 클라우드 투자를 최적화
...
- CSP 파트너는 고객의 요구와 고객 관계의 중심에 대한 첫 번째 연락 지점입니다.
- CSP 파트너는 새 고객을 프로비저닝하고, 구독을 주문하고, 구독을 관리하고, 고객 대신 관리 작업을 수행합니다.
- CSP 파트너는 가격 책정, 약관 및 요금 청구를 제어하면서 고유한 솔루션 또는 재판매 Azure를 사용하여 서비스를 번들합니다.
...
예산 기반 자동화에 대한 자세한 내용은 [예산 기반 자동화](../manage/cost-management-budget-scenario.md)를 참조하세요.
...
자세한 내용은 [Azure Reservations란?](../reservations/save-compute-costs-reservations.md)을 참조하세요.
