...
- 버전 1.0.3719.1700: 이 업데이트는 2021년 11월에 릴리스되었으며 다음과 같이 변경되었습니다.
    - 에이전트 오류 메시지가 업데이트되었습니다.
    - 병렬 스택이 업데이트될 때마다 다시 시작되는 에이전트 문제가 해결되었습니다.
    - 일반 에이전트가 향상되었습니다.
- 버전 1.0.3583.2600: 이 업데이트는 2021년 10월에 릴리스되었으며 Windows 10에서 Windows 11로 업그레이드할 때 병렬 스택이 비활성화되는 문제가 해결되었습니다.
- 버전 1.0.3373.2605: 이 업데이트는 2021년 9월에 릴리스되었으며 MSIX 앱 첨부를 사용할 때 패키지 등록 취소가 중단되는 문제가 해결되었습니다.
