---
title: 클라우드용 Microsoft Defender의 보안 점수
...
ms.locfileid: "131014331"
---
# <a name="secure-score-in-microsoft-defender-for-cloud"></a>클라우드용 Microsoft Defender의 보안 점수
...
이러한 목표를 달성할 수 있는 Defender for Cloud의 핵심 기능은 **보안 점수** 입니다.

Defender for Cloud는 리소스, 구독 및 조직에서 보안 문제를 지속적으로 평가합니다. 그런 다음, 현재 보안 상황을 한눈에 파악할 수 있도록 모든 결과를 단일 점수에 집계합니다. 즉, 점수가 높을수록 식별된 위험 수준은 낮습니다.
...
:::image type="content" source="./media/secure-score-security-controls/security-controls.png" alt-text="클라우드용 Microsoft Defender의 보안 제어 및 보안 점수에 미치는 영향" lightbox="./media/secure-score-security-controls/security-controls.png":::
