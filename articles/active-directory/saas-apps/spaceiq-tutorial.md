...
이 자습서에서는 Azure AD(Azure Active Directory)와 SpaceIQ를 통합하는 방법을 알아봅니다. Azure AD와 SpaceIQ를 통합하면 다음을 수행할 수 있습니다.

* SpaceIQ에 대한 액세스 권한이 있는 사용자를 Azure AD에서 제어할 수 있습니다.
* 사용자가 해당 Azure AD 계정으로 SpaceIQ에 자동으로 로그인되도록 설정할 수 있습니다.
...
* SpaceIQ는 [자동화된 사용자 프로비저닝](spaceiq-provisioning-tutorial.md)을 지원합니다.
...
1. **갤러리에서 추가** 섹션의 검색 상자에 **SpaceIQ** 를 입력합니다.
1. 결과 패널에서 **SpaceIQ** 를 선택한 다음, 앱을 추가합니다. 앱이 테넌트에 추가될 때까지 잠시 동안 기다려 주세요.

## <a name="configure-and-test-azure-ad-sso-for-spaceiq"></a>SpaceIQ에 대한 Azure AD SSO 구성 및 테스트

**B.Simon** 이라는 테스트 사용자를 사용하여 SpaceIQ에서 Azure AD SSO를 구성하고 테스트합니다. SSO가 작동하려면 Azure AD 사용자와 SpaceIQ의 관련 사용자 간에 연결 관계를 설정해야 합니다.

SpaceIQ에서 Azure AD SSO를 구성하고 테스트하려면 다음 단계를 수행하세요.

1. **[Azure AD SSO 구성](#configure-azure-ad-sso)** - 사용자가 이 기능을 사용할 수 있도록 합니다.
    1. **[Azure AD 테스트 사용자 만들기](#create-an-azure-ad-test-user)** - B.Simon을 사용하여 Azure AD Single Sign-On을 테스트합니다.
    1. **[Azure AD 테스트 사용자 할당](#assign-the-azure-ad-test-user)** - B. Simon이 Azure AD Single Sign-On을 사용할 수 있도록 합니다.
1. **[SpaceIQ SSO 구성](#configure-spaceiq-sso)** - 애플리케이션 쪽에서 Single Sign-On 설정을 구성합니다.
    1. **[SpaceIQ 테스트 사용자 만들기](#create-spaceiq-test-user)** - 사용자의 Azure AD 표현과 연결된 B.Simon에 해당하는 사용자를 SpaceIQ에 만듭니다.
...
1. Azure Portal의 **SpaceIQ** 애플리케이션 통합 페이지에서 **관리** 섹션을 찾은 후 **Single Sign-On** 을 선택합니다.
...
4. **SAML로 Single Sign-On 설정** 페이지에서 다음 단계를 수행합니다.
    ...
    b. **회신 URL** 텍스트 상자에서 `https://api.spaceiq.com/saml/<INSTANCE_ID>/callback` 패턴을 사용하여 URL을 입력합니다.
...
이 섹션에서는 Azure Single Sign-On을 사용할 수 있도록 B.Simon에게 SpaceIQ에 대한 액세스 권한을 부여합니다.

1. Azure Portal에서 **엔터프라이즈 애플리케이션** 을 선택한 다음, **모든 애플리케이션** 을 선택합니다.
1. 애플리케이션 목록에서 **SpaceIQ** 를 선택합니다.
...
## <a name="configure-spaceiq-sso"></a>SpaceIQ SSO 구성

1. 새 브라우저 창을 열고 SpaceIQ 환경에 관리자 권한으로 로그인합니다.

1. 로그인되었으면 오른쪽 맨 위의 퍼즐 기호를 클릭한 다음, **통합** 을 클릭합니다.

    ![계정 설정](./media/spaceiq-tutorial/setting.png) 

1. **모든 프로비전 및 SSO** 아래에서 **Azure** 타일을 클릭하여 Azure 인스턴스를 IDP로 추가합니다.

    ![SAML 아이콘](./media/spaceiq-tutorial/azure.png)

1. **SSO** 대화 상자에서 다음 단계를 수행합니다.

    ![SAML 인증 설정](./media/spaceiq-tutorial/configuration.png)
...
SpaceIQ는 자동 사용자 프로비저닝도 지원합니다. 자동 사용자 프로비저닝 구성 방법에 대한 자세한 내용은 [여기](./spaceiq-provisioning-tutorial.md)에서 제공합니다.

## <a name="test-sso"></a>SSO 테스트

이 섹션에서는 다음 옵션을 사용하여 Azure AD Single Sign-On 구성을 테스트합니다.

* Azure Portal에서 이 애플리케이션 테스트를 클릭하면 SSO를 설정한 SpaceIQ에 자동으로 로그인됩니다.

* Microsoft 내 앱을 사용할 수 있습니다. 내 앱에서 SpaceIQ 타일을 클릭하면 SSO를 설정한 SpaceIQ에 자동으로 로그인됩니다. 내 앱에 대한 자세한 내용은 [내 앱 소개](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510)를 참조하세요.
