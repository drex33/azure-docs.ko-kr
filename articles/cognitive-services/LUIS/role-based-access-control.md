...
ms.locfileid: "131894571"
---
# <a name="luis-role-based-access-control"></a>LUIS 역할 기반 액세스 제어

LUIS는 azure 리소스에 대 한 개별 액세스를 관리 하기 위한 권한 부여 시스템용 azure RBAC (역할 기반 액세스 제어)를 지원 합니다. Azure RBAC를 사용 하 여 LUIS authoring 리소스에 대해 다른 팀 구성원에 게 다른 수준의 사용 권한을 할당 합니다. 자세한 내용은 [AZURE RBAC 설명서](/azure/role-based-access-control/) 를 참조 하세요.
...
LUIS는 Azure Active Directory (AAD) 인증을 지원 합니다. 자세한 내용은 [Azure Active Directory를 사용 하 여 인증](/azure/cognitive-services/authentication#authenticate-with-azure-active-directory)을 참조 하세요.
