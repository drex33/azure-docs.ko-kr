...
Azure Portal에서 그룹을 만들고 관리 하는 것 외에도 API Management REST API [그룹](/rest/api/apimanagement/apimanagementrest/azure-api-management-rest-api-group-entity) 엔터티를 사용 하 여 그룹을 만들고 관리할 수 있습니다.
...
## <a name="create-a-group"></a><a name="create-group"> </a>그룹 만들기
...
## <a name="associate-a-group-with-a-product"></a><a name="associate-group-product"> </a>그룹과 제품 연결
...
## <a name="associate-groups-with-developers"></a><a name="associate-group-developer"> </a>그룹과 개발자 연결
