...
| 이벤트 유형 | Description |
| ---------- | ----------- |
| Microsoft.apimanagement | 사용자가 만들어질 때 발생합니다. |
| Microsoft.apimanagement | 사용자가 업데이트될 때 발생합니다. |
| Microsoft.apimanagement | 사용자가 삭제될 때 발생합니다. |
| Microsoft.apimanagement입니다. | API가 만들어질 때 발생합니다. |
| Microsoft.apimanagement이 업데이트 되었습니다. | API가 업데이트될 때 발생합니다. |
| Microsoft.apimanagement | API가 삭제될 때 발생합니다. |
| Microsoft.apimanagement를 만들었습니다. | 제품이 만들어질 때 발생합니다. |
| Microsoft.apimanagement 업데이트 됨 | 제품이 업데이트될 때 발생합니다. |
| Microsoft.apimanagement 삭제 됨 | 제품이 삭제될 때 발생합니다. |
| Microsoft.apimanagement. ReleaseCreated | API 릴리스가 만들어질 때 발생합니다. |
| Microsoft.apimanagement이 업데이트 되었습니다. | API 릴리스가 업데이트될 때 발생합니다. |
| Microsoft.apimanagement 삭제 됨 | API 릴리스가 삭제될 때 발생합니다. |
| Microsoft.apimanagement를 만들었습니다. | 구독이 만들어질 때 발생합니다. |
| Microsoft.apimanagement이 업데이트 되었습니다. | 구독이 업데이트될 때 발생합니다. |
| Microsoft.apimanagement 삭제 됨 | 구독이 삭제될 때 발생합니다. |
