---
title: Azure Portal을 사용하여 통합 런타임 만들기
description: Azure에서 SSIS 패키지를 배포 하 고 실행할 수 있도록 Azure Data Factory에서 Azure Portal를 사용 하 여 Azure SSIS 통합 런타임을 만드는 방법에 대해 알아봅니다.
