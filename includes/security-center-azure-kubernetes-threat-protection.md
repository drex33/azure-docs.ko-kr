...
* **클러스터 수준(Microsoft Defender for Kubernetes에서 제공)** - 클러스터 수준의 위협 보호는 Kubernetes의 감사 로그 분석을 기반으로 합니다. 이 **에이전트 없는** 모니터링을 사용하도록 설정하려면 향상된 보안 기능을 사용하도록 설정합니다. 클러스터가 온-프레미스 또는 다른 클라우드 공급자에 있는 경우 [Azure Arc 지원 Kubernetes 및 Microsoft Defender 확장](../articles/security-center/defender-for-kubernetes-azure-arc.md)을 사용하도록 설정합니다.
