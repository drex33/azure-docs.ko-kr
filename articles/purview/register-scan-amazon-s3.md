...
1. 새로 **만들기를 선택 하** 여 새 자격 증명을 만듭니다.
    ...
    오른쪽에 표시 되는 **새 자격 증명** 창의 **인증 방법** 드롭다운에서 **역할 arn** 을 선택 합니다. 
    
    그런 다음 별도의 파일에 표시 되는 **MICROSOFT 계정 ID** 및 **외부 id** 값을 복사 하거나 AWS의 관련 필드에 붙여 넣을 수 있습니다. 예를 들면 다음과 같습니다.
