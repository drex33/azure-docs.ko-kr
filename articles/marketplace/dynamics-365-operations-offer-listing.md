...
:::image type="content" source="media/dynamics-365/example-d365-operations.png" alt-text="이 제품이 Microsoft AppSource에서 어떻게 표시되는지 보여 줍니다.":::

- 상단의 상자 섹션에는 로고와 제품 이름이 포함되어 있으며 그 뒤에 검색 결과 요약, 등급 및 가격 선택 항목이 있습니다.
- **개요** 탭에는 검색 결과 요약, 설명, 샘플 스크린샷 및 링크된 동영상 썸네일(선택 사항)이 포함되어 있습니다.
- **세부 정보 + 지원** 탭에는 가격 구조, 버전, 라이선스 계약, 개인 정보 취급 방침 및 지원과 같은 주제에 대해 제공한 정보가 포함되어 있습니다.

이러한 마켓플레이스 세부 정보를 입력하는 방법은 아래를 계속 읽으세요.
...
제안이 작동하는 방식을 보여 주는 스크린샷을 1개 이상(최대 5개) 추가합니다. 모든 스크린샷은 1280x720 픽셀이고 PNG 형식이어야 합니다. 각 스크린샷에 대한 캡션을 추가합니다.
...
- [제안 가용성 설정](dynamics-365-operations-availability.md)
