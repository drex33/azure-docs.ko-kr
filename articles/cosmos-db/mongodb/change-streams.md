...
## <a name="scaling-change-streams"></a>변경 스트리밍 크기 조정
대규모 변경 스트리밍을 사용할 때는 부하를 고르게 분산하는 것이 가장 좋습니다. [GetChangeStreamTokens 사용자 지정 명령](../mongodb/custom-commands.md)을 사용하여 실제 분할/파티션에 부하를 분산합니다.
