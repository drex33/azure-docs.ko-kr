---
title: Microsoft 센티널 콘텐츠 허브 카탈로그 | Microsoft Docs
description: 이 문서에서는 현재 사용 가능한 Microsoft 센티널 콘텐츠 허브 패키지를 표시 하 고 자세히 설명 합니다.
services: sentinel
cloud: na
...
ms.locfileid: "132516929"
---
# <a name="microsoft-sentinel-content-hub-catalog"></a>Microsoft 센티널 콘텐츠 허브 카탈로그

[!INCLUDE [Banner for top of topics](./includes/banner.md)]

> [!IMPORTANT]
>
> Microsoft 센티널 content hub 환경은 모든 개별 솔루션 패키지와 마찬가지로 현재 **미리 보기** 상태입니다. 베타 또는 미리 보기로 제공되거나 아직 일반 공급으로 릴리스되지 않은 Azure 기능에 적용되는 추가 약관은 [Microsoft Azure 미리 보기에 대한 추가 사용 약관](https://azure.microsoft.com/support/legal/preview-supplemental-terms/)을 참조하세요.

[Microsoft 센티널 솔루션](sentinel-solutions.md) 은 단일 배포 단계를 사용 하 여 작업 영역에서 microsoft 센티널 콘텐츠 (예: 데이터 커넥터, 통합 문서, 분석 및 자동화)를 획득 하는 통합 된 방법을 제공 합니다.

이 문서에는 작업 영역에서 배포할 수 있는 기본 제공 (기본 제공), 주문형 Microsoft 센티널 데이터 커넥터 및 솔루션이 나열 되어 있습니다. 솔루션을 배포 하면 데이터 커넥터, 플레이 북, 통합 문서, 규칙 등의 포함 된 보안 콘텐츠가 Microsoft 센티널의 관련 영역에 포함 됩니다. 

자세한 내용은 [Microsoft 센티널의 중앙 검색 및 배포](sentinel-solutions-deploy.md)를 참조 하세요.
...
| **Microsoft 센티널 사기** | [통합 문서, 분석 규칙, watchlists](monitor-key-vault-honeytokens.md)  | 보안 위협 방지  |Microsoft |
...
|Name    |Includes  |범주 |지원 요소  |
|---------|---------|---------|---------|
|**Sentinel용 Azure Firewall 솔루션**| [데이터 커넥터](data-connectors-reference.md#azure-firewall), 통합 문서, 분석 규칙, 플레이 북, 구하기 쿼리, 사용자 지정 논리 앱 커넥터 |보안-네트워크 보안, 네트워킹 | 커뮤니티|
|**SQL PaaS 용 Microsoft 센티널**     |  [데이터 커넥터](data-connectors-reference.md#azure-sql-databases), 통합 문서, 분석 규칙, 플레이 북, 구하기 쿼리     | 애플리케이션        |      커뮤니티   |
|**Microsoft 센티널 학습 랩** |통합 문서, 분석 규칙, 플레이 북, 구하기 쿼리 | 교육 및 자습서 |Microsoft |
|**Azure SQL** | [데이터 커넥터](data-connectors-reference.md#azure-sql-databases), 통합 문서, 분석, 플레이 북, 구하기 쿼리  | 애플리케이션 |Microsoft  |
| | | | |
...
|Name   |Includes  |범주 |지원 요소  |
|------------------|---------|---------|---------|
|**Check Point Microsoft 센티널 솔루션**   |[데이터 커넥터](data-connectors-reference.md#check-point), 플레이 북, 사용자 지정 논리 앱 커넥터  | 보안 자동화 (대화 충성도) | [검사점](https://www.checkpoint.com/support-services/contact-support/)|
| | | | |
...
|Name    |Includes  |범주 |지원 요소  |
|---------|---------|---------|---------|
|**Microsoft 센티널 솔루션 갤러리에 대 한 HYAS 정보**| 플레이북| 보안 위협 인텔리전스, 보안 자동화 (대화 충성도) |Microsoft |
| | | | |
...
|Name    |Includes  |범주 |지원 요소  |
|---------|---------|---------|---------|
|**IronNet 사이버 보안 철 방어-Microsoft 센티널** | |보안-네트워크 |Microsoft |
| | | |
...
|Name    |Includes  |범주 |지원 요소  |
|---------|---------|---------|---------|
|**Microsoft 센티널의 모바일 위협 방어**| [데이터 커넥터](data-connectors-reference.md#lookout-mobile-threat-defense-preview)|보안-네트워크 |[Lookout](https://www.lookout.com/support) |
| | | |
...
|Name    |Includes  |범주 |지원 요소  |
|---------|---------|---------|---------|
|**Microsoft 센티널 4 Microsoft Dynamics 365**     |   [데이터 커넥터](data-connectors-reference.md#dynamics-365), 통합 문서, 분석 규칙 및 구하기 쿼리 |      애플리케이션   |Microsoft         |
|**Teams 용 Microsoft 센티널**     | 데이터 커넥터, 분석 규칙, 플레이 북, 구하기 쿼리      |   애플리케이션      |    커뮤니티     |
| | | | |
...
|Name    |Includes  |범주 |지원 요소  |
|---------|---------|---------|---------|
|**Microsoft Sentinel용 Senserva 제안** |데이터 커넥터, 통합 문서, 분석 규칙, 헌팅 쿼리 |규정 준수 |[Senserva](https://www.senserva.com/contact/) |
| | | | |
...
|Name    |Includes  |범주 |지원 요소  |
|---------|---------|---------|---------|
|**Sonrai 보안 - Microsoft Sentinel** |데이터 커넥터, 통합 문서, 분석 규칙   | 규정 준수|Sonrai 보안 |
| | | | |
