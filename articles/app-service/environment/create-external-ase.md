...
8. ASE의 이름을 입력합니다. 이 이름은 앱에 주소를 지정할 수 있는 이름에 사용됩니다. ASE의 이름이 _appsvcenvdemo_ 인 경우 도메인 이름은 *.appsvcenvdemo.p.azurewebsites.net* 입니다. *mytestapp* 이라는 앱을 만든 경우 mytestapp.appsvcenvdemo.p.azurewebsites.net으로 주소를 지정할 수 있습니다. 이름에 공백을 사용할 수 없습니다. 대문자를 사용한 경우 도메인 이름은 해당 이름의 소문자 버전이 됩니다.
...
1. ASE의 이름을 입력합니다. 이 이름은 앱에 주소를 지정할 수 있는 이름에 사용됩니다. ASE의 이름이 _appsvcenvdemo_ 인 경우 도메인 이름은 *.appsvcenvdemo.p.azurewebsites.net* 입니다. *mytestapp* 이라는 앱을 만든 경우 mytestapp.appsvcenvdemo.p.azurewebsites.net으로 주소를 지정할 수 있습니다. 이름에 공백을 사용할 수 없습니다. 대문자를 사용한 경우 도메인 이름은 해당 이름의 소문자 버전이 됩니다.
