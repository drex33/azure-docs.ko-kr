...
| 컴퓨팅 크기 조정 | 지원됨(기본 계층에서 기본 계층으로 크기 조정은 **지원되지 않음)**| 지원 여부 | 지원 여부|
...
| 개발용 서버 중지/시작 | 서버를 최대 7 일까 지 중지할 수 있음 | 서버를 30 일까지 중지할 수 있습니다. | 지원 여부 |
| 저렴 한 비용의 안정적인 SKU | 지원되지 않음 | 지원됨 | 지원 여부 |
...
| Azure AD 인증 | 지원 여부 | 지원되지 않음 | 지원되지 않음|
| Azure defender 지원 | 예 | 예 | 예 |
| 서버 감사 | 지원됨 | 지원 여부 | 사용자 관리 |
...
| 영역 중복 | 지원되지 않음 | 지원 여부 | 지원 여부|
| 대기 영역 배치 | 지원되지 않음 | 지원 여부 | 지원 여부|
| 자동 장애 조치(automatic failover) | 예(다른 서버 회전)| Yes | 사용자 관리|
| 사용자가 강제 장애 조치 (failover) 시작 | 예 | 예 | 사용자 관리 |
...
| 읽기 복제본에 대한 Gtid 지원 | 지원됨 | 지원 여부 | 사용자 관리 |
...
| 데이터 내 복제에 대한 Gtid 지원 | 지원 여부 | 지원됨 | 사용자 관리 |
...
| Terraform 지원 | 지원됨 | 지원 여부 | 지원됨 |
| GitHub 작업 | 지원됨 | 지원 여부 | 사용자 관리 |
