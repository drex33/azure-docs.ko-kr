...
비 Azure 컴퓨터를 Azure Security Center에 추가하려면 [Azure Arc 지원 서버](../azure-arc/servers/overview.md)를 사용하는 것이 좋습니다.
...
축하합니다! 이제 Azure 및 비 Azure 컴퓨터를 한 장소에서 모두 볼 수 있습니다. [자산 인벤토리 페이지](asset-inventory.md)를 열고 관련 리소스 종류로 필터링합니다. 이러한 아이콘은 다음과 같은 종류를 구분합니다.
  ...
  ![Azure Arc 서버에 대한 ASC 아이콘.](./media/quick-onboard-linux-computer/arc-enabled-machine-icon.png) Azure Arc 지원 서버
