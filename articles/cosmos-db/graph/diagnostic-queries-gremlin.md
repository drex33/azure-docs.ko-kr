---
title: Gremlin API에 대한 고급 진단 쿼리 문제 해결
titleSuffix: Azure Cosmos DB
description: Azure Cosmos DB for Gremlin API에 저장된 데이터와 관련된 문제를 해결하기 위해 진단 로그를 쿼리하는 방법에 대해 알아봅니다.
author: StefArroyo
services: cosmos-db
...
ms.locfileid: "122608905"
---
# <a name="troubleshoot-issues-with-advanced-diagnostics-queries-for-the-gremlin-api"></a>Gremlin API에 대한 고급 진단 쿼리 문제 해결
