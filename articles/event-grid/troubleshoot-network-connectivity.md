...
Event Grid 항목/도메인 [진단 로그 사용](enable-diagnostic-logs-topic.md#enable-diagnostic-logs-for-a-custom-topic)에 대한 진단 로그를 사용합니다. 거부된 연결의 IP 주소가 표시됩니다.
