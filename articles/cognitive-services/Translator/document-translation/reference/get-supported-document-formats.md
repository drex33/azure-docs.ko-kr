---
title: 지원되는 문서 형식 가져오기 메서드
titleSuffix: Azure Cognitive Services
description: 지원되는 문서 형식 가져오기 메서드는 지원되는 문서 형식 목록을 반환합니다.
...
### <a name="successful-fileformatlistresult-response"></a>성공적인 fileFormatListResult 응답
...
|value.defaultVersion|문자열|지정되지 않은 경우 기본 버전입니다.|
