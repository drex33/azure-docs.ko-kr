...
ms.locfileid: "130167175"
---
# <a name="disaster-recovery-strategies-for-applications-using-azure-sql-database-elastic-pools"></a>Azure SQL Database 탄력적 풀을 사용하는 애플리케이션 재해 복구 전략
[!INCLUDE[appliesto-sqldb](../includes/appliesto-sqldb.md)]

Azure SQL Database는 재해 발생 시 애플리케이션의 비즈니스 연속성을 위해 몇 가지 기능을 제공합니다. [탄력적 풀](elastic-pool-overview.md) 및 단일 데이터베이스는 동일한 종류의 DR(재해 복구) 기능을 지원합니다. 이 문서에서는 Azure SQL Database 비즈니스 연속성 기능을 활용하는 탄력적 풀에 대한 몇 가지 DR 전략을 설명합니다.
...
![그림 1](./media/disaster-recovery-strategies-for-applications-with-elastic-pool/diagram-1.png)
...
![그림 2](./media/disaster-recovery-strategies-for-applications-with-elastic-pool/diagram-2.png)
...
![그림 3](./media/disaster-recovery-strategies-for-applications-with-elastic-pool/diagram-3.png)
...
![관리 데이터베이스와 유료 고객 주 풀 및 보조 풀 간에는 지역 복제를 사용하고 평가판 고객 풀에는 복제를 사용하지 않는 주 지역 및 DR 지역을 보여 주는 다이어그램](./media/disaster-recovery-strategies-for-applications-with-elastic-pool/diagram-4.png)
...
![주 지역의 중단 및 관리 데이터베이스로 장애 조치(failover), 유료 고객 보조 풀, 평가판 고객을 위한 생성 및 복원을 보여 주는 다이어그램](./media/disaster-recovery-strategies-for-applications-with-elastic-pool/diagram-5.png)
...
![주 지역을 복원한 후 구현할 장애 복구(failback) 단계를 보여 주는 다이어그램](./media/disaster-recovery-strategies-for-applications-with-elastic-pool/diagram-6.png)
...
![관리 데이터베이스와 유료 고객 주 풀 및 보조 풀 간에는 지역 복제를 사용하고 평가판 고객 풀에는 복제를 사용하지 않는 지역 A라는 주 지역 및 지역 B라는 보조 지역을 보여 주는 다이어그램](./media/disaster-recovery-strategies-for-applications-with-elastic-pool/diagram-7.png)
...
![주 지역의 중단 및 관리 데이터베이스로 장애 조치(failover), 유료 고객 보조 풀, 평가판 고객을 위한 지역 B로 생성 및 복원을 보여 주는 다이어그램](./media/disaster-recovery-strategies-for-applications-with-elastic-pool/diagram-8.png)
...
![지역 A를 복원한 후 구현할 장애 복구(failback) 단계를 보여 주는 다이어그램](./media/disaster-recovery-strategies-for-applications-with-elastic-pool/diagram-9.png)
...
* Azure SQL Database 자동화 백업에 대한 자세한 내용은 [Azure SQL Database 자동화 백업](automated-backups-overview.md)을 참조하세요.
...
* 보관을 위해 자동화된 백업을 사용하는 방법을 알아보려면 [데이터베이스 복사](database-copy.md)를 참조하세요.
