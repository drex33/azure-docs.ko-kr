...
지역 중복 백업을 사용 하 여 서버를 구성한 경우 지역 쌍으로 연결 된 [지역](../../best-practices-availability-paired-regions.md)으로 복원할 수 있습니다. 지역 중복 백업 지원 [지역](overview.md#azure-regions)을 참조 하세요.
