...
![동기화 엔진 및 연결된 데이터 원본이 커넥터라는 선으로 연결된 다이어그램](./media/concept-azure-ad-connect-sync-architecture/arch1.png)
...
![커넥터 공간 및 메타버스 네임스페이스로 분리된 동기화 엔진 및 연결된 데이터 원본이 커넥터라는 선으로 연결된 다이어그램](./media/concept-azure-ad-connect-sync-architecture/arch2.png)
...
![연결된 데이터 원본에서 동기화 엔진의 커넥터 공간 네임스페이스로 가져오는 가져오기 개체 다이어그램](./media/concept-azure-ad-connect-sync-architecture/arch3.png)
...
![메타버스에서 커넥터 공간 네임스페이스로 가져온 후 연결된 데이터 원본으로 가져오는 내보내기 개체 다이어그램](./media/concept-azure-ad-connect-sync-architecture/arch4.png)
...
![조인된 개체 및 조인되지 않은 개체가 있는 동기화 엔진에 두 개의 연결된 데이터 개체가 커넥터로 연결된 다이어그램](./media/concept-azure-ad-connect-sync-architecture/arch5.png)
...
![연결된 데이터에서 커넥터 공간(가져오기), 메타버스, 커넥터 공간(동기화), 연결된 데이터(내보내기)로 차례로 이동하는 ID 정보 흐름 다이어그램](./media/concept-azure-ad-connect-sync-architecture/arch6.png)
...
![커넥터를 통한 커넥터 공간 및 연결된 데이터 간 개체 동기화 다이어그램](./media/concept-azure-ad-connect-sync-architecture/arch7.png)
