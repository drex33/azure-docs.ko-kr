---
title: CLI(v2) 관리형 배치 엔드포인트 YAML 스키마
titleSuffix: Azure Machine Learning
description: CLI(v2) 관리형 배치 엔드포인트 YAML 스키마에 대한 참조 설명서입니다.
...
ms.locfileid: "122536071"
---
# <a name="cli-v2-managed-batch-endpoint-yaml-schema"></a>CLI(v2) 관리형 배치 엔드포인트 YAML 스키마

[!INCLUDE [preview disclaimer](../../includes/machine-learning-preview-generic-disclaimer.md)]

## <a name="schema"></a>스키마

원본 JSON 스키마는 https://azuremlschemas.azureedge.net/latest/batchEndpoint.schema.json 에서 찾을 수 있습니다. 스키마는 편의상 JSON 및 YAML 형식으로 아래에 제공됩니다.
