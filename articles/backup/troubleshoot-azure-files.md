...
- 스토리지 계정의 방화벽 설정을 확인하여 "신뢰할 수 있는 _서비스 목록의 Azure 서비스가 이 스토리지 계정에 액세스하도록 허용"_ 예외가 부여되었는지 확인합니다. 예외를 부여하는 단계는 [이](../storage/common/storage-network-security.md?tabs=azure-portal#manage-exceptions) 링크를 참조할 수 있습니다.
