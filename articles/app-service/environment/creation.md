...
내부 및 외부의 두 가지 VIP 유형이 있습니다. 내부 VIP를 사용하면 ASE 서브넷의 주소에서 ASE에 앱이 연결되고 앱이 공용 DNS에 없습니다. 포털에서 만드는 동안 ASE에 대한 Azure 프라이빗 DNS 영역을 만드는 옵션이 있습니다. 외부 VIP를 사용하면 앱이 공용 인터넷 연결 주소에 있고 앱이 공용 DNS에 있습니다. 
