...
> [!NOTE]
> [.NET CLI](/dotnet/core/tools) 및 .NET 5.0은 모두 플랫폼 간이지만 .NET Framework는 그렇지 않습니다. .NET CLI를 사용하여 .NET Framework 앱을 개발하는 경우 Windows 머신을 사용하여 빌드 종속성을 충족하는 것이 좋습니다. .NET 5.0은 플랫폼 간입니다.
...
> [!NOTE]
> [Azure PowerShell](/powershell/azure/) 및 .NET 5.0은 모두 플랫폼 간이지만 .NET Framework는 그렇지 않습니다. .NET CLI를 사용하여 .NET Framework 앱을 개발하는 경우 Windows 머신을 사용하여 빌드 종속성을 충족하는 것이 좋습니다.
