---
title: 'Azure ExpressRoute 개요: 프라이빗 연결을 통해 연결'
...
예를 들어 ExpressRoute를 통해 암스테르담의 Microsoft에 연결하는 경우입니다. 북유럽 및 서유럽에서 호스팅되는 모든 Microsoft 클라우드 서비스에 액세스할 수 있습니다. 지정학적 지역, 연관된 Microsoft 클라우드 지역 및 해당 ExpressRoute 피어링 위치에 대한 개요는 [ExpressRoute 파트너 및 피어링 위치](expressroute-locations.md) 문서를 참조하세요.
...
연결을 종료하지 않고 ExpressRoute 회로 대역폭을 증가시킬 수 있습니다(최상의 방식으로). 자세한 내용은 [ExpressRoute 회로 수정](expressroute-howto-circuit-portal-resource-manager.md#modify)을 참조하세요.
