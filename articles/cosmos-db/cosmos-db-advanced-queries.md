---
title: 고급 진단 쿼리 문제 해결(SQL API)
titleSuffix: Azure Cosmos DB
description: Azure Cosmos DB - SQL API에 저장된 데이터와 관련된 문제를 해결하기 위해 진단 로그를 쿼리하는 방법에 대해 알아봅니다.
author: StefArroyo
services: cosmos-db
...
ms.locfileid: "123097776"
---
# <a name="troubleshoot-issues-with-advanced-diagnostics-queries-for-the-sql-core-api"></a>SQL(코어) API에 대한 고급 진단 쿼리 문제 해결
...
### <a name="top-n10-queries-ordered-by-request-unit-ru-consumption-in-a-specific-time-frame"></a>특정 시간 프레임의 RU(요청 단위) 소비에 따라 정렬된 상위 N(10)개의 쿼리
...
### <a name="queries-with-the-largest-response-lengths-payload-size-of-the-server-response"></a>응답 길이가 가장 큰 쿼리(서버 응답의 페이로드 크기)
