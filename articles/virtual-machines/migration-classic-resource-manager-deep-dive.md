...
![마이그레이션 워크플로를 보여 주는 스크린샷](./media/migration-classic-resource-manager/migration-workflow.png)
...
![원본 클라우드 서비스를 보여 주는 스크린샷](./media/migration-classic-resource-manager/portal-classic.png)

![준비 작업에서 Azure Resource Manager 리소스를 보여 주는 스크린샷](./media/migration-classic-resource-manager/portal-arm.png)

준비 단계가 완료된 후 화면 뒤에 숨어 있는 리소스의 모양은 다음과 같습니다. 데이터 평면의 리소스는 동일합니다. 관리 평면(클래식 배포 모델) 및 제어 평면(리소스 관리자)에서 모두 표시됩니다.

![준비 단계 다이어그램](./media/migration-classic-resource-manager/behind-the-scenes-prepare.png)
...
![중단 단계 다이어그램](media/migration-classic-resource-manager/behind-the-scenes-abort.png)
...
![커밋 단계 다이어그램](media/migration-classic-resource-manager/behind-the-scenes-commit.png)
...
| VM당 공용 IP 주소 |동적 할당 방법의 공용 IP 주소 |VM과 연결된 공용 IP 주소는 할당 방법을 동적으로 설정하여 공용 IP 주소 리소스로 변환됩니다. |
