...
ms.date: 10/21/2021
ms.openlocfilehash: d8ddf4b1159ec4625226c93c8440931ecfb7af17
ms.sourcegitcommit: 1244a72dbec39ac8cf16bb1799d8c46bde749d47
ms.translationtype: MT
ms.contentlocale: ko-KR
ms.lasthandoff: 11/18/2021
ms.locfileid: "132757657"
---
...
- 채점 스크립트 - 점수 매기기/추론을 수행하는 데 필요한 코드
...
자동 크기 조정은 애플리케이션의 부하를 처리하기 위해 적절한 양의 리소스를 자동으로 실행합니다. 관리형 엔드포인트는 Azure Monitor 자동 크기 조정 기능과의 통합을 통해 [자동 크기](/azure/azure-monitor/autoscale/autoscale-overview) 조정을 지원합니다. 메트릭 기반 크기 조정(예: CPU 사용률 >70%), 일정 기반 크기 조정(예: 최대 업무 시간에 대한 크기 조정 규칙) 또는 조합을 구성할 수 있습니다.
