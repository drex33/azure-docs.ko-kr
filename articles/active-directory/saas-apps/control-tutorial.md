---
title: '자습서: Continuity Control과 Azure AD SSO 통합'
...
ms.locfileid: "132296445"
---
# <a name="tutorial-azure-ad-sso-integration-with-continuity-control"></a>자습서: Continuity Control과 Azure AD SSO 통합
...
* Control은 **SP** 시작 SSO를 지원합니다.

> [!NOTE]
> 이 애플리케이션의 식별자는 고정 문자열 값이므로 하나의 테넌트에서 하나의 인스턴스만 구성할 수 있습니다.

## <a name="add-control-from-the-gallery"></a>갤러리에서 Control 추가
...
## <a name="configure-and-test-azure-ad-sso-for-control"></a>Control에 대한 Azure AD SSO 구성 및 테스트

**B.Simon** 이라는 테스트 사용자를 사용하여 Control에서 Azure AD SSO를 구성하고 테스트합니다. 즉, Azure AD 사용자와 Control의 관련 사용자 간에 연결이 형성되어야 합니다.

Control에서 Azure AD SSO를 구성하고 테스트하려면 다음 단계를 수행합니다.

1. **[Azure AD SSO 구성](#configure-azure-ad-sso)** - 사용자가 이 기능을 사용할 수 있도록 합니다.
    1. **[Azure AD 테스트 사용자 만들기](#create-an-azure-ad-test-user)** - B.Simon을 사용하여 Azure AD Single Sign-On을 테스트합니다.
    1. **[Azure AD 테스트 사용자 할당](#assign-the-azure-ad-test-user)** - B. Simon이 Azure AD Single Sign-On을 사용할 수 있도록 합니다.
1. **[Control SSO 구성](#configure-control-sso)** - 애플리케이션 쪽에서 Single Sign-On 설정을 구성합니다.
    1. **[Control 테스트 사용자 만들기](#create-control-test-user)** - B.Simon의 Azure AD 표현과 연결된 해당 사용자를 Control에 만듭니다.
...
1. Azure Portal의 **Control** 애플리케이션 통합 페이지에서 **관리** 섹션을 찾아 **Single Sign-On** 을 선택합니다.
...
* Azure Portal에서 **이 애플리케이션 테스트** 를 클릭합니다. 그러면 로그인 흐름을 시작할 수 있는 Control 로그온 URL로 리디렉션됩니다. 

* Control 로그온 URL로 직접 이동하여 해당 위치에서 로그인 흐름을 시작합니다.

* Microsoft 내 앱을 사용할 수 있습니다. 내 앱에 Control 타일을 클릭하면 Control 로그온 URL로 리디렉션됩니다. 내 앱에 대한 자세한 내용은 [내 앱 소개](../user-help/my-apps-portal-end-user-access.md)를 참조하세요.

## <a name="next-steps"></a>다음 단계

Control을 구성한 후에는 세션 제어를 적용하여 조직의 중요한 데이터의 반출 및 침입을 실시간으로 보호할 수 있습니다. 세션 제어는 조건부 액세스에서 확장됩니다. [Microsoft Defender for Cloud Apps를 사용하여 세션 제어를 적용하는 방법을 알아봅니다](/cloud-app-security/proxy-deployment-aad).
