...
ms.openlocfilehash: 13fd58418864db666a2874d27e7df3ace087610d
ms.sourcegitcommit: 1244a72dbec39ac8cf16bb1799d8c46bde749d47
ms.translationtype: MT
ms.contentlocale: ko-KR
ms.lasthandoff: 11/18/2021
ms.locfileid: "132761556"
---
...
| 제로 트러스트(TIC3.0) |통합 문서 |ID, 보안 - 기타 |Microsoft |
| | | | |
...
|Name    |Includes  |범주 |지원 요소  |
|---------|---------|---------|---------|
|**vArmour 애플리케이션 컨트롤러 및 Microsoft Sentinel 솔루션**|데이터 커넥터, 통합 문서, 분석 규칙 |IT 운영 |[vArmour](https://www.varmour.com/contact-us/) |
| | | | |
...
|Name    |Includes  |범주 |지원 요소  |
|---------|---------|---------|---------|
|**Microsoft Sentinel용 Corelight**|데이터 커넥터, 통합 문서, 분석 규칙, 헌팅 쿼리, 파서 | IT 운영, 보안 - 네트워크 | [Zeek 네트워크](https://support.corelight.com/)|
| | | | |


## <a name="next-steps"></a>다음 단계

이 문서에서는 Microsoft Sentinel 솔루션 및 솔루션을 찾아 배포하는 방법에 대해 알아보세요.
