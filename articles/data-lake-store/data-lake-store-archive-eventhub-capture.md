...
1.  **새 폴더** 를 클릭하고 데이터를 캡처할 폴더의 이름을 입력합니다.
    ...
    ![Data Lake Storage Gen1에서 새 폴더 만들기](./media/data-lake-store-archive-eventhub-capture/data-lake-store-create-new-folder.png "Data Lake Storage Gen1에서 새 폴더 만들기")

1. Data Lake Storage Gen1의 루트에서 사용 권한을 할당합니다. 

    a. **데이터 탐색기** 를 클릭하고 Data Lake Storage Gen1 계정의 루트를 선택한 다음, **액세스** 를 클릭합니다.

    ![계정 루트와 액세스 옵션이 설명선으로 표시된 데이터 탐색기 스크린샷](./media/data-lake-store-archive-eventhub-capture/data-lake-store-assign-permissions-to-root.png "Data Lake Storage Gen1 루트에 대한 권한 할당")

    b. **액세스** 아래에서 **추가** 를 클릭하고 **사용자 또는 그룹 선택** 을 클릭한 후 `Microsoft.EventHubs`를 검색합니다. 

    ![추가 옵션, 사용자 또는 그룹 선택 옵션, Microsoft Eventhubs 옵션이 설명선으로 표시된 액세스 페이지 스크린샷](./media/data-lake-store-archive-eventhub-capture/data-lake-store-assign-eventhub-sp.png "Data Lake Storage Gen1 루트에 대한 권한 할당")
    ...
    **선택** 을 클릭합니다.
    ...
    ![권한 선택 옵션이 설명선으로 표시된 권한 할당 섹션 스크린샷. 이 섹션 옆에는 실행 옵션, 추가 옵션, 다음으로 추가 옵션이 설명선으로 표시된 권한 선택 섹션이 있습니다.](./media/data-lake-store-archive-eventhub-capture/data-lake-store-assign-eventhub-sp1.png "Data Lake Storage Gen1 루트에 대한 권한 할당")
...
1. 데이터를 캡처하려는 Data Lake Storage Gen1 계정 아래의 폴더에 대해 사용 권한을 할당합니다.
    ...
    ![계정의 폴더와 액세스 옵션이 설명선으로 표시된 데이터 탐색기 스크린샷](./media/data-lake-store-archive-eventhub-capture/data-lake-store-assign-permissions-to-folder.png "Data Lake Storage Gen1 폴더에 대한 권한 할당")

    b. **액세스** 아래에서 **추가** 를 클릭하고 **사용자 또는 그룹 선택** 을 클릭한 후 `Microsoft.EventHubs`를 검색합니다. 

    ![추가 옵션, 사용자 또는 그룹 선택 옵션, Microsoft Eventhubs 옵션이 설명선으로 표시된 데이터 탐색기 액세스 페이지 스크린샷](./media/data-lake-store-archive-eventhub-capture/data-lake-store-assign-eventhub-sp.png "Data Lake Storage Gen1 폴더에 대한 권한 할당")
    ...
    **선택** 을 클릭합니다.
    ...
    ![권한 선택 옵션이 설명선으로 표시된 권한 할당 섹션 스크린샷. 이 섹션 옆에는 읽기, 쓰기 및 실행 옵션, 추가 옵션, 다음으로 추가 옵션이 설명선으로 표시된 권한 선택 섹션이 있습니다.](./media/data-lake-store-archive-eventhub-capture/data-lake-store-assign-eventhub-sp-folder.png "Data Lake Storage Gen1 폴더에 대한 권한 할당")
...
1. Event Hubs 네임스페이스의 **개요** 창에서 **+ 이벤트 허브** 를 클릭합니다.
    ...
    ![이벤트 허브 옵션이 설명선으로 표시된 개요 창 스크린샷](./media/data-lake-store-archive-eventhub-capture/data-lake-store-create-event-hub.png "이벤트 허브 만들기")

1. Data Lake Storage Gen1에 데이터를 캡처하도록 Event Hubs를 구성하려면 다음 값을 제공합니다.

    ![이름 텍스트 상자, 캡처 옵션, 캡처 공급자 옵션, Data Lake Store 선택 옵션, Data Lake 경로 옵션이 설명선으로 표시된 이벤트 허브 만들기 대화 상자 스크린샷](./media/data-lake-store-archive-eventhub-capture/data-lake-store-configure-eventhub.png "이벤트 허브 만들기")
