...
1. 이러한 값을 편집하거나 JIT 구성에 더 많은 포트를 추가하려면 클라우드용 Microsoft Defender의 Just-In-Time 페이지를 사용합니다.
...
### <a name="microsoft-defender-for-cloud"></a>[**클라우드용 Microsoft Defender**](#tab/jit-request-asc)
