---
title: 'PowerShell: Azure SQL Database에 대한 활성 지역 복제 구성'
description: Azure PowerShell 예제 스크립트를 사용하여 Azure SQL Database에 대한 활성 지역 복제를 설정하고 장애 조치(Failover)를 수행합니다.
...
ms.locfileid: "130167358"
---
# <a name="use-powershell-to-configure-active-geo-replication-for-a-database-in-azure-sql-database"></a>PowerShell을 사용하여 Azure SQL Database의 데이터베이스에 대한 활성 지역 복제 구성

[!INCLUDE[appliesto-sqldb](../../includes/appliesto-sqldb.md)]

이 Azure PowerShell 스크립트 예제는 Azure SQL Database의 데이터베이스에 대해 활성 지역 복제를 구성하고 데이터베이스의 보조 복제본으로 장애 조치(failover)를 수행합니다.
...
| [Remove-AzSqlDatabaseSecondary](/powershell/module/az.sql/remove-azsqldatabasesecondary) | 데이터베이스와 지정된 보조 데이터베이스 간의 데이터 복제를 종료합니다. |
