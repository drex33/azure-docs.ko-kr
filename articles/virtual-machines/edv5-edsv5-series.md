...
Edsv5 시리즈 가상 머신은 3세대 Intel® Xeon® 8370C(Ice Lake) 프로세서에서 실행되어 최대 3.5GHz의 모든 코어 turbo 클록 속도에 도달합니다.  이러한 가상 머신은 최대 104개의 vCPU와 672 GiB의 RAM뿐만 아니라 최대 3800 GiB의 빠른 로컬 SSD 스토리지를 제공합니다. Edsv5 시리즈 가상 머신은 짧은 대기 시간, 고속 로컬 스토리지를 활용하는 메모리 집약적 엔터프라이즈 애플리케이션 및 애플리케이션에 적합합니다.
