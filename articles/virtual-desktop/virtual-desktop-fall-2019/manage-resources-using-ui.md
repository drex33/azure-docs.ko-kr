...
관리 도구를 배포하고 연결하는 방법을 배웠으므로, 이제 Azure Service 도움말을 사용하여 서비스 이슈와 상태 권고를 모니터링하는 방법을 알아볼 수 있습니다. 자세한 내용은 [서비스 경고 설정 자습서](set-up-service-alerts-2019.md)를 참조하세요.
