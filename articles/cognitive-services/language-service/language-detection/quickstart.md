---
title: '빠른 시작: 언어 감지 클라이언트 라이브러리 사용'
titleSuffix: Azure Cognitive Services
description: 이 빠른 시작을 통해 언어 감지 사용을 시작합니다.
...
이 문서를 통해 클라이언트 라이브러리 및 REST API 사용하여 언어 감지를 시작합니다. 다음 단계에 따라 텍스트 마이닝을 위한 예제 코드를 사용해 봅니다.
