---
title: CLI 스크립트 - Azure Database for MySQL - 유연한 서버(미리 보기) 모니터링 및 크기 조정
...
ms.locfileid: "128604680"
---
# <a name="monitor-and-scale-an-azure-database-for-mysql---flexible-server-preview-using-azure-cli"></a>Azure CLI를 사용하여 Azure Database for MySQL - 유연한 서버(미리 보기) 모니터링 및 크기 조정
