---
title: Azure Virtual Machine Scale Sets 지원 및 도움말 옵션
description: Azure Virtual Machine Scale Sets를 사용하여 솔루션을 만들 때 질문이나 문제에 대한 도움말 및 지원을 받은 방법
author: mimckitt
ms.author: mimckitt
...
다음은 Azure Virtual Machine Scale Sets 솔루션을 개발할 때 도움을 받을 수 있는 위치에 대한 제안입니다.
...
-  [Azure Virtual Machine 확장 집합 문제 해결 설명서](/troubleshoot/azure/virtual-machine-scale-sets/welcome-virtual-machine-scale-sets) 
...
| [Azure 가상 머신 마이그레이션](../virtual-machines/classic-vm-deprecation.md) | [azure-virtual-machine-migration](/answers/topics/azure-virtual-machines-migration.html) | 
...
| [Azure 가상 머신 스토리지](../virtual-machines/managed-disks-overview.md) | [azure-virtual-machine-storage](/answers/topics/azure-virtual-machines-storage.html) | 
...
Azure Virtual Machine Scale Sets를 개발하고 관리하는 데 사용되는 언어 및 도구에 대한 도움이 필요한 경우 GitHub의 리포지토리에서 문제를 엽니다.
...
Azure Virtual Machine Scale Sets에 대한 뉴스 및 정보는 [Azure 블로그](https://azure.microsoft.com/blog/topics/virtual-machines/)에서 공유됩니다.


## <a name="next-steps"></a>다음 단계

[Azure Virtual Machine Scale Sets](overview.md)에 대해 자세히 알아보세요.
