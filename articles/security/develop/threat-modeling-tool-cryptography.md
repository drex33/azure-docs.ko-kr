...
## <a name="use-approved-block-cipher-modes-and-initialization-vectors-for-symmetric-ciphers"></a><a id="vector-ciphers"></a>대칭 암호화에 승인된 블록 암호화 모드 및 초기화 벡터 사용
...
## <a name="use-approved-asymmetric-algorithms-key-lengths-and-padding"></a><a id="padding"></a>승인된 비대칭 알고리즘, 키 길이 및 패딩 사용
...
## <a name="use-approved-random-number-generators"></a><a id="numgen"></a>승인된 난수 생성기 사용
...
## <a name="do-not-use-symmetric-stream-ciphers"></a><a id="stream-ciphers"></a>대칭 스트림 암호화 사용 금지
...
## <a name="use-approved-machmackeyed-hash-algorithms"></a><a id="mac-hash"></a>승인된 MAC/HMAC/키 해시 알고리즘 사용
...
## <a name="use-only-approved-cryptographic-hash-functions"></a><a id="hash-functions"></a>승인된 암호화 해시 함수만 사용
...
## <a name="generate-a-random-symmetric-key-of-sufficient-length-for-authentication-to-iot-hub"></a><a id="random-hub"></a>IoT Hub 인증에 충분한 길이의 임의 대칭 키 생성
...
## <a name="ensure-a-device-management-policy-is-in-place-that-requires-a-use-pin-and-allows-remote-wiping"></a><a id="pin-remote"></a>PIN 사용이 필요하고 원격 지우기를 허용하는 디바이스 관리 정책이 있는지 확인
...
## <a name="ensure-that-signing-keys-are-rolled-over-when-using-identity-server"></a><a id="rolled-server"></a>Identity Server를 사용할 때 서명 키가 롤오버되는지 확인
