---
title: Azure Data Factory를 사용하여 웹 테이블에서 데이터 이동
...
> [!NOTE]
> 이 아티클은 Data Factory 버전 1에 적용됩니다. 현재 버전의 Data Factory 서비스를 사용 중인 경우, [V2의 웹 테이블 커넥터](../connector-web-table.md)를 참조하세요.
