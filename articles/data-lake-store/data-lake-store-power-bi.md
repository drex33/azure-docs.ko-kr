---
title: Azure Data Lake Storage Gen1의 데이터 분석 - Power BI
description: Power BI Desktop을 사용하여 Azure Data Lake Storage Gen1에 저장된 데이터를 분석하고 시각화하는 방법에 대해 알아봅니다.
author: normesta
...
2. **홈** 리본 메뉴에서 **데이터 가져오기**, [자세히]를 차례로 클릭합니다. **데이터 가져오기** 대화 상자에서 **Azure**, **Azure Data Lake Store**, **연결** 을 차례로 클릭합니다.
    ...
    ![Azure Data Lake Store 옵션이 강조 표시되고 및 연결 옵션이 호출된 데이터 가져오기 대화 상자의 스크린샷.](./media/data-lake-store-power-bi/get-data-lake-store-account.png "Data Lake Storage Gen1에 연결")
...
6. 성공적으로 로그인한 후에 **연결** 을 클릭합니다.
    ...
    ![연결 옵션이 호출된 Azure Data Lake Store 대화 상자의 스크린샷.](./media/data-lake-store-power-bi/get-data-lake-store-account-connect.png "Data Lake Storage Gen1에 연결")
...
9. **홈** 리본 메뉴에서 **쿼리 편집** 을 클릭합니다.
    ...
    ![쿼리 편집 옵션이 호출된 홈 리본의 스크린샷.](./media/data-lake-store-power-bi/edit-queries.png "쿼리 편집")
10. [쿼리 편집기]에서 **콘텐츠** 열 아래쪽의 **이진** 를 클릭합니다.
    
    ![내용 열이 호출된 쿼리 편집기의 스크린샷.](./media/data-lake-store-power-bi/convert-query1.png "쿼리 편집")
11. 업로드해 놓은 **Drivers.txt** 파일을 나타내는 파일 아이콘이 표시됩니다. 파일을 마우스 오른쪽 단추로 클릭하고 **CSV** 를 클릭합니다.    
    
    ![CSV 옵션이 호출된 쿼리 편집기의 스크린샷.](./media/data-lake-store-power-bi/convert-query2.png "쿼리 편집")
12. 아래와 같이 출력이 표시됩니다. 이제 시각화를 만드는 데 사용할 수 있는 형식으로 데이터가 준비되었습니다.
    
    ![결과가 예상대로 표시된 쿼리 편집기의 스크린샷](./media/data-lake-store-power-bi/convert-query3.png "쿼리 편집")
13. **홈** 리본 메뉴에서 **닫기 및 적용** 을 클릭한 다음 **닫기 및 적용** 을 다시 클릭합니다.
    
    ![닫기 및 적용 옵션이 호출된 홈 리본의 스크린샷.](./media/data-lake-store-power-bi/load-edited-query.png "쿼리 편집")
...
15. 지정된 국가/지역에 대한 각 도시의 드라이버를 나타내는 원형 차트를 만들겠습니다. 이렇게 하려면, 다음을 선택합니다.
    
    1. Visualizations(시각화) 탭에서 원형 차트 기호를 클릭합니다.
       
        ![원형 차트 만들기](./media/data-lake-store-power-bi/create-pie-chart.png "원형 차트 만들기")
    2. 사용할 열은 **열 4**(도시 이름) 및 **열 7**(국가/지역 이름)입니다. 아래와 같이 열을 **필드** 탭에서 **시각화** 탭으로 끌어갑니다.
