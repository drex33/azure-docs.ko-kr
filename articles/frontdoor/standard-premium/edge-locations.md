---
title: 지역별 Azure Front Door 표준/프리미엄 에지 위치
description: 이 문서에서는 지역에 따라 정렬된 Azure Front Door 표준/프리미엄 에지 위치를 나열합니다.
services: frontdoor
author: duongau
...
* [약어로 Azure Front Door 에지 위치](edge-locations-by-abbreviation.md)를 봅니다.
