---
title: Azure Arc 사용 서버에 대 한 azure Automanage
description: Azure Arc 사용 서버에 대 한 Azure Automanage에 대해 알아보기
...
ms.locfileid: "132310541"
---
# <a name="azure-automanage-for-machines-best-practices---azure-arc-enabled-servers"></a>Azure Automanage for Machines 모범 사례-Azure Arc 사용 서버

이러한 Azure 서비스는 Azure Arc 사용 서버 VM에서 자동 관리 컴퓨터 모범 사례를 사용 하는 경우 자동으로 등록 됩니다. 이는 [클라우드 채택 프레임워크](/azure/cloud-adoption-framework/manage/azure-server-management)에서 찾을 수 있는 모범 사례 백서에 필수적입니다.
...
Automanage는 Azure Arc 사용 서버에 대해 다음과 같은 운영 체제를 지원 합니다.
