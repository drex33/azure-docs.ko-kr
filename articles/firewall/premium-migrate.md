...
ms.openlocfilehash: 1920d62ae70d0fb2cc58cd282d51ee1414788a2a
ms.sourcegitcommit: 9ef0965834870700468c822ddcafc011881fc2d5
ms.translationtype: MT
ms.contentlocale: ko-KR
ms.lasthandoff: 12/02/2021
ms.locfileid: "133483989"
---
...
마이그레이션 프로세스 중에 클래식 방화벽 규칙을 표준 정책으로 마이그레이션해야 할 수 있습니다. Azure Portal를 사용 하 여이 작업을 수행할 수 있습니다.
...
Azure PowerShell를 사용 하 여 Azure 방화벽에서 기존 클래식 규칙을 마이그레이션하여 정책을 만들 수도 있습니다. 자세한 내용은 [PowerShell을 사용 하 여 azure 방화벽 정책으로 Azure 방화벽 구성 마이그레이션](../firewall-manager/migrate-to-policy.md) 을 참조 하세요.
...
## <a name="attach-a-premium-policy-to-a-premium-firewall"></a>Premium 방화벽에 Premium 정책 연결

Azure Portal를 사용 하 여 새 Premium 방화벽에 Premium 정책을 연결할 수 있습니다.

:::image type="content" source="media/premium-migrate/premium-firewall-policy.png" alt-text="방화벽 정책을 보여 주는 스크린샷":::
