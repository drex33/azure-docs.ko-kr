...
**지역/국가 선택** 팝업 창에서 하나 이상의 지역/국가를 선택합니다. **모두 선택** 을 선택하여 가능한 모든 지역/국가에서 제품을 사용할 수 있도록 하거나, 원하는 특정 시장만 선택합니다. 완료되면 **저장** 을 선택합니다.
...
왼쪽 탐색 메뉴에서 다음 탭을 계속 진행하려면 **초안 저장** 을 선택하세요.
