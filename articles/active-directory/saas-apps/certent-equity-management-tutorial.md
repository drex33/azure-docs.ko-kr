...
## <a name="configure-and-test-azure-ad-sso-for-certent-equity-management"></a>Certent Equity Management에 대한 Azure AD SSO 구성 및 테스트
...
Certent Equity Management에서 Azure AD SSO를 구성하고 테스트하려면 다음 단계를 수행합니다.
...
1. **[Certent Equity Management SSO 구성](#configure-certent-equity-management-sso)** - 애플리케이션 쪽에서 Single Sign-On 설정을 구성합니다.
   1. **[Certent Equity Management 테스트 사용자 만들기](#create-certent-equity-management-test-user)** - B.Simon의 Azure AD 표현과 연결된 해당 사용자를 Certent Equity Management에 만듭니다.
...
1. Azure Portal의 **Certent Equity Management** 애플리케이션 통합 페이지에서 **관리** 섹션을 찾아 **Single Sign-On** 을 선택합니다.
...
1. 위에서 언급한 특성 외에도 Certent Equity Management 애플리케이션에는 아래에 표시된 SAML 응답에서 다시 전달되어야 하는 몇 가지 특성이 추가로 필요합니다. 이러한 특성도 미리 채워져 있지만 요구 사항에 따라 검토할 수 있습니다.
   ...
   > [!NOTE]
   > [여기](../develop/howto-add-app-roles-in-azure-ad-apps.md#app-roles-ui)를 클릭하여 Azure AD에서 **역할** 을 구성하는 방법을 알아봅니다.
...
- Azure Portal에서 이 애플리케이션 테스트를 클릭하면 SSO를 설정한 Certent Equity Management에 자동으로 로그인됩니다.

- Microsoft 내 앱을 사용할 수 있습니다. 내 앱에서 Certent Equity Management 타일을 클릭하면 SSO를 설정한 Certent Equity Management에 자동으로 로그인됩니다. 내 앱에 대한 자세한 내용은 [내 앱 소개](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510)를 참조하세요.

## <a name="next-steps"></a>다음 단계

Certent Equity Management가 구성되면 세션 제어를 적용하여 조직의 중요한 데이터의 반출 및 반입을 실시간으로 보호할 수 있습니다. 세션 제어는 조건부 액세스에서 확장됩니다. [Microsoft Defender for Cloud Apps를 사용하여 세션 제어를 적용하는 방법을 알아봅니다](/cloud-app-security/proxy-deployment-any-app).
