...
description: AppDynamics Java 에이전트를 사용하여 Azure Spring Cloud 실행되는 Spring Boot 애플리케이션을 모니터링하는 방법입니다.
author: KarlErickson
ms.author: jiec
...
이 문서에서는 AppDynamics Java 에이전트를 사용하여 Azure Spring Cloud 실행되는 Spring Boot 애플리케이션을 모니터링하는 방법을 설명합니다.
...
* [Azure Spring Cloud Application Insights Java In-Process Agent 사용](/azure/spring-cloud/how-to-application-insights)
