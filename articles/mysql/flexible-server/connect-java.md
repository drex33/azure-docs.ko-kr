---
title: '빠른 시작: Azure Database for MySQL 유연한 서버에서 Java 및 JDBC 사용'
description: Azure Database for MySQL 유연한 서버 데이터베이스에서 Java 및 JDBC를 사용하는 방법을 알아봅니다.
author: mksuni
ms.author: sumuth
ms.service: mysql
...
> [!NOTE]
> MySQL 서버 만들기에 관한 자세한 정보는 [Azure portal을 사용하여 Azure Database for MySQL 서버 만들기](./quickstart-create-server-portal.md)에서 확인할 수 있습니다.
