---
title: Microsoft AppSource에서 소프트웨어 구매
description: Microsoft AppSource(Azure Marketplace)에서 소프트웨어를 구매하는 단계입니다.
...
ms.locfileid: "112575005"
---
# <a name="purchase-software-on-microsoft-appsource"></a>Microsoft AppSource에서 소프트웨어 구매
...
## <a name="configure-software-post-purchase"></a>소프트웨어 구매 후 구성
...
지원이 필요한 경우 Microsoft 365 관리 센터를 통해 [지원 티켓](https://admin.microsoft.com/Adminportal/Home?source=applauncher#/homepage)을 제출합니다.

비즈니스 제품의 경우 [지원팀에 문의](/office365/admin/contact-support-for-business-products?tabs=phone)하세요.
