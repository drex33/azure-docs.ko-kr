...
description: PowerShell을 사용 하 여 Azure Compute 갤러리에서 일반화 된 이미지를 사용 하 여 확장 집합을 만듭니다.
author: cynthn
...
[Azure 계산 갤러리](../virtual-machines/shared-image-galleries.md)에 저장 된 일반화 된 이미지 버전에서 VM을 만듭니다. 특수화 이미지를 사용하여 확장 집합을 만들려면 [특수화 이미지에서 확장 집합 인스턴스 만들기](instance-specialized-image-version-powershell.md)를 참조하세요.
...
이름 지정을 포함 하 여 모든 리소스에 대 한 모든 권한을 사용 하려면 전체 매개 변수 집합을 사용 하 여 Azure Compute 갤러리 이미지를 사용 하 여 확장 집합을 만듭니다. 
