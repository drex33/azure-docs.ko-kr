---
title: '빠른 시작: 텍스트 요약 사용(미리 보기)'
titleSuffix: Azure Cognitive Services
description: 이 빠른 시작을 사용하여 텍스트 요약 사용을 시작합니다.
...
이 문서를 사용하여 클라이언트 라이브러리 및 REST API를 사용하여 텍스트 요약을 시작합니다. 다음 단계에 따라 텍스트 마이닝을 위한 예제 코드를 사용해 봅니다.
