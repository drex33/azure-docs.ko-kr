...
Azure AD에 Dow Jones Factiva를 통합하도록 구성하려면 갤러리의 Dow Jones Factiva를 관리되는 SaaS 앱 목록에 추가해야 합니다.
...
액세스 패널에서 Dow Jones Factiva 타일을 클릭하면 SSO를 설정한 Dow Jones Factiva에 자동으로 로그인되어야 합니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510)를 참조하세요.
