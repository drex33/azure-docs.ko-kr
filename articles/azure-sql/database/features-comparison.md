...
| [CDC(변경 데이터 캡처)](/sql/relational-databases/track-changes/about-change-data-capture-sql-server) | 예 (미리 보기)는 S3 계층 이상입니다. 기본, S0, S1, S2는 지원 되지 않습니다. | 예 |
