...
- [공용 IP 주소 할당](../virtual-network/virtual-network-public-ip-address.md) 사용
...
5. **프로그램** 페이지에서 **이 프로그램 경로** 를 선택 하 고 "%SystemRoot%\s ystem32\svchost.exe '를 입력 한 후 **다음** 을 선택 합니다.
