...
* 사용자가 자신의 Azure AD 계정으로 iQualify LMS에 자동으로 로그온(Single Sign-On)되도록 설정할 수 있습니다.
...
* iQualify LMS는 **SP 및 IDP** 시작 SSO를 지원합니다.
* iQualify LMS는 **Just-In-Time** 사용자 프로비저닝을 지원합니다.
...
4. 검색 상자에 **iQualify LMS** 를 입력하고, 결과 패널에서 **iQualify LMS** 를 선택한 다음, **추가** 단추를 클릭하여 애플리케이션을 추가합니다.

     ![결과 목록의 iQualify LMS](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성 및 테스트

이 섹션에서는 **Britta Simon** 이라는 테스트 사용자를 기반으로 iQualify LMS에서 Azure AD Single Sign-On을 구성하고 테스트합니다.
Single Sign-On이 작동하려면 Azure AD 사용자와 iQualify LMS의 관련 사용자 간에 연결 관계를 설정해야 합니다.

iQualify LMS에서 Azure AD Single Sign-On을 구성하고 테스트하려면 다음 구성 요소를 완료해야 합니다.

1. **[Azure AD Single Sign-On 구성](#configure-azure-ad-single-sign-on)** - 사용자가 이 기능을 사용할 수 있도록 합니다.
2. **[iQualify LMS Single Sign-On 구성](#configure-iqualify-lms-single-sign-on)** - 애플리케이션 쪽에서 Single Sign-On 설정을 구성합니다.
3. **[Azure AD 테스트 사용자 만들기](#create-an-azure-ad-test-user)** - Britta Simon으로 Azure AD Single Sign-On을 테스트하는 데 사용합니다.
4. **[Azure AD 테스트 사용자 할당](#assign-the-azure-ad-test-user)** - Britta Simon이 Azure AD Single Sign-on을 사용할 수 있도록 합니다.
5. **[iQualify LMS 테스트 사용자 만들기](#create-iqualify-lms-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 iQualify LMS에 만듭니다.
...
### <a name="configure-iqualify-lms-single-sign-on"></a>iQualify LMS Single Sign-On 구성

1. 새 브라우저 창을 열고 iQualify 환경에 관리자 권한으로 로그인합니다.

1. 로그인되었으면 오른쪽 맨 위의 아바타를 클릭한 다음, **계정 설정** 을 클릭합니다.
...
1. **SAML 인증 설정** 대화 상자에서 다음 단계를 수행합니다.
    ...
    a. **SAML Single Sign-On 서비스 URL** 상자에 Azure AD 애플리케이션 구성 창에서 복사한 **로그인 URL** 값을 붙여넣습니다.
...
1. Azure Portal에서 **엔터프라이즈 애플리케이션**, **모든 애플리케이션**, **iQualify LMS** 를 차례로 선택합니다.

    ![엔터프라이즈 애플리케이션 블레이드](common/enterprise-applications.png)

2. 애플리케이션 목록에서 **iQualify LMS** 를 선택합니다.

    ![애플리케이션 목록의 iQualify LMS 링크](common/all-applications.png)
...
### <a name="create-iqualify-lms-test-user"></a>iQualify LMS 테스트 사용자 만들기

이 섹션에서는 iQualify LMS에 Britta Simon이라는 사용자를 만듭니다. iQualify LMS는 Just-In-Time 프로비저닝을 지원하며, 기본적으로 사용하도록 설정되어 있습니다. 이 섹션에 작업 항목이 없습니다. iQualify LMS에 사용자가 아직 없는 경우 인증 후에 새 사용자가 만들어집니다.
