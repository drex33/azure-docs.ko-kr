...
`2.13.0-amd64`에 대한 릴리스 정보:

정기 월간 릴리스

`2.12.1-amd64`에 대한 릴리스 정보:
...
`2.16.0-amd64-<locale>`에 대한 릴리스 정보:
...
| `2.16.0-amd64-<locale>`       | `<locale>`은 아래에 나열된 사용 가능한 로캘 중 하나로 대체합니다. 예: `2.16.0-amd64-en-us`.|

이 컨테이너에는 다음과 같은 로캘을 사용할 수 있습니다.

| v2.16.0에 대한 로케일          | 메모                                    | 다이제스트                                                                    |
|-----------------------------|:-----------------------------------------|:--------------------------------------------------------------------------|
| `ar-ae`                     | `ar-AE` 로캘이 있는 컨테이너 이미지입니다. | `sha256:66d3df9332cac66bcba96c8f62af4f1f66658c35b9dba9b382fe7f4c67587e3e` |
| `ar-bh`                     | `ar-BH` 로캘이 있는 컨테이너 이미지입니다. | `sha256:cc0b82b09aad69278903a4e4f1b0aabfbe91fd287d391e89cd05582be0b71ab6` |
| `ar-eg`                     | `ar-EG` 로캘이 있는 컨테이너 이미지입니다. | `sha256:cd4a1f6766c11a4204f789d7534e7ad7255896e99158450362f47417dec39a6d` |
| `ar-iq`                     | `ar-IQ` 로캘이 있는 컨테이너 이미지입니다. | `sha256:4748f3f456e0c79cfeff6250e1b51de87d8298e683d45ae3aaaeae4c11445fb6` |
| `ar-jo`                     | `ar-JO` 로캘이 있는 컨테이너 이미지입니다. | `sha256:030c207f1e114bef95418924b2aa7672ba9c17fc127d5dbee7df3a556b4aaabe` |
| `ar-kw`                     | `ar-KW` 로캘이 있는 컨테이너 이미지입니다. | `sha256:66d3df9332cac66bcba96c8f62af4f1f66658c35b9dba9b382fe7f4c67587e3e` |
| `ar-lb`                     | `ar-LB` 로캘이 있는 컨테이너 이미지입니다. | `sha256:c45c73e524c7880a25acfd99428a57077b041d81e19dc190e7ec396ff980b5a1` |
| `ar-om`                     | `ar-OM` 로캘이 있는 컨테이너 이미지입니다. | `sha256:9fa4fed0e0482aee11f2a341d97a89a5613247e6b3a6450fe932bdc0920c1845` |
| `ar-qa`                     | `ar-QA` 로캘이 있는 컨테이너 이미지입니다. | `sha256:66d3df9332cac66bcba96c8f62af4f1f66658c35b9dba9b382fe7f4c67587e3e` |
| `ar-sa`                     | `ar-SA` 로캘이 있는 컨테이너 이미지입니다. | `sha256:66d3df9332cac66bcba96c8f62af4f1f66658c35b9dba9b382fe7f4c67587e3e` |
| `ar-sy`                     | `ar-SY` 로캘이 있는 컨테이너 이미지입니다. | `sha256:2f8700e87f7ed1d9fd808f7904fd8ef6be799dab29e20f6d67de441021ae5a22` |
| `bg-bg`                     | `bg-BG` 로캘이 있는 컨테이너 이미지입니다. | `sha256:01dfeb367631fbcaa987d0962ed9a3662839842f105e65e780abe7157207cbf9` |
| `ca-es`                     | `ca-ES` 로캘이 있는 컨테이너 이미지입니다. | `sha256:7dbe7d245b02ffa810416d70275240ecbb107669d9d1c85f6c2634b79469fe4e` |
| `cs-cz`                     | `cs-CZ` 로캘이 있는 컨테이너 이미지입니다. | `sha256:c0c9adc8e5216069b56fe96871e3b4fc6469ba42703690de7049456f11626cf4` |
| `da-dk`                     | `da-DK` 로캘이 있는 컨테이너 이미지입니다. | `sha256:ba46c6d9ffacf97a07afe52fec6a3684666fa90e88f39c99759a27dc282e12ab` |
| `de-de`                     | `de-DE` 로캘이 있는 컨테이너 이미지입니다. | `sha256:2cbce47529c9060e4fee468542217fb2e22012f2026928f8fc837c2d628e4fa3` |
| `el-gr`                     | `el-GR` 로캘이 있는 컨테이너 이미지입니다. | `sha256:e024a3c28389ad1217e3230bb34b7930c3de1d9a21df302acb0dd6e05097f74f` |
| `en-au`                     | `en-AU` 로캘이 있는 컨테이너 이미지입니다. | `sha256:a0077aca7aadd2a00a0fc382fc5fd0db57bb85bd6b5f016f5dcba1902c005445` |
| `en-ca`                     | `en-CA` 로캘이 있는 컨테이너 이미지입니다. | `sha256:a3462eaefa5011fbb22674d51af97c7dcff63616cb6e56609acc0972b673e0dd` |
| `en-gb`                     | `en-GB` 로캘이 있는 컨테이너 이미지입니다. | `sha256:8abf2b179447cc42c7c4e914dcdf08fa75f851b326955aacc5d925fffafadaf6` |
| `en-hk`                     | `en-HK` 로캘이 있는 컨테이너 이미지입니다. | `sha256:8dc38299134eb2943550ba1a6e091195fe1c052838d91d385cb9a531bea7cd5c` |
| `en-ie`                     | `en-IE` 로캘이 있는 컨테이너 이미지입니다. | `sha256:a10ddf6a9e87110bbbf051d40d7bfbae288d095c97d2e0c4f3c518943a8f5377` |
| `en-in`                     | `en-IN` 로캘이 있는 컨테이너 이미지입니다. | `sha256:5092271c4531804bacc51a7f2b4a66009e1e10946687f140f5bad8292a58fb32` |
| `en-nz`                     | `en-NZ` 로캘이 있는 컨테이너 이미지입니다. | `sha256:b53ed09c9fd78ca5b5d6591f8be03b97202b9a46f6bd8a6f7cd7d04165fe42de` |
| `en-ph`                     | `en-PH` 로캘이 있는 컨테이너 이미지입니다. | `sha256:ab4c876990917f8e3ad46bc350a2502607866a0346d7108ba5c04f0913a10371` |
| `en-sg`                     | `en-SG` 로캘이 있는 컨테이너 이미지입니다. | `sha256:29971af1bf73faf4b50577fe0f35544a3402001473aad96696acdfbce425c6de` |
| `en-us`                     | `en-US` 로캘이 있는 컨테이너 이미지입니다. | `sha256:b043cedbfa9560d79cf0aaed2de87bca81f53e70f6333638e62bd9ce4d9ace4f` |
| `en-za`                     | `en-ZA` 로캘이 있는 컨테이너 이미지입니다. | `sha256:0e1a6700ed451f8139d5fb492689832b742f04fe716ae887ec77ed97e0b16fd1` |
| `es-ar`                     | `es-AR` 로캘이 있는 컨테이너 이미지입니다. | `sha256:1292e383b854250956eacfd01b299386fab7a08c6e3a84ddcdd33e759fb6b236` |
| `es-bo`                     | `es-BO` 로캘이 있는 컨테이너 이미지입니다. | `sha256:45d66460c80e195cfb8d424642cfa05a4810b5789083dcdfbd02c293665225a6` |
| `es-cl`                     | `es-CL` 로캘이 있는 컨테이너 이미지입니다. | `sha256:bd5b4d9dd3080dde2cb9c4f37c303fe05d13d2d10a71885f79a1116b3ac65a6f` |
| `es-co`                     | `es-CO` 로캘이 있는 컨테이너 이미지입니다. | `sha256:362e9ef6df7aa12c686108f9e63dd3c8526c3bbf13d403e4e278f0d3164423bd` |
| `es-cr`                     | `es-CR` 로캘이 있는 컨테이너 이미지입니다. | `sha256:22ec5f103ed02120475d5a653add1755ad4e918a0c42dae8f642d6b159dead43` |
| `es-cu`                     | `es-CU` 로캘이 있는 컨테이너 이미지입니다. | `sha256:e8355cc6c58efa0b71ed9d72e6fbccecb0a72e91c5d1ae40e06deb401d13b06f` |
| `es-do`                     | `es-DO` 로캘이 있는 컨테이너 이미지입니다. | `sha256:e583318dc7297be07478fc8ffb9af0e92bae8f3bd19710fbef5a807a5db18e92` |
| `es-ec`                     | `es-EC` 로캘이 있는 컨테이너 이미지입니다. | `sha256:ba009383d68c72e3959c867003e1084ae6dfc1b3265b779f9f22d955bb83e909` |
| `es-es`                     | `es-ES` 로캘이 있는 컨테이너 이미지입니다. | `sha256:ba3e327c0bc2f7e3834118c33717096aa4b46c093914c281d6ac997ad9fb297a` |
| `es-gt`                     | `es-GT` 로캘이 있는 컨테이너 이미지입니다. | `sha256:eb1933adefdfb398fd63686608be746fd82b0fcd8d624ad5a7deca91859875e6` |
| `es-hn`                     | `es-HN` 로캘이 있는 컨테이너 이미지입니다. | `sha256:6b4f7053eafdab649d2eab19ff4733dc4378520ad76af100b3b3f157b25f5bd3` |
| `es-mx`                     | `es-MX` 로캘이 있는 컨테이너 이미지입니다. | `sha256:5b755aac00c0a935df9977c39f7983142f29496ffa48944ae8945ca443fd7021` |
| `es-ni`                     | `es-NI` 로캘이 있는 컨테이너 이미지입니다. | `sha256:3f69e2b827a64a3f90cf3c091e41e8812439fec9c74d0870b40583c89132b8fb` |
| `es-pa`                     | `es-PA` 로캘이 있는 컨테이너 이미지입니다. | `sha256:514cd92fb0e86086c3b2a823d182d430f6d7adcccef2630b0c1b6fcf5d1992b1` |
| `es-pe`                     | `es-PE` 로캘이 있는 컨테이너 이미지입니다. | `sha256:f6514a41f0bf0f64cf1c2bb2fd376e310821987e89f2cdc2db1a4ea44096c9db` |
| `es-pr`                     | `es-PR` 로캘이 있는 컨테이너 이미지입니다. | `sha256:386911dbe6aaf56d712de34347f6bf22112f0528c283064e203a9ba203437843` |
| `es-py`                     | `es-PY` 로캘이 있는 컨테이너 이미지입니다. | `sha256:ec6ffa67b0c8cc86bb346f61a53530001dfe480a6310da3312bf640057566289` |
| `es-sv`                     | `es-SV` 로캘이 있는 컨테이너 이미지입니다. | `sha256:866de9a427f2452b059bd9dcdd789700f2548a0fe0155ccb3772e8917c5ef092` |
| `es-us`                     | `es-US` 로캘이 있는 컨테이너 이미지입니다. | `sha256:ce83da1e99858de3ca061ec88b63ee7432d65cdcb552ad318f52b5b056b7729b` |
| `es-uy`                     | `es-UY` 로캘이 있는 컨테이너 이미지입니다. | `sha256:4c1f6dde6223822c86cf360999b80c71dc16d7c9b9aca5def9ade2410e1350a4` |
| `es-ve`                     | `es-VE` 로캘이 있는 컨테이너 이미지입니다. | `sha256:c8aee541e08c5a56b6f52b2104803b410ded52bbc098dfe187a24f25650e2ade` |
| `et-ee`                     | `et-EE` 로캘이 있는 컨테이너 이미지입니다. | `sha256:8f1359a00cb26f0d4a125b7679a3c3a1a224094ca3d10cf6cf95d2e652a23f13` |
| `fi-fi`                     | `fi-FI` 로캘이 있는 컨테이너 이미지입니다. | `sha256:aae716f342587b0ba3b5edbee54b795ecd795304784e0bebebc25d3613be8003` |
| `fr-ca`                     | `fr-CA` 로캘이 있는 컨테이너 이미지입니다. | `sha256:8382eb984b7da565c0cc89e3f43bb78cf743882ef179d252cc0845ee29d56925` |
| `fr-fr`                     | `fr-FR` 로캘이 있는 컨테이너 이미지입니다. | `sha256:91bbf6cd73a8de92affc392fd59daf2a8a11648fdc603330ada61a86b847a975` |
| `ga-ie`                     | `ga-IE` 로캘이 있는 컨테이너 이미지입니다. | `sha256:2cbd71e233b67982005a9bfdc8efb08c8e5791e30fd3ff9fd13e4630142071bd` |
| `gu-in`                     | `gu-IN` 로캘이 있는 컨테이너 이미지입니다. | `sha256:2fb3a645cc4c2211570ad1a53072bcbb275238b7c3fce0ad337cf14056bd437e` |
| `hi-in`                     | `hi-IN` 로캘이 있는 컨테이너 이미지입니다. | `sha256:9298c25cfa026f20653975eaee6048159fe5d2e59ae987291ec910c32e3195b1` |
| `hr-hr`                     | `hr-HR` 로캘이 있는 컨테이너 이미지입니다. | `sha256:66494df736b5835a3365628ad4fb3921d8919622defd9caaa0eb0d1fe09e3288` |
| `hu-hu`                     | `hu-HU` 로캘이 있는 컨테이너 이미지입니다. | `sha256:50e50586ae54f4466251338fa4c2606191c56dfb0bcf63679834d204566af19a` |
| `it-it`                     | `it-IT` 로캘이 있는 컨테이너 이미지입니다. | `sha256:110d50d508663be0407f88d72f29e5adf16ad494ae3e8a0f65b3ec5ce3a2ab54` |
| `ja-jp`                     | `ja-JP` 로캘이 있는 컨테이너 이미지입니다. | `sha256:11df3967ce61d3d0c9cf3328cd9db476017e5bfdc2d3b80e9a0dd192b56754f9` |
| `ko-kr`                     | `ko-KR` 로캘이 있는 컨테이너 이미지입니다. | `sha256:ba08b3543058835df7e93ef494fd63fcbcd5225239c0fdad9ec44bf48ff4a92d` |
| `lt-lt`                     | `lt-LT` 로캘이 있는 컨테이너 이미지입니다. | `sha256:cf2e575a7c4cc2661edcb120f88a5286bff14f5acbbfb4d0cba779ccc045262f` |
| `lv-lv`                     | `lv-LV` 로캘이 있는 컨테이너 이미지입니다. | `sha256:1375408c410da92ed438c820619c3ad91acaa1200a999a8faaa64c569cb55609` |
| `mr-in`                     | `mr-IN` 로캘이 있는 컨테이너 이미지입니다. | `sha256:4c288e63a087469b5199cbacb45b18da2c0b6827919eea205da93162ca31dc5c` |
| `mt-mt`                     | `mt-MT` 로캘이 있는 컨테이너 이미지입니다. | `sha256:c07f593487761ec1032e69d95a42f70a20f6f250edbff296df6098a0adb5cdba` |
| `nb-no`                     | `nb-NO` 로캘이 있는 컨테이너 이미지입니다. | `sha256:46f565fff50b5f552755ba2077381cda59c3e1805aedc495c626df908c1ddf64` |
| `nl-nl`                     | `nl-NL` 로캘이 있는 컨테이너 이미지입니다. | `sha256:4d98c54134af5f5ad3accd3ef3b3d1ca82e3992ba8a471cd7dab204e78184386` |
| `pl-pl`                     | `pl-PL` 로캘이 있는 컨테이너 이미지입니다. | `sha256:43a343b10d45286a11a147cdd6d77ad5cfaa8511f16791ebacfafc160796d6ad` |
| `pt-br`                     | `pt-BR` 로캘이 있는 컨테이너 이미지입니다. | `sha256:d39dab9c34af576e669cd32fd40870c71aa10574da9514d9d95872db2824cdb6` |
| `pt-pt`                     | `pt-PT` 로캘이 있는 컨테이너 이미지입니다. | `sha256:c7ca70edde199824ecb5c5d436c631053a08f084ffdb4bd005c06af4c2bf103b` |
| `ro-ro`                     | `ro-RO` 로캘이 있는 컨테이너 이미지입니다. | `sha256:75295fcf02d37c28af2767be68f2afaa437cfd3ab8b9aa9342f8218f9cd9e324` |
| `ru-ru`                     | `ru-RU` 로캘이 있는 컨테이너 이미지입니다. | `sha256:733912731512fa49a07a7feda04d96ef9b9394fc79f9c185b7abe4b965d5d453` |
| `sk-sk`                     | `sk-SK` 로캘이 있는 컨테이너 이미지입니다. | `sha256:3993117518568f0b8afdb96173eb899395c530b83bd8aec7ba2657e460b289ba` |
| `sl-si`                     | `sl-SI` 로캘이 있는 컨테이너 이미지입니다. | `sha256:00540ff9eaba51ddf053320bb218d4baaf0bdae17485d08bfe6cfc7915ae390f` |
| `sv-se`                     | `sv-SE` 로캘이 있는 컨테이너 이미지입니다. | `sha256:b34263c3679564aa34013ec05f918adc25ef34c56f50ba18617782ac2e7899ef` |
| `ta-in`                     | `ta-IN` 로캘이 있는 컨테이너 이미지입니다. | `sha256:4da568d5ff21f4d3bd48bb3c9717eb8d0e81039e6ac15d3a1060db2ef587744c` |
| `te-in`                     | `te-IN` 로캘이 있는 컨테이너 이미지입니다. | `sha256:a659e570550fc20afea6da7aabe3febe362238f55a207eee4d256154f7b7e938` |
| `th-th`                     | `th-TH` 로캘이 있는 컨테이너 이미지입니다. | `sha256:3b61bde38fe5e7ce7b1c67d8706fae7efdb2a2095f2a1d9a6ba1bec916fe37b6` |
| `tr-tr`                     | `tr-TR` 로캘이 있는 컨테이너 이미지입니다. | `sha256:2fc93929ecaeaab70bb8551984390275a2fb56b37f6a3ee986595e5f3bbdfb6d` |
| `zh-cn`                     | `zh-CN` 로캘이 있는 컨테이너 이미지입니다. | `sha256:85b29efca239efa9bad2a74d6028aebec1cd8af817b6eb3276846c1923789389` |
| `zh-hk`                     | `zh-HK` 로캘이 있는 컨테이너 이미지입니다. | `sha256:2e225f369f20784837f5cf55d1d00e2045a9317c79592ed0b224bc24143b21c0` |
| `zh-tw`                     | `zh-TW` 로캘이 있는 컨테이너 이미지입니다. | `sha256:b3a476b5b653271d5758de33ae1ffbe59e5098a5b033399cdb1fb542f3ce8c4e` |
...
`2.13.0-amd64-<locale>`에 대한 릴리스 정보:

정기 월간 릴리스

`2.12.1-amd64-<locale>`에 대한 릴리스 정보:
...
| 이미지 태그                  | 메모                                    |
|-----------------------------|:-----------------------------------------|
| `2.15.0-amd64-<locale>`     | `<locale>`은 아래에 나열된 사용 가능한 로캘 중 하나로 대체합니다. 예: `2.15.0-amd64-en-us`.|
| `2.14.0-amd64-<locale>`     | `<locale>`은 아래에 나열된 사용 가능한 로캘 중 하나로 대체합니다. 예: `2.14.0-amd64-en-us`.|
| `2.13.0-amd64-<locale>`     | `<locale>`은 아래에 나열된 사용 가능한 로캘 중 하나로 대체합니다. 예: `2.13.0-amd64-en-us`.|
| `2.12.1-amd64-<locale>`     | `<locale>`은 아래에 나열된 사용 가능한 로캘 중 하나로 대체합니다. 예: `2.12.1-amd64-en-us`.|
...
| `ar-eg`                     | `ar-EG` 로캘이 있는 컨테이너 이미지입니다. | `sha256:b7efc1801d4d3f04349495ac7d22bf33a497fd1a84bfffeb410acb159c533aef` |
| `ar-iq`                     | `ar-IQ` 로캘이 있는 컨테이너 이미지입니다. | `sha256:4979c5c0081efa70c6fc8dcd332a832eee97a4b04b0cbfc384764fe0d86567e1` |
| `ar-jo`                     | `ar-JO` 로캘이 있는 컨테이너 이미지입니다. | `sha256:770b2986c9563d980b4558502799d3b8250a7d7219b57c57ed9d7184f9022b90` |
| `ar-kw`                     | `ar-KW` 로캘이 있는 컨테이너 이미지입니다. | `sha256:d2c650631f10bb3d13b90ac13cc8f9780a791b6b6eae4d3663703d61d4fcfa0b` |
| `ar-lb`                     | `ar-LB` 로캘이 있는 컨테이너 이미지입니다. | `sha256:51f5cd8e34df11675da0c4f7fd4e13c00cecbbede60437fefc038e3a21137558` |
| `ar-om`                     | `ar-OM` 로캘이 있는 컨테이너 이미지입니다. | `sha256:c34b2659629285e82f1bed7e50c6f6ee80f6c9ddb1ed6962af4875303fe0b11f` |
| `ar-qa`                     | `ar-QA` 로캘이 있는 컨테이너 이미지입니다. | `sha256:d2c650631f10bb3d13b90ac13cc8f9780a791b6b6eae4d3663703d61d4fcfa0b` |
| `ar-sa`                     | `ar-SA` 로캘이 있는 컨테이너 이미지입니다. | `sha256:d2c650631f10bb3d13b90ac13cc8f9780a791b6b6eae4d3663703d61d4fcfa0b` |
| `ar-sy`                     | `ar-SY` 로캘이 있는 컨테이너 이미지입니다. | `sha256:b3d3da168b41f08156b9df8e9dd5030e73edb49be71d05f8e7af0e6e8ed9f706` |
| `bg-bg`                     | `bg-BG` 로캘이 있는 컨테이너 이미지입니다. | `sha256:1dd1a311b7e4b7e10dc91836b0d211f1545e6437e6a7814624684c5d71491cc1` |
| `ca-es`                     | `ca-ES` 로캘이 있는 컨테이너 이미지입니다. | `sha256:e0f7df4badc9ccd4b6cdd08eec7c88258a7e09e0647abbb900bd4df114599473` |
| `cs-cz`                     | `cs-CZ` 로캘이 있는 컨테이너 이미지입니다. | `sha256:5dab3f7de27f841c2f7ca8a6829eb6ad8f28ab3af62b60fa7e306132b87c7621` |
| `da-dk`                     | `da-DK` 로캘이 있는 컨테이너 이미지입니다. | `sha256:bd35ad26cba823f99d917a726ce5d915fb9dfa6c50d522c23904b7e4236ac4d8` |
| `de-de`                     | `de-DE` 로캘이 있는 컨테이너 이미지입니다. | `sha256:2ce791d2e99c9a7b2ea74978d97f3d433bf6069a2f3f664f98154afef211182e` |
| `el-gr`                     | `el-GR` 로캘이 있는 컨테이너 이미지입니다. | `sha256:5be44216c88ad990592205d01249f5cec661e96409ea56099126c5d7c94ced21` |
| `en-au`                     | `en-AU` 로캘이 있는 컨테이너 이미지입니다. | `sha256:2a038ff2195b76e461ad06de8b402e24394a1f00147853aab148517614c21d5e` |
| `en-ca`                     | `en-CA` 로캘이 있는 컨테이너 이미지입니다. | `sha256:9cc83d8d00d6ab436f2bf8a8094b6e12d8770ea7383db034a46a32e16ce1fbd2` |
| `en-gb`                     | `en-GB` 로캘이 있는 컨테이너 이미지입니다. | `sha256:561e476e9a65446adf7faa5a4966ee9533ce0d24c4543a21347f7f3b3fb25198` |
| `en-hk`                     | `en-HK` 로캘이 있는 컨테이너 이미지입니다. | `sha256:f13e37cb642c93734839136779357aed562d738f1029e0f724950a79e241b954` |
| `en-ie`                     | `en-IE` 로캘이 있는 컨테이너 이미지입니다. | `sha256:375d0abe0627959e11f496b889f227b13b021d7509573e5e0d5c7854be684000` |
| `en-in`                     | `en-IN` 로캘이 있는 컨테이너 이미지입니다. | `sha256:45c88bbe82902d192ed5acff707a26e9d2e126a3f75b982a9871a56c5d6a88b3` |
| `en-nz`                     | `en-NZ` 로캘이 있는 컨테이너 이미지입니다. | `sha256:43e8e036d51ce9cd717d12fecff0e8cbe6d3380484132def9150dc28d28a2367` |
| `en-ph`                     | `en-PH` 로캘이 있는 컨테이너 이미지입니다. | `sha256:b90ce831b16ae8c19b2cabbb100ef934e5123ae55ff655b5d05ae56d47cc6ca9` |
| `en-sg`                     | `en-SG` 로캘이 있는 컨테이너 이미지입니다. | `sha256:2a4559e4fe9b69642e84cf9a349d2183bba5704c095a8ab8f418774d6cdc6dd9` |
| `en-us`                     | `en-US` 로캘이 있는 컨테이너 이미지입니다. | `sha256:bcad8e08c3309e8386d2cdabbbaa940dc438f15ef981fd2f458bd75167f3ab54` |
| `en-za`                     | `en-ZA` 로캘이 있는 컨테이너 이미지입니다. | `sha256:7b083e13cc36621d80b8909a5497cd245693be7ea08bf6504b570f0842db5be2` |
| `es-ar`                     | `es-AR` 로캘이 있는 컨테이너 이미지입니다. | `sha256:4334226f55e2545705c6d7ba0ce844a06c2c92added3997e611a72dec1a4f2c3` |
| `es-bo`                     | `es-BO` 로캘이 있는 컨테이너 이미지입니다. | `sha256:0975691a18470ff69c12e1ef8a644447dad11da057c19e554f5f7b4db72ca5fc` |
| `es-cl`                     | `es-CL` 로캘이 있는 컨테이너 이미지입니다. | `sha256:c44bdff4174fc83959511e64dd8ed2bdb6806d12a3ff5d5c70b94c3fee7ee2f8` |
| `es-co`                     | `es-CO` 로캘이 있는 컨테이너 이미지입니다. | `sha256:15e046b7ae1b47b32258bd80c5d609c148a5c1d2d01ba319c49df834e1e8f193` |
| `es-cr`                     | `es-CR` 로캘이 있는 컨테이너 이미지입니다. | `sha256:8706ca92a56c6a32cec7d7c0d490d3ce16d52888518df93bae9ed0ad6981632c` |
| `es-cu`                     | `es-CU` 로캘이 있는 컨테이너 이미지입니다. | `sha256:99f6fec4002825e9e4e6dafafe1347e3ffd75f313c4db35d6b3bac3616bf4e30` |
| `es-do`                     | `es-DO` 로캘이 있는 컨테이너 이미지입니다. | `sha256:44cf6984f82f0eb286fec16dcd142c21d3f86b36ba9fc364e305c9ce15b723b4` |
| `es-ec`                     | `es-EC` 로캘이 있는 컨테이너 이미지입니다. | `sha256:079808b43605b7386a4af22b18e295cbb377dce83c3a81dbae7aba980a022c3e` |
| `es-es`                     | `es-ES` 로캘이 있는 컨테이너 이미지입니다. | `sha256:f678a5dd24dd4ffbea1872ec545de0e1ec2cd4326b9383ba6b1c041a375693ff` |
| `es-gt`                     | `es-GT` 로캘이 있는 컨테이너 이미지입니다. | `sha256:b541dd582365e727f0deccbf50ed7ae1ad11f525b02a5e9d97c8fe796f5f4054` |
| `es-hn`                     | `es-HN` 로캘이 있는 컨테이너 이미지입니다. | `sha256:859cff274dac5370c00c279b003b4cbcd194e982e3e5d26c65fda7fb71cbdc8d` |
| `es-mx`                     | `es-MX` 로캘이 있는 컨테이너 이미지입니다. | `sha256:01dc0b5cb4effba99d071292d7fbc709ed4a64f89eadc809f86ea97501f6e411` |
| `es-ni`                     | `es-NI` 로캘이 있는 컨테이너 이미지입니다. | `sha256:7f4572b7dd89ac1b5376050f6b35226fb9aec52eea9405969cc684175487e699` |
| `es-pa`                     | `es-PA` 로캘이 있는 컨테이너 이미지입니다. | `sha256:da29fe62e9e32de8d954d2bd9ee739dd8d24b31cd4943df79dda5f10f5814b08` |
| `es-pe`                     | `es-PE` 로캘이 있는 컨테이너 이미지입니다. | `sha256:cefd94d4b3fbdfd2b66994e970024922dcba2edf8b8b9da6f66affe540b24ee6` |
| `es-pr`                     | `es-PR` 로캘이 있는 컨테이너 이미지입니다. | `sha256:1622652a17e67d9cf28a407bc37067c0d06b496fef4bfc121566a054b5529613` |
| `es-py`                     | `es-PY` 로캘이 있는 컨테이너 이미지입니다. | `sha256:18b729556bafdcd42e6c71e52b2dde4f50a358cbbafb8774b565f157744bbd50` |
| `es-sv`                     | `es-SV` 로캘이 있는 컨테이너 이미지입니다. | `sha256:6192e1752fe67d6fad7ee977899847616e20612d13fe62d869591e0bbaa9b98c` |
| `es-us`                     | `es-US` 로캘이 있는 컨테이너 이미지입니다. | `sha256:05268165b9192848af5c20b66d0dd36ab6f32eb4d8f14be05cbb99e82c02bef6` |
| `es-uy`                     | `es-UY` 로캘이 있는 컨테이너 이미지입니다. | `sha256:cacc39fa400e40d92530d90e4ce266fb33251f771b9809c48814c30b98bc0631` |
| `es-ve`                     | `es-VE` 로캘이 있는 컨테이너 이미지입니다. | `sha256:2607efa555ab788fc6e8065e70c853a4aafcfd544d3b83964604f4de4a1a698d` |
| `et-ee`                     | `et-EE` 로캘이 있는 컨테이너 이미지입니다. | `sha256:ed9c87c68be413dbd37f166906a81ca195ac13a176b77ee05a6fcc74a5d7c4aa` |
| `fi-fi`                     | `fi-FI` 로캘이 있는 컨테이너 이미지입니다. | `sha256:d68902cf6ae127401d3b76deff8977e2570a7c93ed1ea412991b5a24258a4ecc` |
| `fr-ca`                     | `fr-CA` 로캘이 있는 컨테이너 이미지입니다. | `sha256:73af6f6cc0c199509f7f36c4ce3745f9f098f215e76d3bc6186c0afad169e590` |
| `fr-fr`                     | `fr-FR` 로캘이 있는 컨테이너 이미지입니다. | `sha256:2f6627d46f11f78fb60681edd80646f274a90950735e29b75cf0bacf2ff1977e` |
| `ga-ie`                     | `ga-IE` 로캘이 있는 컨테이너 이미지입니다. | `sha256:51baee622521baabf97df36ee0855158a57795b0af25081656afec59edbc9586` |
| `gu-in`                     | `gu-IN` 로캘이 있는 컨테이너 이미지입니다. | `sha256:41d74cef7c62996b51c179ff523a6a81fdb9dfecbc818386d703633176802a7b` |
| `hi-in`                     | `hi-IN` 로캘이 있는 컨테이너 이미지입니다. | `sha256:6bd7ecadd5031c66f798c0307eb85bdf98b912c5d3ffd81dd93a7325e164dbba` |
| `hr-hr`                     | `hr-HR` 로캘이 있는 컨테이너 이미지입니다. | `sha256:bab0220a4968a23bea4616421b81199cf5eb195e041c1ba78b23c7fee12473c7` |
| `hu-hu`                     | `hu-HU` 로캘이 있는 컨테이너 이미지입니다. | `sha256:5aaaaf0a65790dcf57adf8bc6647b8bfb86d0d287d0a9d7a04efb8ec793fe750` |
| `it-it`                     | `it-IT` 로캘이 있는 컨테이너 이미지입니다. | `sha256:aa4c24a470b246bb77d00c11aed16042e8e7516fd1fe9df294e7c1337e4ecaaf` |
| `ja-jp`                     | `ja-JP` 로캘이 있는 컨테이너 이미지입니다. | `sha256:ff2ede2432a62a40237f6a72a6e60884f14b70bfbf22fc5c304e5491e57a163d` |
| `ko-kr`                     | `ko-KR` 로캘이 있는 컨테이너 이미지입니다. | `sha256:5208472ce238b2a71390564535c077bafd9ca8333bb05e89d23e95462d6930f9` |
| `lt-lt`                     | `lt-LT` 로캘이 있는 컨테이너 이미지입니다. | `sha256:27ccc4ed68df0ac08c5cca4b365904292f2dc0294dd35f507aba7228ed6184ac` |
| `lv-lv`                     | `lv-LV` 로캘이 있는 컨테이너 이미지입니다. | `sha256:238141d56fcd9ed45462dfd6189f252c2ef82f9d2c78b2d31ec1d35d4006b2b1` |
| `mr-in`                     | `mr-IN` 로캘이 있는 컨테이너 이미지입니다. | `sha256:80015aea35aee6bdf9fd0dfcc07ed944b971e2910cb5f87f659df5a699d4ea4a` |
| `mt-mt`                     | `mt-MT` 로캘이 있는 컨테이너 이미지입니다. | `sha256:e92f28a42dc7f78042cf232662a0f6841c6eee7eba1c2df7a98b11b68bffb146` |
| `nb-no`                     | `nb-NO` 로캘이 있는 컨테이너 이미지입니다. | `sha256:9263f969b4305f11954c38b1fce443f7c4f0b258fdd376d2446a0d0146decc69` |
| `nl-nl`                     | `nl-NL` 로캘이 있는 컨테이너 이미지입니다. | `sha256:2ad8e5d741723d5457f5698c5f6c2bdbbca9d8e405582aa68ea86bad60e88ff7` |
| `pl-pl`                     | `pl-PL` 로캘이 있는 컨테이너 이미지입니다. | `sha256:d872ae9cbfbc7baf76c21144fdda28ef908922d14cd2b76c527eb0af24a72bf6` |
| `pt-br`                     | `pt-BR` 로캘이 있는 컨테이너 이미지입니다. | `sha256:881a2b767b0cbc0fe5f5960a83f6126bff0f3adff8d9aefe85dbba00a0f0b586` |
| `pt-pt`                     | `pt-PT` 로캘이 있는 컨테이너 이미지입니다. | `sha256:df48b6c13b55f483dff794110e47f9735accfa84ec025028f5334954dbb6f947` |
| `ro-ro`                     | `ro-RO` 로캘이 있는 컨테이너 이미지입니다. | `sha256:058482ae932fde66ecfb990c23d5c49d2cffb4c47c99f4a1551b582aa0a26af4` |
| `ru-ru`                     | `ru-RU` 로캘이 있는 컨테이너 이미지입니다. | `sha256:27b9215c6034cae40be0b3b7b19a366cd134b0ec51ade33d90245cdf32205fc4` |
| `sk-sk`                     | `sk-SK` 로캘이 있는 컨테이너 이미지입니다. | `sha256:544686ad0e4a7ab4e33735dba769b5ce11057bf81e6714d124f0230389c473c0` |
| `sl-si`                     | `sl-SI` 로캘이 있는 컨테이너 이미지입니다. | `sha256:bf6e5d3e2536de160a79957b063935627d98f15359f673f89b4a55934ca06209` |
| `sv-se`                     | `sv-SE` 로캘이 있는 컨테이너 이미지입니다. | `sha256:7cf5498bab1a5b28131d12c72a0ea107f2d00e562c51f37cbb87032dbcf50f17` |
| `ta-in`                     | `ta-IN` 로캘이 있는 컨테이너 이미지입니다. | `sha256:0ea488d1dec874d527938e622ec61406ac3d79e99cb7d905042b55bbc6d675c9` |
| `te-in`                     | `te-IN` 로캘이 있는 컨테이너 이미지입니다. | `sha256:8030a1ee3d71b857f1138be2357c4b82113813899e35a0a01a7f465b4f17dd2f` |
| `th-th`                     | `th-TH` 로캘이 있는 컨테이너 이미지입니다. | `sha256:fabe5868e4cb793e6ff0b7dd24bfe1aa2a5f8f833e44b0b414cf2a11531a37bc` |
| `tr-tr`                     | `tr-TR` 로캘이 있는 컨테이너 이미지입니다. | `sha256:eef963f3fc2ea78f806f233c2eb3500dd74e9f82e54a37a7a21ab294ea8adb83` |
| `zh-cn`                     | `zh-CN` 로캘이 있는 컨테이너 이미지입니다. | `sha256:e9f280bf51858e332cdb6a0cc0609ff89c4092e21053249125700efa85d543de` |
...
| `ar-eg`                     | `ar-EG` 로캘이 있는 컨테이너 이미지입니다. | `sha256:ebe36bd9689e12ed888a327de459b3ae26b261ff3371a696924b540ddd8375b9` |
| `ar-iq`                     | `ar-IQ` 로캘이 있는 컨테이너 이미지입니다. | `sha256:dd46d062ba1b7ad03b59c9dd04816a139f976db04739788316431d223e0b5ea8` |
| `ar-jo`                     | `ar-JO` 로캘이 있는 컨테이너 이미지입니다. | `sha256:10284e45719cc5ad1f0783807e5a3b731bb8728fc09e56206788fbb80f0943ee` |
| `ar-kw`                     | `ar-KW` 로캘이 있는 컨테이너 이미지입니다. | `sha256:1f9fc0564b2ba2bdbeb5a3160e7afe6d867f3ad48cc90825054359f0f129b730` |
| `ar-lb`                     | `ar-LB` 로캘이 있는 컨테이너 이미지입니다. | `sha256:1bf6456a34e1ae5f6797741039848020b1c4b7fb68f1816533091abf92be56c1` |
| `ar-om`                     | `ar-OM` 로캘이 있는 컨테이너 이미지입니다. | `sha256:f1389c71a85ea2bc16c9f990bfcd74b0c8d92e576f0dfd5e68bdc9d1e860ba71` |
| `ar-qa`                     | `ar-QA` 로캘이 있는 컨테이너 이미지입니다. | `sha256:1f9fc0564b2ba2bdbeb5a3160e7afe6d867f3ad48cc90825054359f0f129b730` |
| `ar-sa`                     | `ar-SA` 로캘이 있는 컨테이너 이미지입니다. | `sha256:1f9fc0564b2ba2bdbeb5a3160e7afe6d867f3ad48cc90825054359f0f129b730` |
| `ar-sy`                     | `ar-SY` 로캘이 있는 컨테이너 이미지입니다. | `sha256:58ffbf778fa71cacfdddcb6421d9e2514356b75797a3f0f689056c4e7267e527` |
| `bg-bg`                     | `bg-BG` 로캘이 있는 컨테이너 이미지입니다. | `sha256:37baff85bfe5d78b3858c8f7bf921af4c8d73b02fa40b731a0843df908107eba` |
| `ca-es`                     | `ca-ES` 로캘이 있는 컨테이너 이미지입니다. | `sha256:43abb6d9c2a85fb3f7daf757acccbc67058cd5d49d268ef043cf67851fe8d3b7` |
| `cs-cz`                     | `cs-CZ` 로캘이 있는 컨테이너 이미지입니다. | `sha256:db9192414bc542b77670f4a281f0f2b818d23a95cba2751fa43bf60203942b81` |
| `da-dk`                     | `da-DK` 로캘이 있는 컨테이너 이미지입니다. | `sha256:88c502880609a9cd2f35faa7d6d4a527e4e4bc80477deb21977086615677a700` |
| `de-de`                     | `de-DE` 로캘이 있는 컨테이너 이미지입니다. | `sha256:3567cf9cfbc72a0280cc79b561e832c1a3a26d63ddcf41fa2d08e3a80e09b765` |
| `el-gr`                     | `el-GR` 로캘이 있는 컨테이너 이미지입니다. | `sha256:484935e2a676d561c94a2e2a335f5328688e0b71a9683351ef1439a386e92651` |
| `en-au`                     | `en-AU` 로캘이 있는 컨테이너 이미지입니다. | `sha256:b1d18f984bbb86f3cbcc9401608a31c85b9af1c0c6a6cc0f7366bda18e79d5f9` |
| `en-ca`                     | `en-CA` 로캘이 있는 컨테이너 이미지입니다. | `sha256:c04c67628e49557136860cbb64ea350aee8f09ab0664ed00fa09cdeb3fb19726` |
| `en-gb`                     | `en-GB` 로캘이 있는 컨테이너 이미지입니다. | `sha256:dad0620af6f3c4880914b9ca25266c6436d372127a41531f639bf682972197fe` |
| `en-hk`                     | `en-HK` 로캘이 있는 컨테이너 이미지입니다. | `sha256:43dc4ea303c9509f562d50f470b3590beb755aab295b40d9de6a5d2f4ca62c04` |
| `en-ie`                     | `en-IE` 로캘이 있는 컨테이너 이미지입니다. | `sha256:c8370e1398b7ec2b4ca88b4d2e6d62df9e4495c25644231abe59a2baa89287fe` |
| `en-in`                     | `en-IN` 로캘이 있는 컨테이너 이미지입니다. | `sha256:cdf5a3f4dc32113b9fd7e667bddc36820ac359c65b860cc8b94faa6a6c5009b0` |
| `en-nz`                     | `en-NZ` 로캘이 있는 컨테이너 이미지입니다. | `sha256:5d4d5811f02295831b90133aa47ca370a3243ea854ae52971c3439d156eb72c3` |
| `en-ph`                     | `en-PH` 로캘이 있는 컨테이너 이미지입니다. | `sha256:051497eadedd0d9de7a36ce111ea2b82b37e2c98b3e8b06b408d32b791c4b76b` |
| `en-sg`                     | `en-SG` 로캘이 있는 컨테이너 이미지입니다. | `sha256:d2b89396713a1188eef7873f479f8deca9ba2a80c43e19a7d227a6f73509010a` |
| `en-us`                     | `en-US` 로캘이 있는 컨테이너 이미지입니다. | `sha256:5f66867b47fd9fd8d1bc67c05da8ae775f937ab208c192f4199d2de7b30e5aa6` |
| `en-za`                     | `en-ZA` 로캘이 있는 컨테이너 이미지입니다. | `sha256:e08d7cc82725de9ff7aa392a08dc484407f60c950b85525f337c42ff274aff11` |
| `es-ar`                     | `es-AR` 로캘이 있는 컨테이너 이미지입니다. | `sha256:126d73f1cb82c3e2b8995afab07a9d6470ca7b236681ef7aff5194827df52008` |
| `es-bo`                     | `es-BO` 로캘이 있는 컨테이너 이미지입니다. | `sha256:7cfe66dc2bcc9c7b975841954735061e0b287664083f35bb75d226015cd32805` |
| `es-cl`                     | `es-CL` 로캘이 있는 컨테이너 이미지입니다. | `sha256:27c45610f38099a50934e214b75bbb578d3ed61fb982e49427985ac76f7be9d1` |
| `es-co`                     | `es-CO` 로캘이 있는 컨테이너 이미지입니다. | `sha256:b06e4a35f6ad8b195870dfa9816fb81016a9cbdd8adb3c31f30dc09e370f17d4` |
| `es-cr`                     | `es-CR` 로캘이 있는 컨테이너 이미지입니다. | `sha256:8c50b7e3847f095de6bd7599c7a953b82fca9f849411cc7407b20b805c5132a7` |
| `es-cu`                     | `es-CU` 로캘이 있는 컨테이너 이미지입니다. | `sha256:73434492751b1ff9e2a3f141f0c5857d5cf2c5891f1084ce981181cdcb115e69` |
| `es-do`                     | `es-DO` 로캘이 있는 컨테이너 이미지입니다. | `sha256:769db62fab433e1337a8a47db155127e887de4826d035e05345ccd86c9668c72` |
| `es-ec`                     | `es-EC` 로캘이 있는 컨테이너 이미지입니다. | `sha256:e765c40a9b09fc4d9f42a9ef4bd138181c4f4826e63af1787453c10b10cc1554` |
| `es-es`                     | `es-ES` 로캘이 있는 컨테이너 이미지입니다. | `sha256:b589b794035513de33740d5b5b6ecdda04fd059e9efcb1110525d4b076168cf6` |
| `es-gt`                     | `es-GT` 로캘이 있는 컨테이너 이미지입니다. | `sha256:b30b4a330b7e74777e5d2575b1c2bd4dbb7a920d7165dad40b00765a0b04c564` |
| `es-hn`                     | `es-HN` 로캘이 있는 컨테이너 이미지입니다. | `sha256:8d29f96322db11e99200cf14390e225d8c332b3a6848eb6d23d099bfe552dd99` |
| `es-mx`                     | `es-MX` 로캘이 있는 컨테이너 이미지입니다. | `sha256:bf6edf5bd61b57095181546579df3033e26aca7261e822b932137eca6078a947` |
| `es-ni`                     | `es-NI` 로캘이 있는 컨테이너 이미지입니다. | `sha256:a02537bbfd3a4231938a321dbf9a575178018122aa4c387ebc9bbae070f35152` |
| `es-pa`                     | `es-PA` 로캘이 있는 컨테이너 이미지입니다. | `sha256:82f14c7711bcc02b82b75e3be1620b528991e4c5f1859155926bbb58c4941858` |
| `es-pe`                     | `es-PE` 로캘이 있는 컨테이너 이미지입니다. | `sha256:500fa361a26d3da4e1d9c2523b232ab0d6c00ab4a15141bed6086e39022b79d4` |
| `es-pr`                     | `es-PR` 로캘이 있는 컨테이너 이미지입니다. | `sha256:e364eec54c48e2bb5c14d53356ac3942f8bfdd65d7e139c86ce79fa9f85d4634` |
| `es-py`                     | `es-PY` 로캘이 있는 컨테이너 이미지입니다. | `sha256:165bab6f0a5a12c58c8ec04e1b5168228f97031b80ca368529576d507152ccc0` |
| `es-sv`                     | `es-SV` 로캘이 있는 컨테이너 이미지입니다. | `sha256:42855d56f39956d456c5337b022c71352bd54bfd2d7a6a9a9ffeda1b821c938d` |
| `es-us`                     | `es-US` 로캘이 있는 컨테이너 이미지입니다. | `sha256:622193b64874a3169c21862762017c4b9a46590057e388330fba80ab775e7909` |
| `es-uy`                     | `es-UY` 로캘이 있는 컨테이너 이미지입니다. | `sha256:a33ca1aeb6181f6b034ce831aaf3ca1da0df8260b08c87749eceafce6346afd7` |
| `es-ve`                     | `es-VE` 로캘이 있는 컨테이너 이미지입니다. | `sha256:6cf2522c507c77ccf7fa61ef4b54e8dc4a3f3b47b7602aa8306ae867bc53c8c2` |
| `et-ee`                     | `et-EE` 로캘이 있는 컨테이너 이미지입니다. | `sha256:e6672fc9da94245f7d75d91b7d09e4b929d60ef0157d28885e057eef20e347d8` |
| `fi-fi`                     | `fi-FI` 로캘이 있는 컨테이너 이미지입니다. | `sha256:3731f5a8baeebf02300f3d40a3ea3e3fdf343b817122eba47a0188b5568e1666` |
| `fr-ca`                     | `fr-CA` 로캘이 있는 컨테이너 이미지입니다. | `sha256:1567e85ffe2e2660585a40b43e61fa936abf4ccdd8eb89a37294c2bad83f70b3` |
| `fr-fr`                     | `fr-FR` 로캘이 있는 컨테이너 이미지입니다. | `sha256:bea4884eee3382741e1d02d99a530b608d30e48a446ba52a73749bba7ad34fa7` |
| `ga-ie`                     | `ga-IE` 로캘이 있는 컨테이너 이미지입니다. | `sha256:f40151a6519e0678969adb2d492f240e355ac7ac9b4f57f75e0eff878741d33c` |
| `gu-in`                     | `gu-IN` 로캘이 있는 컨테이너 이미지입니다. | `sha256:ab196670c90b23d8a40448431f703483da9605f92e71f6ebc75a72cfc38e1598` |
| `hi-in`                     | `hi-IN` 로캘이 있는 컨테이너 이미지입니다. | `sha256:ec26ed76cde3ae36eae3a5f0b6567ac60ea341e2f95838a84524819829967f4f` |
| `hr-hr`                     | `hr-HR` 로캘이 있는 컨테이너 이미지입니다. | `sha256:054f188fd9be04f57858053a0a6c1146c13c2781eecd732c137807ee94009d22` |
| `hu-hu`                     | `hu-HU` 로캘이 있는 컨테이너 이미지입니다. | `sha256:ea6bf9b3b4bfa1c4a25f1890c90a18fc309ef17afd6044cb66ed0fc31083c957` |
| `it-it`                     | `it-IT` 로캘이 있는 컨테이너 이미지입니다. | `sha256:6869362837c0124964ed75ab8901fcfede3894902018b41b400a55a0b5f20cf0` |
| `ja-jp`                     | `ja-JP` 로캘이 있는 컨테이너 이미지입니다. | `sha256:7f8557bc112fd4ffef29df308bd10c0803cce1f1f6e79e69f88be53d636aeaf6` |
| `ko-kr`                     | `ko-KR` 로캘이 있는 컨테이너 이미지입니다. | `sha256:746602c288d80c0599af276acd50f1434a331f288c95a3cf9ba269386a9a3929` |
| `lt-lt`                     | `lt-LT` 로캘이 있는 컨테이너 이미지입니다. | `sha256:b6f432bc80770f13ca537a2b49a4e89e8f979a8167f2cdaaa8f1242bb3edc97b` |
| `lv-lv`                     | `lv-LV` 로캘이 있는 컨테이너 이미지입니다. | `sha256:f2126bc8886218374550f2f9a941500cf48675abdb70332990e90e456c332f5d` |
| `mr-in`                     | `mr-IN` 로캘이 있는 컨테이너 이미지입니다. | `sha256:82c75a0c741543c2195d271dd82bfd4400901204584d9f7b83d154d418b3eea5` |
| `mt-mt`                     | `mt-MT` 로캘이 있는 컨테이너 이미지입니다. | `sha256:e95f2edc5bc2090e0359c63047c4c5c879522080f8bf7cbc9484d1854b606a12` |
| `nb-no`                     | `nb-NO` 로캘이 있는 컨테이너 이미지입니다. | `sha256:49c5d9b0d9de260d88deda5eeaa09979f44972610b26ddfad7969c91278f055b` |
| `nl-nl`                     | `nl-NL` 로캘이 있는 컨테이너 이미지입니다. | `sha256:3c5789fbb82c62eaa68451d391ec736ae78c298248f3afba027172c477609489` |
| `pl-pl`                     | `pl-PL` 로캘이 있는 컨테이너 이미지입니다. | `sha256:79a2bb077362c29495fdbee7fc6c8fd0990f080718390fb469ae1f01051d597d` |
| `pt-br`                     | `pt-BR` 로캘이 있는 컨테이너 이미지입니다. | `sha256:ef80359958fdf6b07461c3742c3f860c22652ccf9d123693a9947d11626531db` |
| `pt-pt`                     | `pt-PT` 로캘이 있는 컨테이너 이미지입니다. | `sha256:000345b6a1a28cb5970c471e47963f10209acee74cd46afa7d41310a397c9b61` |
| `ro-ro`                     | `ro-RO` 로캘이 있는 컨테이너 이미지입니다. | `sha256:c4a996b483f91f278f42f1696ed1d89d2e4ee8c0ed409e9d21d471303f78bb71` |
| `ru-ru`                     | `ru-RU` 로캘이 있는 컨테이너 이미지입니다. | `sha256:396bab6bcfe341b53b0992fc2aaf4809767d47b8637f6fd21448dee899e5480f` |
| `sk-sk`                     | `sk-SK` 로캘이 있는 컨테이너 이미지입니다. | `sha256:73624839708f88c93645a6a35278d0c2ce9a944c5992e237a4096be9142b74a0` |
| `sl-si`                     | `sl-SI` 로캘이 있는 컨테이너 이미지입니다. | `sha256:86fbdc4e994507b020ff27735b741407d9f7d1e01fce2b17e610dfc9c16d3af9` |
| `sv-se`                     | `sv-SE` 로캘이 있는 컨테이너 이미지입니다. | `sha256:c3ee782b60499ef16127b5829c36fd98c1933890752fdc4af6cc34b7a90747d9` |
| `ta-in`                     | `ta-IN` 로캘이 있는 컨테이너 이미지입니다. | `sha256:d10ced4e32336d4b411e65066dd5486733d19b8d1f4756d60602117bce6557b7` |
| `te-in`                     | `te-IN` 로캘이 있는 컨테이너 이미지입니다. | `sha256:ebcbaec4e3a494099c7edf15b22acbd7b29347fe7cb4825d13504474e72a5900` |
| `th-th`                     | `th-TH` 로캘이 있는 컨테이너 이미지입니다. | `sha256:bb239e9081d9cf4fffeee666346cc3c67ce83b9bda1d2e81a09fdbdf705a7c46` |
| `tr-tr`                     | `tr-TR` 로캘이 있는 컨테이너 이미지입니다. | `sha256:68d554ae90b0a2202be5f09fb03a7d277f7d0cb0336cb0510bb09ecd7f42eb12` |
| `zh-cn`                     | `zh-CN` 로캘이 있는 컨테이너 이미지입니다. | `sha256:2ec742699abb843b91f9516cb863d66ecf5f38d5350c3c23c693dcb2f5804c66` |
| `zh-hk`                     | `zh-HK` 로캘이 있는 컨테이너 이미지입니다. | `sha256:34f21fed7129dbeaef6476b286e5d6741b635f034ea038b8fe467512ee0092e2` |
| `zh-tw`                     | `zh-TW` 로캘이 있는 컨테이너 이미지입니다. | `sha256:f2e2dc638ac2e58177302947df30bea7448563a012deb3e4f48f345c09902bb0` |

| v2.13.0에 대한 로캘          | 메모                                    | 다이제스트                                                                    |
|-----------------------------|:-----------------------------------------|:--------------------------------------------------------------------------|
| `ar-ae`                     | `ar-AE` 로캘이 있는 컨테이너 이미지입니다. | `sha256:9114c6885513cc3ae8d3c9393d3f4f334bb68ff9e444734951f469f8d56fb41c` |
| `ar-bh`                     | `ar-BH` 로캘이 있는 컨테이너 이미지입니다. | `sha256:924dc807076633f4e04f1f604c3db63d908a484c69459bf593d72b58d901cd43` |
| `ar-eg`                     | `ar-EG` 로캘이 있는 컨테이너 이미지입니다. | `sha256:13387db275daf6375e12ce1da5b858493ab71b249a3759e438345ac32119c6b2` |
| `ar-iq`                     | `ar-IQ` 로캘이 있는 컨테이너 이미지입니다. | `sha256:2e8bea90f7a106a94e36d9c90e767c58cd8004a61880af53bd4ffb4292a655fe` |
| `ar-jo`                     | `ar-JO` 로캘이 있는 컨테이너 이미지입니다. | `sha256:23c8529ee0e91fee549523021711a755da4c249f21493a1864a64941b36e2986` |
| `ar-kw`                     | `ar-KW` 로캘이 있는 컨테이너 이미지입니다. | `sha256:9114c6885513cc3ae8d3c9393d3f4f334bb68ff9e444734951f469f8d56fb41c` |
| `ar-lb`                     | `ar-LB` 로캘이 있는 컨테이너 이미지입니다. | `sha256:70bbb43641f22e96e70d3b5723b2599dd83533f33d979ff9dfb04a627799f4d1` |
| `ar-om`                     | `ar-OM` 로캘이 있는 컨테이너 이미지입니다. | `sha256:f6fc1c1bcb7d20f2daa30506a039d16ad0537a60c01e41b399159704a001fe42` |
| `ar-qa`                     | `ar-QA` 로캘이 있는 컨테이너 이미지입니다. | `sha256:9114c6885513cc3ae8d3c9393d3f4f334bb68ff9e444734951f469f8d56fb41c` |
| `ar-sa`                     | `ar-SA` 로캘이 있는 컨테이너 이미지입니다. | `sha256:9114c6885513cc3ae8d3c9393d3f4f334bb68ff9e444734951f469f8d56fb41c` |
| `ar-sy`                     | `ar-SY` 로캘이 있는 컨테이너 이미지입니다. | `sha256:218c1f57623b81770c22c7f871bce58a3227ef5fcbe7581e18a69f77107b5c96` |
| `bg-bg`                     | `bg-BG` 로캘이 있는 컨테이너 이미지입니다. | `sha256:9537460403216802831fa02a6eb3bf7a3f6e1e6669953ab4ae9c98ea6283799a` |
| `ca-es`                     | `ca-ES` 로캘이 있는 컨테이너 이미지입니다. | `sha256:94f68e496546eb3c33cf07b7f88807fa23c3f9d5022c2e630b589e29951f0538` |
| `cs-cz`                     | `cs-CZ` 로캘이 있는 컨테이너 이미지입니다. | `sha256:10de908ebf603c6b3a2a937edc870d5fe1c4dc6bc9bb7e1f0eca9b9ed2b19a88` |
| `da-dk`                     | `da-DK` 로캘이 있는 컨테이너 이미지입니다. | `sha256:cf03effc2a616b8fea8eacf7d45728cd00b9948f4f3e55d692db0125c51881da` |
| `de-de`                     | `de-DE` 로캘이 있는 컨테이너 이미지입니다. | `sha256:9c9a51d595253c54811ba8d7502799b638f6332c0524fca2543f20efb76c7337` |
| `el-gr`                     | `el-GR` 로캘이 있는 컨테이너 이미지입니다. | `sha256:6bb17c45a291f6293970a4de7bfdc9e31fdffedf80e76f66bca3cab118f76252` |
| `en-au`                     | `en-AU` 로캘이 있는 컨테이너 이미지입니다. | `sha256:1e58c2e2416208b658d18fc4bf6374d6032710ff29c09f125c6d19a4d6609e92` |
| `en-ca`                     | `en-CA` 로캘이 있는 컨테이너 이미지입니다. | `sha256:f0c4da3aa11f9eb72adbc7eab0c18047eec5016ec8c2fec2f1132ddceb3b6f3a` |
| `en-gb`                     | `en-GB` 로캘이 있는 컨테이너 이미지입니다. | `sha256:4d0917974effee44ebf1721e9c0d9a3a2ab957613ce3862fe99062add5d5d08a` |
| `en-hk`                     | `en-HK` 로캘이 있는 컨테이너 이미지입니다. | `sha256:b72a01b0cfaa97ea6102b48acb0a546501bb63618ee4ec9b892bdbdc6fd7ce8c` |
| `en-ie`                     | `en-IE` 로캘이 있는 컨테이너 이미지입니다. | `sha256:d26f56f1f4c41b1c035eb47950cb5bc6bd86cbe07ef08c2276275a46ac4c4ad4` |
| `en-in`                     | `en-IN` 로캘이 있는 컨테이너 이미지입니다. | `sha256:0ad933b9b3626d21d8ac0320f7fb4c72bcf6767258e39ac57698ce0269ed7750` |
| `en-nz`                     | `en-NZ` 로캘이 있는 컨테이너 이미지입니다. | `sha256:d6f9344f7cf0b827b63fb91c31e490546732e8a6c93080e925cd922458ae3695` |
| `en-ph`                     | `en-PH` 로캘이 있는 컨테이너 이미지입니다. | `sha256:dbd1fe80e1801b5fa7e468365f469c1b5770b0f27f2e5afb90c25a74702a0a21` |
| `en-sg`                     | `en-SG` 로캘이 있는 컨테이너 이미지입니다. | `sha256:f234725e54af7bda1c6baa7e9f907b703a85118d65249ca0c050c52109397cc6` |
| `en-us`                     | `en-US` 로캘이 있는 컨테이너 이미지입니다. | `sha256:88dd53d975829707f6ef91ad91aec9ed5fd12df8f4ef33e8c3bdf4701eaaca84` |
| `en-za`                     | `en-ZA` 로캘이 있는 컨테이너 이미지입니다. | `sha256:502693715b8b666a9c10084c733848f95201e9882f9bfae7df770bd9dc8bb983` |
| `es-ar`                     | `es-AR` 로캘이 있는 컨테이너 이미지입니다. | `sha256:6aa4f300639f7ee958adced5e7e5867e7f4d4093f2ca953f3ee5da9128bf08f6` |
| `es-bo`                     | `es-BO` 로캘이 있는 컨테이너 이미지입니다. | `sha256:60f01882b393e00743c61c783e98c1cdcf73097c555999f10e5612b06b5afa90` |
| `es-cl`                     | `es-CL` 로캘이 있는 컨테이너 이미지입니다. | `sha256:7b58b3a823c0fff1b92e46dd848610f2c9dcae5be0463845292e810d3efa1b1b` |
| `es-co`                     | `es-CO` 로캘이 있는 컨테이너 이미지입니다. | `sha256:c51291acc65e1a839477f9bdbd042e4c81d2e638f48a00b6ca423023c9fd6c2c` |
| `es-cr`                     | `es-CR` 로캘이 있는 컨테이너 이미지입니다. | `sha256:085b3bf2869fcedb56745e6adc98f2a332d57d0b1ac66cc219cec436a884d7d5` |
| `es-cu`                     | `es-CU` 로캘이 있는 컨테이너 이미지입니다. | `sha256:43e5425cab3f708ed8632152514f4152f45a19953758fb7b5ebe9f4a767bcfdb` |
| `es-do`                     | `es-DO` 로캘이 있는 컨테이너 이미지입니다. | `sha256:249f3165e0347b223ff06e34c309a753965a3df55bda2a78e04d86c946205d06` |
| `es-ec`                     | `es-EC` 로캘이 있는 컨테이너 이미지입니다. | `sha256:624eeed264f25bab59a7723c6e6c3ae760bc63c46ebe3bcd3db171220682c14d` |
| `es-es`                     | `es-ES` 로캘이 있는 컨테이너 이미지입니다. | `sha256:6d2d41e3b78ebba9d5d46fc8bddb90d0d69680a904774f5da1fa01eb4efd68e1` |
| `es-gt`                     | `es-GT` 로캘이 있는 컨테이너 이미지입니다. | `sha256:ce4b4b761d1a2ca2b657b877c46a341a83f0b1a46447007262c051f6785b7312` |
| `es-hn`                     | `es-HN` 로캘이 있는 컨테이너 이미지입니다. | `sha256:d4ecebce65a18763ac1126bf83706e49ebed80b79255e3820a68e97037d2a501` |
| `es-mx`                     | `es-MX` 로캘이 있는 컨테이너 이미지입니다. | `sha256:c3088a60818b85cd0f04445837ea0ddcb6e7ac4f77269471717002166195d6d2` |
| `es-ni`                     | `es-NI` 로캘이 있는 컨테이너 이미지입니다. | `sha256:1d88e66f6fd86ddf6e47596d2e2b9b3fe64ea7e72f6c4c965d3f1c5b98592e1b` |
| `es-pa`                     | `es-PA` 로캘이 있는 컨테이너 이미지입니다. | `sha256:bb07eb832bcd23f302f0a7b6c4e87bf33186a47ed154ac8b42a1f6dea0f35432` |
| `es-pe`                     | `es-PE` 로캘이 있는 컨테이너 이미지입니다. | `sha256:b726f92daf85c8aa6b169767efdb2af1691ddb7b21b8af3e9afcb984f41d8539` |
| `es-pr`                     | `es-PR` 로캘이 있는 컨테이너 이미지입니다. | `sha256:660a5f9e13d62a963c9c92219f8268ad7f7af5ed08890534679e143cff184004` |
| `es-py`                     | `es-PY` 로캘이 있는 컨테이너 이미지입니다. | `sha256:cb708bc008a59ac35e292094eba912af741c49eb7e67c2df3c1023ab41a6d454` |
| `es-sv`                     | `es-SV` 로캘이 있는 컨테이너 이미지입니다. | `sha256:acd788410f8f6f8c269c85e6c70365e751a92976d61b34b7435766c0ae2fd11a` |
| `es-us`                     | `es-US` 로캘이 있는 컨테이너 이미지입니다. | `sha256:f7ef486a64a413f7d69510f25a39ddce9653265852da1b3cc438000f1bbfa368` |
| `es-uy`                     | `es-UY` 로캘이 있는 컨테이너 이미지입니다. | `sha256:7f6975423cbcf201e318bea9865e93a8e4a6a241b472845d90a877400470338b` |
| `es-ve`                     | `es-VE` 로캘이 있는 컨테이너 이미지입니다. | `sha256:e2f498c4a19f88779dfae350e0cefb4f0aa1c518c18f43139d4bec6a4f655f45` |
| `et-ee`                     | `et-EE` 로캘이 있는 컨테이너 이미지입니다. | `sha256:66ec075ea26141d73e07a223f72f10ea8237d0d9675e67d569f026ca6125cd95` |
| `fi-fi`                     | `fi-FI` 로캘이 있는 컨테이너 이미지입니다. | `sha256:34b4ee60880d310aa08f1584c2f8d1a9a0236ac0067b9d8ad8bf5057749f2d9b` |
| `fr-ca`                     | `fr-CA` 로캘이 있는 컨테이너 이미지입니다. | `sha256:709bc27ebd387cc18d3d16136280234f64c4ba28f05383a52e0bbe066574105a` |
| `fr-fr`                     | `fr-FR` 로캘이 있는 컨테이너 이미지입니다. | `sha256:cfd3140a3c7a5234c0273e34b9b124897cff6c2d11403217096616dd34c14e38` |
| `ga-ie`                     | `ga-IE` 로캘이 있는 컨테이너 이미지입니다. | `sha256:f03b3407772d4a5be1642ff0f78c64283c2e8fd9b473f8bab90864a59d4f8a4a` |
| `gu-in`                     | `gu-IN` 로캘이 있는 컨테이너 이미지입니다. | `sha256:c67190092fcf7af406406e5906d9de79a8fb37565e84b2dc0786caee0b5b27e2` |
| `hi-in`                     | `hi-IN` 로캘이 있는 컨테이너 이미지입니다. | `sha256:eea6f9608d9802ac43e755de39d87e95e708d5c642f58de09863363051112540` |
| `hr-hr`                     | `hr-HR` 로캘이 있는 컨테이너 이미지입니다. | `sha256:3943c40ef4696c44887d08a1cb911f535af451b811737b0101a4fa0ef4284d68` |
| `hu-hu`                     | `hu-HU` 로캘이 있는 컨테이너 이미지입니다. | `sha256:52eb41ca6694497356cb23bd02daf4bb2408ffad418696aeb1bdf1f03c2e2845` |
| `it-it`                     | `it-IT` 로캘이 있는 컨테이너 이미지입니다. | `sha256:70aa2b907f114278d839a958dea29c74b64cd1f7a5a0406194d2aa3583c12048` |
| `ja-jp`                     | `ja-JP` 로캘이 있는 컨테이너 이미지입니다. | `sha256:14e222688387847f51fd858c5575e554046796090e41f072d6200d89f5608e4a` |
| `ko-kr`                     | `ko-KR` 로캘이 있는 컨테이너 이미지입니다. | `sha256:8f3ed7b3896b205b5690e5515a5511581715e698cd6fe0704c153d35a4c9af80` |
| `lt-lt`                     | `lt-LT` 로캘이 있는 컨테이너 이미지입니다. | `sha256:806572a1ae31575806062301d22233b753c415388184496ee67589ddbc264d49` |
| `lv-lv`                     | `lv-LV` 로캘이 있는 컨테이너 이미지입니다. | `sha256:780444acc9be4514072926146c36b7ccce003f27577b339cf431fec2ca6d79f5` |
| `mr-in`                     | `mr-IN` 로캘이 있는 컨테이너 이미지입니다. | `sha256:75460753cba8d45babaf859f94dfd1a1c75b312a841eacded099680dc77c2f89` |
| `mt-mt`                     | `mt-MT` 로캘이 있는 컨테이너 이미지입니다. | `sha256:8d92a5f26100d309a11f05ce13e5e5a0f2bbc072df917af158cc251dc75a4d4f` |
| `nb-no`                     | `nb-NO` 로캘이 있는 컨테이너 이미지입니다. | `sha256:d9c75c885591ced0e10cca5594ae5cf92cb1dde73306f8454737b7927aada89a` |
| `nl-nl`                     | `nl-NL` 로캘이 있는 컨테이너 이미지입니다. | `sha256:15cc274d238cae2a1d9cabc3e5a71e4ba90ae6318fea63937c8830bd55da0fc2` |
| `pl-pl`                     | `pl-PL` 로캘이 있는 컨테이너 이미지입니다. | `sha256:a45730afdc6d15060eff8526e1be08f679b25a2be26156d39266a40e6cd82bc9` |
| `pt-br`                     | `pt-BR` 로캘이 있는 컨테이너 이미지입니다. | `sha256:8f578440ae5c9cd81eee18f68c677bb56ced7c6a6a217d98da60dc856fd2e002` |
| `pt-pt`                     | `pt-PT` 로캘이 있는 컨테이너 이미지입니다. | `sha256:99fedeb4acc49fd3185d34532b1a7321931b17f2eda16ab8643312dbf8afcf38` |
| `ro-ro`                     | `ro-RO` 로캘이 있는 컨테이너 이미지입니다. | `sha256:7677c49b2426fb26eff59a97a012d5890aa7fdbc09684ef0fb29fdbe63fac333` |
| `ru-ru`                     | `ru-RU` 로캘이 있는 컨테이너 이미지입니다. | `sha256:452d269e8e12ae1379d4568bc1b15fefdd3679903365adb3a68bc6669c738615` |
| `sk-sk`                     | `sk-SK` 로캘이 있는 컨테이너 이미지입니다. | `sha256:e6fd994a344b5452b4a5b90a499fed0681dd6ef2fab3db161d407cf4f45ff5dd` |
| `sl-si`                     | `sl-SI` 로캘이 있는 컨테이너 이미지입니다. | `sha256:4df5fdc9732c07d479275561522ce34a38c3864098a56e12ec8329e40f4e6f2a` |
| `sv-se`                     | `sv-SE` 로캘이 있는 컨테이너 이미지입니다. | `sha256:49180ac0eccee59a22800f4c1ae870e3a71543e46d2986fc82ec9b77c7de1ea0` |
| `ta-in`                     | `ta-IN` 로캘이 있는 컨테이너 이미지입니다. | `sha256:a0c64efbf2d9d0a111efc79cc7b70e06ac01745de57d9c768f99c54ac5642cee` |
| `te-in`                     | `te-IN` 로캘이 있는 컨테이너 이미지입니다. | `sha256:8811c30c10980a3ddf441f1d4e21240bfb8663af6200c2d666fdeb83f48a79c5` |
| `th-th`                     | `th-TH` 로캘이 있는 컨테이너 이미지입니다. | `sha256:99860f484f52d9665f33d95659daa8aec5071fa5a97534d40ee4941690ce3e96` |
| `tr-tr`                     | `tr-TR` 로캘이 있는 컨테이너 이미지입니다. | `sha256:170b56107ccb22335422c1838e368c0f5cb4518c3309e6259b754ede9e46ff51` |
| `zh-cn`                     | `zh-CN` 로캘이 있는 컨테이너 이미지입니다. | `sha256:d8721f303ca0b24705c42e8c0f5d20dcafb3d00b278b7c363d1a4c129f5e2cbd` |
| `zh-hk`                     | `zh-HK` 로캘이 있는 컨테이너 이미지입니다. | `sha256:12af9f057acec8231dcdeb1e4037ac53a95957796b5e8dbf48f55db6970a4431` |
| `zh-tw`                     | `zh-TW` 로캘이 있는 컨테이너 이미지입니다. | `sha256:b2c1d333b7718c9cc2708287e388c45abcd28a3e8d7fc3c758cc4b73d2697662` |

| v2.12.1에 대한 로캘          | 메모                                    | 다이제스트                                                                    |
|-----------------------------|:-----------------------------------------|:--------------------------------------------------------------------------|
| `ar-ae`                     | `ar-AE` 로캘이 있는 컨테이너 이미지입니다. | `sha256:070b6f390dbe7b81b72845c1c9c83087979e1e330d84d417f39a371298a4d270` |
| `ar-bh`                     | `ar-BH` 로캘이 있는 컨테이너 이미지입니다. | `sha256:2b67e2a2a3ba79e52c5de4b2af7f3d3db565466d9a55d5f9d7501f349f42b49d` |
| `ar-eg`                     | `ar-EG` 로캘이 있는 컨테이너 이미지입니다. | `sha256:71cccd4dc4938397ea5b065fb32ab7347350c834edb036805362ca28e7cfec94` |
| `ar-iq`                     | `ar-IQ` 로캘이 있는 컨테이너 이미지입니다. | `sha256:a9000def8d9c634af244384442c2723ad887c79e7f80a767bf7fcf3638a9deac` |
| `ar-jo`                     | `ar-JO` 로캘이 있는 컨테이너 이미지입니다. | `sha256:b8be9222b3e1bc40ba86c41e707f239d9ae23bc87d90b800615c314a443d947f` |
| `ar-kw`                     | `ar-KW` 로캘이 있는 컨테이너 이미지입니다. | `sha256:070b6f390dbe7b81b72845c1c9c83087979e1e330d84d417f39a371298a4d270` |
| `ar-lb`                     | `ar-LB` 로캘이 있는 컨테이너 이미지입니다. | `sha256:d41dbc9e93ae524abb95d2adde53924a32956ab1ec14a115916e5e531b3f3624` |
| `ar-om`                     | `ar-OM` 로캘이 있는 컨테이너 이미지입니다. | `sha256:3071d896f82d062e126331e3162d5408eb399aeda3041be2336f81bed0634e5e` |
| `ar-qa`                     | `ar-QA` 로캘이 있는 컨테이너 이미지입니다. | `sha256:070b6f390dbe7b81b72845c1c9c83087979e1e330d84d417f39a371298a4d270` |
| `ar-sa`                     | `ar-SA` 로캘이 있는 컨테이너 이미지입니다. | `sha256:070b6f390dbe7b81b72845c1c9c83087979e1e330d84d417f39a371298a4d270` |
| `ar-sy`                     | `ar-SY` 로캘이 있는 컨테이너 이미지입니다. | `sha256:d7207eb391d0455ae112b61bc2c22280618131ad9591324bcde7e5057777fc26` |
| `bg-bg`                     | `bg-BG` 로캘이 있는 컨테이너 이미지입니다. | `sha256:c5c9639b9e09e07f6d8733017d30beed3aad54fa91c69c72526d34aa27ead884` |
| `ca-es`                     | `ca-ES` 로캘이 있는 컨테이너 이미지입니다. | `sha256:dc6b7697099cd966aa4c8ba0b192ccb286b4241a76b12dbf494a9de319191334` |
| `cs-cz`                     | `cs-CZ` 로캘이 있는 컨테이너 이미지입니다. | `sha256:ded8e56b863567e73b92cba4b7abeaf3f8c9ae335280a9645961d683ebfe8f9f` |
| `da-dk`                     | `da-DK` 로캘이 있는 컨테이너 이미지입니다. | `sha256:d3fc39e0d0454609bde5f6df67d7ade199f5361559ce11f097e97fca312d78b7` |
| `de-de`                     | `de-DE` 로캘이 있는 컨테이너 이미지입니다. | `sha256:bbd8ede305ec5b551cdfac857507a1d05c3ca95119e431f0f43fe073d830f8fd` |
| `el-gr`                     | `el-GR` 로캘이 있는 컨테이너 이미지입니다. | `sha256:e4f39db7de5fb8106237f73adb2fbb229a7b8cb21291e593a346f928af87503f` |
| `en-au`                     | `en-AU` 로캘이 있는 컨테이너 이미지입니다. | `sha256:186731d8479923a9dce053aee78f1347cd512471ead33802faef19bfa4e94883` |
| `en-ca`                     | `en-CA` 로캘이 있는 컨테이너 이미지입니다. | `sha256:04ede5a65eaf6f1d7a36d97056468b024b1577e3cf3a2cdafcd511d1de64f9d8` |
| `en-gb`                     | `en-GB` 로캘이 있는 컨테이너 이미지입니다. | `sha256:ef48d6889daec88405e7a86b3851df449066da8f0f62404260eabe68081e9b32` |
| `en-hk`                     | `en-HK` 로캘이 있는 컨테이너 이미지입니다. | `sha256:7d66fb960d55822c648919557d8e921c570dbbe36b165621f2bd5081df3c51c1` |
| `en-ie`                     | `en-IE` 로캘이 있는 컨테이너 이미지입니다. | `sha256:4285ff1d4b2231bc112a50c22072dabb303240ce18aeeab7183da3a572298a6a` |
| `en-in`                     | `en-IN` 로캘이 있는 컨테이너 이미지입니다. | `sha256:b32b94f8a2bf56e0fa2cf63f885e9456b430411038ce2ebef6abd45159787ef6` |
| `en-nz`                     | `en-NZ` 로캘이 있는 컨테이너 이미지입니다. | `sha256:c2162d7524bafd554fea81f2b3d95f3848ff0bf4ec0c4bd9d9bc4f2eae75ca27` |
| `en-ph`                     | `en-PH` 로캘이 있는 컨테이너 이미지입니다. | `sha256:e55f7d21d3b9d230bba78b41eb2418abacb7e6d832a0ec350ab86f98420260ce` |
| `en-sg`                     | `en-SG` 로캘이 있는 컨테이너 이미지입니다. | `sha256:d0d3d6d266f05cdedcaf75949ece66492e2e37b15684a80d08de3494381a5d10` |
| `en-us`                     | `en-US` 로캘이 있는 컨테이너 이미지입니다. | `sha256:b708d553eeb22958563c24fef18edc67f89d1b4ea0ff31a66ea34c624fcec878` |
| `en-za`                     | `en-ZA` 로캘이 있는 컨테이너 이미지입니다. | `sha256:5a5ad9afb9f0935ec9ffd5a1034bed186c46d2f9ea82ab485f949695ca4c2b61` |
| `es-ar`                     | `es-AR` 로캘이 있는 컨테이너 이미지입니다. | `sha256:c0f4dde13c319b4fd75b6b8615fc68aacd22ac04cf8b605d8d62486a08851d2d` |
| `es-bo`                     | `es-BO` 로캘이 있는 컨테이너 이미지입니다. | `sha256:af5f1435cd3e58ee9e98d8623a071dd72f30bf9ddbd90e1a61f06677ff34c0d3` |
| `es-cl`                     | `es-CL` 로캘이 있는 컨테이너 이미지입니다. | `sha256:ba42ed9a8c102b1af53873fc0d9ccd288723be3f5a409bf1480363381f8127fa` |
| `es-co`                     | `es-CO` 로캘이 있는 컨테이너 이미지입니다. | `sha256:08292bac0b6d97c5ba3cb2b277c53289235216c124c72ce74c0a2d734860c777` |
| `es-cr`                     | `es-CR` 로캘이 있는 컨테이너 이미지입니다. | `sha256:e245443a75fdcdd8c10463a45a80d716d36cf336dfb23948f17d50939f65e919` |
| `es-cu`                     | `es-CU` 로캘이 있는 컨테이너 이미지입니다. | `sha256:d5d853b26104f2b9b7bf48a89dfe8a19f72c5d689eb474d68c8234c8b297dbf0` |
| `es-do`                     | `es-DO` 로캘이 있는 컨테이너 이미지입니다. | `sha256:9a503a29fdf52a973c0e9339ac8b4f52442e7130c340ca7e12c8a38df004c8a1` |
| `es-ec`                     | `es-EC` 로캘이 있는 컨테이너 이미지입니다. | `sha256:661726852daeb5d1d839c05e95c0a683e9722564356089bd4023edfbf83076ae` |
| `es-es`                     | `es-ES` 로캘이 있는 컨테이너 이미지입니다. | `sha256:3c55158c8e030fbad2f090b587cbd6501303128af77ff0bddc8819e6a9a88e62` |
| `es-gt`                     | `es-GT` 로캘이 있는 컨테이너 이미지입니다. | `sha256:31ea64c3cf1d442b5182d664a16afd81ac402ab8a0c2434e642317f20c920be4` |
| `es-hn`                     | `es-HN` 로캘이 있는 컨테이너 이미지입니다. | `sha256:1ed31bb1cd484fc23b177c355ef65c12dc2b937c113b2b175f8b383e9390ca86` |
| `es-mx`                     | `es-MX` 로캘이 있는 컨테이너 이미지입니다. | `sha256:0c979930fa983fd76f6d3610b2d9c1018eaefe456b8b5d07f5ff90d605bebc9e` |
| `es-ni`                     | `es-NI` 로캘이 있는 컨테이너 이미지입니다. | `sha256:7bb685a97e64130caaea382d1b33b57ffb4dbeb16881f421ed212f81f0d46de2` |
| `es-pa`                     | `es-PA` 로캘이 있는 컨테이너 이미지입니다. | `sha256:4da6a791737e136e494753666c7a40518e147c7bd225461165714510c19a44c6` |
| `es-pe`                     | `es-PE` 로캘이 있는 컨테이너 이미지입니다. | `sha256:62b41c8003fcc17f5aef9729cfcbbdf81990e1ba2bc4ddefcd947ce3374f5794` |
| `es-pr`                     | `es-PR` 로캘이 있는 컨테이너 이미지입니다. | `sha256:eb396527bd28bfbd4a5d70ea29775b8352f3490d159b3ceeb32b442058817e12` |
| `es-py`                     | `es-PY` 로캘이 있는 컨테이너 이미지입니다. | `sha256:a70f0196b552934d35b165059b28f192f97f83d451ae08ec0d267ab8a3c6adf5` |
| `es-sv`                     | `es-SV` 로캘이 있는 컨테이너 이미지입니다. | `sha256:361588561ed3ade02926e9db88ae1a9455fd76e6370ad794638d794129aa0036` |
| `es-us`                     | `es-US` 로캘이 있는 컨테이너 이미지입니다. | `sha256:120b28f629f4825e7b7f52f28f535f6c1bf2f8139c8288867a4bf491fc155a4e` |
| `es-uy`                     | `es-UY` 로캘이 있는 컨테이너 이미지입니다. | `sha256:ebc2b82704cb4d1be4d3dcfad933978ceb3daa8077cf6cadf560d8c33d6f4334` |
| `es-ve`                     | `es-VE` 로캘이 있는 컨테이너 이미지입니다. | `sha256:33931d7b35f8e7a05822aa7052fb89e8de3124311e70ff567a7f9ca158223f27` |
| `et-ee`                     | `et-EE` 로캘이 있는 컨테이너 이미지입니다. | `sha256:cd0a9c661b4645763d73a947e933b9d4e817485f4b9d6d0ac173195693a29f33` |
| `fi-fi`                     | `fi-FI` 로캘이 있는 컨테이너 이미지입니다. | `sha256:06e90396c307396ef395c23efc3157f75c207f230fb048d73ece407edd24c7b4` |
| `fr-ca`                     | `fr-CA` 로캘이 있는 컨테이너 이미지입니다. | `sha256:d9be6bca9c3abf839796d8f89bf43d2646080150057f6eb343c66042bc98ccfc` |
| `fr-fr`                     | `fr-FR` 로캘이 있는 컨테이너 이미지입니다. | `sha256:1c3ffb5730c401124edbb7b347569ca3bebd33412a24b32802f4d41401e911dc` |
| `ga-ie`                     | `ga-IE` 로캘이 있는 컨테이너 이미지입니다. | `sha256:218d319b2835da7b09ab4536e5d8301ede2bcd3bc023606d05d7294c534982cf` |
| `gu-in`                     | `gu-IN` 로캘이 있는 컨테이너 이미지입니다. | `sha256:dea03196c1ad06cb1bf9914b5c5d1a631aafbaa5bd74a4d53d08dec982f545fe` |
| `hi-in`                     | `hi-IN` 로캘이 있는 컨테이너 이미지입니다. | `sha256:5f33b06d0f77fd3c5d351284b2aff41681927cfa7fbda00ead338f7bd54f6575` |
| `hr-hr`                     | `hr-HR` 로캘이 있는 컨테이너 이미지입니다. | `sha256:2b7e558abb94a74e6b5a7f467289ba5cb32970967cd7409db2c150290ed9844d` |
| `hu-hu`                     | `hu-HU` 로캘이 있는 컨테이너 이미지입니다. | `sha256:05619049274edcd572d1ac6fabf11e0bdd2e95a9145e99065f46d2f26a2dc960` |
| `it-it`                     | `it-IT` 로캘이 있는 컨테이너 이미지입니다. | `sha256:75253c7bb0ef67b50767593e36129dc98c8d9de60a31b2a7069d07a0cb6b6400` |
| `ja-jp`                     | `ja-JP` 로캘이 있는 컨테이너 이미지입니다. | `sha256:46bce0ab6a09f0837a4f884e29a69d38591e513e157d334fd39a2c6f1f08bb06` |
| `ko-kr`                     | `ko-KR` 로캘이 있는 컨테이너 이미지입니다. | `sha256:747bfeb07d354b848f7ffbd292c16befc00586d62b958fbb42f8b497a0dec87c` |
| `lt-lt`                     | `lt-LT` 로캘이 있는 컨테이너 이미지입니다. | `sha256:eab3cf2323ec4d86b923693595e16724dd6090d60a1a93a9d65f73c55b684448` |
| `lv-lv`                     | `lv-LV` 로캘이 있는 컨테이너 이미지입니다. | `sha256:1c5085250bcdbde6b619594b2f920c307b3d97672f01f03608618bd52a4374a7` |
| `mr-in`                     | `mr-IN` 로캘이 있는 컨테이너 이미지입니다. | `sha256:b35274995b93587b8957101e8139598011d760df1f4c36f966114a4352b865cf` |
| `mt-mt`                     | `mt-MT` 로캘이 있는 컨테이너 이미지입니다. | `sha256:59b5088fef6b8ba41eed98dd738159e914c292ce790a3b8a934aa0ac6c161cca` |
| `nb-no`                     | `nb-NO` 로캘이 있는 컨테이너 이미지입니다. | `sha256:a0074f10622c8ccc7d288cfa131786a02fe2c98e2cbe22caa0d07690c436f8b3` |
| `nl-nl`                     | `nl-NL` 로캘이 있는 컨테이너 이미지입니다. | `sha256:a6fc1ad6ea87c5f6282f3d10f724358e30f0f05c91084d52fd665e356bd6119b` |
| `pl-pl`                     | `pl-PL` 로캘이 있는 컨테이너 이미지입니다. | `sha256:9fc1363f4466d4e0bba3f2fb74efc54ff24fe43a55fe7703aa75da2b42e563c3` |
| `pt-br`                     | `pt-BR` 로캘이 있는 컨테이너 이미지입니다. | `sha256:e3ec228d0eb76f91cd1fe723607eb0b96b9e1dc8874c40d1307f2b3585ab1912` |
| `pt-pt`                     | `pt-PT` 로캘이 있는 컨테이너 이미지입니다. | `sha256:9e6bdf31a80cb8a97b495ce39144d4957d9608e541aae9be6c5c35456476d4af` |
| `ro-ro`                     | `ro-RO` 로캘이 있는 컨테이너 이미지입니다. | `sha256:240baf152c419caeee33c7f18285d930af15d14ce784967305accf6541722a22` |
| `ru-ru`                     | `ru-RU` 로캘이 있는 컨테이너 이미지입니다. | `sha256:53eff9f8eb08bba90efb30d8fdb2c9760bb0d8ae60cda967b72f0433ae18f524` |
| `sk-sk`                     | `sk-SK` 로캘이 있는 컨테이너 이미지입니다. | `sha256:39ff9f4f25ed4953cd5db2d0083339d712ab1ff2adfdcf3e8cd461da94cb1c97` |
| `sl-si`                     | `sl-SI` 로캘이 있는 컨테이너 이미지입니다. | `sha256:a4747493c498b85448de88e4a2b9f967a33886e256c5b7b257c0cebe41963245` |
| `sv-se`                     | `sv-SE` 로캘이 있는 컨테이너 이미지입니다. | `sha256:f49c20ffe5a816f929d0231f7bbd8ddfec37b74b0de992012401b6ff1f0d7b92` |
| `ta-in`                     | `ta-IN` 로캘이 있는 컨테이너 이미지입니다. | `sha256:d56c941c25964d6eca44fa033f12e4bfdc1e34df24bcad03ea35ba687fd91a4a` |
| `te-in`                     | `te-IN` 로캘이 있는 컨테이너 이미지입니다. | `sha256:18cec69b7f443140755c55cdc3593a4be7decbf774420e7aeeb38eff92b7b880` |
| `th-th`                     | `th-TH` 로캘이 있는 컨테이너 이미지입니다. | `sha256:60f1de16c63c4b1d1450c1b58f06b9ae6f33547d133b07e6f9e57035188a82f6` |
| `tr-tr`                     | `tr-TR` 로캘이 있는 컨테이너 이미지입니다. | `sha256:b314044779cd4296cca629d1e5cd01c0c1caebccfb32603b32c07e0374b2832c` |
| `zh-cn`                     | `zh-CN` 로캘이 있는 컨테이너 이미지입니다. | `sha256:5819f0f4fb50e4fb8f0485dfdd134ebac74b2376371a0b8f6c915a3e15873d6d` |
| `zh-hk`                     | `zh-HK` 로캘이 있는 컨테이너 이미지입니다. | `sha256:c2346a98f8d17ee50da4ced6d4cccf7d36a4e9589c571237b3f4850a411d66e0` |
| `zh-tw`                     | `zh-TW` 로캘이 있는 컨테이너 이미지입니다. | `sha256:3accfe8f947359764e92831bdfb5d33ac8add29e8c43ef0af3dfe1c3ff004783` |
...
`1.15.0-amd64-<locale-and-voice>`에 대한 릴리스 정보:
...
| `bg-bg-ivan`                                | `bg-BG` 로캘과 `bg-BG-Ivan` 음성이 있는 컨테이너 이미지입니다.            | `sha256:19f8c32f6723470c14c4b1731ff256853ee5c441a95a89faff767c2c4e4447a9` |
| `ca-es-herenarus`                           | `ca-ES` 로캘과 `ca-ES-HerenaRUS` 음성이 있는 컨테이너 이미지입니다.       | `sha256:16835388036906af8b35238f05b7f17308b8fae92bf4c89199dcc0b35bb289d6` |
| `cs-cz-jakub`                               | `cs-CZ` 로캘과 `cs-CZ-Jakub` 음성이 있는 컨테이너 이미지입니다.           | `sha256:06af13ede8234c14f8a48b956017cd7858a1c0d984042a9a60309ae9f8f6a25b` |
| `da-dk-hellerus`                            | `da-DK` 로캘과 `da-DK-HelleRUS` 음성이 있는 컨테이너 이미지입니다.        | `sha256:1c6375ee05948ec9a9b2554e2423e2c2d68e7595f58d401bd2f9fc25bd512bde` |
| `de-at-michael`                             | `de-AT` 로캘과 `de-AT-Michael` 음성이 있는 컨테이너 이미지입니다.         | `sha256:27e88c817ab91b2a4dbb5df1f88828708445993c1d657d974b6253f1820e280f` |
| `de-ch-karsten`                             | `de-CH` 로캘과 `de-CH-Karsten` 음성이 있는 컨테이너 이미지입니다.         | `sha256:6b8ce6192783c1b158410a43a8fd9517cfe63c8b4a3cd0f1118acd891e7ebea5` |
| `de-de-heddarus`                            | `de-DE` 로캘과 `de-DE-Hedda` 음성이 있는 컨테이너 이미지입니다.           | `sha256:28e1a6f0860165a4f3750b059334117240e0613ddf44d1e3c41615093bd3e226` |
| `de-de-hedda`                               | `de-DE` 로캘과 `de-DE-Hedda` 음성이 있는 컨테이너 이미지입니다.           | `sha256:28e1a6f0860165a4f3750b059334117240e0613ddf44d1e3c41615093bd3e226` |
| `de-de-stefan-apollo`                       | `de-DE` 로캘과 `de-DE-Stefan-Apollo` 음성이 있는 컨테이너 이미지입니다.   | `sha256:3730dfefb60f3a74df523e790738595b29e3dc694a16506a6deccffec264aa2a` |
| `el-gr-stefanos`                            | `el-GR` 로캘과 `el-GR-Stefanos` 음성이 있는 컨테이너 이미지입니다.        | `sha256:dfce427d7c08bd26d38513fd4b5c85662fe4feeddefa75e1245c37bb5b245b45` |
| `en-au-catherine`                           | `en-AU` 로캘과 `en-AU-Catherine` 음성이 있는 컨테이너 이미지입니다.       | `sha256:71a9a64adc48044e2ce81119bc118056a906db284311fc3761b3cdfe21c6ad18` |
| `en-au-hayleyrus`                           | `en-AU` 로캘과 `en-AU-HayleyRUS` 음성이 있는 컨테이너 이미지입니다.       | `sha256:a42624ebf51afff052a0ed8518f474855d70b4a9245cd8e81492b449e6b765d1` |
| `en-ca-heatherrus`                          | `en-CA` 로캘과 `en-CA-HeatherRUS` 음성이 있는 컨테이너 이미지입니다.      | `sha256:b5f745bbf9de83f57ac4e6e2760049e10a8eaae362018c4d5a4ace02a50710dc` |
| `en-ca-linda`                               | `en-CA` 로캘과 `en-CA-Linda` 음성이 있는 컨테이너 이미지입니다.           | `sha256:6638a92b495c76ca16331c652b123fa52163242cfbd8f8298c9118a0f1261719` |
| `en-gb-george-apollo`                       | `en-GB` 로캘과 `en-GB-George-Apollo` 음성이 있는 컨테이너 이미지입니다.   | `sha256:748c7042dfa3107f387c34ee29269fc2bd96f27af525f2dc7b50275dae106bd1` |
| `en-gb-hazelrus`                            | `en-GB` 로캘과 `en-GB-HazelRUS` 음성이 있는 컨테이너 이미지입니다.        | `sha256:8a439470579f95645bf5831ee5f0643b872d6bdbd7426cf57264bb5a13c12624` |
| `en-gb-susan-apollo`                        | `en-GB` 로캘과 `en-GB-Susan-Apollo` 음성이 있는 컨테이너 이미지입니다.    | `sha256:ad9c5741a2b19fc936ec740fa0bbd2700e09e361d7ce9df0bb5fb204f6c31ec5` |
| `en-ie-sean`                                | `en-IE` 로캘과 `en-IE-Sean` 음성이 있는 컨테이너 이미지입니다.            | `sha256:45d1d07f67c81b11f7b239f0e46bd229694d0e795b01e72e583b2aecf671af3e` |
| `en-in-heera-apollo`                        | `en-IN` 로캘과 `en-IN-Heera-Apollo` 음성이 있는 컨테이너 이미지입니다.    | `sha256:f4cd71fac26b0d1f0693ce91535a0fd14ac90e323c6f9d8239f3eb7a196ff454` |
| `en-in-priyarus`                            | `en-IN` 로캘과 `en-IN-PriyaRUS` 음성이 있는 컨테이너 이미지입니다.        | `sha256:5a228190a5fe62aaa5f8443ab4041d2a7af381e30236333a44c364e990eeaba4` |
| `en-in-ravi-apollo`                         | `en-IN` 로캘과 `en-IN-Ravi-Apollo` 음성이 있는 컨테이너 이미지입니다.     | `sha256:3f477ad93ff643f90adf268775c9b8cd8fb3b2cadf347b3663317184c4e462c6` |
| `en-us-aria24krus`                          | `en-US` 로캘과 `en-US-Aria24kRUS` 음성이 있는 컨테이너 이미지입니다.      | `sha256:d4ece3a336171cd46068831b3203460c86e5cd7f053b56a8a7017a0547580030` |
| `en-us-ariarus`                             | `en-US` 로캘과 `en-US-AriaRUS` 음성이 있는 컨테이너 이미지입니다.         | `sha256:d4ece3a336171cd46068831b3203460c86e5cd7f053b56a8a7017a0547580030` |
| `en-us-benjaminrus`                         | `en-US` 로캘과 `en-US-BenjaminRUS` 음성이 있는 컨테이너 이미지입니다.     | `sha256:f668eb749ee51c01bcadf0df8e1a0b6fc000fb64a93bd12458bcff4e817bd4cf` |
| `en-us-guy24krus`                           | `en-US` 로캘과 `en-US-Guy24kRUS` 음성이 있는 컨테이너 이미지입니다.       | `sha256:50900ece25a078bc4e0a0fec845cc9516e975a7b90621e4fdea135c16b593752` |
| `en-us-zirarus`                             | `en-US` 로캘과 `en-US-ZiraRUS` 음성이 있는 컨테이너 이미지입니다.         | `sha256:772bdc81780a05f7400a88b1cddcef6ef0be153ce873df23918986f72920aa41` |
| `es-es-helenarus`                           | `es-ES` 로캘과 `es-ES-HelenaRUS` 음성이 있는 컨테이너 이미지입니다.       | `sha256:ab25fc60c8a8e095fcf63fe953bd2acf1f0569e6aafb02e90da916f7ef1905ce` |
| `es-es-laura-apollo`                        | `es-ES` 로캘과 `es-ES-Laura-Apollo` 음성이 있는 컨테이너 이미지입니다.    | `sha256:11c144693d62b28e1444378638295e801c07888fd6ff70903bdbb775a8cd4c7a` |
| `es-es-pablo-apollo`                        | `es-ES` 로캘과 `es-ES-Pablo-Apollo` 음성이 있는 컨테이너 이미지입니다.    | `sha256:56db18adc44ee4412fd64f2d9303960525627ecf9b6cd6c201d5260af5340378` |
| `es-mx-hildarus`                            | `es-MX` 로캘과 `es-MX-HildaRUS` 음성이 있는 컨테이너 이미지입니다.        | `sha256:80ad68c2ca58380ca3d88e509ad32a21f70ecc41fab701f629e2de509162bf61` |
| `es-mx-raul-apollo`                         | `es-MX` 로캘과 `es-MX-Raul-Apollo` 음성이 있는 컨테이너 이미지입니다.     | `sha256:fd51cdcc46ac5c81949d7ff3ceeacf7144fb6e516089fff645b64b9159269488` |
| `fi-fi-heidirus`                            | `fi-FI` 로캘과 `fi-FI-HeidiRUS` 음성이 있는 컨테이너 이미지입니다.        | `sha256:0ba17a99d35d4963110316d6bb7742082d0362f23490790bb8a8142f459ed143` |
| `fr-ca-caroline`                            | `fr-CA` 로캘과 `fr-CA-Caroline` 음성이 있는 컨테이너 이미지입니다.        | `sha256:67304f764165b34c051104d8ef51202dcbaafcf3b88d5568ac41b54ecf820563` |
| `fr-ca-harmonierus`                         | `fr-CA` 로캘과 `fr-CA-HarmonieRUS` 음성이 있는 컨테이너 이미지입니다.     | `sha256:9b428ec672b60e8e6f9642cc5f23741e84df5e68477bb5fd4fdee4222e401d47` |
| `fr-ch-guillaume`                           | `fr-CH` 로캘과 `fr-CH-Guillaume` 음성이 있는 컨테이너 이미지입니다.       | `sha256:d3fedebf0321f9135335be369fec84be42a3653977f0834c6b5fda3fefeab81e` |
| `fr-fr-hortenserus`                         | `fr-FR` 로캘과 `fr-FR-HortenseRUS` 음성이 있는 컨테이너 이미지입니다.     | `sha256:2d33762773d299ffd37a3103b3c32ce8d1b7f3f107daf6514be4006cfbc8fd47` |
| `fr-fr-julie-apollo`                        | `fr-FR` 로캘과 `fr-FR-Julie-Apollo` 음성이 있는 컨테이너 이미지입니다.    | `sha256:54f762a2d68cc8a33049b18085fac44f5bad1750a1d85347d5174550fe2c2798` |
| `fr-fr-paul-apollo`                         | `fr-FR` 로캘과 `fr-FR-Paul-Apollo` 음성이 있는 컨테이너 이미지입니다.     | `sha256:7d3e4a75495be2c503f55596d39a5bdfe75538b453a5fb7edb7d17e0c036f3f0` |
| `he-il-asaf`                                | `he-IL` 로캘과 `he-IL-Asaf` 음성이 있는 컨테이너 이미지입니다.            | `sha256:729bd1c6128ee059e89d04e2e2fd5cd925e59550014b901bf5ac0b7cd44e9fa4` |
| `hi-in-hemant`                              | `hi-IN` 로캘과 `hi-IN-Hemant` 음성이 있는 컨테이너 이미지입니다.          | `sha256:9ed035183c7c2a0debe44dc6bae67d097334b0be8f5bec643b7e320c534b7cb2` |
| `hi-in-kalpana-apollo`                      | `hi-IN` 로캘과 `hi-IN-Kalpana-Apollo` 음성이 있는 컨테이너 이미지입니다.  | `sha256:f043d625788fd61bba7454a64502572a2e4fed310775c371c71db3c0fcf6aa01` |
| `hi-in-kalpana`                             | `hi-IN` 로캘과 `hi-IN-Kalpana` 음성이 있는 컨테이너 이미지입니다.         | `sha256:f043d625788fd61bba7454a64502572a2e4fed310775c371c71db3c0fcf6aa01` |
| `hr-hr-matej`                               | `hr-HR` 로캘과 `hr-HR-Matej` 음성이 있는 컨테이너 이미지입니다.           | `sha256:a320245b93af76b125386f4566383ec6e13a21c951a8468d1f0f87e800b79bb6` |
| `hu-hu-szabolcs`                            | `hu-HU` 로캘과 `hu-HU-Szabolcs` 음성이 있는 컨테이너 이미지입니다.        | `sha256:94d86ae188bb08df0192de4221404132d631cae6aa6d4fc4bfc0ffcce8f68d89` |
| `id-id-andika`                              | `id-ID` 로캘과 `id-ID-Andika` 음성이 있는 컨테이너 이미지입니다.          | `sha256:8fee6f6d8552fae0ce050765ea5c842497a699f5feb700f705c506dab3bac4a6` |
| `it-it-cosimo-apollo`                       | `it-IT` 로캘과 `it-IT-Cosimo-Apollo` 음성이 있는 컨테이너 이미지입니다.   | `sha256:1d99f0f538e0d61b527fbc77f9281e0f932bac7e6ba513b13ecfc734bd95f44d` |
| `it-it-luciarus`                            | `it-IT` 로캘과 `it-IT-LuciaRUS` 음성이 있는 컨테이너 이미지입니다.        | `sha256:99db33a668e298c58be1c50b9d4b84aeb0949f0334187b02167cfa3044997993` |
| `ja-jp-ayumi-apollo`                        | `ja-JP` 로캘과 `ja-JP-Ayumi-Apollo` 음성이 있는 컨테이너 이미지입니다.    | `sha256:50d1e986d318692917968654008466fc3cca4911c3bcd36af67f37e91de18fe2` |
| `ja-jp-harukarus`                           | `ja-JP` 로캘과 `ja-JP-HarukaRUS` 음성이 있는 컨테이너 이미지입니다.       | `sha256:7736a87dcf3595056bb558c6cb38094d1732bb164406a99d87c0ac09c8eee271` |
| `ja-jp-ichiro-apollo`                       | `ja-JP` 로캘과 `ja-JP-Ichiro-Apollo` 음성이 있는 컨테이너 이미지입니다.   | `sha256:6ce704a51150e0ee092f2197ba7cf4bcbf8473e5cd56a9a0839ad81d87b2dfe2` |
| `ko-kr-heamirus`                            | `ko-KR` 로캘과 `ko-KR-HeamiRUS` 음성이 있는 컨테이너 이미지입니다.        | `sha256:ec5d75470dbae50cb5bc2f93ed642e40446b099cb2302499b3a83b3a27358bd0` |
| `ms-my-rizwan`                              | `ms-MY` 로캘과 `ms-MY-Rizwan` 음성이 있는 컨테이너 이미지입니다.          | `sha256:e572b62f0b4153382318266dcd59d6e92daf8acc6f323e461d517d34f9be45dd` |
| `nb-no-huldarus`                            | `nb-NO` 로캘과 `nb-NO-HuldaRUS` 음성이 있는 컨테이너 이미지입니다.        | `sha256:691ef2ead95a0d4703cd6064bac9355e86a361fcffe5ad36a78e9f1e1c78739c` |
| `nl-nl-hannarus`                            | `nl-NL` 로캘과 `nl-NL-HannaRUS` 음성이 있는 컨테이너 이미지입니다.        | `sha256:f52a717d4d8b7db39b18c9a9e448e2e6d6e19600093518002a6fc03f0b2a57c9` |
| `pl-pl-paulinarus`                          | `pl-PL` 로캘과 `pl-PL-PaulinaRUS` 음성이 있는 컨테이너 이미지입니다.      | `sha256:1927ff28b40b7c37ee1b8d5f4efb2fd7d905affd35c27983940c7e5795763c70` |
| `pt-br-daniel-apollo`                       | `pt-BR` 로캘과 `pt-BR-Daniel-Apollo` 음성이 있는 컨테이너 이미지입니다.   | `sha256:ebce3b7b51fb28fce4c446fbbf3607f4307b1cec3f9fa7abdd046839a259e91d` |
| `pt-br-heloisarus`                          | `pt-BR` 로캘과 `pt-BR-HeloisaRUS` 음성이 있는 컨테이너 이미지입니다.      | `sha256:195e719735768fdf6ea2f1fc829a40cae5af4d35b62e52d1c798e680f915dd12` |
| `pt-pt-heliarus`                            | `pt-PT` 로캘과 `pt-PT-HeliaRUS` 음성이 있는 컨테이너 이미지입니다.        | `sha256:f0ea6ec57615a55b13f491e6f96b3cc0e29092f63a981fd29771bcfa2b26c0e1` |
| `ro-ro-andrei`                              | `ro-RO` 로캘과 `ro-RO-Andrei` 음성이 있는 컨테이너 이미지입니다.          | `sha256:deee319f2b6d8145f3ed567cfcdfa2ca718cd1b408f8d9fbf15f90d02d5b6b35` |
| `ru-ru-ekaterinarus`                        | `ru-RU` 로캘과 `ru-RU-EkaterinaRUS` 음성이 있는 컨테이너 이미지입니다.    | `sha256:d0005c1363e197c0f85180a07d650655b473117de12170a631f3049d99f86581` |
| `ru-ru-irina-apollo`                        | `ru-RU` 로캘과 `ru-RU-Irina-Apollo` 음성이 있는 컨테이너 이미지입니다.    | `sha256:53731218ed6e2bed2227c25a2a2e1d528a19dbc078e2af55aa959d191df50487` |
| `ru-ru-pavel-apollo`                        | `ru-RU` 로캘과 `ru-RU-Pavel-Apollo` 음성이 있는 컨테이너 이미지입니다.    | `sha256:81b2a56f72460a780466337136729b011ef1eac4689b1ec9edbbd980b53ba6c3` |
| `sk-sk-filip`                               | `sk-SK` 로캘과 `sk-SK-Filip` 음성이 있는 컨테이너 이미지입니다.           | `sha256:e3d44c7ac30b1b9b186eaf1761ccadd89b17fcb4d4f63e1dab246a80093967f3` |
| `sl-si-lado`                                | `sl-SI` 로캘과 `sl-SI-Lado` 음성이 있는 컨테이너 이미지입니다.            | `sha256:8ecb2b3d0c60f4c88522090d24e55d84a6132b751d71b41a3d1ebbae78fc3b2b` |
| `sv-se-hedvigrus`                           | `sv-SE` 로캘과 `sv-SE-HedvigRUS` 음성이 있는 컨테이너 이미지입니다.       | `sha256:5b61e4ebe696e7cee23403ec4aed299cbf4874c0eeb5a163a82ba0ba752b78a8` |
| `ta-in-valluvar`                            | `ta-IN` 로캘과 `ta-IN-Valluvar` 음성이 있는 컨테이너 이미지입니다.        | `sha256:adf3c421feb6385ba3acb241750d909a42f41d09b5ebbc66dbb50dac84ef5638` |
| `te-in-chitra`                              | `te-IN` 로캘과 `te-IN-Chitra` 음성이 있는 컨테이너 이미지입니다.          | `sha256:e9fc71faf37ca890a82e29bec29b6cfd94299e2d78aaed8c98bc09add2522e2d` |
| `th-th-pattara`                             | `th-TH` 로캘과 `th-TH-Pattara` 음성이 있는 컨테이너 이미지입니다.         | `sha256:b02cc2b23a7d1ec2f3f2d3917a51316fb009597d5d9606b5f129968c35c365f6` |
| `tr-tr-sedarus`                             | `tr-TR` 로캘과 `tr-TR-SedaRUS` 음성이 있는 컨테이너 이미지입니다.         | `sha256:961773f7f544cc0643590f4ed44d40f12e3fa23e44834afd199e261651b702ae` |
| `vi-vn-an`                                  | `vi-VN` 로캘과 `vi-VN-An` 음성이 있는 컨테이너 이미지입니다.              | `sha256:f1fdda1c758a4361d2fb594f02d47be7cf88571e5a51fb845b1b00bf0b89d20e` |
| `zh-cn-huihuirus`                           | `zh-CN` 로캘과 `zh-CN-HuihuiRUS` 음성이 있는 컨테이너 이미지입니다.       | `sha256:183125591097ab157bf57088fae3a8ab0af4472cabd3d1c7bdaba51748e73342` |
| `zh-cn-kangkang-apollo`                     | `zh-CN` 로캘과 `zh-CN-Kangkang-Apollo` 음성이 있는 컨테이너 이미지입니다. | `sha256:72a77502eb91ebf407bfbfb068b442e1c281da33814e042b026973af2d8d42e0` |
| `zh-cn-yaoyao-apollo`                       | `zh-CN` 로캘과 `zh-CN-Yaoyao-Apollo` 음성이 있는 컨테이너 이미지입니다.   | `sha256:9a202b3172def1a35553d7adf5298af71b44dde10ee261752b057b3dcc39ddea` |
| `zh-hk-danny-apollo`                        | `zh-HK` 로캘과 `zh-HK-Danny-Apollo` 음성이 있는 컨테이너 이미지입니다.    | `sha256:9bbba04f272231084b9c87d668e5a71ab7f61d464eeaab50d44a3f2121874524` |
| `zh-hk-tracy-apollo`                        | `zh-HK` 로캘과 `zh-HK-Tracy-Apollo` 음성이 있는 컨테이너 이미지입니다.    | `sha256:048d335ea90493fde6ccce8715925e472fddb405c3208bba5ac751bfdf85b254` |
| `zh-hk-tracyrus`                            | `zh-HK` 로캘과 `zh-HK-TracyRUS` 음성이 있는 컨테이너 이미지입니다.        | `sha256:048d335ea90493fde6ccce8715925e472fddb405c3208bba5ac751bfdf85b254` |
| `zh-tw-hanhanrus`                           | `zh-TW` 로캘과 `zh-TW-HanHanRUS` 음성이 있는 컨테이너 이미지입니다.       | `sha256:fe30bb665c416d0a6cc3547425e1736802d7527eebdd919ee4ed66989ebc368b` |
| `zh-tw-yating-apollo`                       | `zh-TW` 로캘과 `zh-TW-Yating-Apollo` 음성이 있는 컨테이너 이미지입니다.   | `sha256:6308d4e4302d02bbb4043ec6cceb6e574b7e156a5d774bef095be6c34af7194c` |
| `zh-tw-zhiwei-apollo`                       | `zh-TW` 로캘과 `zh-TW-Zhiwei-Apollo` 음성이 있는 컨테이너 이미지입니다.   | `sha256:e40dda8b5e9313a5962c260c1e9eb410b19e60fa74062ad0691455dc8442a4d9` |


# <a name="previous-version"></a>[이전 버전](#tab/previous)

`1.14.1-amd64-<locale-and-voice>`에 대한 릴리스 정보:
...
릴리스 `v1.10.0` 정보: 정기적인 월간 업그레이드

| 이미지 태그                                  | 메모                                                                      |
|---------------------------------------------|:---------------------------------------------------------------------------|
| `latest`                                    | `en-US` 로캘과 `en-US-AriaNeural` 음성이 있는 컨테이너 이미지입니다.      |
| `1.10.0-amd64-<locale-and-voice>`           | `<locale>`은 아래에 나열된 사용 가능한 로캘 중 하나로 대체합니다. 예: `1.10.0-amd64-en-us-arianeural`. |
...
| `en-gb-sonianeural`                 | `en-GB` 로캘과 `en-GB-SoniaNeural` 음성이 있는 컨테이너 이미지입니다.     |
...
| `zh-cn-xiaochenneural-preview`      | `zh-CN` 로캘과 `zh-CN-XiaoChenNeural` 음성이 있는 컨테이너 이미지입니다.  |
| `zh-cn-xiaohanneural`               | `zh-CN` 로캘과 `zh-CN-XiaoHanNeural` 음성이 있는 컨테이너 이미지입니다.   |
| `zh-cn-xiaomoneural`                | `zh-CN` 로캘과 `zh-CN-XiaoMoNeural` 음성이 있는 컨테이너 이미지입니다.    |
| `zh-cn-xiaoqiuneural-preview`       | `zh-CN` 로캘과 `zh-CN-XiaoQiuNeural` 음성이 있는 컨테이너 이미지입니다.   |
| `zh-cn-xiaoruineural`               | `zh-CN` 로캘과 `zh-CN-XiaoRuiNeural` 음성이 있는 컨테이너 이미지입니다.   |
| `zh-cn-xiaoshuangneural-preview`    | `zh-CN` 로캘과 `zh-CN-XiaoShuangNeural` 음성이 있는 컨테이너 이미지입니다.|
| `zh-cn-xiaoxuanneural`              | `zh-CN` 로캘과 `zh-CN-XiaoXuanNeural` 음성이 있는 컨테이너 이미지입니다.  |
| `zh-cn-xiaoyanneural-preview`       | `zh-CN` 로캘과 `zh-CN-XiaoYanNeural` 음성이 있는 컨테이너 이미지입니다.   |
| `zh-cn-yunxineural`                 | `zh-CN` 로캘과 `zh-CN-YunXiNeural` 음성이 있는 컨테이너 이미지입니다.     |
...
| 이미지 태그                                  | 메모                                                                      |
|---------------------------------------------|:---------------------------------------------------------------------------|
| `1.8.0-amd64-<locale-and-voice>`            | `<locale>`은 아래에 나열된 사용 가능한 로캘 중 하나로 대체합니다. 예: `1.8.0-amd64-en-us-arianeural`. |
| `1.7.0-amd64-<locale-and-voice>`            | `<locale>`은 아래에 나열된 사용 가능한 로캘 중 하나로 대체합니다. 예: `1.7.0-amd64-en-us-arianeural`. |
