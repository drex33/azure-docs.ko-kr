...
- [Azure Active Directory B2B 협업 FAQ](faq.yml)
- [게스트 사용자에 대한 상환 상태 다시 설정(미리 보기)](reset-redemption-status.md)
...
- [B2B 외부 협업을 사용하도록 설정 및 게스트를 초대할 수 있는 사용자 관리](delegate-invitations.md)
- [Azure AD 외부 ID에 대한 청구 모델](external-identities-pricing.md)
- [예: AD FS(Active Directory Federation Services)와 함께 SAML/WS-Fed IdP 페더레이션 구성(미리 보기)](direct-federation-adfs.md)
- [게스트 사용자를 위한 SAML/WS-Fed ID 공급자와의 페더레이션(미리 보기)](direct-federation.md)
- [Google을 B2B 게스트 사용자에 대한 ID 공급자로 추가](google-federation.md)
- [외부 ID용 ID 공급자](identity-providers.md)
- [게스트 사용자로써 조직 나가기](leave-the-organization.md)
...
- [Google을 B2B 게스트 사용자에 대한 ID 공급자로 추가](google-federation.md)
- [예: AD FS(Active Directory Federation Services)(미리 보기)를 사용하여 직접 페더레이션](direct-federation-adfs.md)
- [게스트 사용자를 위한 AD FS 및 타사 공급자와의 직접 페더레이션(미리 보기)](direct-federation.md)
- [이메일 일회용 암호 인증](one-time-passcode.md)
- [게스트 사용자에 대한 상환 상태 다시 설정(미리 보기)](reset-redemption-status.md)
- [Azure Active Directory B2B 협업 초대 이메일의 요소](invitation-email-elements.md)
- [Azure Active Directory B2B 협업 문제 해결](troubleshoot.md)
- [빠른 시작: PowerShell을 사용하여 게스트 사용자 추가](b2b-quickstart-invite-powershell.md)
- [B2B Collaboration 사용자에 대한 조건부 액세스](conditional-access.md)
...
- [셀프 서비스 등록에 사용자 지정 승인 워크플로 추가](self-service-sign-up-add-approvals.md)
- [게스트 사용자에 대한 상환 상태 다시 설정](reset-redemption-status.md)
- [API 커넥터를 사용하여 셀프 서비스 등록 사용자 지정 및 확장](api-connectors-overview.md)
- [Azure Active Directory B2B 협업 FAQ](faq.yml)
- [Azure Active Directory B2B 협업 초대 상환](redemption-experience.md)
- [외부 ID용 ID 공급자](identity-providers.md)
- [앱에 셀프 서비스 가입 사용자 흐름 추가(미리 보기)](self-service-sign-up-user-flow.md)
- [이메일 일회용 암호 인증](one-time-passcode.md)
- [Azure Portal에서 Azure Active Directory B2B Collaboration 사용자 추가](add-users-administrator.md)
...
- [내부 사용자를 B2B 협업에 초대](invite-internal-users.md)
- [Microsoft 365 외부 공유 및 Azure AD(Azure Active Directory) B2B 협업](o365-external-user.md)
- [게스트 사용자를 위한 SAML/WS-Fed ID 공급자와의 페더레이션(미리 보기)](direct-federation.md)
