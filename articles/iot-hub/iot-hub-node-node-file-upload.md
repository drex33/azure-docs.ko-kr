...
이 섹션에서는 IoT 허브에 파일을 업로드하는 디바이스 앱을 만듭니다. 코드는 [Azure IoT node.js SDK](https://github.com/Azure/azure-iot-sdk-node) 디바이스 샘플의 [upload_to_blob_advanced.js](https://github.com/Azure/azure-iot-sdk-node/blob/master/device/samples/upload_to_blob_advanced.js) 샘플에서 사용할 수 있는 코드를 기반으로 합니다.
