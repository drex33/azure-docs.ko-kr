...
| 10.19.10006 | 해당 없음 | 2018년 12월 | <ul><li> 사소한 안정화 픽스 </li></ul> | 
| 8.0.11136 | 해당 없음 | 2018년 9월 |  <ul><li> VM 이동 시 리소스 ID 변경 검색에 대한 지원이 추가됨 </li><li> 비 확장 설치 사용 시 보고 리소스 ID에 대한 지원이 추가됨 </li></ul>| 
...
> [!NOTE]
> 추가 속성은 [Azure Monitor에 Azure Windows 컴퓨터 연결](../../azure-monitor/agents/agent-windows.md)을 참조하세요.
