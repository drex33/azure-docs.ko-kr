...
상업용 마켓플레이스의 범주 및 하위 [범주에서 범주 및 하위 범주의](categories.md)전체 목록을 참조하세요. 가상 머신 제품은 항상 Azure Marketplace의 **컴퓨팅** 범주 아래에 표시됩니다.
...
> [!NOTE]
> 사용자 지정 수정을 대상으로 하는 고객은 구매하는 동안 표준 계약 대한 범용 수정(있는 경우)도 받게 됩니다.
...
- [VM 제품 목록 구성](azure-vm-offer-listing.md)
