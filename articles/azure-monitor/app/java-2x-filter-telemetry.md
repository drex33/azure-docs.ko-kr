---
title: Java 웹앱에서 Azure Application Insights 원격 분석 필터링
...
필터는 [Java 웹앱이 Application Insights로 보내는](java-2x-get-started.md) 원격 분석을 선택하는 방법을 제공합니다. 사용할 수 있는 몇 가지 기본 필터가 있으며 사용자 지정 필터를 직접 작성할 수도 있습니다.
...
### <a name="3-invoke-your-filter-java-spring"></a>3. 필터 호출(Java Spring)
...
`application.properties`에서 고유한 필터 매개 변수를 만들고 Spring Boot의 표면화된 구성 프레임워크를 활용하여 해당 매개 변수를 사용자 지정 필터에 전달해야 합니다. 
