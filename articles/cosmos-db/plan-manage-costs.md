...
비용을 예측하는 데 있어 보조적 역할을 하며 Azure Cosmos DB로 마이그레이션하기 위한 용량 계획을 수행하는 데 도움이 될 수 있습니다. 기존 데이터베이스 클러스터에서 Azure Cosmos DB로의 마이그레이션을 계획하는 경우 용량 계획에 기존 데이터베이스 클러스터에 대한 정보를 사용할 수 있습니다.
...
> [!TIP]
> 예산이 책정된 프로비전된 처리량을 초과하지 않도록 [하려면 계정의 프로비전된 총 처리량을 제한합니다.](./limit-total-account-throughput.md)
