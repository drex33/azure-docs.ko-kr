...
ms.locfileid: "129638376"
---
## <a name="supported-operating-systems-and-drivers"></a>지원되는 운영 체제 및 드라이버

### <a name="nvidia-tesla-cuda-drivers"></a>NVIDIA Tesla(CUDA) 드라이버

NC, NCv2, NCv3, NCasT4_v3, ND 및 NDv2 시리즈 VM용 NVIDIA Tesla(CUDA) 드라이버는 다음 표에 나열된 운영 체제에서 테스트됩니다(NV 시리즈의 경우 선택 사항). CUDA 드라이버는 일반적이고 Azure에만 해당되지 않습니다. 최신 드라이버에 대해서는 [NVIDIA](https://www.nvidia.com/) 웹 사이트를 참조하세요.
...
Windows Server 2019의 경우 Windows Server 2016 1607, 1709 및 Windows 10(빌드 21H1까지):
- [GRID 13(471.68)(.exe)](https://go.microsoft.com/fwlink/?linkid=874181)
...
- [GRID 13(471.68)(.exe)](https://download.microsoft.com/download/9/b/4/9b4d4f8d-7962-4a67-839b-37cc95756759/471.68_grid_winserver2012R2_64bit_azure_swl.exe)
