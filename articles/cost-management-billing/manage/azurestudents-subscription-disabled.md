...
2. 잔액 페이지에 사용한 크레딧과 남은 크레딧에 대한 정보가 제공됩니다. 크레딧 차트 아래에서 크레딧 만료 날짜를 확인할 수 있습니다.  
    ...
    ![학생용 Azure 구독에 대한 크레딧 정보를 보여주는 스크린샷](./media/azurestudents-subscription-disabled/azurestudents-credit-balance.png)

3. Azure 크레딧을 사용 하는 서비스의 사용량을 확인 하려면 왼쪽 탐색 영역에서 **사용량** 을 선택한 다음 학생용 Azure 구독을 선택 합니다.

    ![학생용 Azure 크레딧의 사용량 정보를 보여주는 스크린샷](./media/azurestudents-subscription-disabled/azurestudents-credit-usage.png)

표에는 다음 열이 포함됩니다.

* **서비스 이름:** Azure 크레딧을 사용 하는 서비스입니다.
* **서비스 리소스:** 사용 중인 서비스의 측정 단위입니다.
* **지출:** 서비스에서 소비한 USD ($)의 크레딧 양입니다.
