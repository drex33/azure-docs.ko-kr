...
5. **비용 제어**
   ...
   | [PowerShell 스크립트를 사용하여 모든 랩 VM 삭제](./devtest-lab-faq.yml) |테스트가 완료되면 한 번에 모든 랩을 삭제합니다.|
...
6. **각 테스터와 랩 공유**
    ...
    테스터와 공유하는 링크를 사용하여 랩에 직접 액세스할 수 있습니다. [Microsoft 계정](./devtest-lab-faq.yml)이 있으면 Azure 계정이 없어도 됩니다. 테스터는 다른 테스터가 만든 VM을 볼 수 없습니다.  
   ...
   | [랩에 대한 링크 가져오기](./devtest-lab-faq.yml) |테스터가 하이퍼링크를 통해 랩에 직접 액세스하는 방법을 알아봅니다.|
