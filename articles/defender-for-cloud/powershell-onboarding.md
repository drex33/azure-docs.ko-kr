...
ms.author: memildin
ms.custom: mode-api
ms.openlocfilehash: a649ca2d57d961458c7d3059ef8e0980b207e073
ms.sourcegitcommit: 56235f8694cc5f88db3afcc8c27ce769ecf455b0
ms.translationtype: HT
ms.contentlocale: ko-KR
ms.lasthandoff: 11/24/2021
ms.locfileid: "133077552"
---
...
Microsoft Defender for Cloud PowerShell 모듈을 사용하여 프로그래매틱한 방식으로 Azure 워크로드를 보호할 수 있습니다. PowerShell을 사용하면 작업을 자동화하고 수동 작업에 내재된 사용자 오류를 피할 수 있습니다. 이는 수백 개에서 수천 개의 리소스를 포함 하는 수십 개의 구독과 관련 된 대규모 배포에서 특히 유용 하며, 모두 처음부터 보안 되어야 합니다.
...
1. [Microsoft Defender For Cloud에서 보안 강화를](enable-enhanced-security.md)사용 하도록 설정 합니다.
