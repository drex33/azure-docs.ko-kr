...
description: 이 자습서에서는 PowerShell을 사용하여 Azure Content Delivery Network 엔드포인트 프로필 및 엔드포인트의 여러 측면을 관리하는 방법을 알아봅니다.
services: cdn
documentationcenter: ''
author: duongau
manager: danielgi
...
PowerShell을 사용하여 Azure CDN 프로필 및 엔드포인트를 관리하려면 Azure PowerShell 모듈이 설치되어 있어야 합니다.  Azure PowerShell을 설치하고 `Connect-AzAccount` cmdlet을 사용하여 Azure에 연결하는 방법을 알아보려면 [Azure PowerShell 설치 및 구성 방법](/powershell/azure/)을 참조하세요.
...
`New-AzCdnDeliveryRule`, `New=AzCdnDeliveryRuleCondition`, `New-AzCdnDeliveryRuleAction`을 사용하여 Microsoft 프로필에서 Azure CDN의 Azure CDN 표준 규칙 엔진을 구성할 수 있습니다. 
