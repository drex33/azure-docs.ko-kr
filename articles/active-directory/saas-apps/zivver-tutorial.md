...
ms.locfileid: "132332500"
---
# <a name="tutorial-azure-active-directory-integration-with-zivver"></a>자습서: ZIVVER와 Azure Active Directory 통합

이 자습서에서는 Azure AD(Azure Active Directory)와 ZIVVER를 통합하는 방법에 대해 알아봅니다. Azure AD와 ZIVVER를 통합하면 다음을 수행할 수 있습니다.

* Azure AD에서 ZIVVER에 액세스할 수 있는 사용자를 제어합니다.
* 사용자가 Azure AD 계정으로 ZIVVER에 자동으로 로그인되도록 설정합니다.
...
* ZIVVER는 **IDP** 시작 SSO를 지원합니다.

> [!NOTE]
> 이 애플리케이션의 식별자는 고정 문자열 값이므로 하나의 테넌트에서 하나의 인스턴스만 구성할 수 있습니다.

## <a name="add-zivver-from-the-gallery"></a>갤러리에서 ZIVVER 추가
...
1. **갤러리에서 추가** 섹션의 검색 상자에 **ZIVVER** 를 입력합니다.
1. 결과 패널에서 **ZIVVER** 를 선택한 다음, 앱을 추가합니다. 앱이 테넌트에 추가될 때까지 잠시 동안 기다려 주세요.

## <a name="configure-and-test-azure-ad-sso-for-zivver"></a>ZIVVER에서 Azure AD SSO 구성 및 테스트

**B.Simon** 이라는 테스트 사용자를 사용하여 ZIVVER에서 Azure AD SSO를 구성하고 테스트합니다. SSO가 작동하려면 Azure AD 사용자와 ZIVVER의 관련 사용자 간에 연결 관계를 설정해야 합니다.

ZIVVER에서 Azure AD SSO를 구성하고 테스트하려면 다음 단계를 수행합니다.

1. **[Azure AD SSO 구성](#configure-azure-ad-sso)** - 사용자가 이 기능을 사용할 수 있도록 합니다.
    1. **[Azure AD 테스트 사용자 만들기](#create-an-azure-ad-test-user)** - B.Simon을 사용하여 Azure AD Single Sign-On을 테스트합니다.
    1. **[Azure AD 테스트 사용자 할당](#assign-the-azure-ad-test-user)** - B. Simon이 Azure AD Single Sign-On을 사용할 수 있도록 합니다.
1. **[ZIVVER SSO 구성](#configure-zivver-sso)** - 애플리케이션 쪽에서 Single Sign-On 설정을 구성합니다.
    1. **[ZIVVER 테스트 사용자 만들기](#create-zivver-test-user)** - B.Simon의 Azure AD 표현과 연결된 해당 사용자를 ZIVVER에 만듭니다.
...
1. Azure Portal의 **ZIVVER** 애플리케이션 통합 페이지에서 **관리** 섹션을 찾은 후 **Single Sign-On** 을 선택합니다.
...
4. **기본 SAML 구성** 섹션에서 다음 단계를 수행합니다.
    ...
    **식별자** 텍스트 상자에서 `https://app.zivver.com/SAML/Zivver` URL을 입력합니다.
...
이 섹션에서는 Azure Single Sign-On을 사용할 수 있도록 B.Simon에게 ZIVVER에 대한 액세스 권한을 부여합니다.

1. Azure Portal에서 **엔터프라이즈 애플리케이션** 을 선택한 다음, **모든 애플리케이션** 을 선택합니다.
1. 애플리케이션 목록에서 **ZIVVER** 를 선택합니다.
...
## <a name="configure-zivver-sso"></a>ZIVVER SSO 구성
...
* Azure Portal에서 이 애플리케이션 테스트를 클릭하면 SSO를 설정한 ZIVVER에 자동으로 로그인됩니다.

* Microsoft 내 앱을 사용할 수 있습니다. 내 앱에서 ZIVVER 타일을 클릭하면 SSO를 설정한 ZIVVER에 자동으로 로그인됩니다. 내 앱에 대한 자세한 내용은 [내 앱 소개](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510)를 참조하세요.

## <a name="next-steps"></a>다음 단계

ZIVVER가 구성되면 세션 제어를 적용하여 조직에서 중요한 데이터의 반출 및 반입을 실시간으로 보호할 수 있습니다. 세션 제어는 조건부 액세스에서 확장됩니다. [Microsoft Defender for Cloud Apps를 사용하여 세션 제어를 적용하는 방법을 알아봅니다](/cloud-app-security/proxy-deployment-aad).
