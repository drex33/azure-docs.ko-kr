...
## <a name="add-mvision-cloud-azure-ad-sso-configuration-from-the-gallery"></a>갤러리에서 MVISION Cloud Azure AD SSO Configuration 추가
...
## <a name="configure-and-test-azure-ad-sso-for-mvision-cloud-azure-ad-sso-configuration"></a>MVISION Cloud Azure AD SSO Configuration에 대한 Azure AD SSO 구성 및 테스트
...
MVISION Cloud Azure AD SSO Configuration에서 Azure AD SSO를 구성하고 테스트하려면 다음 단계를 수행합니다.
...
이 섹션에서는 Azure Single Sign-On을 사용할 수 있도록 B.Simon에게 MVISION Cloud Azure AD SSO Configuration에 대한 액세스 권한을 부여합니다.

1. Azure Portal에서 **엔터프라이즈 애플리케이션** 을 선택한 다음, **모든 애플리케이션** 을 선택합니다.
1. 애플리케이션 목록에서 **MVISION Cloud Azure AD SSO Configuration** 을 선택합니다.
...
이 섹션에서는 MVISION Cloud Azure AD SSO Configuration에서 B.Simon이라는 사용자를 만듭니다. [MVISION Cloud Azure AD SSO Configuration 지원 팀](mailto:support@skyhighnetworks.com)과 협력하여 MVISION Cloud Azure AD SSO Configuration 플랫폼에 사용자를 추가합니다. Single Sign-On을 사용하려면 먼저 사용자를 만들고 활성화해야 합니다.
...
* Azure Portal에서 **이 애플리케이션 테스트** 를 클릭합니다. 그러면 로그인 흐름을 시작할 수 있는 MVISION Cloud Azure AD SSO Configuration 로그온 URL로 리디렉션됩니다.  

* MVISION Cloud Azure AD SSO Configuration 로그온 URL로 직접 이동하여 해당 위치에서 로그인 흐름을 시작합니다.
...
MVISION Cloud Azure AD SSO Configuration이 구성되면 세션 제어를 적용하여 조직의 중요한 데이터의 반출 및 반입을 실시간으로 보호할 수 있습니다. 세션 제어는 조건부 액세스에서 확장됩니다. [Microsoft Defender for Cloud Apps를 사용하여 세션 제어를 적용하는 방법을 알아봅니다](/cloud-app-security/proxy-deployment-any-app).
