---
title: Azure Portal 설정 및 기본 설정 관리(이전 버전)
description: 사용자의 기본 설정에 맞게 Azure Portal 기본 설정을 변경할 수 있습니다. 이 문서에서는 이전 버전의 설정 환경에 대해 설명합니다.
ms.date: 06/17/2021
ms.topic: how-to
...
ms.locfileid: "112372228"
---
# <a name="manage-azure-portal-settings-and-preferences-older-version"></a>Azure Portal 설정 및 기본 설정 관리(이전 버전)

사용자의 기본 설정에 맞게 Azure Portal 기본 설정을 변경할 수 있습니다. 

> [!IMPORTANT]
> 모든 Azure 사용자를 최신 환경으로 이동하는 중입니다. 이 토픽에서는 이전 환경에 대해 설명합니다. 최신 정보에 대해서는 [Azure Portal 설정 및 기본 설정 관리](set-preferences.md)를 참조하세요.

대부분의 설정은 전역 페이지 헤더의 **설정** 메뉴에서 사용할 수 있습니다.

![설정이 강조 표시된 전역 페이지 헤더 아이콘을 보여주는 스크린샷](./media/original-preferences/header-settings.png)
...
:::image type="content" source="media/original-preferences/filter-subscription-default-view.png" alt-text="구독 별로 리소스 목록을 필터링합니다.":::

1. 전역 페이지 헤더에서 디렉터리 및 구독 필터 아이콘을 선택합니다.

1. 포털을 시작할 때 기본 구독으로 사용할 구독을 선택합니다. 

    :::image type="content" source="media/original-preferences/default-directory-subscription-filter.png" alt-text="포털을 시작할 때 기본 구독으로 사용할 구독을 선택합니다."::: 
...
![기본 보기가 강조 표시된 Azure Portal 설정을 보여주는 스크린샷](./media/original-preferences/default-view.png)
...
포털 메뉴의 기본 모드는 페이지에서 포털 메뉴가 차지하는 공간의 크기를 제어합니다.

![포털 메뉴에 대한 기본 모드를 설정하는 방법을 보여 주는 스크린샷](./media/original-preferences/menu-mode.png)
...
![테마가 강조 표시된 Azure Portal 설정을 보여주는 스크린샷](./media/original-preferences/theme.png)
...
![팝업 알림이 강조 표시된 Azure Portal 설정을 보여주는 스크린샷](./media/original-preferences/pop-up-notifications.png)

현재 세션 중에 수신된 모든 알림을 읽으려면 전역 헤더에서 **알림** 을 선택합니다.

![알림이 강조 표시된 Azure Portal global 헤더를 보여주는 스크린샷](./media/original-preferences/read-notifications.png)
...
![비활성 시간 제한 설정이 강조 표시된 포털 설정을 보여주는 스크린샷](./media/original-preferences/inactive-sign-out-user.png)
...
![디렉터리 비활성 시간 제한 정책 재정의 설정이 강조 표시된 포털 설정을 보여주는 스크린샷](./media/original-preferences/inactive-sign-out-override.png)
...
1. 링크 텍스트 **구성 디렉터리 수준 시간 제한** 을 선택합니다.
    ...
    ![링크 텍스트가 강조 표시된 포털 설정을 보여주는 스크린샷](./media/original-preferences/settings-admin.png)
...
1. **적용** 을 선택합니다.
    ...
    ![디렉터리 수준 비활성 시간 제한 설정 페이지를 보여주는 스크린샷](./media/original-preferences/configure.png)

비활성 시간 제한 정책이 올바르게 설정되었는지 확인하려면 전역 페이지 헤더에서 **알림** 을 선택합니다. 성공 알림이 나열되는지 확인합니다.

![디렉터리 수준 비활성 시간 제한에 대한 성공 알림 메시지를 보여주는 스크린샷](./media/original-preferences/confirmation.png)
...
![기본 설정의 복원을 보여주는 스크린샷](./media/original-preferences/useful-links-restore-defaults.png)
...
![설정 내보내기를 보여주는 스크린샷](./media/original-preferences/useful-links-export-settings.png)
...
![설정 삭제를 보여주는 스크린샷](./media/original-preferences/useful-links-delete-settings.png)
...
**적용** 을 선택하여 언어 및 지역 형식 설정을 업데이트합니다.
   ...
   ![언어 및 지역 형식 설정을 보여주는 스크린샷](./media/original-preferences/language.png)
