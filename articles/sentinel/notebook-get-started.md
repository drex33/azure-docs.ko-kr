...
ms.topic: how-to
ms.date: 11/09/2021
ms.openlocfilehash: 42fefa26f08d4075bedd511f0ffd07b93a269a24
ms.sourcegitcommit: 1244a72dbec39ac8cf16bb1799d8c46bde749d47
ms.translationtype: MT
ms.contentlocale: ko-KR
ms.lasthandoff: 11/18/2021
ms.locfileid: "132760080"
---
...
이 자습서의 단계에서는 Microsoft **Sentinel을** 통해 Azure ML 작업 영역에서 Microsoft Sentinel ML Notebooks 시작 가이드를 실행하는 방법을 설명합니다. 로컬을 비롯한 다른 환경에서 Notebook을 실행하는 유사한 단계를 수행하기 위한 지침으로 이 자습서를 사용할 수도 있습니다.
...
선택한 쿼리의 경우 모든 필수 및 선택적 매개 변수가 쿼리의 전체 텍스트와 함께 표시됩니다. 다음은 그 예입니다.
...
필요에 `start` 따라 및 `end` 시간을 설정합니다. 다음은 그 예입니다.
...
출력에는 결과의 처음 5개 행이 표시됩니다. 다음은 그 예입니다.
...
출력에는 결과에 대한 세부 정보가 표시됩니다. 다음은 그 예입니다.
...
출력에는 IP 주소에 대한 지리적 위치 정보가 표시됩니다. 다음은 그 예입니다.
...
필요한 설정은 자격 증명 모음 속성에서 얻는 모든 값이지만, 일부 설정은 다른 이름을 가질 수 있습니다. 다음은 그 예입니다.
...
1. Key Vault 대한 자격 증명 모음 세부 정보를 입력합니다. 다음은 그 예입니다.
...
1. 다음 방법 중 하나 이상을 선택합니다.
    ...
    - **cli** - 인증된 Azure CLI 세션에서 자격 증명을 사용합니다.
