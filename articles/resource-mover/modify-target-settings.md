...
ms.date: 02/08/2021
ms.author: raynew
ms.openlocfilehash: bf1330eb7c676206e0d46049a6be0b40e5042794
ms.sourcegitcommit: b00a2d931b0d6f1d4ea5d4127f74fc831fb0bca9
ms.translationtype: MT
ms.contentlocale: ko-KR
ms.lasthandoff: 11/20/2021
ms.locfileid: "132863696"
---
...
**공용 IP 주소 이름, SKU, 영역** | 표준 공용 IP 주소에 대한 이름, [SKU](../virtual-network/ip-services/public-ip-addresses.md#sku), [영역](../virtual-network/ip-services/public-ip-addresses.md#sku)을 지정합니다.<br/><br/> 영역 중복으로 지정하려면 **영역 중복** 으로 입력합니다.
