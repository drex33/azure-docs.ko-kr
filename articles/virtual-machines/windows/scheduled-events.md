...
**적용 대상**: heavy_check_mark: Windows VM: heavy_check_mark: 유연한 확장 집합: heavy_check_mark: 단일 확장 집합
...
### <a name="enabling-and-disabling-scheduled-events"></a>Scheduled Events 사용 및 사용 안 함
