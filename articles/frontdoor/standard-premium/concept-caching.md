...
> * Azure 전면 도어를 통해 개체가 캐시에 저장 되는 최소 시간을 보장할 수 없습니다. 자주 요청 되는 콘텐츠를 위한 공간을 확보 하기 위해 콘텐츠가 자주 요청 되지 않은 경우 캐시 된 콘텐츠가 만료 되기 전에에 지 캐시에서 제거 될 수 있습니다.
>
