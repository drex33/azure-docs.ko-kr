...
ms.openlocfilehash: fc64d94066e7a187b88a0a9d37466894e9a92440
ms.sourcegitcommit: 3a063c59bb9396ce1d4b9a3565b194edf30393a2
ms.translationtype: MT
ms.contentlocale: ko-KR
ms.lasthandoff: 11/23/2021
ms.locfileid: "132964683"
---
...
Azure Kubernetes Service 클러스터에 Azure Machine Learning 확장을 배포하기 전에 다음을 수행해야 합니다.

- AKS 클러스터에 기능을 등록합니다. 자세한 내용은 [필수 구성 Azure Kubernetes Service 참조하세요.](#aks-prerequisites)
- 인바운드 및 아웃바운드 네트워크 트래픽을 구성합니다. 자세한 내용은 [AKS(인바운드 및 아웃바운드 네트워크 트래픽) 구성을](how-to-access-azureml-behind-firewall.md#azure-kubernetes-services-1)참조하세요.

AKS 클러스터에 Azure Machine Learning 확장을 배포하려면 [Azure Machine Learning 확장 배포](#deploy-azure-machine-learning-extension) 섹션을 참조하세요.
...
### <a name="azure-kubernetes-service-aks"></a>AKS(Azure Kubernetes Service) <a id="aks-prerequisites"></a>

AKS 클러스터의 경우 Azure Arc 연결은 선택 **사항입니다.**

그러나 클러스터에 기능을 등록해야 합니다. 다음 명령을 사용하여 기능을 등록합니다.
...
### <a name="azure-redhat-openshift-service-aro-and-openshift-container-platform-ocp-only"></a>ARO(Azure RedHat OpenShift Service) 및 OCP(OpenShift Container Platform)만 해당

* ARO 또는 OCP Kubernetes 클러스터가 실행되고 있습니다. 자세한 내용은 [ARO Kubernetes 클러스터 만들기](../openshift/tutorial-create-cluster.md) 및 [OCP Kubernetes 클러스터 만들기를 참조하세요.](https://docs.openshift.com/container-platform/4.6/installing/installing_platform_agnostic/installing-platform-agnostic.html)
...
> [!NOTE]
> AKS 또는 Azure Arc 사용하도록 설정된 Kubernetes 클러스터에 대한 컴퓨팅 연결 지원에는 Azure CLI `ml` 확장 >= 2.0.1a4 버전이 필요합니다. 자세한 내용은 [CLI 설치 및 설정(v2)을 참조하세요.](how-to-configure-cli.md)
