...
5. **3단계** 에서는 기술 자료의 이름을 **내 샘플 QnA KB** 로 지정합니다.

6. **4단계** 에서는 다음 표를 사용하여 설정을 구성합니다.
...
1. _markdown_ 으로 서식이 지정된 답변을 추가합니다.

    ` * Azure QnA Maker service\n* Azure Cognitive Search\n* Azure web app\n* Azure app plan`

    :::image type="content" source="../media/qnamaker-create-publish-knowledge-base/add-question-and-answer.png" alt-text="질문을 텍스트로 추가하고 답변을 markdown으로 서식을 지정합니다.":::
...
오른쪽 위에서 **저장 후 학습** 을 선택하여 편집 내용을 저장하고 QnA Maker를 학습합니다. 저장하지 않으면 편집 내용은 보관되지 않습니다.
