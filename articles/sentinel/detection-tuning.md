...
1. 두 번째 정보 창에서는 제외할 [엔터티의](entities.md) 목록을 권장 합니다. 이러한 엔터티는 사용자가 닫고 **가양성** 으로 분류 한 인시던트에 매우 밀접 하 게 연관 되어 있습니다. 나열 된 각 엔터티 옆에 있는 더하기 기호를 선택 하 여이 규칙의 이후 실행에서 쿼리에서 제외 합니다. 
