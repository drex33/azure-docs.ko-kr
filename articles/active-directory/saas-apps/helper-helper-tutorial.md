---
title: '자습서: Helper Helper와 Azure Active Directory 통합 | Microsoft Docs'
...
ms.locfileid: "124826347"
---
# <a name="tutorial-integrate-helper-helper-with-azure-active-directory"></a>자습서: Azure Active Directory와 Helper Helper 통합
...
액세스 패널에서 Helper Helper 타일을 선택하면 SSO를 설정한 Helper Helper에 자동으로 로그인되어야 합니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510)를 참조하세요.
