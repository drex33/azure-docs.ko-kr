---
title: 빠른 시작 – Azure Portal을 사용하는 Microsoft Azure 기밀 원장
description: Azure Portal을 통해 Microsoft Azure 기밀 원장 사용 방법 알아보기
author: msmbaldwin
ms.author: mbaldwin
ms.date: 10/18/2021
...
ms.openlocfilehash: 76237fc30d277a278ecade3162a434cb4f997b58
ms.sourcegitcommit: 56235f8694cc5f88db3afcc8c27ce769ecf455b0
ms.translationtype: HT
ms.contentlocale: ko-KR
ms.lasthandoff: 11/24/2021
ms.locfileid: "133039151"
---
# <a name="quickstart-create-a-confidential-ledger-using-the-azure-portal"></a>빠른 시작: Azure Portal을 사용하여 기밀 원장 만들기

Azure 기밀 원장은 데이터를 그대로 유지해야 하는 중요한 데이터 로그 및 레코드에 대해 높은 무결성 저장소를 제공하는 클라우드 서비스입니다. Azure 기밀 원장에 대한 자세한 내용 및 기밀 원장에 저장할 수 있는 항목의 예는 [Microsoft Azure 기밀 원장 정보](overview.md)를 참조하세요.
...
1. 검색 상자에 "기밀 원장"을 입력합니다.

1. 결과 목록에서 **기밀 원장** 을 선택합니다.

1. 기밀 원장 섹션에서 **만들기** 를 선택합니다.
...
- **기밀 원장 이름**: 이 예제에서는 "test-create-ledger-demo"입니다. 다른 단계에서 이 이름을 사용합니다.
...
다른 Azure 기밀 원장 문서도 이 빠른 시작을 이용해 작성됩니다. 후속 문서를 계속 진행하려는 경우 이러한 리소스를 그대로 유지하는 것이 좋습니다. 

더 이상 필요 없으면 리소스 그룹을 삭제하고 기밀 원장 및 관련 리소스를 삭제합니다. 포털을 통해 리소스 그룹을 삭제하려면:
...
이 빠른 시작에서는 Azure Portal을 사용하여 기밀 원장을 만들었습니다. Azure 기밀 원장 및 이를 애플리케이션과 통합하는 방법에 대해 자세히 알아보려면 아래 문서로 계속 진행하세요.
