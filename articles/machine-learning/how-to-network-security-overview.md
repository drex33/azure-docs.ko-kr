...
1. 작업 영역의 Azure Storage 계정에 대한 속성에서 방화벽 설정의 허용 목록에 클라이언트 IP 주소를 추가합니다. 자세한 내용은 [방화벽 및 가상 네트워크 구성을 참조하세요.](/azure/storage/common/storage-network-security#configuring-access-from-on-premises-networks)
