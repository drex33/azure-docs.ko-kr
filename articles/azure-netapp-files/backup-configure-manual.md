...
* 수동 백업을 만들면 볼륨에 스냅샷이 생성됩니다. 그런 다음, 스냅샷이 Azure Storage로 전송됩니다. 이 스냅샷은 자동으로 삭제되지 않습니다. 해당 스냅샷을 수동으로 삭제해야 합니다.  그러나 최신 수동 백업에 대해 생성된 스냅샷은 삭제할 수 없습니다.  따라서 후속 수동 백업을 만든 후에는 유지하지 않아도 되는 경우 이전 수동 백업에 대해 생성된 스냅샷을 정리(삭제)할 수 있습니다. 
