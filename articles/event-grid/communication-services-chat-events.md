---
title: Azure Communication Services - 채팅 이벤트
description: 이 문서에서는 채팅 이벤트에 대한 Event Grid 이벤트 원본으로 Azure Communication Services 사용하는 방법을 설명합니다.
ms.topic: conceptual
ms.date: 10/15/2021
ms.author: vikramdh
ms.openlocfilehash: 62b18bf0dd4667e173fe1cfb6c169dfe87fc0f8f
ms.sourcegitcommit: 147910fb817d93e0e53a36bb8d476207a2dd9e5e
ms.translationtype: MT
ms.contentlocale: ko-KR
ms.lasthandoff: 10/18/2021
ms.locfileid: "130134251"
---
# <a name="azure-communication-services---chat-events"></a>Azure Communication Services - 채팅 이벤트

이 문서에서는 통신 서비스 채팅 이벤트에 대한 속성 및 스키마를 제공합니다. 이벤트 스키마에 대한 소개는 [Azure Event Grid 이벤트 스키마](event-schema.md)를 참조하세요.

## <a name="event-types"></a>일정 유형

Azure Communication Services 다음과 같은 채팅 이벤트 유형을 내선합니다.
