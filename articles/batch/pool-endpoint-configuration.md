...
기본적으로 Batch는 [노드 사용자](/rest/api/batchservice/computenode/adduser)가 네트워크 연결을 사용하여 외부에서 Batch 풀의 컴퓨팅 노드에 연결할 수 있게 해줍니다. 예를 들어 사용자는 포트 3389의 RDP(원격 데스크톱)를 통해 Windows 풀의 컴퓨팅 노드에 연결할 수 있습니다. 마찬가지로, 기본적으로 사용자는 포트 22의 SSH(Secure Shell)를 통해 Linux 풀의 컴퓨팅 노드에 연결할 수 있습니다. 
