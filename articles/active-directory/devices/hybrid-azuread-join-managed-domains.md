...
디바이스에서 [디바이스 등록 연결 테스트](/samples/azure-samples/testdeviceregconnectivity/testdeviceregconnectivity/) 스크립트를 사용하여 시스템 계정을 통해 위의 Microsoft 리소스에 액세스할 수 있는지 확인합니다.
