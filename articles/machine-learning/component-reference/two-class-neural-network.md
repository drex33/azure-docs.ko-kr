---
title: 'Two-Class 신경망: 구성 요소 참조'
titleSuffix: Azure Machine Learning
description: Azure Machine Learning Two-Class 신경망 구성 요소를 사용하여 이진 분류기를 만드는 방법을 알아봅니다.
...
ms.locfileid: "131570125"
---
# <a name="two-class-neural-network-component"></a>Two-Class 신경망 구성 요소

이 문서에서는 Azure Machine Learning 디자이너의 구성 요소에 대해 설명합니다.

이 구성 요소를 사용하여 값이 두 개뿐인 대상을 예측하는 데 사용할 수 있는 신경망 모델을 만듭니다.
...
1.  파이프라인에 **2클래스 신경망** 구성 요소를 추가합니다. 이 구성 요소는 **분류** 범주의 **Machine Learning**, **Initialize** 에서 찾을 수 있습니다.  
