...
ms.openlocfilehash: 54bf102cbcc9e78cbf734ed7d0287d4328c14f65
ms.sourcegitcommit: 56235f8694cc5f88db3afcc8c27ce769ecf455b0
ms.translationtype: HT
ms.contentlocale: ko-KR
ms.lasthandoff: 11/24/2021
ms.locfileid: "133068386"
---
...
1. 서브넷이 생성되면 페이지가 자동으로 **3단계** 로 이동합니다. 3단계의 경우 다음 값을 사용합니다.
   ...
   * **계층:** 계층은 SKU입니다. 이 연습의 경우 드롭다운에서 **표준** 을 선택합니다. 표준 SKU를 선택하면 호스트 스케일링 인스턴스 수를 구성할 수 있습니다. 기본 SKU는 호스트 크기 조정을 지원하지 않습니다. 자세한 내용은 [구성 설정 - SKU](configuration-settings.md#skus)를 참조하세요.
   * **인스턴스 수:** 호스트 스케일링 설정입니다. 슬라이더를 사용하여 구성합니다. 기본 계층 SKU를 지정하는 경우 2개의 인스턴스로 제한되며 이 설정을 구성할 수 없습니다. 자세한 내용은 [구성 설정 - 호스트 스케일링](configuration-settings.md#instance)을 참조하세요. 인스턴스 수는 표준 SKU에만 적용됩니다. 이 빠른 시작에서는 모든 배율 단위 [가격 책정](https://azure.microsoft.com/pricing/details/azure-bastion) 고려 사항을 염두에 두고 원하는 인스턴스 수를 선택할 수 있습니다.
