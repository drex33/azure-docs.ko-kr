...
ms.openlocfilehash: ccabe53d75bf6cca4083236e07032253de908f05
ms.sourcegitcommit: 4298f71f502c70d601a7c58b28fc7bca62be3595
ms.translationtype: MT
ms.contentlocale: ko-KR
ms.lasthandoff: 11/25/2021
ms.locfileid: "133133204"
---
...
> [!NOTE]
> 로케일의 발음 `en-US` 평가는 모든 음성 [텍스트로의 지역](regions.md#speech-to-text-text-to-speech-and-translation)에서 사용할 수 있습니다. 및 `en-GB` `zh-CN` 로케일에 대한 지원은 미리 보기로 제공됩니다.

## <a name="pronunciation-assessment-with-the-speech-sdk"></a>Speech SDK를 사용한 발음 평가

다음 조각에서는 를 만든 다음 에 적용하는 방법을 보여 `PronunciationAssessmentConfig` `SpeechRecognizer` 줍니다.
...
| `PronScore` | 지정된 음성의 발음 품질을 나타내는 전체 점수입니다. 이는 가중치를 가진 , 및 에서 `AccuracyScore` 집계됩니다. `FluencyScore` `CompletenessScore` |
| `ErrorType` | 이 값은 `ReferenceText`와 비교하여 단어가 생략되었거나, 삽입되었거나, 잘못 발음되었는지 여부를 나타냅니다. 가능한 값은 `None` (이 단어에 오류가 없음을 의미함), `Omission` , 및 `Insertion` `Mispronunciation` 입니다. |
