...
| [Gremlin API, 데이터베이스 및 그래프용 서버리스 Azure Cosmos 계정 만들기](../scripts/cli/gremlin/create.md?toc=%2fcli%2fazure%2ftoc.json)| Gremlin API에 대한 서버리스 Azure Cosmos DB 계정, 데이터베이스 및 그래프를 만듭니다. |
