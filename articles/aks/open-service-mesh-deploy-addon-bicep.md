...
ms.date: 9/20/2021
ms.author: pgibson
ms.openlocfilehash: 1fc5f82dc6732ae004d137c68a3ceecf69f43236
ms.sourcegitcommit: 1244a72dbec39ac8cf16bb1799d8c46bde749d47
ms.translationtype: MT
ms.contentlocale: ko-KR
ms.lasthandoff: 11/18/2021
ms.locfileid: "132753743"
---
...
> [!NOTE]
> `osm.aks.parameters.json`는 Bicep 배포에 필요한 예제 템플릿 매개 변수 파일입니다. 배포 환경에 맞게 지정된 매개 변수를 업데이트해야 합니다. 이 예제에서 사용하는 특정 매개 변수 값은 다음 매개 변수를 업데이트해야 합니다. _clusterName,_ _clusterDNSPrefix,_ _k8Version_ 및 _sshPubKey_ 입니다. 해당 지역에서 지원되는 Kubernetes 버전 목록을 찾으려면 `az aks get-versions --location <region>` 명령을 사용하세요.
