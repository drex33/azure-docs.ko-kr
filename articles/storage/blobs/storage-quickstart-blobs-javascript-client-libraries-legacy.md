...
ms.topic: quickstart
ms.subservice: blobs
ms.openlocfilehash: 05c403319621cd53c336fb09f91bfa3a8d9b5d12
ms.sourcegitcommit: 56235f8694cc5f88db3afcc8c27ce769ecf455b0
ms.translationtype: HT
ms.contentlocale: ko-KR
ms.lasthandoff: 11/24/2021
ms.locfileid: "133049850"
---
...
이 코드는 스크립트 파일에 참조를 추가하고, 사용자 고유의 JavaScript 코드를 위한 공간을 제공합니다. 이 빠른 시작에서는 `azure-storage-blob.js` 스크립트 파일을 사용하여 VS Code에서 열고, 내용을 읽고, 중단점을 설정할 수 있습니다. 프로덕션 환경에서는 zip 파일에도 제공되는 더 간단한 *azure-storage.blob.min.js* 파일을 사용해야 합니다.
