...
## <a name="configure-and-test-azure-ad-sso-for-opsgenie"></a>OpsGenie에 대한 Azure AD SSO 구성 및 테스트
...
OpsGenie에서 Azure AD SSO를 구성하고 테스트하려면 다음 단계를 수행합니다.
...
1. **[OpsGenie SSO 구성](#configure-opsgenie-sso)** - 애플리케이션 쪽에서 Single Sign-On 설정을 구성합니다.
    1. **[OpsGenie 테스트 사용자 만들기](#create-opsgenie-test-user)** - B.Simon의 Azure AD 표현과 연결된 해당 사용자를 OpsGenie에 만듭니다.
...
1. Azure Portal의 **OpsGenie** 애플리케이션 통합 페이지에서 **관리** 섹션을 찾아 **Single Sign-On** 을 선택합니다.
...
1. OpsGenie 내에서 구성을 자동화하려면 **확장 설치** 를 클릭하여 **내 앱 보안 로그인 브라우저 확장** 을 설치해야 합니다.

    ![내 앱 확장](common/install-myappssecure-extension.png)

2. 브라우저에 확장을 추가한 후 **OpsGenie 설정** 을 클릭하면 OpsGenie 애플리케이션으로 이동됩니다. 여기서 관리자 자격 증명을 입력하여 OpsGenie에 로그인합니다. 브라우저 확장에서 애플리케이션을 자동으로 구성하고 3-7단계를 자동화합니다.

    ![설정 구성](common/setup-sso.png)

3. OpsGenie를 수동으로 설정하려면 다른 웹 브라우저 창에서 관리자 권한으로 OpsGenie 회사 사이트에 로그인합니다.
...
* Azure Portal에서 이 애플리케이션 테스트를 클릭하면 SSO를 설정한 OpsGenie에 자동으로 로그인됩니다.

* Microsoft 내 앱을 사용할 수 있습니다. 내 앱에서 OpsGenie 타일을 클릭하면 SSO를 설정한 OpsGenie에 자동으로 로그인됩니다. 내 앱에 대한 자세한 내용은 [내 앱 소개](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510)를 참조하세요.

## <a name="next-steps"></a>다음 단계

* OpsGenie가 구성되면 세션 제어를 적용하여 조직의 중요한 데이터의 반출 및 반입을 실시간으로 보호할 수 있습니다. 세션 제어는 조건부 액세스에서 확장됩니다. [Microsoft Defender for Cloud Apps를 사용하여 세션 제어를 적용하는 방법을 알아봅니다](/cloud-app-security/proxy-deployment-any-app).
