...
>
>- 백업을 아직 구성하지 않은 경우 다음 단계를 완료하여 설정을 검토하고 수정합니다.
...
이 프로세스는 스토리지 수준에 있으므로 [가격 책정에 영향을 미칩니다.](https://azure.microsoft.com/pricing/details/backup/)
