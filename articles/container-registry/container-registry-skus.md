...
[Az acr show 사용](/cli/azure/acr#az_acr_show_usage) 명령 또는 [목록](/rest/api/containerregistry/registries/list-usages) 사용 REST API를 사용 하 여 레지스트리의 현재 저장소 및 기타 리소스 사용량에 대 한 스냅숏을 가져옵니다. 해당 레지스트리의 서비스 계층에 대 한 제한과 비교해 볼 수 있습니다. 포털의 레지스트리의 **개요** 페이지에도 Storage 사용이 표시 됩니다.
