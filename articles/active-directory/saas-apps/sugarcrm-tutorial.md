...
## <a name="add-sugar-crm-from-the-gallery"></a>갤러리에서 Sugar CRM 추가
...
## <a name="configure-and-test-azure-ad-sso-for-sugar-crm"></a>Sugar CRM에 대한 Azure AD SSO 구성 및 테스트
...
Sugar CRM에서 Azure AD SSO를 구성하고 테스트하려면 다음 단계를 수행합니다.
...
1. Azure Portal의 **Sugar CRM** 애플리케이션 통합 페이지에서 **관리** 섹션을 찾아 **Single Sign-On** 을 선택합니다.
...
1. **관리** 섹션에서 **암호 관리** 를 클릭합니다.
    ...
    ![스크린샷은 암호 관리를 선택할 수 있는 관리 섹션을 보여줍니다.](./media/sugarcrm-tutorial/ic795889.png "관리")

1. **SAML 인증 사용** 을 선택합니다.

    ![스크린샷은 SAML 인증을 선택하는 옵션을 보여줍니다.](./media/sugarcrm-tutorial/ic795890.png "관리")

1. **SAML Authentication** 섹션에서 다음 단계를 수행합니다.

    ![SAML 인증](./media/sugarcrm-tutorial/save.png "SAML 인증")  
...
1. **관리** 섹션에서 **사용자 관리** 를 클릭합니다.
    ...
    ![스크린샷은 사용자 관리를 선택할 수 있는 관리 섹션을 보여줍니다.](./media/sugarcrm-tutorial/ic795893.png "관리")
...
1. **사용자 프로필** 탭에서 다음 단계를 수행합니다.
    ...
    ![스크린샷은 설명된 값을 입력할 수 있는 사용자 프로필 탭을 보여줍니다.](./media/sugarcrm-tutorial/ic795895.png "새 사용자")
...
1. 암호 탭에서 다음 단계를 수행합니다.
    ...
    ![스크린샷은 설명된 값을 입력할 수 있는 암호 탭을 보여줍니다.](./media/sugarcrm-tutorial/ic795896.png "새 사용자")
...
* Azure Portal에서 **이 애플리케이션 테스트** 를 클릭합니다. 그러면 로그인 흐름을 시작할 수 있는 Sugar CRM 로그온 URL로 리디렉션됩니다. 

* Sugar CRM 로그온 URL로 직접 이동하여 해당 위치에서 로그인 흐름을 시작합니다.

* Microsoft 내 앱을 사용할 수 있습니다. 내 앱에서 Sugar CRM 타일을 클릭하면 Sugar CRM 로그온 URL로 리디렉션됩니다. 내 앱에 대한 자세한 내용은 [내 앱 소개](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510)를 참조하세요.

## <a name="next-steps"></a>다음 단계

Sugar CRM이 구성되면 세션 제어를 적용하여 조직의 중요한 데이터의 반출 및 반입을 실시간으로 보호할 수 있습니다. 세션 제어는 조건부 액세스에서 확장됩니다. [Microsoft Defender for Cloud Apps를 사용하여 세션 제어를 적용하는 방법을 알아봅니다](/cloud-app-security/proxy-deployment-any-app).
