...
## <a name="enable-http-strict-transport-security-hsts"></a><a id="http-hsts"></a>HSTS(HTTP 엄격한 전송 보안)를 사용하도록 설정
...
## <a name="enable-https---secure-transport-channel"></a><a id="https-transport"></a>HTTPS 사용 설정 - 보안 전송 채널
...
## <a name="wcf-use-a-least-privileged-account-to-run-your-wcf-service"></a><a id="least-account-wcf"></a>WCF: 최소 권한 계정을 사용하여 WCF 서비스 실행
...
## <a name="secure-device-to-field-gateway-communication"></a><a id="device-field"></a>디바이스-필드 게이트웨이 통신 보안
...
## <a name="secure-device-to-cloud-gateway-communication-using-ssltls"></a><a id="device-cloud"></a>SSL/TLS를 사용하여 디바이스-클라우드 게이트웨이 통신 보안
