---
title: Azure Linux VM의 컴퓨팅 벤치마크 점수
...
| [고성능 컴퓨팅](#high-performance-compute) | [HBv2](#hbrsv2) [HB](#hbs---memory-bandwidth-amd-epyc) [HC](#hcs---dense-computation-intel-xeon-platinum-8168)  |
| [메모리 최적화](#memory-optimized) | [DSv2](#dsv2---general-purpose--premium-storage) [Dv2](#dv2---general-compute) [Esv3](#esv3---memory-optimized--premium-storage) [Ev3](#ev3---memory-optimized) [Easv4](#easv4) [Eav4](#eav4) [Edsv4](#edsv4) [Edv4](#edv4) [Esv4](#esv4) [Ev4](#ev4) [Msv2](#msv2-high-memory) [Ms](#m-series-medium-memory)  |
| [스토리지 최적화](#storage-optimized) | [Lsv2](#lsv2---storage-optimized)  |
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_F2s_v2 | Intel(R) Xeon(R) 플래티넘 8168 CPU @ 2.70GHz | 2 | 1 | 4.0 | 35,925 | 603 | 1.68% | 308 |
| Standard_F2s_v2 | Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz | 2 | 1 | 4.0 | 35,659 | 344 | 0.96% | 112 |
| Standard_F4s_v2 | Intel(R) Xeon(R) 플래티넘 8168 CPU @ 2.70GHz | 4 | 1 | 8.0 | 65,819 | 851 | 1.29% | 245 |
| Standard_F4s_v2 | Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz | 4 | 1 | 8.0 | 65,683 | 459 | 0.70% | 98 |
| Standard_F8s_v2 | Intel(R) Xeon(R) 플래티넘 8168 CPU @ 2.70GHz | 8 | 1 | 16.0 | 136,027 | 1,272 | 0.94% | 238 |
| Standard_F8s_v2 | Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz | 8 | 1 | 16.0 | 135,829 | 912 | 0.67% | 91 |
| Standard_F16s_v2 | Intel(R) Xeon(R) 플래티넘 8168 CPU @ 2.70GHz | 16 | 1 | 32.0 | 271,369 | 1,955 | 0.72% | 280 |
| Standard_F16s_v2 | Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz | 16 | 1 | 32.0 | 271,236 | 1,325 | 0.49% | 105 |
| Standard_F32s_v2 | Intel(R) Xeon(R) 플래티넘 8168 CPU @ 2.70GHz | 32 | 1 | 64.0 | 538,734 | 3,795 | 0.70% | 245 |
| Standard_F32s_v2 | Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz | 32 | 1 | 64.0 | 537,915 | 7,646 | 1.42% | 91 |
| Standard_F48s_v2 | Intel(R) Xeon(R) 플래티넘 8168 CPU @ 2.70GHz | 48 | 2 | 96.0 | 780,596 | 8,712 | 1.12% | 182 |
| Standard_F48s_v2 | Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz | 48 | 1 | 96.0 | 749,662 | 21,751 | 2.90% | 56 |
| Standard_F64s_v2 | Intel(R) Xeon(R) 플래티넘 8168 CPU @ 2.70GHz | 64 | 2 | 128.0 | 1,035,424 | 11,557 | 1.12% | 175 |
| Standard_F64s_v2 | Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz | 64 | 2 | 128.0 | 1,023,867 | 17,292 | 1.69% | 63 |
| Standard_F72s_v2 | Intel(R) Xeon(R) 플래티넘 8168 CPU @ 2.70GHz | 72 | 2 | 144.0 | 1,126,078 | 12,094 | 1.07% | 182 |
...
### <a name="dsv2---general-purpose--premium-storage"></a>DSv2 - 범용 + Premium Storage
...
| VM 크기 | CPU | vCPU | NUMA 노드 | 메모리(GiB) | Avg 점수 | StdDev | StdDev% | #실행 |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_D2as_v4 | AMD EPYC 7452 32-코어 프로세서 | 2 | 1 | 8.0 | 38,230 | 313 | 0.82% | 77 |
| Standard_D4as_v4 | AMD EPYC 7452 32-코어 프로세서 | 4 | 1 | 16.0 | 71,707 | 790 | 1.10% | 98 |
| Standard_D8as_v4 | AMD EPYC 7452 32-코어 프로세서 | 8 | 1 | 32.0 | 151,474 | 1,599 | 1.06% | 56 |
| Standard_D16as_v4 | AMD EPYC 7452 32-코어 프로세서 | 16 | 2 | 64.0 | 292,074 | 9,782 | 3.35% | 91 |
| Standard_D32as_v4 | AMD EPYC 7452 32-코어 프로세서 | 32 | 4 | 128.0 | 575,465 | 14,574 | 2.53% | 98 |
| Standard_D48as_v4 | AMD EPYC 7452 32-코어 프로세서 | 48 | 6 | 192.0 | 843,316 | 21,739 | 2.58% | 105 |
| Standard_D64as_v4 | AMD EPYC 7452 32-코어 프로세서 | 64 | 8 | 256.0 | 1,120,467 | 30,714 | 2.74% | 7 |
...
| VM 크기 | CPU | vCPU | NUMA 노드 | 메모리(GiB) | Avg 점수 | StdDev | StdDev% | #실행 |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_D2a_v4 | AMD EPYC 7452 32-코어 프로세서 | 2 | 1 | 8.0 | 38,061 | 1,219 | 3.20% | 119 |
| Standard_D4a_v4 | AMD EPYC 7452 32-코어 프로세서 | 4 | 1 | 16.0 | 70,996 | 2,280 | 3.21% | 140 |
| Standard_D8a_v4 | AMD EPYC 7452 32-코어 프로세서 | 8 | 1 | 32.0 | 151,379 | 1,946 | 1.29% | 147 |
| Standard_D16a_v4 | AMD EPYC 7452 32-코어 프로세서 | 16 | 2 | 64.0 | 293,654 | 6,263 | 2.13% | 161 |
| Standard_D32a_v4 | AMD EPYC 7452 32-코어 프로세서 | 32 | 4 | 128.0 | 571,897 | 16,009 | 2.80% | 147 |
| Standard_D48a_v4 | AMD EPYC 7452 32-코어 프로세서 | 48 | 6 | 192.0 | 837,332 | 22,923 | 2.74% | 161 |
| Standard_D64a_v4 | AMD EPYC 7452 32-코어 프로세서 | 64 | 8 | 256.0 | 1,126,793 | 29,148 | 2.59% | 21 |
| Standard_D96a_v4 | AMD EPYC 7452 32-코어 프로세서 | 96 | 12 | 384.0 | 1,590,434 | 31,887 | 2.00% | 14 |

### <a name="dcs---confidential-compute-series"></a>DCS - 기밀 컴퓨팅 시리즈
...
## <a name="high-performance-compute"></a>고성능 컴퓨팅
...
### <a name="hbs---memory-bandwidth-amd-epyc"></a>HBS - 메모리 대역폭(AMD EPYC)
(10/14/2020 PBIID:7668456)

| VM 크기 | CPU | vCPU | NUMA 노드 | 메모리(GiB) | Avg 점수 | StdDev | StdDev% | #실행 |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_HB60rs | AMD EPYC 7551 32-코어 프로세서 | 60 | 15 | 228.0 | 986,593 | 28,102 | 2.85% | 21 |

### <a name="hcs---dense-computation-intel-xeon-platinum-8168"></a>HCS - 고밀도 계산(Intel Xeon Platinum 8168)
(10/14/2020 PBIID:7668456)

| VM 크기 | CPU | vCPU | NUMA 노드 | 메모리(GiB) | Avg 점수 | StdDev | StdDev% | #실행 |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_HC44rs | Intel(R) Xeon(R) 플래티넘 8168 CPU @ 2.70GHz | 44 | 2 | 352.0 | 995,006 | 25,995 | 2.61% | 21 |
...
| VM 크기 | CPU | vCPU | NUMA 노드 | 메모리(GiB) | Avg 점수 | StdDev | StdDev% | #실행 |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_E2as_v4 | AMD EPYC 7452 32-코어 프로세서 | 2 | 1 | 16.0 | 38,155 | 432 | 1.13% | 259 |
| Standard_E4as_v4 | AMD EPYC 7452 32-코어 프로세서 | 4 | 1 | 32.0 | 71,500 | 1,260 | 1.76% | 259 |
| Standard_E8as_v4 | AMD EPYC 7452 32-코어 프로세서 | 8 | 1 | 64.0 | 151,201 | 3,171 | 2.10% | 259 |
| Standard_E16as_v4 | AMD EPYC 7452 32-코어 프로세서 | 16 | 2 | 128.0 | 293,186 | 6,371 | 2.17% | 280 |
| Standard_E20as_v4 | AMD EPYC 7452 32-코어 프로세서 | 20 | 3 | 160.0 | 363,292 | 8,744 | 2.41% | 280 |
| Standard_E32as_v4 | AMD EPYC 7452 32-코어 프로세서 | 32 | 4 | 256.0 | 570,199 | 14,140 | 2.48% | 294 |
| Standard_E48as_v4 | AMD EPYC 7452 32-코어 프로세서 | 48 | 6 | 384.0 | 841,547 | 21,858 | 2.60% | 301 |
| Standard_E64as_v4 | AMD EPYC 7452 32-코어 프로세서 | 64 | 8 | 512.0 | 1,108,151 | 28,783 | 2.60% | 28 |
| Standard_E96as_v4 | AMD EPYC 7452 32-코어 프로세서 | 96 | 12 | 672.0 | 1,578,349 | 27,080 | 1.72% | 42 |
...
| VM 크기 | CPU | vCPU | NUMA 노드 | 메모리(GiB) | Avg 점수 | StdDev | StdDev% | #실행 |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_E2a_v4 | AMD EPYC 7452 32-코어 프로세서 | 2 | 1 | 16.0 | 38,035 | 900 | 2.37% | 196 |
| Standard_E4a_v4 | AMD EPYC 7452 32-코어 프로세서 | 4 | 1 | 32.0 | 71,345 | 949 | 1.33% | 196 |
| Standard_E8a_v4 | AMD EPYC 7452 32-코어 프로세서 | 8 | 1 | 64.0 | 151,511 | 1,940 | 1.28% | 189 |
| Standard_E16a_v4 | AMD EPYC 7452 32-코어 프로세서 | 16 | 2 | 128.0 | 292,668 | 7,220 | 2.47% | 196 |
| Standard_E20a_v4 | AMD EPYC 7452 32-코어 프로세서 | 20 | 3 | 160.0 | 361,845 | 9,332 | 2.58% | 196 |
| Standard_E32a_v4 | AMD EPYC 7452 32-코어 프로세서 | 32 | 4 | 256.0 | 570,615 | 14,419 | 2.53% | 196 |
| Standard_E48a_v4 | AMD EPYC 7452 32-코어 프로세서 | 48 | 6 | 384.0 | 841,419 | 26,181 | 3.11% | 196 |
| Standard_E64a_v4 | AMD EPYC 7452 32-코어 프로세서 | 64 | 8 | 512.0 | 1,116,891 | 28,545 | 2.56% | 14 |
| Standard_E96a_v4 | AMD EPYC 7452 32-코어 프로세서 | 96 | 12 | 672.0 | 1,592,228 | 32,515 | 2.04% | 14 |
...
### <a name="msv2-high-memory"></a>Msv2 상위 메모리
...
### <a name="m-series-medium-memory"></a>M 시리즈 중간 메모리
...
### <a name="lsv2---storage-optimized"></a>Lsv2 - 스토리지 최적화
(10/13/2020 PBIID:7668456)

| VM 크기 | CPU | vCPU | NUMA 노드 | 메모리(GiB) | Avg 점수 | StdDev | StdDev% | #실행 |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_L8s_v2 | AMD EPYC 7551 32-코어 프로세서 | 8 | 1 | 64.0 | 102,237 | 1,320 | 1.29% | 77 |
| Standard_L16s_v2 | AMD EPYC 7551 32-코어 프로세서 | 16 | 2 | 128.0 | 198,472 | 3,734 | 1.88% | 70 |
| Standard_L32s_v2 | AMD EPYC 7551 32-코어 프로세서 | 32 | 4 | 256.0 | 390,015 | 10,126 | 2.60% | 77 |
| Standard_L48s_v2 | AMD EPYC 7551 32-코어 프로세서 | 48 | 6 | 384.0 | 583,388 | 15,479 | 2.65% | 77 |
| Standard_L64s_v2 | AMD EPYC 7551 32-코어 프로세서 | 64 | 8 | 512.0 | 774,827 | 19,205 | 2.48% | 77 |
| Standard_L80s_v2 | AMD EPYC 7551 32-코어 프로세서 | 80 | 10 | 640.0 | 966,682 | 22,811 | 2.36% | 77 |
...
더 이상 사용되지 않는 이전 시리즈는 표시되지 않습니다. N 시리즈는 GPU 중심이고 Coremark는 GPU 성능을 측정하지 않으므로 표시되지 않습니다.  최신 시리즈는 아직 벤치마킹되지 않았을 수 있습니다.
이 문서의 이전 버전에서는 Ubuntu 16.04에서 수행된 벤치마크 실행을 예로 들었으며, 이로 인해 Ubuntu 18.04에서 실행되는 현재 벤치마크보다 성능이 약간 낮습니다.
