---
title: Bicep 함수 - 문자열
description: 문자열 작업을 위해 Bicep 파일에서 사용할 함수를 설명합니다.
author: mumian
ms.author: jgao
ms.topic: conceptual
ms.date: 10/01/2021
ms.openlocfilehash: 9418afa9d9afc7ec7de713de9bd8a7bd282ce2fb
ms.sourcegitcommit: 692382974e1ac868a2672b67af2d33e593c91d60
ms.translationtype: MT
ms.contentlocale: ko-KR
ms.lasthandoff: 10/22/2021
ms.locfileid: "130219662"
---
...
Bicep 파일에서 문자열의 서식을 지정하려면 이 함수를 사용합니다. .NET의 [System.String.Format](/dotnet/api/system.string.format) 메서드와 동일한 서식 옵션을 사용합니다.
...
[이전에 성공한 배포를 다시 배포하는 옵션](../templates/rollback-on-error.md)을 사용하고 이전 배포에 newGuid를 사용하는 매개 변수가 포함된 경우 해당 매개 변수는 재평가되지 않습니다. 대신 이전 배포의 매개 변수 값이 롤백 배포에서 자동으로 다시 사용됩니다.
...
기본값에 대한 newGuid 함수에 의존하는 Bicep 파일은 주의를 기울여 재배포해야 합니다. 재배포할 때 매개 변수 값을 제공하지 않으면 함수는 재평가됩니다. 새 리소스를 만드는 대신 기존 리소스를 업데이트하려면 이전 배포의 매개 변수 값을 제공해야 합니다.
...
다음 예제에서는 newGuid 함수를 사용하여 스토리지 계정에 대한 고유한 이름을 만듭니다. 이 Bicep 파일은 스토리지 계정이 짧은 시간 동안 존재하고 다시 배포되지 않는 테스트 환경에 사용할 수 있습니다.
