...
App Service Environment는 [Azure App Service](../overview.md)의 [프리미엄][PremiumTier] 서비스 계획 옵션으로, Web Apps, Mobile Apps 및 API Apps을 포함하여 높은 확장성으로 Azure App Service 앱을 안전하게 실행하기 위해 완전히 격리된 전용 환경을 제공합니다.  
...
App Service 환경이 높은 확장성을 지원하고 네트워크 액세스를 보호하는 방법에 대한 개요는 App Service Environment에서 [AzureCon 심층 분석][AzureConDeepDive]을 참조하세요!
