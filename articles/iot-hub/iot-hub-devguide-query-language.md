...
쿼리 기능은 [C# 서비스 SDK](iot-hub-devguide-sdks.md)의 **RegistryManager** 클래스에서 공개합니다.
...
쿼리 기능은 [Node.js용 Azure IoT 서비스 SDK](iot-hub-devguide-sdks.md)의 **Registry** 개체에서 공개합니다.
