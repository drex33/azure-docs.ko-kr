...
| `environment` | `environment` | 선택 사항입니다.  Azure Machine Learning [환경](/python/api/azureml-core/azureml.core.environment.environment)|

유추 구성 파일에서 Azure Machine Learning [환경](/python/api/azureml-core/azureml.core.environment.environment)의 전체 사양을 포함할 수 있습니다. 이 환경이 작업 영역에 없는 경우 Azure Machine Learning에서 만듭니다. 그렇지 않으면 필요한 경우 Azure Machine Learning에서 환경을 업데이트합니다. 다음 JSON은 예제입니다.
...
구분된 CLI 매개 변수에서 기존 Azure Machine Learning [환경](/python/api/azureml-core/azureml.core.environment.environment)을 사용하고 유추 구성 파일에서 "환경" 키를 제거할 수도 있습니다. 환경 이름에 -e를 사용하고 환경 버전에 --ev를 사용합니다. --ev를 지정하지 않으면 최신 버전이 사용됩니다. 다음은 유추 구성 파일의 예제입니다.
...
또한 기존 Azure Machine Learning [환경](/python/api/azureml-core/azureml.core.environment.environment)(AzureML-Minimal)의 최신 버전을 사용합니다.
