...
ms.openlocfilehash: b3b718435982f2a07c5e41dc134131db071748f9
ms.sourcegitcommit: 93c7420c00141af83ed3294923b4826dd4dc6ff2
ms.translationtype: MT
ms.contentlocale: ko-KR
ms.lasthandoff: 12/02/2021
ms.locfileid: "133435513"
---
...
모든 데이터를 특정 지리적 영역 내에 유지하는 것이 중요한 경우 인스턴스를 만드는 지역의 [지역 쌍 지역](../availability-zones/cross-region-replication-azure.md#azure-cross-region-replication-pairings-for-all-geographies) 위치를 확인하여 데이터 상주 요구 사항을 충족하는지 확인하세요.
