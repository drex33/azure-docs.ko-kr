...
description: 데이터의 수집 및 사용을 제어하는 국가, 지역, 산업별 요구 사항에 대한 Azure Storage의 규정 준수 제안에 대한 요약을 읽습니다.
services: storage
author: fhryo-msft
ms.service: storage
ms.topic: conceptual
...
- [EAR(미국 수출 관리 규정)](https://aka.ms/AzureCompliance)
...
- [FCA(영국)](https://aka.ms/AzureCompliance)
- [FFIEC](https://www.microsoft.com/trustcenter/compliance/FFIEC)
- [FISC(일본)](https://www.microsoft.com/trustcenter/compliance/fisc)
...
- [BIR 2012(네덜란드)](https://www.microsoft.com/TrustCenter/Compliance/bir-2012)
- [C5(독일)](https://www.microsoft.com/TrustCenter/Compliance/C5)
- [CCSL/IRAP(오스트레일리아)](https://www.microsoft.com/trustcenter/compliance/ccsl)
- [CS Gold Mark(일본)](https://www.microsoft.com/trustcenter/compliance/cloud-security-mark)
...
- [LOPD(스페인)](https://aka.ms/AzureCompliance)
- [MTCS(싱가포르)](https://www.microsoft.com/trustcenter/compliance/mtcs)
- [My Number(일본)](https://www.microsoft.com/trustcenter/privacy/we-set-and-adhere-to-stringent-standards#my_number)
- [NZ CC Framework(뉴질랜드)](https://www.microsoft.com/trustcenter/compliance/nzcc)
- [PASF(영국)](https://aka.ms/AzureCompliance)
- [PDPA(아르헨티나)](https://www.microsoft.com/trustcenter/privacy/we-set-and-adhere-to-stringent-standards#argentina)
- [PIPEDA(캐나다)](https://www.microsoft.com/trustcenter/privacy/we-set-and-adhere-to-stringent-standards#canadian_privacy_laws)
- [TRUCS(중국)](https://www.trustcenter.cn/compliance/default.html#TCS)
- [UK-G-Cloud](https://www.microsoft.com/trustcenter/compliance/uk-g-cloud)

## <a name="next-steps"></a>다음 단계

Microsoft Azure 및 Azure Storage는 준수 제품에서 업계 선두를 유지하고 있으며, [Microsoft TrustCenter](https://www.microsoft.com/TrustCenter/Compliance/default.aspx)에서 최신 적용 범위 및 세부 정보를 확인할 수 있습니다.
