...
상업용 마켓플레이스 게시자로 가입하려면 [파트너 센터](https://go.microsoft.com/fwlink/?linkid=2165614)로 이동하세요.
...
### <a name="how-can-my-own-employees-use-our-offers-from-the-marketplace-without-being-charged"></a>직원이 비용을 청구받지 않고 마켓플레이스에서 제공하는 제품을 어떻게 사용할 수 있나요?

Microsoft가 직원에게 청구하고 제품 판매에 대한 매장 서비스 요금을 평가하지 않도록 하려면 먼저 가격이 $0인 제품에 대한 [비공개 요금제](./private-offers.md)를 만들고, 구매하려는 내부 사용자에게 이 제안을 보내야 합니다.

또한 [개인 Marketplace](/marketplace/create-manage-private-azure-marketplace) 기능을 사용 하여 관리자가 승인한 특정 제품만 내부 사용자가 구매하도록 할 수 있습니다.

### <a name="how-do-i-get-support-assistance-for-the-commercial-marketplace"></a>상업용 마켓플레이스에 대한 지원을 받으려면 어떻게 해야 하나요?

마켓플레이스 게시자 지원 팀에 문의하려면 파트너 센터 내에서 [지원 티켓을 제출](https://go.microsoft.com/fwlink/?linkid=2165533)하면 됩니다.
...
상업용 마켓플레이스 내에서 귀사의 제품에 대한 보고를 제공합니다. 고객, 주문, 스토어 참여 등에 대한 데이터에 액세스하려면 [파트너 센터에서 상업용 마켓플레이스에 대한 분석](analytics.md)으로 이동합니다.
...
게시자가 제안 제거를 시작하면 게시자는 고객에 대한 제거 통신을 소유합니다.
...
### <a name="can-i-limit-the-resellers-who-are-allowed-to-sell-my-offer"></a>제품을 판매할 수 있는 재판매인을 제한할 수 있나요?
...
일반적으로 이전 청구 주기의 모든 구매에 대해 고객에게 매월 청구됩니다. VM 이미지, SaaS 애플리케이션 및 관리형 애플리케이션과 같은 요금 청구 플랜이 있는 사용량 기반 제품은 사용한 후에 요금이 청구됩니다. 구독 기반 플랜은 해당 기간의 시작 날짜부터 청구됩니다.
...
환불은 특정 조건 및 특정 요금에 따라 고객에게 제공됩니다. 매월 청구되는 월정액 환불에 대한 요청은 구매 후 24시간 이내에 접수되어야 합니다. 이와 비슷하게 매년 청구되는 연정액 환불에 대한 요청은 구매 후 14일 이내에 접수되어야 합니다. 

사용량(가상 머신 제품 또는 요금제 청구)에 따른 변동 요금에 대해서는 환불되지 않습니다.

> [!NOTE]
> 가상 머신의 요금제 사용량, SaaS, Azure 앱에 대한 요금제 청구 또는 제품 사용의 다른 인스턴스(종량제 등)에 대해 환불은 불가합니다.  공급 업체가 환불을 받으면 파트너 센터 [지급 보고](/partner-center/payout-statement?context=/azure/marketplace/context/context)에 반영됩니다.
