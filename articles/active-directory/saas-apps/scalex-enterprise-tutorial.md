...
1. 오른쪽 위에 있는 메뉴를 클릭하고 **Contoso Administration(Contoso 관리)** 를 선택합니다.
    ...
    ![오른쪽 위의 메뉴에서 선택한 회사 이름 예제를 보여주는 스크린샷.](./media/scalex-enterprise-tutorial/Test_Admin.png)

1. 최상위 메뉴에서 **Integrations(통합)** 을 선택하고 **Single Sign-On** 을 선택합니다.

    ![선택된 "통합"과 드롭다운 메뉴에서 선택된 "Single Sign-On"을 보여주는 스크린샷.](./media/scalex-enterprise-tutorial/admin_sso.png) 
