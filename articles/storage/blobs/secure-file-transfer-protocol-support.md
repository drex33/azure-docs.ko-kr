...
이제 Azure Blob Storage 대한 SFTP 지원을 통해 단일 설정으로 Blob Storage 계정에 대해 SFTP 엔드포인트를 사용하도록 설정할 수 있습니다. 그런 다음 추가 작업을 수행할 필요 없이 데이터를 안전하게 전송하도록 인증을 위한 로컬 사용자 ID를 설정할 수 있습니다. 
