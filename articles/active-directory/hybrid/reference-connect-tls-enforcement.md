...
description: Azure AD Connect 서버에서 TLS(전송 계층 보안) 1.2만 사용하도록 강제 적용하는 방법을 알아봅니다.
...
### <a name="powershell-script-to-check-tls-12"></a>TLS 1.2를 확인하는 PowerShell 스크립트
다음 PowerShell 스크립트를 사용하여 Azure AD Connect 서버에서 현재 TLS 1.2 설정을 확인할 수 있습니다.
...
```
적절한 TLS1.2 구성을 보여 주는 출력 예:

![이미지](https://user-images.githubusercontent.com/38323403/138769930-2cdd290b-8f18-4f52-8a80-c12e5f8a56ba.png)

### <a name="powershell-script-to-enable-tls-12"></a>TLS 1.2를 사용하도록 설정하는 PowerShell 스크립트
다음 PowerShell 스크립트를 사용하여 Azure AD Connect 서버에서 TLS 1.2를 적용할 수 있습니다.
...
### <a name="powershell-script-to-disable-tls-12-not-recommended"></a>TLS 1.2를 사용하지 않도록 설정하는 PowerShell 스크립트(권장하지 않음)
