...
1. 백업 상태 이벤트 _또는 복원 상태 이벤트를_ 보려면 **메트릭을 선택합니다.**

   그러면 자격 증명 모음에 대한 상태 이벤트 수를 표시하는 차트가 렌더링됩니다. 화면 맨 위에 있는 필터를 사용하여 시간 범위 및 집계 세분성을 조정할 수 있습니다.
