...
4. 페이지의 오른쪽 위 모서리에서 **프로필** > **계정 설정** > **SSO(Single Sign On)** 를 클릭합니다.
    ...
    ![스크린샷은 SSO가 비활성화된 계정 설정 페이지를 보여줍니다.](./media/watch-by-colors-tutorial/config01.png)

5. **SSO(Single Sign On)** 페이지에서 다음 단계를 수행합니다.

    ![스크린샷은 SAML을 활성화할 수 있는 SAML 설정 탭을 보여줍니다.](./media/watch-by-colors-tutorial/config02.png)
...
1. 페이지의 오른쪽 위 모서리에서 **프로필** > **사용자** > **사용자 추가** 를 클릭합니다.
    ...
    ![스크린샷은 사용자 페이지를 보여줍니다.](./media/watch-by-colors-tutorial/config03.png)

1. **사용자 세부 정보** 페이지에서 다음 단계를 수행합니다.

    ![스크린샷은 설명된 값을 입력할 수 있는 사용자 세부 정보를 보여줍니다.](./media/watch-by-colors-tutorial/config04.png)
...
액세스 패널에서 Watch by Colors 타일을 클릭하면 SSO를 설정한 Watch by Colors에 자동으로 로그인됩니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510)를 참조하세요.
