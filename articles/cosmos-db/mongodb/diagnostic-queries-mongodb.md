---
title: Mongo API에 대한 고급 진단 쿼리 문제 해결
titleSuffix: Azure Cosmos DB
description: Azure Cosmos DB for MongoDB API에 저장된 데이터와 관련된 문제를 해결하기 위해 진단 로그를 쿼리하는 방법에 대해 알아봅니다.
services: cosmos-db
...
ms.locfileid: "122605197"
---
# <a name="troubleshoot-issues-with-advanced-diagnostics-queries-for-the-mongodb-api"></a>MongoDB API에 대한 고급 진단 쿼리 문제 해결
...
### <a name="requests-throttled-statuscode--429-or-16500-in-a-specific-time-window"></a>특정 시간 창에서 조절된 요청(statusCode = 429 또는 16500) 
...
### <a name="timed-out-requests-statuscode--50-in-a-specific-time-window"></a>특정 시간 창에서 시간 초과된 요청(statusCode = 50) 
...
### <a name="queries-with-large-response-lengths-payload-size-of-the-server-response"></a>응답 길이가 긴 쿼리(서버 응답의 페이로드 크기)
