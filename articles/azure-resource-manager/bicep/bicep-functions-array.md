---
title: Bicep 함수 - 배열
description: Bicep 파일에서 배열 작업에 사용하는 함수에 대해 설명합니다.
author: mumian
ms.topic: conceptual
ms.author: jgao
ms.date: 10/18/2021
...
다음 예제에서는 items 함수에서 반환되는 배열을 보여 있습니다.
...
* 값으로 구분되는 문자열 값의 배열을 가져오려면 [split](./bicep-functions-string.md#split)을 참조하세요.
