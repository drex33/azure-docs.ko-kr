...
* 게이트웨이 해제는 서버에 대한 연결에 영향을 미칠 수 있습니다. 권장되지 **않습니다.** 애플리케이션의 연결 문자열에서 형식으로 서버의 FQDN(정규화된 도메인 이름)을 사용해야 `<servername>.postgres.database.azure.com` 합니다. 
