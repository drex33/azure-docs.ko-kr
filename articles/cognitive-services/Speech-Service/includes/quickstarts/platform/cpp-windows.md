---
title: '빠른 시작: C++(Windows)용 Speech SDK 플랫폼 설정 - Speech Service'
titleSuffix: Azure Cognitive Services
description: 이 가이드를 통해 Speech Service SDK를 사용하여 Windows Desktop에서 C++용 플랫폼을 설정합니다.
