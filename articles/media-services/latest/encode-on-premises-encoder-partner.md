---
title: 온-프레미스 인코더 파트너 되기
description: 이 문서에서는 온-프레미스 라이브 스트리밍 인코더를 확인하는 방법을 설명합니다.
...
1. Media Services 계정에서 **스트리밍 엔드포인트** 가 실행 중인지 확인합니다. 
2. **라이브 인코딩** 라이브 이벤트를 만들고 시작합니다. <br/> 자세한 내용은 [라이브 이벤트 상태 및 청구](live-event-states-billing-concept.md)를 참조하세요.
...
[테스트된 온-프레미스 인코더](encode-recommended-on-premises-live-encoders.md)
