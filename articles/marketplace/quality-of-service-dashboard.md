...
ms.date: 08/28/2021
ms.openlocfilehash: cc95eed3c0a39f9d4a3a2133654b6558d8d28d92
ms.sourcegitcommit: 0770a7d91278043a83ccc597af25934854605e8b
ms.translationtype: MT
ms.contentlocale: ko-KR
ms.lasthandoff: 09/13/2021
ms.locfileid: "124838780"
---
...
파트너 센터의 서비스 품질 대시보드에 액세스 하려면 **상업적 Marketplace**  >  [](https://partner.microsoft.com/dashboard/commercial-marketplace/quality-of-service/summary)  >  **서비스 품질** 분석을 선택 합니다.
...
**월 범위**: 각 페이지의 오른쪽 위 모서리에 월 범위 선택이 있습니다. 지난 6 개월 또는 12 개월을 기준으로 월 범위를 선택 하거나 최대 기간이 12 개월 인 사용자 지정 월 범위를 선택 하 여 **서비스 품질** 페이지 그래프의 출력을 사용자 지정 합니다. 기본 월 범위 (선택 기간)는 6 개월입니다.
...
오류 코드에 대 한 자세한 내용은 [azure 서비스의 Azure Resource Manager 및 리소스 공급자](/azure/azure-resource-manager/management/azure-services-resource-providers) [를 사용한 일반적인 Azure 배포 오류 해결](/azure/azure-resource-manager/templates/common-deployment-errors) 을 참조 하세요.
...
이 그래프에는 선택한 월 범위의 성공한 배포 수에 대 한 열 지도가 표시 됩니다. 또한 각 지역에 대한 실패 백분율을 표시합니다. 녹색에서 빨간색으로의 색 배율은 낮음에서 높은 실패율 값을 나타냅니다. 테이블에서 레코드를 선택하여 배포 지역을 확대합니다.
...
- 빨간색 지역은 실패율이 높고 녹색은 낮은 것을 나타냅니다.
...
- 배포 날짜별로 정렬된 상위 1000개 배포의 번호가 매겨진 목록을 표시합니다.
- 그리드의 각 열을 정렬할 수 있습니다.
- 컨트롤을 확장하고 테이블을 내보냅니다.
- 세부 정보 보기의 페이지가 페이지가 났습니다. 맨 아래에서 다른 페이지를 선택합니다.
...
| 상관관계 ID | 상관관계 ID | 서로 다른 배포를 구분하는 데 사용되는 식별자입니다. 동일한 값은 배포되는 모든 리소스가 하나의 배포에 대한 것임을 의미합니다. |
|

## <a name="next-steps"></a>다음 단계

- 배포 오류에 대한 자세한 내용은 [Azure Resource Manager 일반적인 Azure 배포 오류 해결을](/azure/azure-resource-manager/templates/common-deployment-errors)참조하세요.
- 리소스 공급자에 대한 자세한 내용은 [Azure 서비스용 리소스 공급자를 참조하세요.](/azure/azure-resource-manager/management/azure-services-resource-providers)
- 제품에 대한 Marketplace 활동을 요약하는 집계 데이터의 그래프, 추세 및 값은 [상업용 Marketplace 분석의 요약 대시보드](/azure/marketplace/summary-dashboard)를 참조하세요.
- 그래픽 및 다운로드 가능 형식으로 주문 정보를 보려면 [상업용 마켓플레이스 분석의 주문 대시보드](/azure/marketplace/orders-dashboard)를 참조하세요.
- VM(가상 머신) 제품 사용량 및 요금제 청구 메트릭은 [상업용 마켓플레이스 분석의 사용량 대시보드](/azure/marketplace/usage-dashboard)를 참조하세요.
- 증가 추세를 비롯한 고객에 대한 자세한 내용은 [상업용 Marketplace 분석의 고객 대시보드](/azure/marketplace/customer-dashboard)를 참조하세요.
- 라이선스에 대 한 자세한 내용은 [상용 marketplace 분석의 라이선스 대시보드](/azure/marketplace/license-dashboard)를 참조 하세요.
- 최근 30일 동안의 다운로드 요청 목록은 [상업용 Marketplace 분석의 다운로드 대시보드](/azure/marketplace/downloads-dashboard)를 참조하세요.
- Microsoft AppSource 및 Azure Marketplace의 제품에 대 한 고객 의견의 통합 보기를 보려면 [상용 Marketplace 분석의 등급 및 리뷰 대시보드](/azure/marketplace/ratings-reviews)를 참조 하세요.
- 상용 marketplace 분석 및 데이터 용어의 포괄적인 사전에 대 한 Faq는 [상업적 marketplace 분석 일반적인 질문](/azure/marketplace/analytics-faq)을 참조 하세요.
