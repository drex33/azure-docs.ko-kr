...
3. **CreateIoTHub** 메서드에 다음 코드를 추가합니다. 이 코드는 JSON 표현을 만들고 생성하는 IoT Hub를 설명합니다. IoT Hub를 지원하는 현재 위치 목록은 [Azure 상태](https://azure.microsoft.com/status/)를 참조하세요.
...
> [!NOTE]
> 이 예제 애플리케이션은 대금이 청구되는 S1 표준 IoT Hub를 추가합니다. 작업이 완료되면 [Azure Portal](https://portal.azure.com/)을 통하거나 **Remove-AzResource** PowerShell cmdlet을 사용하여 IoT Hub를 삭제할 수 있습니다.
