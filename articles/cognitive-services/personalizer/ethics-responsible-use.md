...
* 맞춤 설정을 적용할 사용 사례 선택
* [보상 함수](concept-rewards.md) 작성
* 컨텍스트 및 맞춤 설정에 사용할 가능한 작업과 관련된 [기능](concepts-features.md) 선택
...
부정적 부작용 또는 투명성 부족에 대한 잠재력이 높은 Personalizer 사용의 예로, 지나치게 간소화된 즉각적인 보상으로 인해 개인에게 불리한 결과를 초래할 수 있는 많은 장기적 복합 요인에 따라 "보상"이 달라지는 시나리오가 있습니다. 이러한 시나리오는 "결과적" 선택 또는 손해의 위험을 수반하는 선택으로 간주되는 경향이 있습니다. 예를 들면 다음과 같습니다.


* **금융**: 개인이 모르거나, 얻을 수 없거나, 이의를 제기할 수 없는 데이터를 기반으로 하는 위험 요인이 있는 대출, 금융 및 보험 제품에 맞춤 설정이 제공됩니다.
...
* **타사 보상 평가**: 사용자 자신의 동작으로 보상을 생성하는 대신 사용자에 대한 후자의 제3자 평가를 기반으로 하는 보상인 항목을 맞춤 설정합니다.
* **탐색에 대한 과민성**: Personalizer의 탐색 동작으로 인해 손해가 발생할 수 있습니다.
...
* 사용 사례가 [GDPR](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32016R0679) 제22조 또는 기타 법률에 따라 규제되는 데이터 주제에 큰 영향을 미치는 자동화된 처리를 구성하는지 여부를 고려합니다.
* 자기 충족 예언 루프를 고려합니다. 이는 맞춤 설정 보상에서 모델을 학습시키고 이후에 인구 통계 그룹이 관련 콘텐츠에 액세스하지 못하도록 추가로 배제할 수 있는 경우에 발생할 수 있습니다. 예를 들어 저소득층 지역에 있는 대부분의 사람들은 프리미엄 보험 상품의 혜택을 받지 못하고 있으며, 충분히 탐색하지 않을 경우 이웃에 있는 어느 누구도 해당 상품의 혜택을 전혀 받지 못하는 경향이 있습니다.
...
* 자문: 이 정보를 사용하여 콘텐츠를 맞춤 설정하면 사용자가 관심을 갖고 기뻐할까요? 특정 항목을 강조 표시하거나 숨기도록 결정한 방법을 보여 주는 것이 편할까요?
