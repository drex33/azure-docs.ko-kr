...
>9월 게스트 OS는 현재 자동 업데이트에 대해 구성된 클라우드 서비스 VM에 롤아웃되고 있습니다. 롤아웃이 완료되면 이 버전은 Azure Portal 및 구성 파일을 통해 수동으로 업데이트할 수 있습니다. 다음 패치는 9월 게스트 OS에 포함되어 있습니다. 이 목록은 변경될 수 있습니다. 
