...
* Azure Pipelines와 함께 Bicep를 사용 하는 방법에 대 한 자세한 내용 및 실습 지침은 [Bicep를 사용 하 여 Azure 리소스 배포 및 Azure Pipelines](/learn/paths/bicep-azure-pipelines/) 에서 **Microsoft Learn** 을 참조 하세요.
