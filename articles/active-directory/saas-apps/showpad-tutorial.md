...
* 사용자가 자신의 Azure AD 계정으로 Showpad에 자동으로 로그온(Single Sign-On)되도록 설정할 수 있습니다.
...
* Showpad에서 **SP** 시작 SSO를 지원합니다.
* Showpad는 **Just In Time** 사용자 프로비저닝을 지원합니다.
...
2. **[Showpad Single Sign-On 구성](#configure-showpad-single-sign-on)** - 애플리케이션 쪽에서 Single Sign-On 설정을 구성합니다.
3. **[Azure AD 테스트 사용자 만들기](#create-an-azure-ad-test-user)** - Britta Simon으로 Azure AD Single Sign-On을 테스트하는 데 사용합니다.
4. **[Azure AD 테스트 사용자 할당](#assign-the-azure-ad-test-user)** - Britta Simon이 Azure AD Single Sign-on을 사용할 수 있도록 합니다.
5. **[Showpad 테스트 사용자 만들기](#create-showpad-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 Showpad에 만듭니다.
...
4. **기본 SAML 구성** 섹션에서 다음 단계를 수행합니다.
    ...
    ![Showpad 도메인 및 URL Single Sign-On 정보](common/sp-identifier.png)

    a. **로그온 URL** 텍스트 상자에서 `https://<comapany-name>.showpad.biz/login` 패턴을 사용하는 URL을 입력합니다.

    b. **식별자(엔터티 ID)** 텍스트 상자에서 `https://<company-name>.showpad.biz` 패턴을 사용하는 URL을 입력합니다.
...
6. **Showpad 설정** 섹션에서 요구 사항에 해당하는 적절한 URL을 복사합니다.
...
### <a name="configure-showpad-single-sign-on"></a>Showpad Single Sign-On 구성
...
### <a name="create-showpad-test-user"></a>Showpad 테스트 사용자 만들기

이 섹션에서는 Showpad에서 Britta Simon이라는 사용자를 만듭니다. Showpad는 기본적으로 사용하도록 설정되는 Just-In-Time 사용자 프로비저닝을 지원합니다. 이 섹션에 작업 항목이 없습니다. Showpad에 사용자가 아직 없는 경우 인증 후에 새 사용자가 만들어집니다.

### <a name="test-single-sign-on"></a>Single Sign-On 테스트 

이 섹션에서는 액세스 패널을 사용하여 Azure AD Single Sign-On 구성을 테스트합니다.

액세스 패널에서 Showpad 타일을 클릭하면, SSO를 설정한 Showpad에 자동으로 로그인됩니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510)를 참조하세요.
