...
ms.author: mahender
ms.custom: seodec18
ms.openlocfilehash: d688e043618c023b4a4f2f00f5263ac60b1d469f
ms.sourcegitcommit: 1e9139680ca51f55ac965c4dd6dd82bf2fd43675
ms.translationtype: MT
ms.contentlocale: ko-KR
ms.lasthandoff: 12/04/2021
ms.locfileid: "133543909"
---
...
참조에 버전을 지정 하지 않으면 앱은 주요 자격 증명 모음에 있는 최신 버전을 사용 합니다. 순환 이벤트와 같이 최신 버전을 사용할 수 있게 되 면 앱은 자동으로 업데이트 되 고 24 시간 이내에 최신 버전을 사용 합니다. 지연 시간은 App Service 키 자격 증명 모음 참조의 값을 캐시 하 고 24 시간 간격으로 refetches 때문입니다. 사이트 다시 시작이 발생 하는 앱의 모든 구성 변경으로 인해 참조 된 모든 암호가 즉시 다시 페치 됩니다.
