...
1. 왼쪽 창의 메뉴에서 **IoT Edge** 를 선택한 다음 **IoT Edge 디바이스 추가** 를 선택합니다.
   ...
   ![Azure Portal에서 IoT Edge 디바이스 추가](./media/how-to-provision-single-device-linux-symmetric/portal-add-iot-edge-device.png)
...
1. 탐색기의 맨 아래에서 **Azure IoT Hub** 섹션을 확장합니다.
   ...
   ![Azure IoT Hub 디바이스 확장 섹션](./media/how-to-provision-single-device-linux-symmetric/azure-iot-hub-devices.png)
...
![Azure Portal에서 IoT 허브 내 모든 IoT Edge 디바이스를 확인할 수 있습니다.](./media/how-to-provision-single-device-linux-symmetric/portal-view-devices.png)
...
![VS Code를 사용하여 IoT 허브 내 모든 IoT Edge 디바이스 보기](./media/how-to-provision-single-device-linux-symmetric/view-devices.png)
