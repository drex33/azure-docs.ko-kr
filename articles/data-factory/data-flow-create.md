...
:::image type="content" source="media/data-flow/v2portal.png" alt-text="버전으로 V2가 선택된 새 데이터 팩터리 창을 보여 주는 스크린샷":::
...
:::image type="content" source="media/data-flow/template.png" alt-text="데이터 흐름을 사용하여 데이터 변환이 선택된 데이터 흐름 탭을 보여 주는 스크린샷":::

Azure Blob Storage 계정 정보를 입력하라는 메시지가 표시됩니다.

:::image type="content" source="media/data-flow/template2.png" alt-text="사용자 입력을 입력할 수 있는 데이터 흐름을 사용하여 데이터 변환 창을 보여 주는 스크린샷":::
...
:::image type="content" source="media/data-flow/newresource.png" alt-text="팩터리 리소스 메뉴에서 선택한 데이터 흐름을 보여 주는 스크린샷":::
