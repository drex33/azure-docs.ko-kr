...
리소스 공급자 및 유형: [Microsoft.KeyVault/vaults](/azure-monitor/essentials/metrics-supported#microsoftkeyvaultvaults)
...
참조는 [Microsoft.KeyVault/vaults 목록을 참조하세요.](/azure-monitor/essentials/resource-logs-categories#microsoftkeyvaultvaults)  자세한 내용은 [로깅 Azure Key Vault 참조하세요.](logging.md)
...
Key Vault [Azure Diagnostics,](/azure-monitor/reference/tables/azurediagnostics) [Azure 활동](/azure-monitor/reference/tables/azureactivity) 테이블 및 Azure Metrics 테이블을 사용하여 리소스 로그 정보를 [저장합니다.](/azure-monitor/reference/tables/azuremetrics) 다음 열이 관련됩니다.
