...
- 작업 영역에 배포 하려는 사용자 지정 콘텐츠 파일을 포함 하는 GitHub 또는 Azure DevOps 리포지토리에 대 한 액세스는 [ARM (관련 Azure Resource Manager) 템플릿에](../azure-resource-manager/templates/index.yml)액세스 합니다.
