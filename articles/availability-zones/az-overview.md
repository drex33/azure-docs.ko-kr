...
> [!NOTE]
> 표준 SKU 공용 IP 주소 및 공용 IP 주소 접두사 리소스 종류 모두에는 “영역 없음” 옵션도 있습니다.  이를 통해 고객은 표준 SKU 공용 IP를 활용하고 표준 SKU만 허용하는 리소스에 연결할 수 있지만, 중복성 보장은 제공되지 않습니다.  (기본에서 표준 SKU로 [업그레이드된](../virtual-network/public-ip-upgrade-portal.md) 모든 공용 IP 주소는 “영역 없음” 유형이 됩니다.)
