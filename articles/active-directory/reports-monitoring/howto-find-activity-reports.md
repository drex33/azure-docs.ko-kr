---
title: Azure Portal에서 사용자 작업 보고서 찾기 | Microsoft Docs
...
ms.openlocfilehash: b097686e9b3d9f2e79ba7686105c178cb2601449
ms.sourcegitcommit: 27ddccfa351f574431fb4775e5cd486eb21080e0
ms.translationtype: HT
ms.contentlocale: ko-KR
ms.lasthandoff: 11/08/2021
ms.locfileid: "131995866"
---
...
감사 보고서의 고급 필터링을 사용하여 **범주** 필터에서 지정하면 특정 범주의 감사 데이터에 액세스할 수 있습니다. 예를 들어 사용자와 관련된 모든 작업을 보려면 **UserManagement** 범주를 선택합니다. 
...
**서비스** 드롭다운 필터를 사용하여 특정 서비스에 대해 필터링할 수도 있습니다. 예를 들어 셀프 서비스 암호 관리와 관련된 모든 감사 이벤트를 가져오려면 **셀프 서비스 암호 관리** 필터를 선택합니다.
...
비정상 작업 보고서는 Azure AD가 검색하고 보고할 수 있는 보안 관련 위험 검색에 대한 정보를 제공합니다.

다음 표에는 Azure Portal의 Azure AD 비정상 작업 보안 보고서 및 해당하는 위험 검색 형식이 나열되어 있습니다. 자세한 내용은 [Azure Active Directory 위험 탐지](../identity-protection/overview-identity-protection.md)를 참조하세요.  


| Azure AD 비정상 작업 보고서 |  ID 보호 위험 검색 형식|
| :--- | :--- |
...
다음 Azure AD 비정상 작업 보안 보고서는 Azure Portal에서 위험 검색으로 포함되지 않습니다.

* 여러 번의 실패 후 로그인
* 여러 지역에서의 로그인


### <a name="detected-risk-detections"></a>검색된 위험 검색

[Azure Portal](https://portal.azure.com)의 **Azure Active Directory** 블레이드 **보안** 섹션에서 검색된 위험 검색에 대한 보고서에 액세스할 수 있습니다. 검색된 위험 검색은 다음과 같은 보고서에서 추적됩니다.   
...
Azure Portal에서 활동 로그를 다운로드할 경우, 크기는 최근 레코드 순으로 정렬된 250000개로 제한됩니다. 
...
최근에 Azure Portal에 로그인했고 `Activity logs > Sign-ins` 블레이드에 이 작업에 대한 로그인 로그가 표시될 것으로 예상했지만 찾을 수 없습니다.
 ...
 ![Azure Active Directory에 대한 로그인을 보여 주는 스크린샷.](./media/troubleshoot-missing-audit-data/02.png)
