...
1. Marketplace 제품 페이지에서 **+ 새로 만들기 제품**  >  **Azure Virtual Machine** 을 선택 합니다.

    [![왼쪽 창 메뉴 옵션 및 "새 제안" 단추 ](./media/create-vm/new-offer-azure-virtual-machine-workspaces.png) 를 보여 주는 스크린샷 ](./media/create-vm/new-offer-azure-virtual-machine-workspaces.png#lightbox)
...
시험 사용을 사용하도록 설정하려면 **시험 사용 지원** 확인란을 선택합니다. 나중에 시험 사용을 구성합니다. 시험 사용을 통해 CRM을 구성해야 합니다(다음 섹션 참조). 제품에서 시험 사용을 제거하려면 이 확인란을 선택 취소합니다.
...
- [가상 머신 제품 속성 구성](azure-vm-create-properties.md)
