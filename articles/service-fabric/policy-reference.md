...
ms.openlocfilehash: 115160133918afce6b1be4782a0336e6ecaa36f1
ms.sourcegitcommit: 54e7b2e036f4732276adcace73e6261b02f96343
ms.translationtype: MT
ms.contentlocale: ko-KR
ms.lasthandoff: 10/12/2021
ms.locfileid: "129808460"
---
# <a name="azure-policy-built-in-definitions-for-azure-service-fabric"></a>Azure Service Fabric에 대한 Azure Policy 기본 제공 정의

이 페이지는 Azure Service Fabric에 대한 [Azure Policy](../governance/policy/overview.md) 기본 제공 정책 정의의 인덱스입니다. 다른 서비스에 대한 추가 Azure Policy 기본 제공 기능은 [Azure Policy 기본 제공 정의](../governance/policy/samples/built-in-policies.md)를 참조하세요.
