---
title: '자습서: Canvas와 Azure AD SSO 통합'
...
ms.date: 09/09/2021
ms.author: jeedes
ms.openlocfilehash: bfd75937c84f11f2829920850c3148d92cccd05d
ms.sourcegitcommit: 677e8acc9a2e8b842e4aef4472599f9264e989e7
ms.translationtype: HT
ms.contentlocale: ko-KR
ms.lasthandoff: 11/11/2021
ms.locfileid: "132296540"
---
# <a name="tutorial-azure-ad-sso-integration-with-canvas"></a>자습서: Canvas와 Azure AD SSO 통합
...
4. **기본 SAML 구성** 섹션에서 다음 단계를 수행합니다.
    ...
    b. **로그온 URL** 텍스트 상자에서 `https://<tenant-name>.instructure.com` 패턴을 사용하는 URL을 입력합니다.

    a. **식별자(엔터티 ID)** 텍스트 상자에서 `https://<tenant-name>.instructure.com/saml2` 패턴을 사용하는 URL을 입력합니다.

    > [!NOTE]
    > 이러한 값은 실제 값이 아닙니다. 해당 값을 실제 식별자 및 로그온 URL로 업데이트합니다. 이러한 값을 얻으려면 [Canvas 클라이언트 지원팀](https://community.canvaslms.com/community/help)에 문의하세요. Azure Portal의 **기본 SAML 구성** 섹션에 표시된 패턴을 참조할 수도 있습니다.
...
2. **코스 \> 관리된 계정 \> Microsoft** 로 이동합니다.
    ...
    ![캔버스](./media/canvas-lms-tutorial/course.png "캔버스")

3. 왼쪽 탐색 창에서 **인증** 을 선택한 다음 **새 SAML Config 추가** 를 클릭합니다.

    ![인증](./media/canvas-lms-tutorial/tools.png "인증")
...
3. **사용자** 를 클릭합니다.
   ...
   ![스크린샷은 사용자가 선택된 캔버스 메뉴를 보여줍니다.](./media/canvas-lms-tutorial/user.png "사용자")

4. **새 사용자 추가** 를 클릭합니다.

   ![스크린샷은 새 사용자 추가 단추를 보여줍니다.](./media/canvas-lms-tutorial/add-user.png "사용자")

5. 새 사용자 추가 대화 상자 페이지에서 다음 단계를 수행합니다.

   ![사용자 추가](./media/canvas-lms-tutorial/name.png "사용자 추가")
...
* Microsoft 내 앱을 사용할 수 있습니다. 내 앱에서 Canvas 타일을 클릭하면 SSO를 설정한 Canvas에 자동으로 로그인됩니다. 내 앱에 대한 자세한 내용은 [내 앱 소개](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510)를 참조하세요.

## <a name="next-steps"></a>다음 단계

Canvas가 구성되면 세션 제어를 적용하여 조직의 중요한 데이터의 반출 및 반입을 실시간으로 보호할 수 있습니다. 세션 제어는 조건부 액세스에서 확장됩니다. [Microsoft Defender for Cloud Apps를 사용하여 세션 제어를 적용하는 방법을 알아봅니다](/cloud-app-security/proxy-deployment-any-app).
