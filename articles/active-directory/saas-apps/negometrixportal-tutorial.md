---
title: '자습서: NegometrixPortal SSO(Single Sign On)와 Azure Active Directory SSO(Single Sign On) 통합 | Microsoft Docs'
...
ms.locfileid: "124741551"
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-negometrixportal-single-sign-on-sso"></a>자습서: NegometrixPortal SSO(Single Sign On)와 Azure Active Directory SSO(Single Sign On) 통합
...
* NegometrixPortal SSO(Single Sign On)의 **SP** 시작 SSO 지원

> [!NOTE]
> 이 애플리케이션의 식별자는 고정 문자열 값이므로 하나의 테넌트에서 하나의 인스턴스만 구성할 수 있습니다.

## <a name="adding-negometrixportal-single-sign-on-sso-from-the-gallery"></a>갤러리에서 NegometrixPortal SSO(Single Sign On) 추가
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-negometrixportal-single-sign-on-sso"></a>NegometrixPortal SSO(Single Sign-on)을 위한 Azure AD Single Sign-On 구성 및 테스트
...
NegometrixPortal SSO(Single Sign-on)로 Azure AD Single Sign-On을 구성하고 테스트하려면 다음 구성 요소를 완료해야 합니다.
...
1. **[NegometrixPortal SSO(Single Sign On) 구성](#configure-negometrixportal-single-sign-on-sso-sso)** - 애플리케이션 쪽에서 Single Sign-On 설정을 구성합니다.
    * **[NegometrixPortal SSO(Single Sign On) 테스트 사용자 만들기](#create-negometrixportal-single-sign-on-sso-test-user)** - 사용자의 Azure AD 표현과 연결된 B. Simon에 해당하는 사용자를 NegometrixPortal SSO(Single Sign On)에 만듭니다.
...
1. [Azure Portal](https://portal.azure.com/)의 **NegometrixPortal SSO(Single Sign On)** 애플리케이션 통합 페이지에서 **관리** 섹션을 찾고 **Single Sign-On** 을 선택합니다.
...
액세스 패널에서 NegometrixPortal SSO(Single Sign On) 타일을 클릭하면 SSO를 설정한 NegometrixPortal SSO(Single Sign On)에 자동으로 로그인됩니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510)를 참조하세요.
...
- [Azure AD에서 NegometrixPortal SSO(Single Sign On) 시험 사용](https://aad.portal.azure.com/)