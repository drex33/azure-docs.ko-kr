...
1. **그룹** 을 선택한 다음, **명명 정책** 을 선택하여 명명 정책 페이지를 엽니다.
    ...
    ![관리 센터에서 명명 정책 페이지 열기](./media/groups-quickstart-naming-policy/policy.png)
...
1. **명명 정책** 페이지에서 **차단된 단어** 를 선택합니다.
    ...
    ![명명 정책에서 차단된 단어 목록 편집 및 업로드](./media/groups-quickstart-naming-policy/blockedwords.png)
...
명명 정책에 대한 PowerShell cmdlet, 기술 제약 조건, 사용자 지정 차단 단어의 목록 추가 및 Microsoft 365 앱의 최종 사용자 환경에 대해 자세히 알아보는 다음 문서를 진행하세요.
