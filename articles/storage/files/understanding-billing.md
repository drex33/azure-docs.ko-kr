...
|-|-|-|-|-|-|
| 100 | 500 | 최대 4,000 | 12,600,000 | 44 | 66 |
| 500 | 900 | 최대 4,000 | 11,160,000 | 60 | 90 |
| 1,024 | 1,424 | 최대 4,000 | 10,713,600 | 81 | 122 |
| 5,120 | 5,520 | 최대 15,360 | 35,424,000 | 245 | 368 |
| 10,240 | 10,640 | 최대 30,720 | 72,288,000 | 450 | 675 |
| 33,792 | 34,192 | 최대 100,000 | 236,908,800 | 1,392 | 2,088 |
| 51,200 | 51,600 | 최대 100,000 | 174,240,000 | 2,088 | 3,132 |
...
### <a name="logical-size-versus-physical-size"></a>논리적 크기 대 물리적 크기
Azure Files 대한 데이터 휴지 용량 요금은 파일의 "크기" 또는 "콘텐츠 길이"라고도 하는 논리적 크기에 따라 청구됩니다. 파일의 논리적 크기는 디스크에 있는 파일의 실제 크기와 구별되며, "디스크의 크기" 또는 "사용된 크기"라고도 합니다. 파일의 실제 크기는 파일의 논리적 크기보다 크거나 작을 수 있습니다.
...
#### <a name="cloud-enumeration-scans-cost"></a>클라우드 열거형 검사 비용
