...
다음 예제 구성에서는 컨테이너를 설치할 때 사용할 수 있는 옵션을 보여 줍니다.
...
단일 컨테이너 앱에서 여러 컨테이너를 정의할 수 있습니다. 컨테이너 그룹을 [Pod라고 합니다.](https://kubernetes.io/docs/concepts/workloads/pods) Pod의 컨테이너는 하드 디스크와 네트워크 리소스를 공유하고 동일한 애플리케이션 수명 주기 를 [경험합니다.](application-lifecycle-management.md)
