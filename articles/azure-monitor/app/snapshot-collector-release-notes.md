...
- [ArgumentException 수정: 대리자는 동일한 형식이어야 합니다.](https://github.com/microsoft/ApplicationInsights-SnapshotCollector/issues/16)
...
- CompatibilityVersion을 추가하여 호환성이 Snapshot Collector 에이전트와 업로더 간의 동기화를 개선합니다.
...
- SnapshotCollector에 Azure Active Directory 인증을 추가합니다. 여기에서 Application Insights Azure AD 인증에 [](./azure-ad-authentication.md)대해 자세히 알아보세요.
