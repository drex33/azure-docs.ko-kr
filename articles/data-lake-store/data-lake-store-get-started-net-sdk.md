---
title: .NET을 통해 Azure Data Lake Storage Gen1 계정 관리
description: Azure Data Lake Storage Gen1 계정 관리 작업에 .NET SDK를 사용하는 방법을 알아봅니다.
author: normesta
...
2. **콘솔 앱(.NET Framework)** , **다음** 을 차례로 선택합니다.
