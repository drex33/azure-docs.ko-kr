...
이 섹션에서는 로컬 환경을 구성하고, Azure IoT C# 샘플을 설치하고, 시뮬레이션된 온도 컨트롤러를 만드는 샘플을 실행합니다.
...
1. 콘솔에서 코드 샘플을 실행합니다. 샘플은 자동 온도 조절기 센서가 있는 시뮬레이션된 온도 컨트롤러를 만듭니다.
