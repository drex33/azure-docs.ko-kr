...
* 사용자가 해당 Azure AD 계정으로 Bersin에 자동으로 로그인(Single Sign-On)되도록 설정할 수 있습니다.
...
* Bersin에서 **SP 및 IDP** 시작 SSO를 지원합니다.
...
4. 검색 상자에 **Bersin** 을 입력하고 결과 패널에서 **Bersin** 을 선택한 후 **추가** 단추를 클릭하여 애플리케이션을 추가합니다.

    ![결과 목록의 Bersin](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성 및 테스트

이 섹션에서는 **Britta Simon** 이라는 테스트 사용자를 기반으로 Bersin에서 Azure AD Single Sign-On을 구성하고 테스트합니다. Single Sign-On이 작동하려면 Azure AD 사용자와 Bersin의 관련 사용자 간에 연결 관계를 설정해야 합니다.

Bersin에서 Azure AD Single Sign-On을 구성하고 테스트하려면 다음 구성 요소를 완료해야 합니다.

1. **[Azure AD Single Sign-On 구성](#configure-azure-ad-single-sign-on)** - 사용자가 이 기능을 사용할 수 있도록 합니다.
2. **[Bersin Single Sign-On 구성](#configure-bersin-single-sign-on)** - 애플리케이션 쪽에서 Single Sign-On 설정을 구성합니다.
3. **[Azure AD 테스트 사용자 만들기](#create-an-azure-ad-test-user)** - Britta Simon으로 Azure AD Single Sign-On을 테스트하는 데 사용합니다.
4. **[Azure AD 테스트 사용자 할당](#assign-the-azure-ad-test-user)** - Britta Simon이 Azure AD Single Sign-on을 사용할 수 있도록 합니다.
5. **[Bersin 테스트 사용자 만들기](#create-bersin-test-user)** - Britta Simon의 Azure AD 표현과 연결된 대응 사용자를 Bersin에 만듭니다.
...
1. [Azure Portal](https://portal.azure.com/)의 **Bersin** 애플리케이션 통합 페이지에서 **Single Sign-On** 을 선택합니다.
...
4. **IDP** 시작 모드에서 애플리케이션을 구성하려면 **기본 SAML 구성** 섹션에서 다음 단계를 수행합니다.
    ...
    ![스크린샷은 식별자, 회신 URL을 입력하고 저장을 선택할 수 있는 기본 SAML 구성을 보여줍니다.](common/idp-identifier-relay.png)

    a. **식별자** 텍스트 상자에서 `https://www.bersin.com/shibboleth` 패턴을 사용하여 URL을 입력합니다.

    b. **추가 URL 설정** 을 클릭합니다.

    다. **릴레이 상태** 텍스트 상자에서 `https://www.bersin.com/secure/` 패턴을 사용하는 URL을 입력합니다.

5. **SP** 시작 모드에서 애플리케이션을 구성하려면 **추가 URL 설정** 을 클릭하고 다음 단계를 수행합니다.

    ![스크린샷은 로그온 URL을 입력할 수 있는 추가 URL 설정을 보여줍니다.](common/metadata-upload-additional-signon.png)

    **로그인 URL** 텍스트 상자에서 `https://www.bersin.com/Login.aspx` 패턴을 사용하여 URL을 입력합니다.

6. **SAML로 Single Sign-On 설정** 페이지의 **SAML 서명 인증서** 섹션에서 **다운로드** 를 클릭하여 요구 사항에 따라 제공된 옵션에서 **페더레이션 메타데이터 XML** 을 다운로드하고 컴퓨터에 저장합니다.

    ![인증서 다운로드 링크](common/metadataxml.png)

7. **Bersin 설정** 섹션에서 요구 사항에 따라 적절한 URL을 복사합니다.
...
1. Azure Portal에서 **엔터프라이즈 애플리케이션**, **모든 애플리케이션**, **Bersin** 을 차례로 선택합니다.

    ![엔터프라이즈 애플리케이션 블레이드](common/enterprise-applications.png)

2. 애플리케이션 목록에서 **Bersin** 을 선택합니다.

    ![애플리케이션 목록의 Bersin 링크](common/all-applications.png)
...
### <a name="create-bersin-test-user"></a>Bersin 테스트 사용자 만들기
...
액세스 패널에서 Bersin 타일을 클릭하면 SSO를 설정한 Bersin에 자동으로 로그인됩니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510)를 참조하세요.
