...
description: Azure Data Factory 또는 Synapse Analytics Azure HDInsight 클러스터에서 Hadoop MapReduce 프로그램을 실행하여 데이터를 처리하는 방법을 알아봅니다.
...
ms.locfileid: "131005708"
---
# <a name="transform-data-using-hadoop-mapreduce-activity-in-azure-data-factory-or-synapse-analytics"></a>Azure Data Factory 또는 Synapse Analytics Hadoop MapReduce 활동을 사용하여 데이터 변환
...
Azure Data Factory 또는 Synapse Analytics [파이프라인의](concepts-pipelines-activities.md) HDInsight MapReduce 작업은 [사용자](compute-linked-services.md#azure-hdinsight-linked-service) 고유 또는 주문형 HDInsight [클러스터에서](compute-linked-services.md#azure-hdinsight-on-demand-linked-service) MapReduce 프로그램을 호출합니다. 이 문서는 데이터 변환 및 지원되는 변환 활동의 일반적인 개요를 표시하는 [데이터 변환 활동](transform-data.md) 문서에서 작성합니다.

자세한 내용은 [Azure Data Factory](introduction.md) 및 [Synapse Analytics](../synapse-analytics/overview-what-is.md)대한 소개 문서를 읽고 [자습서:](tutorial-transform-data-spark-powershell.md) 이 문서를 읽기 전에 데이터 변환 자습서를 수행합니다.
