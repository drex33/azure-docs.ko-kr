---
title: CLI 스크립트 - Azure Database for MySQL - 유연한 서버(미리 보기)에서 감사 로그 구성
...
ms.locfileid: "128604705"
---
# <a name="configure-audit-logs-on-an-azure-database-for-mysql---flexible-server-preview-using-azure-cli"></a>Azure CLI를 사용하여 Azure Database for MySQL - 유연한 서버(미리 보기)에서 감사 로그 구성
