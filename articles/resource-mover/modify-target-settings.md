...
**공용 IP 주소 이름, SKU, 영역** | 표준 공용 IP 주소에 대한 이름, [SKU](../virtual-network/ip-services/public-ip-addresses.md#sku), [영역](../virtual-network/ip-services/public-ip-addresses.md#standard)을 지정합니다.<br/><br/> 영역 중복으로 지정하려면 **영역 중복** 으로 입력합니다.
