---
title: 'Two-Class 평균 퍼셉트론: 구성 요소 참조'
titleSuffix: Azure Machine Learning
description: 디자이너에서 Two-Class 평균 퍼셉트론 구성 요소를 사용 하 여 이진 분류자를 만드는 방법에 대해 알아봅니다.
...
ms.locfileid: "131570149"
---
# <a name="two-class-averaged-perceptron-component"></a>Two-Class 평균 퍼셉트론 구성 요소

이 문서에서는 Azure Machine Learning 디자이너의 구성 요소에 대해 설명 합니다.

이 구성 요소를 사용 하 여 평균 퍼셉트론 알고리즘을 기반으로 기계 학습 모델을 만듭니다.  
...
1.  **2 클래스 평균 퍼셉트론** 구성 요소를 파이프라인에 추가 합니다.  
