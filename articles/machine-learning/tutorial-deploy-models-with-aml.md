...
Notebook을 실행하려면 먼저 [자습서(1부): 이미지 분류 모델 학습](tutorial-train-models-with-aml.md)에서 모델 학습을 완료합니다.   그런 다음, 복제된 *tutorials/image-classification-mnist-data* 폴더에서 *img-classification-part2-deploy.ipynb* Notebook을 엽니다.
