...
## <a name="assign-an-identity-to-your-linux-vm"></a>Linux VM에 ID 할당
...
## <a name="grant-access-to-a-resource-group-in-azure-resource-manager"></a>Azure Resource Manager의 리소스 그룹에 대한 액세스 권한 부여
