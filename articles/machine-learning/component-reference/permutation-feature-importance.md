---
title: '순열 기능 중요도: 구성 요소 참조'
titleSuffix: Azure Machine Learning
description: 디자이너에서 순열 기능 중요도 구성 요소를 사용 하 여 기능 변수의 순열 기능 중요도 점수를 계산 하는 방법에 대해 알아봅니다.
...
ms.locfileid: "131570498"
---
# <a name="permutation-feature-importance"></a>순열 기능 중요도

이 문서에서는 Azure Machine Learning designer에서 순열 기능 중요도 구성 요소를 사용 하 여 데이터 집합에 대 한 기능 중요도 점수 집합을 계산 하는 방법을 설명 합니다. 이러한 점수를 사용하여 모델에 사용할 최상의 기능을 결정할 수 있습니다.

이 구성 요소에서 기능 값은 한 번에 한 열에 임의로 섞은 됩니다. 모델의 성능은 이전 및 이후에 여러 번 측정됩니다. 표준 메트릭 중 하나를 선택하여 성능을 측정할 수 있습니다.

구성 요소가 반환 하는 점수는 순열의 후 학습 된 모델의 성능 *변화* 를 나타냅니다. 중요한 기능은 일반적으로 순서 섞기 프로세스보다 더 중요하므로 중요도 점수가 높아집니다. 
...
1.  파이프라인에 순열 기능 중요도 구성 요소를 추가 합니다. **기능 선택** 범주에서이 구성 요소를 찾을 수 있습니다. 
...
7.  구성 요소는 기능 열 목록과 이와 관련 된 점수를 출력 합니다. 목록은 점수의 내림차순으로 순위가 매겨집니다.  
...
구성 요소가 제공 하는 순위는 [필터 기반 기능 선택](filter-based-feature-selection.md)에서 가져온 순위와 다릅니다. 필터 기반 기능 선택은 모델을 *생성하기 전에* 점수를 계산합니다. 
