...
[요청 단위(RU/s 또는 RU)](request-units.md)를 기준으로 컨테이너 수준 또는 데이터베이스 수준에서 처리량을 프로비저닝할 수 있습니다. 다음 표에는 컨테이너/데이터베이스당 스토리지 및 처리량 제한이 나열되어 있습니다. Storage 데이터 및 인덱스 스토리지의 결합된 양을 나타냅니다.
...
| 리소스 | 기본 제한 |
| --- | --- |
| 구독당 최대 데이터베이스 계정 수 | 기본값은 50입니다. 최대 1,000개의 [Azure 지원 티켓을 제출하여](create-support-request-quota-increase.md) 늘릴 수 있습니다.|
