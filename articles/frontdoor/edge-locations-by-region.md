...
이 문서에서는 지역별로 정렬된 Azure Front Door용 에지 위치가 포함된 현재 도시를 나열합니다. 각 도시마다 에지 위치가 두 개 이상 포함될 수 있습니다. 현재 Azure Front Door 100개 도시 간에 118개의 에지 위치가 있습니다.
