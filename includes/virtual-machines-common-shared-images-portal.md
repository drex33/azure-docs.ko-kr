...
이미지 정의 이름은 대문자 또는 소문자, 숫자, 점, 대시 및 마침표로 구성될 수 있습니다. 이미지 정의에 대해 지정할 수 있는 값에 대한 자세한 내용은 [이미지 정의](../articles/virtual-machines/shared-image-galleries.md#image-definitions)를 참조하세요.

갤러리 내에서 갤러리 이미지 정의를 만듭니다. 
...
포털에서 기존 VM을 이미지로 캡처할 수도 있습니다. 자세한 내용은 [포털에서 VM 이미지 만들기](../articles/virtual-machines/capture-image-portal.md)를 참조하세요.
