---
title: PowerShell 샘플 - 사용자 지정 도메인을 사용하는 Azure Active Directory 애플리케이션 프록시 앱
...
이 PowerShell 스크립트 예제는 사용자 지정 도메인 및 사용자 지정 도메인과 연관된 인증서 정보를 사용 중인 모든 Azure AD(Azure Active Directory) 애플리케이션 프록시 애플리케이션을 나열합니다.
