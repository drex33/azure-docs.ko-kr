...
이 기능은 이제 지원 되는 [공용 클라우드](./migrate-support-matrix.md#supported-geographies-public-cloud) 및 [정부 클라우드 지역](./migrate-support-matrix.md#supported-geographies-azure-government) 에서 미리 보기로 제공 됩니다.
