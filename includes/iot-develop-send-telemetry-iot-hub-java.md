...
ms.openlocfilehash: 87b5d9ef14b28680ac6b4edc2dade4a601412ab5
ms.sourcegitcommit: 66b6e640e2a294a7fbbdb3309b4829df526d863d
ms.translationtype: HT
ms.contentlocale: ko-KR
ms.lasthandoff: 12/01/2021
ms.locfileid: "133358055"
---
...
1. 콘솔을 열어 Azure IoT Java 디바이스 SDK를 설치하고, 빌드하고, 코드 샘플을 실행합니다. 다음 단계에서 이 콘솔을 사용합니다.
    ...
    **Linux 및 Raspberry Pi OS**
    ...
    JAVA_HOME(`echo $JAVA_HOME`) 환경 변수가 설정되어 있는지 확인합니다. JAVA_HOME 설정에 대한 내용은 [Linux/Raspberry Pi 필수 조건](#linux-or-raspberry-pi-os)을 참조하세요.
