...
ms.subservice: pstn
ms.openlocfilehash: 84e57f2e966b3c9dd334b54b879fe71d64108975
ms.sourcegitcommit: 66b6e640e2a294a7fbbdb3309b4829df526d863d
ms.translationtype: MT
ms.contentlocale: ko-KR
ms.lasthandoff: 12/01/2021
ms.locfileid: "133386890"
---
# <a name="phone-number-types-in-azure-communication-services"></a>Azure Communication Services의 전화 번호 유형

> [!IMPORTANT]
> 전화 번호 가용성은 현재 미국(푸에르토리코 포함), 영국 및 아일랜드에 청구 주소가 있는 유료 Azure 구독으로 제한됩니다. 평가판 계정 또는 Azure 체험 크레딧을 사용하여 전화 번호를 얻을 수 없습니다. 자세한 내용은 이 문서의 [구독 자격](../numbers/sub-eligibility-number-capability.md) 섹션을 참조하세요.
...
- [전화 번호 받기](../../quickstarts/telephony/get-phone-number.md)
- [전화 걸기](../../quickstarts/voice-video-calling/getting-started-with-calling.md)
- [SMS 보내기](../../quickstarts/sms/send.md)
