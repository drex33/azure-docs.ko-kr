...
### <a name="bulk-mode-enabled"></a>대량 모드 사용 
[대량 모드 사용](https://devblogs.microsoft.com/cosmosdb/introducing-bulk-support-in-the-net-sdk/)을 설정하면 읽기 및 쓰기 작업이 최적의 네트워크 성능을 위해 최적화되고 전용 대량 API를 통해 백 엔드로 전송됩니다. 대량 모드를 사용하는 상태에서 읽기 작업을 수행하는 동안 401 오류가 발생하면 애플리케이션이 [읽기 전용 키](secure-access-to-data.md#primary-keys)를 사용하고 있음을 의미하는 경우가 많습니다.

#### <a name="solution"></a>솔루션
대량 모드를 사용하는 상태에서 작업을 수행할 때 읽기/쓰기 키 또는 쓰기 액세스 권한 부여 메커니즘을 사용합니다.
