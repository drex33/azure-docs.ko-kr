---
title: 공용 IP 주소 접두사 만들기 - PowerShell
...
ms.locfileid: "113667320"
---
# <a name="create-a-public-ip-address-prefix-using-powershell"></a>PowerShell을 사용하여 공용 IP 주소 접두사 만들기
...
이 섹션에서는 Azure PowerShell을 사용하여 영역 중복, 영역 및 비영역 공용 IP 접두사를 만듭니다. 
...
### <a name="non-zonal-ipv4-prefix"></a>비영역 IPv4 접두사
...
### <a name="non-zonal-ipv6-prefix"></a>비영역 IPv6 접두사
...
- [공용 IP 접두사](public-ip-address-prefix.md)를 사용하는 경우의 시나리오와 이점에 관해 알아봅니다.
