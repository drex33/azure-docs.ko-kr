...
|애플리케이션 관리|애플리케이션 TLS/SSL 인증서 추가|
...
|그룹 관리|그룹 구성원 대량 다운로드 - 시작됨|
|그룹 관리|그룹 구성원 대량 다운로드 - 완료됨|
|그룹 관리|그룹 구성원 대량 가져오기 - 시작됨|
|그룹 관리|그룹 구성원 대량 가져오기 - 완료됨|
|그룹 관리|그룹 구성원 대량 제거 - 시작됨|
|그룹 관리|그룹 구성원 대량 제거 - 완료됨|
|그룹 관리|그룹 대량 다운로드 - 시작됨|
|그룹 관리|그룹 대량 다운로드 - 완료됨|
...
|사용자 관리|추가됨|
|사용자 관리|대입|
|사용자 관리|사용자 대량 만들기 - 시작됨|
|사용자 관리|사용자 대량 만들기 - 완료됨|
|사용자 관리|사용자 대량 삭제 - 시작됨|
|사용자 관리|사용자 대량 삭제 - 완료됨|
|사용자 관리|사용자 대량 다운로드 - 시작됨|
|사용자 관리|사용자 대량 다운로드 - 완료됨|
|사용자 관리|삭제된 사용자 대량 복원 - 시작됨|
|사용자 관리|삭제된 사용자 대량 복원 - 완료됨|
|사용자 관리|사용자 대량 초대 - 시작됨|
|사용자 관리|사용자 대량 초대 - 완료됨|
...
|감사 범주|활동|
|---|---|
|권한 관리|권한 관리 역할 할당 추가|
|권한 관리|관리자가 패키지에 액세스하도록 사용자를 직접 할당|       
|권한 관리|관리자가 사용자 액세스 패키지 할당을 직접 제거|
|권한 관리|액세스 패키지 할당 요청 승인|
|권한 관리|사용자를 외부 스폰서로 할당|
|권한 관리|사용자를 내부 스폰서로 할당|
|권한 관리|액세스 패키지 할당 요청 자동 승인|
|권한 관리|액세스 패키지 할당 요청 취소|
|권한 관리|액세스 패키지 만들기|
|권한 관리|액세스 패키지 할당 정책 만들기|
|권한 관리|액세스 패키지 할당 사용자 업데이트 요청 만들기|   
|권한 관리|액세스 패키지 카탈로그 만들기|
|권한 관리|연결된 조직 만들기|  
|권한 관리|사용자 지정 작업 만들기|
|권한 관리|리소스 제거 요청 만들기|
|권한 관리|리소스 요청 만들기|
|권한 관리|액세스 패키지 삭제|
|권한 관리|액세스 패키지 할당 정책 삭제|
|권한 관리|액세스 패키지 카탈로그 삭제|
|권한 관리|연결된 조직 삭제|
|권한 관리|액세스 패키지 할당 요청 거부|
|권한 관리|권한 관리가 사용자에 대한 액세스 패키지 할당 요청 제거|
|권한 관리|사용자 지정 작업 실행|
|권한 관리|액세스 패키지 할당 확장|
|권한 관리|실패한 액세스 패키지 할당 요청|
|권한 관리|액세스 패키지 할당 요청 수행|
|권한 관리|액세스 패키지 리소스 할당 수행| 
|권한 관리|액세스 패키지 할당 요청을 부분적으로 수행|
|권한 관리|액세스 패키지 할당 요청을 수행할 준비가 완료됨|
|권한 관리|권한 관리 역할 할당 제거|
|권한 관리|액세스 패키지 리소스 할당 제거|
|권한 관리|사용자를 외부 스폰서로 제거|
|권한 관리|사용자를 내부 스폰서로 제거|
|권한 관리|향후 액세스 패키지 할당 예약|
|권한 관리|액세스 패키지 업데이트|
|권한 관리|액세스 패키지 할당 정책 업데이트|
|권한 관리|액세스 패키지 카탈로그 업데이트|
|권한 관리|액세스 패키지 카탈로그 리소스 업데이트|
|권한 관리|연결된 조직 업데이트|
|권한 관리|사용자 지정 작업 업데이트|
|권한 관리|사용자가 액세스 패키지 할당 요청|
|권한 관리|사용자가 서비스 사용자를 대신하여 액세스 패키지 할당 요청|
|권한 관리|사용자가 액세스 패키지 할당을 확장하도록 요청|
|권한 관리|사용자가 액세스 패키지 할당을 제거하도록 요청|
...
|---|---|
|사용자 초대|외부 사용자 삭제|
|사용자 초대|이메일이 전송되지 않음, 사용자 구독 취소됨|
|사용자 초대|이메일 구독됨|
|사용자 초대|이메일 구독 취소됨|
|사용자 초대|초대 메일|
|사용자 초대|외부 사용자 초대|
|사용자 초대|초대 재설정 상태를 사용하여 외부 사용자 초대|
|사용자 초대|B2B 협업에 내부 사용자 초대|
|사용자 초대|외부 사용자 초대 사용|
|사용자 초대|바이럴 테넌트 만들기|
|사용자 초대|바이럴 사용자 만들기|
