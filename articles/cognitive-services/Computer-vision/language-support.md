...
ms.date: 04/17/2019
ms.author: pafarley
ms.openlocfilehash: 39207cddaf2033f127534a83481b648844eb79ac
ms.sourcegitcommit: 611b35ce0f667913105ab82b23aab05a67e89fb7
ms.translationtype: MT
ms.contentlocale: ko-KR
ms.lasthandoff: 10/14/2021
ms.locfileid: "130002494"
---
...
> **언어 코드 선택 사항**
>
> OCR의 딥 러닝 기반 범용 모델 읽기는 혼합 언어가 있는 텍스트 줄을 포함하여 문서의 모든 다국어 텍스트를 추출하며 언어 코드를 지정할 필요가 없습니다. 언어에 대해 확신하고 서비스가 관련 모델만 적용하도록 강제 적용하려는 경우가 아니면 언어 코드를 매개 변수로 제공하지 마십시오. 그렇지 않으면 서비스가 불완전하고 잘못된 텍스트를 반환할 수 있습니다.
...
다음 표에서는 읽기에서 지원하는 필기 언어를 나열합니다.
...
다음 표에서는 OCR API에서 지원하는 인쇄 언어를 나열합니다.
