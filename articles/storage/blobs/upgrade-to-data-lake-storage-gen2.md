...
[Azure Data Lake Storage Gen2에서 제공 되는 Blob Storage 기능](./storage-feature-support-in-storage-accounts.md) 을 참조 하 여 Data Lake Storage Gen2에서 Blob 저장소 기능에 대 한 현재 지원을 이해 합니다. 
