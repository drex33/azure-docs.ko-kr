---
title: '빠른 시작: Azure Portal을 사용하여 Data Explorer 풀 만들기(미리 보기)'
description: 이 가이드의 단계에 따라 Azure Portal을 사용하여 새 Data Explorer 풀을 만듭니다.
ms.topic: quickstart
ms.date: 11/02/2021
author: shsagir
ms.author: shsagir
...
ms.openlocfilehash: 6f7e950a629c5d2d8a6cedba9e0eb745982be824
ms.sourcegitcommit: 56235f8694cc5f88db3afcc8c27ce769ecf455b0
ms.translationtype: HT
ms.contentlocale: ko-KR
ms.lasthandoff: 11/24/2021
ms.locfileid: "133071208"
---
...
이 문서에서는 Azure Portal을 사용하여 Synapse 작업 영역에서 Data Explorer 풀을 만드는 단계를 설명합니다.
...
1. Data Explorer 풀을 만들 Synapse 작업 영역에서 **새 Data Explorer 풀** 을 선택합니다.

    ![개요 섹션이 강조 표시된 Azure Portal 홈페이지.](media/create-data-explorer-pool-portal/goto-data-explorer-pool-portal.png)
...
1. **기본 사항** 탭에서 다음 정보를 입력합니다.
    ...
    ![Azure Portal 새 Data Explorer 풀 기본 사항](media/create-data-explorer-pool-portal/create-data-explorer-pool-basics-portal.png)
...
1. **다음: 추가 설정** 을 선택합니다. 다음 설정을 사용하고 나머지 설정은 기본값 그대로 둡니다.
    ...
    | 설정 | 제안 값 | 설명 |
    |--|--|--|
    | 크기 조정 | 수동 크기 조정 | 이 빠른 시작에 자동 크기 조정이 필요하지 않습니다. |
    | 개수 | 2 | 이 빠른 시작에서는 비용을 줄이기 위해 이 값을 가장 작은 크기로 설정합니다. |

    ![Azure Portal 새 Data Explorer 풀 고급 설정](media/create-data-explorer-pool-portal/create-data-explorer-pool-advanced-settings-portal.png)
...
1. 세부 정보가 올바른지 확인한 다음 **만들기** 를 선택합니다.
    ...
    ![Azure Portal 새 Data Explorer 풀 만들기](media/create-data-explorer-pool-portal/create-data-explorer-pool-portal.png)

1. 프로비전이 완료되면 작업 영역 **개요** 페이지로 돌아가 새 Data Explorer 풀 시작 페이지가 표시되는지 확인합니다.

    ![Azure Portal 새 Data Explorer 풀 목록](media/create-data-explorer-pool-portal/verify-data-explorer-pool-portal.png)

## <a name="clean-up-data-explorer-pool-resources-using-the-azure-portal"></a>Azure Portal을 사용하여 Data Explorer 풀 리소스 정리

Azure Portal을 사용하여 작업 영역에서 Data Explorer 풀을 삭제하려면 다음 단계를 사용합니다.
...
1. Data Explorer 풀(이 경우 **contosodataexplorer**)을 제거하려면 **자세히[...]**  > **삭제** 를 선택합니다.
    ...
    ![최근에 만든 풀이 선택된 Data Explorer 풀 목록.](media/create-data-explorer-pool-portal/create-data-explorer-pool-portal.png)

1. 삭제를 확인하려면 삭제할 풀의 이름을 입력하고 **삭제** 를 선택합니다.

    ![최근에 만든 풀의 삭제를 확인합니다.](media/create-data-explorer-pool-portal/confirm-deletion-data-explorer-pool-portal.png)
