...
탄력적 풀의 각 읽기 전용 복제본에는 vCore, 메모리, 데이터 IOPS, TempDB, 작업자, 세션과 같은 자체 리소스가 있습니다. 탄력적 풀의 각 읽기 전용 복제본에는 이 문서의 뒷부분에서 설명하는 리소스 한도가 적용됩니다.
...
|최대 로그 크기 <sup>2</sup>|154|227|461|461|461|614|
...
|풀당 최대 데이터 IOPS <sup>3</sup> |400|800|1200|1600|2000|2400|
|풀당 최대 로그 속도(MBps)|6|12|18|24|30|36|
|풀당 최대 동시 작업자(요청) <sup>4</sup> |210|420|630|840|1050|1260|
|풀당 최대 동시 로그인 수 <sup>4</sup> |210|420|630|840|1050|1260|
...
<sup>4</sup> 개별 데이터베이스의 최대 동시 작업자(요청)는 [단일 데이터베이스 리소스 한도](resource-limits-vcore-single-databases.md)를 참조하세요. 예를 들어, 탄력적 풀이 Gen5를 사용 중이고 데이터베이스당 최대 vCore가 2로 설정된 경우 최대 동시 작업자 값은 200입니다.  데이터베이스당 최대 vCore가 0.5로 설정된 경우 Gen5에는 vCore당 최대 100개의 동시 작업자가 있으므로 최대 동시 작업자 값은 50입니다. vCore 수가 1개 이하인 다른 데이터베이스당 최대 vCore 설정의 경우 최대 동시 작업자 수가 유사하게 크기 조정됩니다.
...
|최대 로그 크기(GB) <sup>2</sup>|614|614|614|614|1075|1,229|
|TempDB 최대 데이터 크기(GB)|224|256|288|320|512|768|
|스토리지 유형|프리미엄(원격) 스토리지|프리미엄(원격) 스토리지|프리미엄(원격) 스토리지|프리미엄(원격) 스토리지|프리미엄(원격) 스토리지|프리미엄(원격) 스토리지|
|IO 대기 시간(근사치)|5-7ms(쓰기)<br>5-10ms(읽기)|5-7ms(쓰기)<br>5-10ms(읽기)|5-7ms(쓰기)<br>5-10ms(읽기)|5-7ms(쓰기)<br>5-10ms(읽기)|5-7ms(쓰기)<br>5-10ms(읽기)|5-7ms(쓰기)<br>5-10ms(읽기)|
|풀당 최대 데이터 IOPS <sup>3</sup>|2800|3200|3600|4000|6400|9600|
|풀당 최대 로그 속도(MBps)|42|48|54|60|62.5|62.5|
|풀당 최대 동시 작업자(요청) <sup>4</sup>|1470|1,680|1890|2100|3,360|5040|
|최대 동시 로그인 풀(요청) <sup>4</sup>|1470|1,680|1890|2100|3,360|5040|
|최대 동시 세션|30,000|30,000|30,000|30,000|30,000|30,000|
...
|최대 로그 크기(GB) <sup>2</sup>|154|227|461|461|461|614|614|
...
|풀당 최대 데이터 IOPS <sup>3</sup>|800|1600|2400|3200|4000|4800|5600|
|풀당 최대 로그 속도(MBps)|12|24|36|48|60|62.5|62.5|
|풀당 최대 동시 작업자(요청) <sup>4</sup>|210|420|630|840|1050|1260|1470|
|풀당 최대 동시 로그인(요청) 수 <sup>4</sup>|210|420|630|840|1050|1260|1470|
...
|최대 로그 크기(GB) <sup>2</sup>|614|922|922|922|1,229|1,229|1,229|
|TempDB 최대 데이터 크기(GB)|512|576|640|768|1024|1280|2560|
|스토리지 유형|프리미엄(원격) 스토리지|프리미엄(원격) 스토리지|프리미엄(원격) 스토리지|프리미엄(원격) 스토리지|프리미엄(원격) 스토리지|프리미엄(원격) 스토리지|프리미엄(원격) 스토리지|
|IO 대기 시간(근사치)|5-7ms(쓰기)<br>5-10ms(읽기)|5-7ms(쓰기)<br>5-10ms(읽기)|5-7ms(쓰기)<br>5-10ms(읽기)|5-7ms(쓰기)<br>5-10ms(읽기)|5-7ms(쓰기)<br>5-10ms(읽기)|5-7ms(쓰기)<br>5-10ms(읽기)|5-7ms(쓰기)<br>5-10ms(읽기)|
|풀당 최대 데이터 IOPS <sup>3</sup> |6,400|7,200|8,000|9,600|12,800|16,000|16,000|
|풀당 최대 로그 속도(MBps)|62.5|62.5|62.5|62.5|62.5|62.5|62.5|
|풀당 최대 동시 작업자(요청) <sup>4</sup>|1,680|1890|2100|2520|3,360|4200|8400|
|풀당 최대 동시 로그인(요청) 수 <sup>4</sup>|1,680|1890|2100|2520|3,360|4200|8400|
|최대 동시 세션|30,000|30,000|30,000|30,000|30,000|30,000|30,000|
...
|최대 로그 크기(GB) <sup>2</sup>|336|336|336|336|512|
...
|풀당 최대 데이터 IOPS <sup>3</sup>|2560|3200|3840|4480|5120|
|풀당 최대 로그 속도(MBps)|48|60|62.5|62.5|62.5|
|풀당 최대 동시 작업자(요청) <sup>4</sup>|400|500|600|700|800|
|풀당 최대 동시 로그인(요청) 수 <sup>4</sup>|800|1000|1200|1400|1600|
...
|최대 로그 크기(GB) <sup>2</sup>|512|512|512|1024|1024|1024|
|TempDB 최대 데이터 크기(GB)|83|93|111|148|167|333|
|스토리지 유형|원격 SSD|원격 SSD|원격 SSD|원격 SSD|원격 SSD|원격 SSD|
|IO 대기 시간(근사치)|5-7ms(쓰기)<br>5-10ms(읽기)|5-7ms(쓰기)<br>5-10ms(읽기)|5-7ms(쓰기)<br>5-10ms(읽기)|5-7ms(쓰기)<br>5-10ms(읽기)|5-7ms(쓰기)<br>5-10ms(읽기)|5-7ms(쓰기)<br>5-10ms(읽기)|
|풀당 최대 데이터 IOPS <sup>3</sup>|5760|6400|7680|10240|11520|12800|
|풀당 최대 로그 속도(MBps)|62.5|62.5|62.5|62.5|62.5|62.5|
|풀당 최대 동시 작업자(요청) <sup>4</sup>|900|1000|1200|1600|1800|3600|
|풀당 최대 동시 로그인(요청) 수 <sup>4</sup>|1800|2000|2400|3200|3600|7200|
|최대 동시 세션|30,000|30,000|30,000|30,000|30,000|30,000|
...
|최대 로그 크기(GB) <sup>2</sup>|227|461|614|614|
...
|풀당 최대 데이터 IOPS <sup>3</sup>|800|1600|2400|3200|
|풀당 최대 로그 속도(MBps)|12|24|36|48|
|풀당 최대 동시 작업자(요청) <sup>4</sup>|168|336|504|672|
|풀당 최대 동시 로그인(요청) 수 <sup>4</sup>|168|336|504|672|
...
|최대 로그 크기(GB) <sup>2</sup>|307|307|307|307|307|
...
|풀당 최대 데이터 IOPS <sup>3</sup>|9,000|13,500|18,000|22,500|27,000|
|풀당 최대 로그 속도(MBps)|20|30|40|50|60|
|풀당 최대 동시 작업자(요청) <sup>4</sup>|420|630|840|1050|1260|
|풀당 최대 동시 로그인(요청) 수 <sup>4</sup>|420|630|840|1050|1260|
|최대 동시 세션|30,000|30,000|30,000|30,000|30,000|
...
|최대 로그 크기(GB) <sup>2</sup>|307|307|307|307|307|307|
|TempDB 최대 데이터 크기(GB)|224|256|288|320|512|768|
...
|풀당 최대 데이터 IOPS <sup>3</sup>|31,500|36,000|40,500|45,000|72,000|96,000|
|풀당 최대 로그 속도(MBps)|70|80|80|80|80|80|
|풀당 최대 동시 작업자(요청) <sup>4</sup>|1470|1,680|1890|2100|3,360|5040|
|풀당 최대 동시 로그인(요청) 수 <sup>4</sup>|1470|1,680|1890|2100|3,360|5040|
|최대 동시 세션|30,000|30,000|30,000|30,000|30,000|30,000|
|데이터베이스별로 최소/최대 탄력적 풀 vcore 선택|0, 0.25, 0.5, 1...7|0, 0.25, 0.5, 1...8|0, 0.25, 0.5, 1...9|0, 0.25, 0.5, 1...10|0, 0.25, 0.5, 1...10, 16|0, 0.25, 0.5, 1...10, 16, 24|
|복제본 수|4|4|4|4|4|4|
|다중 AZ|예|예|예|예|예|예|
...
|최대 로그 크기(GB) <sup>2</sup>|307|307|461|461|922|922|
...
|스토리지 유형|로컬 SSD|로컬 SSD|로컬 SSD|로컬 SSD|로컬 SSD|로컬 SSD|
|IO 대기 시간(근사치)|1-2ms(쓰기)<br>1-2ms(읽기)|1-2ms(쓰기)<br>1-2ms(읽기)|1-2ms(쓰기)<br>1-2ms(읽기)|1-2ms(쓰기)<br>1-2ms(읽기)|1-2ms(쓰기)<br>1-2ms(읽기)|1-2ms(쓰기)<br>1-2ms(읽기)|
|풀당 최대 데이터 IOPS <sup>3</sup>|18,000|27,000|36,000|45,000|54,000|63,000|
|풀당 최대 로그 속도(MBps)|60|90|120|120|120|120|
|풀당 최대 동시 작업자(요청) <sup>4</sup>|420|630|840|1050|1260|1470|
|풀당 최대 동시 로그인(요청) 수 <sup>4</sup>|420|630|840|1050|1260|1470|
|최대 동시 세션|30,000|30,000|30,000|30,000|30,000|30,000|
...
|최대 로그 크기(GB) <sup>2</sup>|922|922|922|1,229|1,229|1,229|1,229|
|TempDB 최대 데이터 크기(GB)|512|576|640|768|1024|1280|2560|
...
|풀당 최대 데이터 IOPS <sup>3</sup>|72,000|81,000|90,000|108,000|144,000|180,000|256,000|
...
|스토리지 유형|로컬 SSD|로컬 SSD|로컬 SSD|로컬 SSD|로컬 SSD|로컬 SSD|
|IO 대기 시간(근사치)|1-2ms(쓰기)<br>1-2ms(읽기)|1-2ms(쓰기)<br>1-2ms(읽기)|1-2ms(쓰기)<br>1-2ms(읽기)|1-2ms(쓰기)<br>1-2ms(읽기)|1-2ms(쓰기)<br>1-2ms(읽기)|1-2ms(쓰기)<br>1-2ms(읽기)|
|풀당 최대 데이터 IOPS <sup>3</sup>|12,499|15,624|18,748|21,873|24,998|28,123|
|풀당 최대 로그 속도(MBps)|48|60|72|84|96|108|
|풀당 최대 동시 작업자(요청) <sup>4</sup>|800|1,000|1,200|1,400|1,600|1,800|
|풀당 최대 동시 로그인(요청) 수 <sup>4</sup>|800|1,000|1,200|1,400|1,600|1,800|
...
|최대 로그 크기(GB) <sup>2</sup>|427|512|683|1024|1024|
...
|스토리지 유형|로컬 SSD|로컬 SSD|로컬 SSD|로컬 SSD|로컬 SSD|
|IO 대기 시간(근사치)|1-2ms(쓰기)<br>1-2ms(읽기)|1-2ms(쓰기)<br>1-2ms(읽기)|1-2ms(쓰기)<br>1-2ms(읽기)|1-2ms(쓰기)<br>1-2ms(읽기)|1-2ms(쓰기)<br>1-2ms(읽기)|
|풀당 최대 데이터 IOPS <sup>3</sup>|31,248|37,497|49,996|99,993|160,000|
|풀당 최대 로그 속도(MBps)|120|144|192|264|264|
|풀당 최대 동시 작업자(요청) <sup>4</sup>|2,000|2,400|3,200|6,400|12,800|
|풀당 최대 동시 로그인(요청) 수 <sup>4</sup>|2,000|2,400|3,200|6,400|12,800|
...
|최대 로그 크기(GB) <sup>2</sup>|230|230|230|230|
|TempDB 최대 데이터 크기(GB)|64|128|192|256|
...
|풀당 최대 데이터 IOPS <sup>3</sup>|15750|31500|47250|56000|
