...
| ![logo-Adobe ID 관리](./media/tutorial-list/active-directory-saas-adobe-identity-management-tutorial.png)| [Adobe ID 관리](adobe-identity-management-tutorial.md)|
...
| ![logo-Kendis - Azure AD 통합](./media/tutorial-list/active-directory-saas-kendis-azure-ad-integration.png)| [Kendis - Azure AD Integration](kendis-scaling-agile-platform-tutorial.md)|
