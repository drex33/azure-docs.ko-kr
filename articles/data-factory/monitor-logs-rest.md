---
title: Azure Monitor REST API를 통해 진단 로그를 설정 합니다.
...
ms.locfileid: "124838771"
---
# <a name="setup-diagnostic-logs-via-the-azure-monitor-rest-api"></a>Azure Monitor REST API를 통해 진단 로그를 설정 합니다.
