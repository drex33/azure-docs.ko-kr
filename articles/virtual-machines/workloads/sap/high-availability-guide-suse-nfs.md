...
1. **[A]** drbd 분할 브레인(split-brain) 검색 설정
   ...
   분할 브레인(split-brain) 시나리오에서 자동으로 복구할 수도 있습니다. 자세한 내용은 [분할 브레인(split-brain) 자동 복구 정책](https://www.linbit.com/drbd-user-guide/users-guide-drbd-8-4/#s-automatic-split-brain-recovery-configuration)을 참조하세요.
