...
ms.locfileid: "128648984"
---
# <a name="azure-files-api-reference"></a>Azure Files API 참조
...
### <a name="storage-management-net-apis"></a>스토리지 관리 .NET APIs
...
다음 표에는 Azure Files C++ API에 대한 참조 및 샘플 설명서가 나와 있습니다.

|  버전  | 참조 설명서 | 소스 코드/추가 정보 | 빠른 시작 |
| :-------: | ----------------------- | ------- | ---------- |
| 12.x | [C++ API용 Azure SDK](https://azure.github.io/azure-sdk-for-cpp/index.html) | [라이브러리 소스 코드](https://github.com/Azure/azure-sdk-for-cpp/tree/main/sdk/storage) | [C++를 사용하여 Azure Files 개발](./storage-c-plus-plus-how-to-use-files.md) |
