...
ms.openlocfilehash: f5398975cba2ef177c7a38dc54fd545fa9970ac8
ms.sourcegitcommit: 1244a72dbec39ac8cf16bb1799d8c46bde749d47
ms.translationtype: MT
ms.contentlocale: ko-KR
ms.lasthandoff: 11/18/2021
ms.locfileid: "132761951"
---
...
Microsoft 센티널에서 microsoft 센티널에 수집 하는 로그와 microsoft에서 생성 한 위협 인텔리전스 데이터를 일치 시킬 수 있도록 기본 제공 **Microsoft 위협 인텔리전스 일치 분석** 분석 규칙 템플릿을 사용 하 여 [규칙을 만듭니다](detect-threats-built-in.md#use-built-in-analytics-rules) .
...
1. Microsoft에서 **Microsoft 위협 인텔리전스 일치 분석** 규칙을 사용 하도록 설정한 microsoft 센티널 작업 영역에서 **인시던트** 를 선택 하 고 **microsoft 위협 인텔리전스 분석** 을 검색 합니다.
...
목적에 따라 작성 된 Microsoft 센티널 통합 문서를 사용 하 여 Microsoft 센티널에서 위협 인텔리전스에 대 한 주요 정보를 시각화할 수 있으며, 비즈니스 요구에 따라 통합 문서를 쉽게 사용자 지정할 수 있습니다.

Microsoft 센티널에 제공 된 위협 인텔리전스 통합 문서를 찾는 방법 및 통합 문서를 편집 하 여 사용자 지정 하는 방법의 예는 다음과 같습니다.

1. [Azure Portal](https://portal.azure.com/)에서 **Microsoft 센티널** 서비스로 이동 합니다.

1. 위협 인텔리전스 데이터 커넥터를 사용하여 위협 지표를 가져온 **작업 영역** 을 선택합니다.

1. Microsoft 센티널 메뉴의 **위협 관리** 섹션에서 **통합 문서** 를 선택 합니다.
...
통합 문서는 Microsoft 센티널의 모든 측면에 대 한 정보를 제공 하는 강력한 대화형 대시보드를 제공 합니다. 통합 문서를 사용하면 많은 작업을 수행할 수 있으며, 제공된 템플릿이 좋은 출발점이지만, 이러한 템플릿을 사용자 지정하거나, 다양한 데이터 원본을 결합하는 새로운 대시보드를 만들어 데이터를 고유한 방식으로 시각화할 수 있습니다. Microsoft 센티널 통합 문서는 Azure Monitor 통합 문서를 기반으로 하기 때문에 이미 광범위 한 설명서를 사용할 수 있으며 더 많은 템플릿이 있습니다. [Azure Monitor 통합 문서를 사용하여 대화형 보고서를 만드는](../azure-monitor/visualize/workbooks-overview.md) 방법에 대한 이 문서에서 시작하는 것이 좋습니다. 

더 많은 템플릿을 다운로드 하 고 사용자 고유의 템플릿을 제공할 수 있는 [GitHub에서 Azure Monitor 통합 문서](https://github.com/microsoft/Application-Insights-Workbooks) 에 대 한 풍부한 커뮤니티도 있습니다.

## <a name="next-steps"></a>다음 단계

이 문서에서는 Microsoft 센티널 전체에서 위협 인텔리전스 표시기를 사용할 수 있는 모든 방법을 배웠습니다. Microsoft 센티널의 위협 인텔리전스에 대 한 자세한 내용은 다음 문서를 참조 하세요.
- [Microsoft 센티널의 위협 인텔리전스를 이해](understand-threat-intelligence.md)합니다.
- Microsoft 센티널을 [Stix/TAXII 위협 인텔리전스 피드에](./connect-threat-intelligence-taxii.md)커넥트 합니다.
- Microsoft 센티널에 [위협 인텔리전스 플랫폼을 커넥트](./connect-threat-intelligence-tip.md) 합니다.
- Microsoft 센티널과 쉽게 통합 될 수 있는 [TIP platform, TAXII 피드 및 강화](threat-intelligence-integration.md) 를 참조 하세요.
