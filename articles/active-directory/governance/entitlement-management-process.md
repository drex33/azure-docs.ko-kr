...
이메일에는 링크 승인자가 클릭하여 액세스 요청을 승인하거나 거부할 수 있는 내 액세스로 이동하는 링크가 포함되어 있습니다. 다음은 액세스 요청을 완료하기 위해 승인자에게 전송되는 샘플 메일 알림입니다.
...
### <a name="multi-stage-approval-access-request-emails"></a>다단계 승인 액세스 요청 이메일
