...
`az vmss create`을 사용하여 새 가상 머신 확장 집합을 만들고 `capacity-reservation-group` 속성을 추가하여 확장 집합을 기존 용량 예약 그룹에 연결합니다. 아래 예에서는 미국 동부 위치에서 Standard_Ds1_v2 VM에 대한 균일한 확장 집합을 만들고 확장 집합을 용량 예약 그룹에 연결합니다.
